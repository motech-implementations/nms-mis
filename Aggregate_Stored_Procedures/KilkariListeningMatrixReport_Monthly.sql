...
SET dt = (select cast(last_etl_time as datetime) from ETL_info_table where table_id = 86);

SET currentMonth = (select cast(CONCAT(YEAR(CURDATE()), '-',  MONTH(CURDATE()), '-01 00:00:00') as datetime));

WHILE dt < currentMonth DO

truncate table agg_kilkari_listening_matrix_temp;

insert into agg_kilkari_listening_matrix_temp (state_id, district_id, healthBlock_id, date, calls_listened_percentage, contentListened_morethan75, contentListened_50_75, contentListened_25_50, contentListened_lessthan25)
...
insert into agg_kilkari_listening_matrix (location_type, location_id, date, calls_listened_percentage, contentListened_morethan75, contentListened_50_75, contentListened_25_50, contentListened_lessthan25)
select 'NATIONAL' as location_type, '0' as location_id, date as date, calls_listened_percentage, SUM(contentListened_morethan75), SUM(contentListened_50_75), SUM(contentListened_25_50), SUM(contentListened_lessthan25) from agg_kilkari_listening_matrix_temp group by calls_listened_percentage

UNION ALL
select 'STATE' as location_type, state_id as location_id, date as date, calls_listened_percentage, SUM(contentListened_morethan75), SUM(contentListened_50_75), SUM(contentListened_25_50), SUM(contentListened_lessthan25) from agg_kilkari_listening_matrix_temp group by state_id, calls_listened_percentage

UNION ALL
select 'DISTRICT' as location_type, district_id as location_id, date as date, calls_listened_percentage, SUM(contentListened_morethan75), SUM(contentListened_50_75), SUM(contentListened_25_50), SUM(contentListened_lessthan25) from agg_kilkari_listening_matrix_temp group by district_id, calls_listened_percentage

UNION ALL
select 'BLOCK' as location_type, healthBlock_id as location_id, date as date, calls_listened_percentage, SUM(contentListened_morethan75), SUM(contentListened_50_75), SUM(contentListened_25_50), SUM(contentListened_lessthan25) from agg_kilkari_listening_matrix_temp group by healthBlock_id, calls_listened_percentage;

SET dt = DATE_ADD(dt, INTERVAL 1 MONTH);
update ETL_info_table set last_etl_time = dt where table_id = 86;
