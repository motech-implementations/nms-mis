CREATE DEFINER=`etluser`@`%` PROCEDURE `KilkariListeningMatrixReportYear`()
BEGIN
DECLARE dt DATETIME;
...
update ETL_info_table set last_etl_time = dt where table_id = 90;
