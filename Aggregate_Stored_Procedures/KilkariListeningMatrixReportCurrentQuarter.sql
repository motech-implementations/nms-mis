...
DELETE from agg_kilkari_listening_matrix where period_type = 'CURRENT QUARTER';
...
update ETL_info_table set last_etl_time = currdate where table_id = 89;
