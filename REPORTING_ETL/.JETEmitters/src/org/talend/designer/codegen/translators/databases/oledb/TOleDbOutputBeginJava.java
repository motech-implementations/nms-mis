...
public class TOleDbOutputBeginJava {
  ...
  protected final String TEXT_46 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_47 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_48 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_49 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_50 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_51 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_52 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_53 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_54 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_55 = " = false;";
  protected final String TEXT_56 = NL;
  protected final String TEXT_57 = NL + "        int updateKeyCount_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_60 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_61 = NL + "        int deleteKeyCount_";
  protected final String TEXT_62 = " = ";
  protected final String TEXT_63 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_64 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_65 = " ";
  protected final String TEXT_66 = NL + "org.talend.net.Object conn_";
  protected final String TEXT_67 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_68 = ",";
  protected final String TEXT_69 = ",new java.lang.Object[]{";
  protected final String TEXT_70 = "});";
  protected final String TEXT_71 = NL;
  protected final String TEXT_72 = NL + "conn_";
  protected final String TEXT_73 = ".invokeGeneric(\"Open\");";
  protected final String TEXT_74 = NL + NL + NL;
  protected final String TEXT_75 = NL + "    org.talend.net.Object delCmd_";
  protected final String TEXT_76 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_77 = "," + NL + "    \t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\"DELETE FROM \"+";
  protected final String TEXT_78 = "," + NL + "    \tconn_";
  protected final String TEXT_79 = NL + "    \t});";
  protected final String TEXT_80 = NL + "   \tdeletedCount_";
  protected final String TEXT_81 = " = deletedCount_";
  protected final String TEXT_82 = " + (Integer)delCmd_";
  protected final String TEXT_83 = ".invokeGeneric(\"ExecuteNonQuery\");" + NL + "    ";
  ...
  protected final String TEXT_88 = ")\";" + NL + "            org.talend.net.Object cmd_";
  ...
  protected final String TEXT_93 = NL + "\t    String update_";
  protected final String TEXT_94 = " = \"UPDATE \" + ";
  protected final String TEXT_95 = " + \" SET ";
  protected final String TEXT_96 = " WHERE ";
  protected final String TEXT_97 = "\";" + NL + "\t    org.talend.net.Object cmd_";
  protected final String TEXT_98 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_99 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tupdate_";
  protected final String TEXT_100 = "," + NL + "    \t\tconn_";
  protected final String TEXT_101 = NL + "    \t});" + NL + "\t    ";
  protected final String TEXT_102 = NL + "\t    org.talend.net.Object cmd_";
  protected final String TEXT_103 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_104 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\t\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_105 = " + \" WHERE ";
  protected final String TEXT_106 = "\"," + NL + "    \t\tconn_";
  protected final String TEXT_107 = NL + "    \t});" + NL + "\t    String insert_";
  protected final String TEXT_108 = " = \"INSERT INTO \" + ";
  protected final String TEXT_109 = " + \" (";
  protected final String TEXT_110 = ") VALUES (";
  protected final String TEXT_111 = ")\";" + NL + "\t    org.talend.net.Object cmdInsert_";
  protected final String TEXT_112 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_113 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tinsert_";
  protected final String TEXT_114 = "," + NL + "    \t\tconn_";
  protected final String TEXT_115 = NL + "    \t});" + NL + "\t    String update_";
  protected final String TEXT_116 = " = \"UPDATE \" + ";
  protected final String TEXT_117 = " + \" SET ";
  protected final String TEXT_118 = " WHERE ";
  protected final String TEXT_119 = "\";" + NL + "\t    org.talend.net.Object cmdUpdate_";
  protected final String TEXT_120 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_121 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tupdate_";
  ...
  protected final String TEXT_128 = "\";" + NL + "\t    org.talend.net.Object cmdUpdate_";
  protected final String TEXT_129 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_130 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tupdate_";
  protected final String TEXT_131 = "," + NL + "    \t\tconn_";
  protected final String TEXT_132 = NL + "    \t});" + NL + "\t    String insert_";
  protected final String TEXT_133 = " = \"INSERT INTO \" + ";
  protected final String TEXT_134 = " + \" (";
  protected final String TEXT_135 = ") VALUES (";
  protected final String TEXT_136 = ")\";" + NL + "\t    org.talend.net.Object cmdInsert_";
  protected final String TEXT_137 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_138 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tinsert_";
  protected final String TEXT_139 = "," + NL + "    \t\tconn_";
  protected final String TEXT_140 = NL + "    \t});\t\t" + NL + "\t    ";
  protected final String TEXT_141 = NL + "\t    String delete_";
  protected final String TEXT_142 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_143 = " + \" WHERE ";
  protected final String TEXT_144 = "\";" + NL + "\t    org.talend.net.Object cmd_";
  protected final String TEXT_145 = " = org.talend.net.Object.createInstance(";
  protected final String TEXT_146 = "," + NL + "    \t\t\"System.Data.OleDb.OleDbCommand\",new java.lang.Object[] {" + NL + "    \t\tdelete_";
  ...
  protected final String TEXT_179 = NL + "\t    int commitEvery_";
  protected final String TEXT_180 = " = ";
  protected final String TEXT_181 = ";" + NL + "\t    int commitCounter_";
