...
public class TImpalaOutputBeginJava {
  ...
  protected final String TEXT_166 = NL + "\tString tableName_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "\tint nb_line_";
  protected final String TEXT_169 = " = 0;";
  protected final String TEXT_170 = NL + "    String insertPrefix_";
  protected final String TEXT_171 = " = \"INSERT ";
  protected final String TEXT_172 = " \" + tableName_";
  protected final String TEXT_173 = " + \" (";
  protected final String TEXT_174 = ") VALUES \";\t\t" + NL + "\tjava.lang.StringBuilder sbValue_";
  protected final String TEXT_175 = " = null;" + NL + "    java.sql.Statement stmt_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".createStatement();" + NL + "    int rowCount";
  protected final String TEXT_178 = " = 0;" + NL + "    boolean needInitialization_";
  protected final String TEXT_179 = " = true;" + NL + "\t ";
