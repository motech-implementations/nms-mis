...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_1088 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t" + NL + "                \t";
  protected final String TEXT_1089 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1090 = NL + "                \tString errormessage_";
  protected final String TEXT_1091 = " = printSQLException_";
  protected final String TEXT_1092 = ".getSQLException(e,false);" + NL + "                \tint countSum_";
  protected final String TEXT_1093 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1094 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1095 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "    \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1096 = " += 1;" + NL + "    \t\t\t\t\t}else{" + NL + "    \t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1109 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1110 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1111 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1112 = " <= commitCounter_";
  protected final String TEXT_1113 = ") {";
  protected final String TEXT_1114 = NL + "                if ((batchSize_";
  protected final String TEXT_1115 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1116 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1117 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1118 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1119 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1120 = ": pstmt_";
  protected final String TEXT_1121 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1122 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1123 = " += 1;" + NL + "        \t\t\t\t\t}else{" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1124 = " += (countEach_";
  protected final String TEXT_1125 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1126 = ");" + NL + "        \t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1127 = NL + "            \t    \t";
  protected final String TEXT_1128 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1129 = " += countSum_";
  protected final String TEXT_1130 = ";" + NL + "            \t    \t";
  protected final String TEXT_1131 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1132 = " += countSum_";
  protected final String TEXT_1133 = ";" + NL + "            \t    \t";
  protected final String TEXT_1134 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1135 = " += countSum_";
  protected final String TEXT_1136 = ";" + NL + "            \t    \t";
  protected final String TEXT_1137 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t" + NL + "                \t";
  protected final String TEXT_1138 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1139 = NL + "                \t\tString errormessage_";
  protected final String TEXT_1140 = " = printSQLException_";
  protected final String TEXT_1141 = ".getSQLException(e,false);" + NL + "                \t\tint countSum_";
  protected final String TEXT_1142 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1143 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1144 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1145 = " += 1;" + NL + "        \t\t\t\t\t}else{" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1146 = " += (countEach_";
  protected final String TEXT_1147 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1148 = ");" + NL + "        \t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1149 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1150 = " += countSum_";
  ...
  protected final String TEXT_1158 = NL + "                }" + NL + "                }";
  protected final String TEXT_1159 = NL + "                \t";
  protected final String TEXT_1160 = NL + "                \tconn_";
  protected final String TEXT_1161 = ".commit();" + NL + "                \t";
  protected final String TEXT_1162 = NL + "                \tcommitCounter_";
  protected final String TEXT_1163 = "=0;" + NL + "                }";
