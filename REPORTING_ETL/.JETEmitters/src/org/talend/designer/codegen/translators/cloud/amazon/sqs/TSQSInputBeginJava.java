...
public class TSQSInputBeginJava
{
  ...
  protected final String TEXT_75 = NL + "\t" + NL + "\tint nbline_";
  protected final String TEXT_76 = " = 0;" + NL + "\t" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_77 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_78 = " - Receiving messages from :\" + ";
  protected final String TEXT_79 = ");" + NL + "\t\t";
  protected final String TEXT_80 = NL + "\t\tcom.amazonaws.services.sqs.model.ReceiveMessageRequest ";
  protected final String TEXT_81 = "_receiveMessageRequest = new com.amazonaws.services.sqs.model.ReceiveMessageRequest(";
  protected final String TEXT_82 = ")" + NL + "\t\t";
  protected final String TEXT_83 = ".withVisibilityTimeout(";
  protected final String TEXT_84 = ")";
  protected final String TEXT_85 = NL + "\t\t";
  protected final String TEXT_86 = ".withWaitTimeSeconds(";
  protected final String TEXT_87 = ")";
  protected final String TEXT_88 = NL + "\t\t";
  protected final String TEXT_89 = ".withAttributeNames(\"All\")";
  protected final String TEXT_90 = NL + "\t\t";
  protected final String TEXT_91 = ".withMessageAttributeNames(\"All\")";
  protected final String TEXT_92 = ".withMaxNumberOfMessages(10);" + NL + "\t\t" + NL + "\t\tList<com.amazonaws.services.sqs.model.Message> ";
  protected final String TEXT_93 = "_messages = null;" + NL + "\t\tboolean isContinueReceive_";
  protected final String TEXT_94 = " = true;" + NL + "\t\twhile (isContinueReceive_";
  protected final String TEXT_95 = ") {" + NL + "\t\t\t";
  protected final String TEXT_96 = "_messages = conn_";
  protected final String TEXT_97 = ".receiveMessage(";
  protected final String TEXT_98 = "_receiveMessageRequest).getMessages();" + NL + " \t\t\tfor (com.amazonaws.services.sqs.model.Message ";
  protected final String TEXT_99 = "_message : ";
  protected final String TEXT_100 = "_messages) {" + NL + " \t\t\t\tnbline_";
