...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_65 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_66 = " = false;" + NL;
  protected final String TEXT_67 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_68 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_69 = "\");";
  protected final String TEXT_70 = NL + NL + "\tjava.sql.Connection connection_";
  ...
  protected final String TEXT_79 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconnection_";
