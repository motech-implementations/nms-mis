...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_49 = NL + "        /* initialize feature count */" + NL + "        int nbFeature_";
  protected final String TEXT_50 = " = 0;" + NL + "" + NL + "        java.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();";
  ...
  protected final String TEXT_56 = " < 1) {" + NL + "                throw new RuntimeException(\"For update, the schema must have a key\");" + NL + "            }";
  protected final String TEXT_57 = NL + "            int deleteKeyCount_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "            if(deleteKeyCount_";
  protected final String TEXT_60 = " < 1) {" + NL + "                throw new RuntimeException(\"For delete, the schema must have a key\");" + NL + "            }";
  protected final String TEXT_61 = NL + "    int nb_line_";
  protected final String TEXT_62 = " = 0;" + NL + "    int nb_line_update_";
  protected final String TEXT_63 = " = 0;" + NL + "    int nb_line_inserted_";
  protected final String TEXT_64 = " = 0;" + NL + "    int nb_line_deleted_";
  protected final String TEXT_65 = " = 0;" + NL + "    int nb_line_rejected_";
  protected final String TEXT_66 = " = 0;" + NL + "" + NL + "    int tmp_batchUpdateCount_";
  protected final String TEXT_67 = " = 0;" + NL + "" + NL + "    int deletedCount_";
  protected final String TEXT_68 = "=0;" + NL + "    int updatedCount_";
  protected final String TEXT_69 = "=0;" + NL + "    int insertedCount_";
  protected final String TEXT_70 = "=0;" + NL + "    int rejectedCount_";
  protected final String TEXT_71 = "=0;" + NL + "" + NL + "    boolean whetherReject_";
  protected final String TEXT_72 = " = false;" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_73 = " = null;" + NL + "" + NL + "    //optional table" + NL + "    String dbschema_";
  protected final String TEXT_74 = " = null;" + NL + "    String tableName_";
  ...
  protected final String TEXT_90 = ".get(dsAlias_";
  protected final String TEXT_91 = ").getConnection();" + NL + "    \t\t} else {";
  protected final String TEXT_92 = NL + "                    String driverClass_";
  protected final String TEXT_93 = " = \"oracle.jdbc.OracleDriver\";";
  protected final String TEXT_94 = NL + "                    String driverClass_";
  protected final String TEXT_95 = " = \"oracle.jdbc.driver.OracleDriver\";";
  protected final String TEXT_96 = NL;
  protected final String TEXT_97 = NL + NL + "                java.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_105 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_106 = " + \":\" + ";
  protected final String TEXT_107 = " + \":\" + ";
  protected final String TEXT_108 = ";";
  protected final String TEXT_109 = NL + "                    url_";
  protected final String TEXT_110 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_111 = " + \")(port=\" + ";
  protected final String TEXT_112 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_113 = " + \")))\";";
  protected final String TEXT_114 = NL + "                    url_";
  protected final String TEXT_115 = " = \"jdbc:oracle:oci8:@\" + ";
  protected final String TEXT_116 = ";;";
  protected final String TEXT_117 = NL + "                    url_";
  protected final String TEXT_118 = " = ";
  protected final String TEXT_119 = ";";
  protected final String TEXT_120 = NL + "                String dbUser_";
  ...
  protected final String TEXT_130 = NL + NL + "                String dbPwd_";
  protected final String TEXT_131 = " = decryptedPassword_";
  protected final String TEXT_132 = ";" + NL + "                dbschema_";
  ...
  protected final String TEXT_138 = ");" + NL + "                    if(dbschema_";
  protected final String TEXT_139 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_140 = ")) //get schema from connection" + NL + "                    {" + NL + "                        dbschema_";
  protected final String TEXT_141 = "=conn_";
  protected final String TEXT_142 = ".getMetaData().getUserName();" + NL + "                    }" + NL;
  ...
  protected final String TEXT_148 = NL + "                    java.util.Properties atnParamsPrope_";
  protected final String TEXT_149 = " = new java.util.Properties();" + NL + "                    atnParamsPrope_";
  protected final String TEXT_150 = ".put(\"user\",dbUser_";
  protected final String TEXT_151 = ");" + NL + "                    atnParamsPrope_";
  protected final String TEXT_152 = ".put(\"password\",dbPwd_";
  protected final String TEXT_153 = ");" + NL + "                    if(";
  protected final String TEXT_154 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_155 = ") && !\"\".equals(";
  protected final String TEXT_156 = ")){" + NL + "                        atnParamsPrope_";
  protected final String TEXT_157 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_158 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "                    }" + NL + "                    conn_";
  protected final String TEXT_159 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_160 = ", atnParamsPrope_";
  protected final String TEXT_161 = ");";
  protected final String TEXT_162 = NL + "            }";
  protected final String TEXT_163 = NL + "        resourceMap.put(\"conn_";
  protected final String TEXT_164 = "\", conn_";
  protected final String TEXT_165 = ");";
  protected final String TEXT_166 = NL + "            conn_";
  protected final String TEXT_167 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  protected final String TEXT_168 = " = ";
  protected final String TEXT_169 = ";" + NL + "            int commitCounter_";
  ...
  protected final String TEXT_175 = NL + "        int count_";
  protected final String TEXT_176 = "=0;";
  protected final String TEXT_177 = NL + NL + "        if(dbschema_";
  protected final String TEXT_178 = " == null || dbschema_";
  protected final String TEXT_179 = ".trim().length() == 0) {" + NL + "            tableName_";
  protected final String TEXT_180 = " = (";
  protected final String TEXT_181 = ")";
  protected final String TEXT_182 = ";" + NL + "        } else {" + NL + "            tableName_";
  ...
  protected final String TEXT_194 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_201 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();";
  protected final String TEXT_204 = NL + "                              stmtCreate_";
  protected final String TEXT_205 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_206 = "));";
  protected final String TEXT_207 = NL + "                    stmtCreate_";
  protected final String TEXT_208 = ".execute(((\"";
  protected final String TEXT_209 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_210 = ".";
  protected final String TEXT_211 = ", \"";
  protected final String TEXT_212 = "\")";
  protected final String TEXT_213 = ".toUpperCase()";
  ...
  protected final String TEXT_221 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_225 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_242 = NL + "                    String keyCheckTable_";
  protected final String TEXT_243 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_244 = "+\"][\"+";
  protected final String TEXT_245 = "+\"][\"+";
  protected final String TEXT_246 = "+\"][\"+";
  protected final String TEXT_247 = "+\"][\"+";
  protected final String TEXT_248 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_249 = " + \"]\";";
  protected final String TEXT_250 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_251 = " = conn_";
  protected final String TEXT_252 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_253 = " + \"]\";";
  protected final String TEXT_254 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_255 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_256 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_257 = ")== null){//}";
  protected final String TEXT_258 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_259 = " = conn_";
  protected final String TEXT_260 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_261 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_262 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_263 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_264 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_265 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_270 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_271 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_272 = " = tableNameForSearch_";
  protected final String TEXT_273 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_274 = " = tableNameForSearch_";
  protected final String TEXT_275 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_276 = " = dbMetaData_";
  protected final String TEXT_277 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_278 = ", tableNameForSearch_";
  protected final String TEXT_279 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_280 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_281 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_282 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_286 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_287 = " = dbMetaData_";
  protected final String TEXT_288 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_289 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_303 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_321 = ".toUpperCase()";
  ...
  protected final String TEXT_327 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_328 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_337 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_338 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_339 = " == null || dbschema_";
  protected final String TEXT_340 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_341 = " = conn_";
  protected final String TEXT_342 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_343 = " = stmtSchema_";
  protected final String TEXT_344 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_345 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_346 = " = rsSchema_";
  protected final String TEXT_347 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_348 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_349 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_350 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_351 = " = rsTable_";
  protected final String TEXT_352 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_353 = " = rsTable_";
  protected final String TEXT_354 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_355 = ".equals";
  protected final String TEXT_356 = "IgnoreCase";
  protected final String TEXT_357 = "(";
  protected final String TEXT_358 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_363 = " ==null || dbschema_";
  protected final String TEXT_364 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_365 = ".equals";
  protected final String TEXT_366 = "IgnoreCase";
  protected final String TEXT_367 = "(schema_";
  ...
  protected final String TEXT_371 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_372 = " = ";
  protected final String TEXT_373 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_374 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_375 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_376 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_377 = " =  tableForSearch_";
  protected final String TEXT_378 = ".substring(1,tableForSearch_";
  protected final String TEXT_379 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_380 = " =  tableForSearch_";
  protected final String TEXT_381 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_385 = ".getTables(null, conn_";
  protected final String TEXT_386 = ".getSchema(), tableForSearch_";
  protected final String TEXT_387 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_388 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_389 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_390 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_394 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_395 = " = dbMetaData_";
  protected final String TEXT_396 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_397 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_398 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_399 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_400 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_401 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_402 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_403 = ".close();";
  protected final String TEXT_404 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_405 = " = conn_";
  protected final String TEXT_406 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_407 = " = dbMetaData_";
  protected final String TEXT_408 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_409 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_410 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_411 = " = rsTable_";
  protected final String TEXT_412 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_413 = ".equalsIgnoreCase(";
  protected final String TEXT_414 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_415 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_416 = ".close();";
  protected final String TEXT_417 = NL + "                                if(!whetherExist_";
  protected final String TEXT_418 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_419 = " = conn_";
  protected final String TEXT_420 = ".createStatement();";
  protected final String TEXT_421 = NL + "                                                      stmtCreate_";
  protected final String TEXT_422 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_423 = "));";
  protected final String TEXT_424 = NL + "                                            stmtCreate_";
  protected final String TEXT_425 = ".execute(((\"";
  protected final String TEXT_426 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_427 = ".";
  protected final String TEXT_428 = ", \"";
  protected final String TEXT_429 = "\")";
  protected final String TEXT_430 = ".toUpperCase()";
  protected final String TEXT_431 = ")+\")";
  protected final String TEXT_432 = "\"));";
  protected final String TEXT_433 = NL + "                                        stmtCreate_";
  protected final String TEXT_434 = ".execute(\"";
  protected final String TEXT_435 = ")\");";
  protected final String TEXT_436 = NL + "                                    stmtCreate_";
  protected final String TEXT_437 = ".close();" + NL + "                                }";
  protected final String TEXT_438 = NL + "                                if(whetherExist_";
  protected final String TEXT_439 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_440 = " = conn_";
  protected final String TEXT_441 = ".createStatement();";
  protected final String TEXT_442 = NL + "                                                      stmtDrop_";
  protected final String TEXT_443 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_444 = "));";
  protected final String TEXT_445 = NL + "                                    stmtDrop_";
  protected final String TEXT_446 = ".execute(\"";
  protected final String TEXT_447 = "\" ";
  protected final String TEXT_448 = ");";
  protected final String TEXT_449 = NL + "                                    stmtDrop_";
  protected final String TEXT_450 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_456 = NL + "                                        stmtCreate_";
  protected final String TEXT_457 = ".execute(((\"";
  protected final String TEXT_458 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_468 = NL + "                                stmtCreate_";
  protected final String TEXT_469 = ".close();";
  protected final String TEXT_470 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_471 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_472 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_478 = NL + "            stmtClear_";
  protected final String TEXT_479 = ".executeUpdate(\"";
  protected final String TEXT_480 = "\");";
  protected final String TEXT_481 = NL + "            stmtClear_";
  protected final String TEXT_482 = ".close();";
  protected final String TEXT_483 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_484 = " = conn_";
  protected final String TEXT_485 = ".createStatement();";
  protected final String TEXT_486 = NL + "                              stmtTruncCount_";
  protected final String TEXT_487 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_488 = "));";
  protected final String TEXT_489 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_490 = " = stmtTruncCount_";
  protected final String TEXT_491 = ".executeQuery(\"";
  protected final String TEXT_492 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_493 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_494 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_498 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_499 = " = conn_";
  protected final String TEXT_500 = ".createStatement();";
  protected final String TEXT_501 = NL + "                              stmtTrunc_";
  protected final String TEXT_502 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_509 = NL + "                if(!conn_";
  protected final String TEXT_510 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_511 = ".commit();" + NL + "                }";
  protected final String TEXT_512 = NL + "            deletedCount_";
  protected final String TEXT_513 = " += rsTruncCountNumber_";
  protected final String TEXT_514 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_515 = ".close();";
  protected final String TEXT_516 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_517 = " = conn_";
  protected final String TEXT_518 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_519 = " = stmtTruncCount_";
  protected final String TEXT_520 = ".executeQuery(\"";
  protected final String TEXT_521 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_522 = " = conn_";
  protected final String TEXT_523 = ".createStatement();";
  protected final String TEXT_524 = NL + "                conn_";
  protected final String TEXT_525 = ".commit();";
  protected final String TEXT_526 = NL + "            stmtTrunc_";
  protected final String TEXT_527 = ".executeUpdate(\"";
  protected final String TEXT_528 = "\");";
  protected final String TEXT_529 = NL + "            while(rsTruncCount_";
  protected final String TEXT_530 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_531 = " += rsTruncCount_";
  protected final String TEXT_532 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_533 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_534 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_535 = ".close();";
  protected final String TEXT_536 = NL + "                String insert_";
  protected final String TEXT_537 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_555 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_556 = " = conn_";
  protected final String TEXT_557 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_558 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_559 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_560 = ",insert_";
  protected final String TEXT_561 = ",keyPsmt_";
  ...
  protected final String TEXT_576 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_577 = " = conn_";
  protected final String TEXT_578 = ".prepareStatement(update_";
  protected final String TEXT_579 = ");";
  protected final String TEXT_580 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_581 = " = conn_";
  protected final String TEXT_582 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_583 = " + \" WHERE ";
  protected final String TEXT_584 = "\");" + NL + "                String insert_";
  protected final String TEXT_585 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_586 = " + \" (";
  protected final String TEXT_587 = ") VALUES (";
  protected final String TEXT_588 = ")\";";
  protected final String TEXT_589 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_590 = " = new StringBuffer(insert_";
  protected final String TEXT_591 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_592 = ".insert(insert_";
  protected final String TEXT_593 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_594 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_595 = " =insertStringBuffer_";
  protected final String TEXT_596 = ".toString(); ";
  protected final String TEXT_597 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_598 = " = conn_";
  protected final String TEXT_599 = ".prepareStatement(insert_";
  protected final String TEXT_600 = ");" + NL + "                String update_";
  protected final String TEXT_601 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_602 = " + \" SET ";
  protected final String TEXT_603 = " WHERE ";
  protected final String TEXT_604 = "\";";
  protected final String TEXT_605 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_606 = " = new StringBuffer(update_";
  protected final String TEXT_607 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_608 = ".insert(update_";
  protected final String TEXT_609 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_610 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_611 = " =updateStringBuffer_";
  protected final String TEXT_612 = ".toString(); ";
  protected final String TEXT_613 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_614 = " = conn_";
  protected final String TEXT_615 = ".prepareStatement(update_";
  ...
  protected final String TEXT_622 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_623 = " = new StringBuffer(update_";
  protected final String TEXT_624 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_625 = ".insert(update_";
  protected final String TEXT_626 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_627 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_628 = " =updateStringBuffer_";
  protected final String TEXT_629 = ".toString(); ";
  protected final String TEXT_630 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_631 = " = conn_";
  protected final String TEXT_632 = ".prepareStatement(update_";
  protected final String TEXT_633 = ");" + NL + "                String insert_";
  protected final String TEXT_634 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_635 = " + \" (";
  protected final String TEXT_636 = ") VALUES (";
  protected final String TEXT_637 = ")\";";
  protected final String TEXT_638 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_639 = " = new StringBuffer(insert_";
  protected final String TEXT_640 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_641 = ".insert(insert_";
  protected final String TEXT_642 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_643 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_644 = " =insertStringBuffer_";
  protected final String TEXT_645 = ".toString(); ";
  protected final String TEXT_646 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_647 = " = conn_";
  protected final String TEXT_648 = ".prepareStatement(insert_";
  protected final String TEXT_649 = ");";
  protected final String TEXT_650 = NL + "                String delete_";
  protected final String TEXT_651 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_652 = " + \" WHERE ";
  protected final String TEXT_653 = "\";";
  protected final String TEXT_654 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_655 = " = new StringBuffer(delete_";
  protected final String TEXT_656 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_657 = ".insert(delete_";
  protected final String TEXT_658 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_659 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_660 = " =deleteStringBuffer_";
  protected final String TEXT_661 = ".toString();  ";
  protected final String TEXT_662 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_663 = " = conn_";
  protected final String TEXT_664 = ".prepareStatement(delete_";
  protected final String TEXT_665 = ");";
  protected final String TEXT_666 = NL + "                StringBuffer query_";
  protected final String TEXT_667 = " = null;";
  protected final String TEXT_668 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_669 = " = insert_";
  ...
  protected final String TEXT_675 = NL + "\t\t\tupdate_";
  protected final String TEXT_676 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_677 = " = update_";
  protected final String TEXT_678 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_679 = " = insert_";
  protected final String TEXT_680 = ".split(\"\\\\?\");";
  protected final String TEXT_681 = NL + "\t\t\tdelete_";
  protected final String TEXT_682 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_683 = " = delete_";
  protected final String TEXT_684 = ".split(\"\\\\?\");";
  protected final String TEXT_685 = NL + "\t\t\treplace_";
  protected final String TEXT_686 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_687 = " = replace_";
  protected final String TEXT_688 = ".split(\"\\\\?\");";
  protected final String TEXT_689 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_690 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_691 = " = insertIgnore_";
  protected final String TEXT_692 = ".split(\"\\\\?\");";
  protected final String TEXT_693 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_694 = " = insert_";
  protected final String TEXT_695 = ".split(\"\\\\?\");";
  protected final String TEXT_696 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_697 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_698 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_699 = " = true;";
  protected final String TEXT_700 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_701 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_702 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_703 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_704 = " clobTypeUtil_";
  protected final String TEXT_705 = "=new ClobTypeUtil_";
  protected final String TEXT_706 = "();";
  protected final String TEXT_707 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_708 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_709 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_710 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_711 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_712 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_713 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_714 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_715 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_716 = " blobTypeUtil_";
  protected final String TEXT_717 = "=new BlobTypeUtil_";
  protected final String TEXT_718 = "();";
  protected final String TEXT_719 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_720 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_721 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_722 = " =null;";
  protected final String TEXT_723 = NL + "            StringBuffer query_";
  protected final String TEXT_724 = " = null;";
  protected final String TEXT_725 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_726 = " = null;";
  protected final String TEXT_727 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_728 = " =  null;";
  protected final String TEXT_729 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_730 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_731 = " = null;";
  protected final String TEXT_732 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_733 = " = null;";
  protected final String TEXT_734 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_735 = " = null;";
  protected final String TEXT_736 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_737 = " = null;";
  protected final String TEXT_738 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_739 = " = null;";
  protected final String TEXT_740 = NL + NL + NL + NL;
