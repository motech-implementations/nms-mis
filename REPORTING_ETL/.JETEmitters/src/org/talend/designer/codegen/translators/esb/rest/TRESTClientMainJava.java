...
public class TRESTClientMainJava
{
  ...
  protected final String TEXT_224 = ");" + NL + "\t}" + NL + "" + NL + "\t// if FORM request then capture query parameters into Form, otherwise set them as queries" + NL + "\t";
  protected final String TEXT_225 = NL + "\t\tjavax.ws.rs.core.Form form_";
  protected final String TEXT_226 = " = new javax.ws.rs.core.Form();" + NL + "\t\t";
  protected final String TEXT_227 = NL + "\t\t\tform_";
  protected final String TEXT_228 = ".param(";
  protected final String TEXT_229 = " ,";
  protected final String TEXT_230 = ");" + NL + "\t\t";
  protected final String TEXT_231 = NL + "\t\trequestBody_";
  protected final String TEXT_232 = " = form_";
  protected final String TEXT_233 = ";" + NL + "\t";
  protected final String TEXT_234 = NL + "\t\t";
  protected final String TEXT_235 = NL + "\t\t\twebClient_";
  protected final String TEXT_236 = ".query(";
  protected final String TEXT_237 = " ,";
  protected final String TEXT_238 = ");" + NL + "\t\t";
  protected final String TEXT_239 = NL + "\t";
  protected final String TEXT_240 = NL + NL + NL + "\ttry {" + NL + "\t\t// start send request" + NL + "\t\t";
  protected final String TEXT_241 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_242 = " = webClient_";
  protected final String TEXT_243 = ".get";
  protected final String TEXT_244 = "Collection";
  protected final String TEXT_245 = "(responseClass_";
  protected final String TEXT_246 = ");" + NL + "\t\t";
  protected final String TEXT_247 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_248 = " = webClient_";
  protected final String TEXT_249 = ".post";
  protected final String TEXT_250 = "ObjectGetCollection";
  protected final String TEXT_251 = "(requestBody_";
  protected final String TEXT_252 = ", responseClass_";
  protected final String TEXT_253 = ");" + NL + "\t\t";
  protected final String TEXT_254 = NL + "\t\t\tresponseDoc_";
  protected final String TEXT_255 = " = webClient_";
  protected final String TEXT_256 = ".put(requestBody_";
  protected final String TEXT_257 = ", responseClass_";
  protected final String TEXT_258 = ");" + NL + "\t\t";
  protected final String TEXT_259 = NL + "\t\t\torg.apache.cxf.jaxrs.client.WebClient.getConfig(webClient_";
  protected final String TEXT_260 = ").getRequestContext().put(\"use.httpurlconnection.method.reflection\", true);" + NL + "\t\t\tresponseDoc_";
  protected final String TEXT_261 = " = webClient_";
  protected final String TEXT_262 = ".invoke(\"PATCH\", requestBody_";
  protected final String TEXT_263 = ", responseClass_";
  protected final String TEXT_264 = ");" + NL + "\t\t";
  protected final String TEXT_265 = NL + "\t\t\twebClient_";
  protected final String TEXT_266 = ".invoke(\"";
  protected final String TEXT_267 = "\", requestBody_";
  protected final String TEXT_268 = ");" + NL + "\t\t";
  protected final String TEXT_269 = NL + NL + NL + "\t\tint webClientResponseStatus_";
  protected final String TEXT_270 = " = webClient_";
  protected final String TEXT_271 = ".getResponse().getStatus();" + NL + "\t\tif (webClientResponseStatus_";
  protected final String TEXT_272 = " >= 300) {" + NL + "\t\t\tthrow new javax.ws.rs.WebApplicationException(webClient_";
  protected final String TEXT_273 = ".getResponse());" + NL + "\t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_274 = NL + "\t\t\tif (";
  protected final String TEXT_275 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_276 = " = new ";
  protected final String TEXT_277 = "Struct();" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_278 = ".statusCode = webClientResponseStatus_";
  protected final String TEXT_279 = ";" + NL + "\t\t\t";
  protected final String TEXT_280 = NL + "\t\t\tif (responseDoc_";
  protected final String TEXT_281 = " != null) {" + NL + "\t\t\t\tif (responseClass_";
  protected final String TEXT_282 = " == String.class) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_283 = ".string = (String) responseDoc_";
  protected final String TEXT_284 = ";" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\troutines.system.Document responseTalendDoc_";
  protected final String TEXT_285 = " = null;" + NL + "\t\t\t\t\tif (null != responseDoc_";
  protected final String TEXT_286 = ") {" + NL + "\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_287 = " = new routines.system.Document();" + NL + "\t\t\t\t\t\tresponseTalendDoc_";
  protected final String TEXT_288 = ".setDocument((org.dom4j.Document) responseDoc_";
  protected final String TEXT_289 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_290 = ".body = responseTalendDoc_";
  protected final String TEXT_291 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_292 = NL + NL + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_293 = "_HEADERS\", webClient_";
  protected final String TEXT_294 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\tif (null != webClient_";
  protected final String TEXT_296 = ".getResponse().getHeaders().get(\"CorrelationID\")) {" + NL + "\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_297 = "_CORRELATION_ID\", webClient_";
  protected final String TEXT_298 = ".getResponse().getHeaders().get(\"CorrelationID\").get(0));" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_299 = NL + "\t\t";
  protected final String TEXT_300 = NL + NL + "\t} catch (javax.ws.rs.WebApplicationException ex_";
  protected final String TEXT_301 = ") {" + NL + "\t\t";
  protected final String TEXT_302 = NL + "\t\t\tif (";
  protected final String TEXT_303 = " == null) {" + NL + "\t\t\t\t";
  protected final String TEXT_304 = " = new ";
  protected final String TEXT_305 = "Struct();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_306 = ".errorCode = ex_";
  protected final String TEXT_307 = ".getResponse().getStatus();" + NL + "" + NL + "\t\t\tString errorMessage_";
  protected final String TEXT_308 = " = null;" + NL + "\t\t\ttry {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_309 = " = ex_";
  protected final String TEXT_310 = ".getResponse().readEntity(String.class);" + NL + "\t\t\t} catch (Exception exe_";
  protected final String TEXT_311 = ") {" + NL + "\t\t\t\t// ignore" + NL + "\t\t\t}" + NL + "\t\t\tif (null == errorMessage_";
  protected final String TEXT_312 = " || 0 == errorMessage_";
  protected final String TEXT_313 = ".trim().length()) {" + NL + "\t\t\t\terrorMessage_";
  protected final String TEXT_314 = " = ex_";
  protected final String TEXT_315 = ".getMessage();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_316 = ".errorMessage = errorMessage_";
  protected final String TEXT_317 = ";" + NL + "" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_318 = "_HEADERS\", ex_";
  protected final String TEXT_319 = ".getResponse().getHeaders());" + NL + "\t\t\t";
  ...
  protected final String TEXT_325 = NL + "\t\t\tthrow ex_";
  protected final String TEXT_326 = ";" + NL + "\t\t";
  protected final String TEXT_327 = NL + "\t}" + NL + "" + NL + "} catch(Exception e_";
  protected final String TEXT_328 = ") {" + NL + "\t";
  protected final String TEXT_329 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_330 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_331 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_332 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_333 = NL + "}" + NL;
  protected final String TEXT_334 = NL + "java.util.Collection<String> responseParts_";
  protected final String TEXT_335 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_336 = NL + "org.apache.cxf.jaxrs.ext.multipart.MultipartBody multipartBody_";
  protected final String TEXT_337 = " =responseDoc_";
  protected final String TEXT_338 = ".readEntity(org.apache.cxf.jaxrs.ext.multipart.MultipartBody.class);" + NL + "try {" + NL + "\tfor (org.apache.cxf.jaxrs.ext.multipart.Attachment att_";
  protected final String TEXT_339 = " : multipartBody_";
  protected final String TEXT_340 = ".getAllAttachments()) {" + NL + "       java.io.InputStream is_";
  protected final String TEXT_341 = " = att_";
  protected final String TEXT_342 = ".getDataHandler().getInputStream();" + NL + "       java.util.Scanner s_";
  protected final String TEXT_343 = " = new java.util.Scanner(is_";
  protected final String TEXT_344 = ").useDelimiter(\"\\\\A\");" + NL + "       responseParts_";
  protected final String TEXT_345 = ".add(s_";
  protected final String TEXT_346 = ".hasNext() ? s_";
  protected final String TEXT_347 = ".next() : \"\");" + NL + "       is_";
  protected final String TEXT_348 = ".close();" + NL + "   }" + NL + "} catch (java.io.IOException e_";
  protected final String TEXT_349 = ") {" + NL + "\t";
  protected final String TEXT_350 = NL + "\t\tthrow new TalendException(e_";
  protected final String TEXT_351 = ", currentComponent, globalMap);" + NL + "\t";
  protected final String TEXT_352 = NL + "\t\tnew TalendException(e_";
  protected final String TEXT_353 = ", currentComponent, globalMap).printStackTrace();" + NL + "\t";
  protected final String TEXT_354 = NL + "}";
  protected final String TEXT_355 = NL + "for (String responsePart_";
  protected final String TEXT_356 = " : responseDoc_";
  protected final String TEXT_357 = ") {" + NL + "    responseParts_";
  protected final String TEXT_358 = ".add(responsePart_";
  protected final String TEXT_359 = ");" + NL + "}";
  protected final String TEXT_360 = NL + "for (String responsePart_";
  protected final String TEXT_361 = " : responseParts_";
  protected final String TEXT_362 = ") {" + NL + "    row1 = new row1Struct();" + NL + "    row1.string = responsePart_";
