...
public class TParAccelOutputMainJava {
  ...
  protected final String TEXT_50 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_51 = " = buffersSize_";
  protected final String TEXT_52 = ";";
  protected final String TEXT_53 = NL + "            batchSize_";
  protected final String TEXT_54 = " = buffersSize_";
  ...
  protected final String TEXT_60 = ".addBatch();" + NL + "                       batchSizeCounter_";
  ...
  protected final String TEXT_79 = NL + "                                   rejectedCount_";
  protected final String TEXT_80 = " = rejectedCount_";
  protected final String TEXT_81 = " + 1;";
  protected final String TEXT_82 = NL + "                                   ";
  protected final String TEXT_83 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_98 = ".addBatch();" + NL + "                       batchSizeCounter_";
  ...
  protected final String TEXT_106 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_117 = NL + "                                   rejectedCount_";
  protected final String TEXT_118 = " = rejectedCount_";
  protected final String TEXT_119 = " + 1;";
  protected final String TEXT_120 = NL + "                                   ";
  protected final String TEXT_121 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_122 = NL + "                                   ";
  protected final String TEXT_123 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_135 = ".next()) {" + NL + "                checkCount_";
  ...
  protected final String TEXT_146 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_147 = " = updatedCount_";
  protected final String TEXT_148 = " + pstmtUpdate_";
  protected final String TEXT_149 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_150 = "++;";
  protected final String TEXT_151 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_164 = NL + "                            rejectedCount_";
  ...
  protected final String TEXT_173 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_212 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_213 = "=pstmtUpdate_";
  protected final String TEXT_214 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_215 = " = updatedCount_";
  protected final String TEXT_216 = "+updateFlag_";
  protected final String TEXT_217 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_218 = " == 0) {";
  protected final String TEXT_219 = NL + "                        ";
  protected final String TEXT_220 = NL + "                    insertedCount_";
  protected final String TEXT_221 = " = insertedCount_";
  protected final String TEXT_222 = " + pstmtInsert_";
  protected final String TEXT_223 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_224 = "++;";
  protected final String TEXT_225 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_226 = "++;" + NL + "             \t   ";
  protected final String TEXT_227 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_256 = NL + "                           pstmt_";
  protected final String TEXT_257 = ".addBatch();" + NL + "                           batchSizeCounter_";
  protected final String TEXT_258 = "++;" + NL + "                           nb_line_";
  protected final String TEXT_259 = "++;";
  protected final String TEXT_260 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_261 = " = deletedCount_";
  protected final String TEXT_262 = " + pstmt_";
  protected final String TEXT_263 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_264 = "++;";
  protected final String TEXT_265 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_288 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_299 = NL + "                if ((batchSize_";
  protected final String TEXT_300 = " > 0) && (batchSize_";
  protected final String TEXT_301 = " <= batchSizeCounter_";
  protected final String TEXT_302 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_303 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_304 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_305 = " = 0;";
  protected final String TEXT_306 = NL + "                        status_";
  protected final String TEXT_307 = " = pstmt_";
  protected final String TEXT_308 = ".executeBatch();";
  protected final String TEXT_309 = NL + "                        for(int countEach_";
  protected final String TEXT_310 = ": status_";
  protected final String TEXT_311 = ") {" + NL + "                            countSum_";
  protected final String TEXT_312 = " += (countEach_";
  protected final String TEXT_313 = " < 0 ? 0 : countEach_";
  protected final String TEXT_314 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_315 = NL + "                            throw(e);";
  protected final String TEXT_316 = NL + "                        for(int countEach_";
  protected final String TEXT_317 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_318 = " += (countEach_";
  protected final String TEXT_319 = " < 0 ? 0 : countEach_";
  protected final String TEXT_320 = ");" + NL + "                        }";
  protected final String TEXT_321 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_322 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_323 = " = pstmt_";
  protected final String TEXT_324 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_325 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_326 = " = tmp_batchUpdateCount_";
  protected final String TEXT_327 = " > countSum_";
  protected final String TEXT_328 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_329 = " : countSum_";
  protected final String TEXT_330 = ";";
  protected final String TEXT_331 = NL + "                        insertedCount_";
  protected final String TEXT_332 = " += tmp_batchUpdateCount_";
  protected final String TEXT_333 = ";";
  protected final String TEXT_334 = NL + "                        updatedCount_";
  protected final String TEXT_335 = " += tmp_batchUpdateCount_";
  protected final String TEXT_336 = ";";
  protected final String TEXT_337 = NL + "                        deletedCount_";
  protected final String TEXT_338 = " += tmp_batchUpdateCount_";
  protected final String TEXT_339 = ";";
  protected final String TEXT_340 = NL + "               }";
  protected final String TEXT_341 = NL + "                commitCounter_";
  protected final String TEXT_342 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_343 = " <= commitCounter_";
  protected final String TEXT_344 = ") {";
  protected final String TEXT_345 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_346 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_347 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_348 = NL + "\t                    for(int countEach_";
  protected final String TEXT_349 = ": pstmt_";
  protected final String TEXT_350 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_351 = " += (countEach_";
  protected final String TEXT_352 = " < 0 ? 0 : countEach_";
  protected final String TEXT_353 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_354 = NL + "\t                    ";
  protected final String TEXT_355 = NL + "\t                        insertedCount_";
  ...
  protected final String TEXT_361 = NL + "\t                        deletedCount_";
  protected final String TEXT_362 = " += countSum_";
  protected final String TEXT_363 = ";" + NL + "\t                    ";
  protected final String TEXT_364 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_365 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_366 = NL + "                        throw(e);";
  protected final String TEXT_367 = NL + "                        int countSum_";
  protected final String TEXT_368 = " = 0;" + NL + "                        for(int countEach_";
  ...
  protected final String TEXT_373 = NL + "                            insertedCount_";
  protected final String TEXT_374 = " += countSum_";
  protected final String TEXT_375 = ";";
  protected final String TEXT_376 = NL + "                            updatedCount_";
  protected final String TEXT_377 = " += countSum_";
  protected final String TEXT_378 = ";";
  protected final String TEXT_379 = NL + "                            deletedCount_";
  protected final String TEXT_380 = " += countSum_";
  ...
  protected final String TEXT_388 = "=0;" + NL + "            }";
