...
public class THttpRequestMainJava
{
  ...
  protected final String TEXT_142 = "\" + \"_ERROR_MESSAGE\",\"Request failed:\" + responseCode_";
  protected final String TEXT_143 = " + \" \" + responseMessage_";
  protected final String TEXT_144 = ");";
  protected final String TEXT_145 = NL + "            throw new RuntimeException(\"Request failed:\" + responseCode_";
  protected final String TEXT_146 = " + \" \" + responseMessage_";
  protected final String TEXT_147 = ");";
  protected final String TEXT_148 = NL + "    }" + NL;
  protected final String TEXT_149 = NL + "                    ";
  protected final String TEXT_150 = ".ResponseContent = sb_";
  ...
  protected final String TEXT_158 = " - Closing the connection to the server.\");";
  protected final String TEXT_159 = NL + "    urlConn_";
  protected final String TEXT_160 = ".disconnect();";
  protected final String TEXT_161 = NL + "    log.info(\"";
  protected final String TEXT_162 = " - Connection to the server closed.\");";
  protected final String TEXT_163 = NL + "}catch(Exception e){";
  protected final String TEXT_164 = NL + "            log.error(\"";
  protected final String TEXT_165 = " - \" + e.getMessage());";
  protected final String TEXT_166 = NL + "        System.err.println(e.getMessage());" + NL + "        globalMap.put(\"";
  protected final String TEXT_167 = "\" + \"_ERROR_MESSAGE\",e.getMessage());";
