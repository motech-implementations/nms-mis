...
public class TMaxDBOutputBeginJava {
  ...
  protected final String TEXT_50 = NL + "        int updateKeyCount_";
  protected final String TEXT_51 = " = ";
  protected final String TEXT_52 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_53 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_54 = NL + "        int deleteKeyCount_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_57 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_58 = NL + NL + "int nb_line_";
  protected final String TEXT_59 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_60 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_61 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_62 = " = 0;" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_69 = " = false;" + NL + "java.lang.Class.forName(\"com.sap.dbtech.jdbc.DriverSapDB\");";
  protected final String TEXT_70 = NL + "String url_";
  protected final String TEXT_71 = " = \"jdbc:sapdb://\" + ";
  ...
  protected final String TEXT_92 = NL + NL + "resourceMap.put(\"conn_";
  ...
  protected final String TEXT_100 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_101 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_121 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_122 = " = conn_";
  protected final String TEXT_123 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_124 = " = dbMetaData_";
  protected final String TEXT_125 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_126 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_127 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_128 = " = rsTable_";
  protected final String TEXT_129 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_130 = ".equalsIgnoreCase(";
  protected final String TEXT_131 = ")) {" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_151 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_159 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_162 = NL + "            deletedCount_";
  protected final String TEXT_163 = " = deletedCount_";
  protected final String TEXT_164 = " + stmtClear_";
  protected final String TEXT_165 = ".executeUpdate(\"";
  protected final String TEXT_166 = "\");" + NL + "            \t";
  protected final String TEXT_167 = NL + "            stmtClear_";
  protected final String TEXT_168 = ".close();";
  protected final String TEXT_169 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_172 = " = stmtTruncCount_";
  protected final String TEXT_173 = ".executeQuery(\"";
  protected final String TEXT_174 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_175 = " = conn_";
  protected final String TEXT_176 = ".createStatement();" + NL + "            \t";
  protected final String TEXT_177 = NL + "            stmtTrunc_";
  protected final String TEXT_178 = ".executeUpdate(\"";
  protected final String TEXT_179 = "\");" + NL + "            \t";
  protected final String TEXT_180 = NL + "            while(rsTruncCount_";
  protected final String TEXT_181 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_182 = " += rsTruncCount_";
  protected final String TEXT_183 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_184 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_185 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_186 = ".close();";
  protected final String TEXT_187 = NL + "\t    String insert_";
  protected final String TEXT_188 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_193 = ".prepareStatement(insert_";
  protected final String TEXT_194 = ");" + NL + "\t    ";
  protected final String TEXT_195 = NL + "\t    String update_";
  protected final String TEXT_196 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_201 = ".prepareStatement(update_";
  protected final String TEXT_202 = ");" + NL + "\t    ";
  protected final String TEXT_203 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_206 = " + \" WHERE ";
  ...
  protected final String TEXT_215 = " = \"UPDATE \" + ";
  protected final String TEXT_216 = " + \" SET ";
  protected final String TEXT_217 = " WHERE ";
  protected final String TEXT_218 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".prepareStatement(update_";
  protected final String TEXT_221 = ");" + NL + "\t    ";
  protected final String TEXT_222 = NL + "\t    String update_";
  protected final String TEXT_223 = " = \"UPDATE \" + ";
  protected final String TEXT_224 = " + \" SET ";
  protected final String TEXT_225 = " WHERE ";
  protected final String TEXT_226 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = ".prepareStatement(update_";
  protected final String TEXT_229 = ");" + NL + "\t    String insert_";
  protected final String TEXT_230 = " = \"INSERT INTO \" + ";
  protected final String TEXT_231 = " + \" (";
  protected final String TEXT_232 = ") VALUES (";
  protected final String TEXT_233 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_234 = " = conn_";
  protected final String TEXT_235 = ".prepareStatement(insert_";
  protected final String TEXT_236 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_237 = NL + "\t    String delete_";
  protected final String TEXT_238 = " = \"DELETE FROM \" + ";
  protected final String TEXT_239 = " + \" WHERE ";
  protected final String TEXT_240 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_241 = " = conn_";
  protected final String TEXT_242 = ".prepareStatement(delete_";
  protected final String TEXT_243 = ");" + NL + "\t    ";
  protected final String TEXT_244 = NL + "        StringBuffer query_";
  protected final String TEXT_245 = " = null;" + NL + "       \t";
  protected final String TEXT_246 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_247 = " = insert_";
  ...
  protected final String TEXT_253 = NL + "\t\t\tupdate_";
  protected final String TEXT_254 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_255 = " = update_";
  protected final String TEXT_256 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_257 = " = insert_";
  protected final String TEXT_258 = ".split(\"\\\\?\");";
  protected final String TEXT_259 = NL + "\t\t\tdelete_";
  protected final String TEXT_260 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_261 = " = delete_";
  protected final String TEXT_262 = ".split(\"\\\\?\");";
  protected final String TEXT_263 = NL + "\t\t\treplace_";
  protected final String TEXT_264 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_265 = " = replace_";
  protected final String TEXT_266 = ".split(\"\\\\?\");";
  protected final String TEXT_267 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_268 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_269 = " = insertIgnore_";
  protected final String TEXT_270 = ".split(\"\\\\?\");";
  protected final String TEXT_271 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_272 = " = insert_";
  protected final String TEXT_273 = ".split(\"\\\\?\");";
  protected final String TEXT_274 = NL + "        int commitEvery_";
  protected final String TEXT_275 = " = ";
  protected final String TEXT_276 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_277 = " = 0;";
