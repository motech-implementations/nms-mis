...
public class TFileArchiveMainJava
{
  ...
  protected final String TEXT_112 = "_ARCHIVE_FILENAME\", zipFile_";
  protected final String TEXT_113 = ".contains(\"\\\\\") ?" + NL + "    zipFile_";
  protected final String TEXT_114 = ".substring((zipFile_";
  protected final String TEXT_115 = ".lastIndexOf(\"\\\\\")+2)) : zipFile_";
  protected final String TEXT_116 = ".substring((zipFile_";
  protected final String TEXT_117 = ".lastIndexOf(\"/\"))+1));" + NL + "" + NL + "   zip_";
  protected final String TEXT_118 = ".doZip();" + NL;
