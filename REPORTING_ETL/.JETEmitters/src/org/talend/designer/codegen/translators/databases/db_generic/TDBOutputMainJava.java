...
public class TDBOutputMainJava {
  ...
  protected final String TEXT_52 = " = new StringBuffer(\"\");";
  protected final String TEXT_53 = NL + "\t\t\t\tcommitEvery_";
  ...
  protected final String TEXT_69 = ".executeUpdate(query_";
  protected final String TEXT_70 = ".toString().trim());";
  ...
  protected final String TEXT_110 = NL + "                updatedCount_";
  protected final String TEXT_111 = " = updatedCount_";
  protected final String TEXT_112 = " + pstmt_";
  protected final String TEXT_113 = ".executeUpdate(query_";
  ...
  protected final String TEXT_118 = ".executeUpdate();";
  protected final String TEXT_119 = NL + "                nb_line_";
  ...
  protected final String TEXT_147 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_148 = " = pstmt_";
  protected final String TEXT_149 = ".executeQuery(query_";
  protected final String TEXT_150 = ".toString().trim());" + NL + "    \t\tquery_";
  protected final String TEXT_151 = " = new StringBuffer(\"\");" + NL + "    \t\t";
  protected final String TEXT_152 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_153 = " = pstmt_";
  protected final String TEXT_154 = ".executeQuery();" + NL + "    \t\t";
  protected final String TEXT_155 = NL + "    \t\tint checkCount_";
  protected final String TEXT_156 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_157 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_158 = " = rs_";
  protected final String TEXT_159 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_172 = NL + "                try {";
  protected final String TEXT_173 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_174 = " = updatedCount_";
  protected final String TEXT_175 = " + pstmtUpdate_";
  protected final String TEXT_176 = ".executeUpdate(query_";
  protected final String TEXT_177 = ".toString().trim());" + NL + "            \t";
  protected final String TEXT_178 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_179 = " = updatedCount_";
  protected final String TEXT_180 = " + pstmtUpdate_";
  protected final String TEXT_181 = ".executeUpdate();" + NL + "            \t";
  ...
  protected final String TEXT_214 = NL + "                try {";
  protected final String TEXT_215 = NL + "                    insertedCount_";
  protected final String TEXT_216 = " = insertedCount_";
  protected final String TEXT_217 = " + pstmtInsert_";
  protected final String TEXT_218 = ".executeUpdate(query_";
  ...
  protected final String TEXT_229 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_243 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_249 = NL + "    \t    int updateFlag_";
  protected final String TEXT_250 = "=0;" + NL + "    \t    ";
  ...
  protected final String TEXT_262 = NL + "    \t" + NL + "            try {";
  protected final String TEXT_263 = NL + "                updateFlag_";
  protected final String TEXT_264 = "=pstmtUpdate_";
  protected final String TEXT_265 = ".executeUpdate(query_";
  protected final String TEXT_266 = ".toString().trim());";
  protected final String TEXT_267 = NL + "                updateFlag_";
  protected final String TEXT_268 = "=pstmtUpdate_";
  protected final String TEXT_269 = ".executeUpdate();";
  protected final String TEXT_270 = NL + "                updatedCount_";
  protected final String TEXT_271 = " = updatedCount_";
  protected final String TEXT_272 = " + updateFlag_";
  protected final String TEXT_273 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_284 = NL + "                    insertedCount_";
  protected final String TEXT_285 = " = insertedCount_";
  protected final String TEXT_286 = " + pstmtInsert_";
  protected final String TEXT_287 = ".executeUpdate(query_";
  protected final String TEXT_288 = ".toString().trim());";
  protected final String TEXT_289 = NL + "                    insertedCount_";
  protected final String TEXT_290 = " = insertedCount_";
  protected final String TEXT_291 = " + pstmtInsert_";
  protected final String TEXT_292 = ".executeUpdate();";
  protected final String TEXT_293 = NL + "                \tnb_line_";
  protected final String TEXT_294 = "++;";
  protected final String TEXT_295 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_296 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_297 = NL + "             \t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_298 = " = true;";
  ...
  protected final String TEXT_310 = NL + "                            rejectedCount_";
  protected final String TEXT_311 = " = rejectedCount_";
  protected final String TEXT_312 = " + 1;";
  protected final String TEXT_313 = NL + "                            ";
  protected final String TEXT_314 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_315 = NL + "                            ";
  protected final String TEXT_316 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_317 = ";" + NL + "                           ";
  protected final String TEXT_318 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_319 = NL + "                }";
  protected final String TEXT_320 = NL + "                    ";
  protected final String TEXT_321 = NL + "                        query_";
  protected final String TEXT_322 = " = ";
  protected final String TEXT_323 = ";";
  protected final String TEXT_324 = NL + "                globalMap.put(\"";
  protected final String TEXT_325 = "_QUERY\", query_";
  protected final String TEXT_326 = ".toString().trim());";
  protected final String TEXT_327 = NL + "            try {" + NL + "\t\t\t";
  protected final String TEXT_328 = NL + "               deletedCount_";
  protected final String TEXT_329 = " = deletedCount_";
  protected final String TEXT_330 = " + pstmt_";
  protected final String TEXT_331 = ".executeUpdate(query_";
  protected final String TEXT_332 = ".toString().trim());" + NL + "\t\t\t";
  protected final String TEXT_333 = NL + "               deletedCount_";
  protected final String TEXT_334 = " = deletedCount_";
  protected final String TEXT_335 = " + pstmt_";
  protected final String TEXT_336 = ".executeUpdate();" + NL + "\t\t\t";
  protected final String TEXT_337 = NL + "\t\t\t\tnb_line_";
  protected final String TEXT_338 = "++;";
  protected final String TEXT_339 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_340 = " = true;";
  protected final String TEXT_341 = NL + "                    throw(e);";
  protected final String TEXT_342 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_352 = NL + "                        rejectedCount_";
  protected final String TEXT_353 = " = rejectedCount_";
  protected final String TEXT_354 = " + 1;";
  protected final String TEXT_355 = NL + "                        ";
  protected final String TEXT_356 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_357 = NL + "                        ";
  protected final String TEXT_358 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_359 = ";";
  protected final String TEXT_360 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_361 = NL + "            }" + NL + "    \t";
  protected final String TEXT_362 = NL + "            if(!whetherReject_";
  protected final String TEXT_363 = ") {";
  protected final String TEXT_364 = NL + "                            ";
  protected final String TEXT_365 = " = new ";
  protected final String TEXT_366 = "Struct();";
  ...
  protected final String TEXT_373 = NL + "            commitCounter_";
  protected final String TEXT_374 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_375 = " <= commitCounter_";
  protected final String TEXT_376 = ") {" + NL + "            \t";
  protected final String TEXT_377 = NL + "            \tconn_";
  protected final String TEXT_378 = ".commit();" + NL + "            \t";
  protected final String TEXT_379 = " " + NL + "            \tcommitCounter_";
  protected final String TEXT_380 = "=0;" + NL + "            }\t" + NL + "    \t";
