...
public class TAccessOutputBeginJava {
  ...
  protected final String TEXT_68 = " = false;" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_74 = NL + "java.lang.Class.forName(\"net.ucanaccess.jdbc.UcanaccessDriver\");";
  protected final String TEXT_75 = NL + "String url_";
  protected final String TEXT_76 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_77 = ";" + NL + "" + NL + "String dbUser_";
  ...
  protected final String TEXT_96 = NL + "\tString atnParams_";
  protected final String TEXT_97 = " = ";
  protected final String TEXT_98 = ";" + NL + "\tatnParams_";
  protected final String TEXT_99 = " = atnParams_";
  protected final String TEXT_100 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_101 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_102 = ".put(\"user\",dbUser_";
  protected final String TEXT_103 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_104 = ".put(\"password\",dbPwd_";
  protected final String TEXT_105 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_106 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_107 = ".getBytes()));" + NL + "  " + NL + "\tconn_";
  protected final String TEXT_108 = " =  java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_109 = ", atnParamsPrope_";
  protected final String TEXT_110 = ");";
  protected final String TEXT_111 = NL + "resourceMap.put(\"conn_";
  protected final String TEXT_112 = "\", conn_";
  protected final String TEXT_113 = ");";
  protected final String TEXT_114 = NL + "\t\tconn_";
  protected final String TEXT_115 = ".setAutoCommit(false);\t" + NL + "\t    int commitEvery_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = ";" + NL + "" + NL + "\t    int commitCounter_";
  ...
  protected final String TEXT_122 = NL + "            stmtDrop_";
  ...
  protected final String TEXT_137 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_138 = " = conn_";
  protected final String TEXT_139 = ".getMetaData();" + NL + "            java.sql.ResultSet rsTable_";
  protected final String TEXT_140 = " = dbMetaData_";
  protected final String TEXT_141 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "            boolean whetherExist_";
  protected final String TEXT_142 = " = false;" + NL + "            while(rsTable_";
  protected final String TEXT_143 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_144 = " = rsTable_";
  protected final String TEXT_145 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_146 = ".equalsIgnoreCase(";
  protected final String TEXT_147 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_148 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_149 = NL + "                if(!whetherExist_";
  protected final String TEXT_150 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_164 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_174 = NL + "            deletedCount_";
  protected final String TEXT_175 = " = deletedCount_";
  protected final String TEXT_176 = " + stmtClear_";
  protected final String TEXT_177 = ".executeUpdate(\"";
  protected final String TEXT_178 = "\");";
  protected final String TEXT_179 = "\t" + NL + "\t    String insert_";
  protected final String TEXT_180 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_181 = " + \"] (";
  protected final String TEXT_182 = ") VALUES (";
  protected final String TEXT_183 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_184 = " = conn_";
  protected final String TEXT_185 = ".prepareStatement(insert_";
  protected final String TEXT_186 = ");" + NL + "\t    ";
  protected final String TEXT_187 = NL + "\t    String update_";
  protected final String TEXT_188 = " = \"UPDATE [\" + ";
  protected final String TEXT_189 = " + \"] SET ";
  protected final String TEXT_190 = " WHERE ";
  protected final String TEXT_191 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".prepareStatement(update_";
  protected final String TEXT_194 = ");" + NL + "\t    ";
  protected final String TEXT_195 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + ";
  protected final String TEXT_198 = " + \"] WHERE ";
  protected final String TEXT_199 = "\");\t" + NL + "\t    String insert_";
  protected final String TEXT_200 = " = \"INSERT INTO [\" + ";
  ...
  protected final String TEXT_205 = ".prepareStatement(insert_";
  protected final String TEXT_206 = ");" + NL + "\t    String update_";
  protected final String TEXT_207 = " = \"UPDATE [\" + ";
  protected final String TEXT_208 = " + \"] SET ";
  protected final String TEXT_209 = " WHERE ";
  protected final String TEXT_210 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".prepareStatement(update_";
  ...
  protected final String TEXT_221 = ");" + NL + "\t    String insert_";
  protected final String TEXT_222 = " = \"INSERT INTO [\" + ";
  protected final String TEXT_223 = "+\"] (";
  protected final String TEXT_224 = ") VALUES (";
  protected final String TEXT_225 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_226 = " = conn_";
  protected final String TEXT_227 = ".prepareStatement(insert_";
  protected final String TEXT_228 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_229 = NL + "\t    String delete_";
  protected final String TEXT_230 = " = \"DELETE  FROM [\" + ";
  protected final String TEXT_231 = " + \"] WHERE ";
  protected final String TEXT_232 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".prepareStatement(delete_";
  protected final String TEXT_235 = ");" + NL + "\t    ";
  protected final String TEXT_236 = NL + "        StringBuffer query_";
  protected final String TEXT_237 = " = null;" + NL + "       \t";
  protected final String TEXT_238 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_239 = " = insert_";
  ...
  protected final String TEXT_248 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_249 = " = insert_";
  protected final String TEXT_250 = ".split(\"\\\\?\");";
  protected final String TEXT_251 = NL + "\t\t\tdelete_";
  protected final String TEXT_252 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_253 = " = delete_";
  protected final String TEXT_254 = ".split(\"\\\\?\");";
  protected final String TEXT_255 = NL + "\t\t\treplace_";
  protected final String TEXT_256 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_257 = " = replace_";
  protected final String TEXT_258 = ".split(\"\\\\?\");";
  protected final String TEXT_259 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_260 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_261 = " = insertIgnore_";
  protected final String TEXT_262 = ".split(\"\\\\?\");";
  protected final String TEXT_263 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_264 = " = insert_";
  protected final String TEXT_265 = ".split(\"\\\\?\");";
