...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_56 = NL + NL + "String tableName_";
  ...
  protected final String TEXT_77 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_78 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_79 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_80 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_81 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_82 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_83 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_84 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_90 = NL + "\t\tjava.sql.Savepoint  sp_";
  ...
  protected final String TEXT_94 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_95 = " = ";
  protected final String TEXT_96 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_97 = ".get(dsAlias_";
  protected final String TEXT_98 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_99 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_100 = " = dataSources_";
  protected final String TEXT_101 = ".get(dsAlias_";
  protected final String TEXT_102 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_103 = NL + "\t";
  protected final String TEXT_104 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  protected final String TEXT_105 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_106 = "+\":\"+";
  protected final String TEXT_107 = "+\"/\"+";
  protected final String TEXT_108 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_128 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_129 = "\", conn_";
  protected final String TEXT_130 = ");";
  protected final String TEXT_131 = NL + "    \tjava.sql.Savepoint  sp_";
  protected final String TEXT_132 = " = null;" + NL + "\t";
  protected final String TEXT_133 = NL + "        conn_";
  protected final String TEXT_134 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_137 = " = 0;";
  protected final String TEXT_138 = NL;
  protected final String TEXT_139 = NL + "    if(conn_";
  protected final String TEXT_140 = ".getAutoCommit()){" + NL + "    \tthrow new RuntimeException(\"Connection autocommit must be off to use savePoint\");" + NL + "    }";
  protected final String TEXT_141 = NL;
  protected final String TEXT_142 = NL + "   int batchSize_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_145 = "=0;";
  protected final String TEXT_146 = NL;
  protected final String TEXT_147 = NL + "int count_";
  ...
  protected final String TEXT_153 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_160 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_164 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_180 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_184 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_201 = NL + "                    String keyCheckTable_";
  protected final String TEXT_202 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_203 = "+\"][\"+";
  protected final String TEXT_204 = "+\"][\"+";
  protected final String TEXT_205 = "+\"][\"+";
  protected final String TEXT_206 = "+\"][\"+";
  protected final String TEXT_207 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_208 = " + \"]\";";
  protected final String TEXT_209 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_212 = " + \"]\";";
  protected final String TEXT_213 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_214 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_215 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_216 = ")== null){//}";
  protected final String TEXT_217 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_220 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_221 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_222 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_223 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_224 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_229 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_230 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_231 = " = tableNameForSearch_";
  protected final String TEXT_232 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_233 = " = tableNameForSearch_";
  protected final String TEXT_234 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_235 = " = dbMetaData_";
  protected final String TEXT_236 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_237 = ", tableNameForSearch_";
  protected final String TEXT_238 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_239 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_240 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_241 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_262 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_286 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_287 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_296 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_297 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_298 = " == null || dbschema_";
  protected final String TEXT_299 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_300 = " = conn_";
  protected final String TEXT_301 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_302 = " = stmtSchema_";
  protected final String TEXT_303 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_304 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_305 = " = rsSchema_";
  protected final String TEXT_306 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_307 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_308 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_309 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_310 = " = rsTable_";
  protected final String TEXT_311 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_312 = " = rsTable_";
  protected final String TEXT_313 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_314 = ".equals";
  protected final String TEXT_315 = "IgnoreCase";
  protected final String TEXT_316 = "(";
  protected final String TEXT_317 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_323 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_324 = ".equals";
  protected final String TEXT_325 = "IgnoreCase";
  protected final String TEXT_326 = "(schema_";
  ...
  protected final String TEXT_330 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_333 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_334 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_335 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_336 = " =  tableForSearch_";
  protected final String TEXT_337 = ".substring(1,tableForSearch_";
  protected final String TEXT_338 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_339 = " =  tableForSearch_";
  protected final String TEXT_340 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_344 = ".getTables(null, conn_";
  protected final String TEXT_345 = ".getSchema(), tableForSearch_";
  protected final String TEXT_346 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_347 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_348 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_349 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_350 = ".close();" + NL + "\t\t\t\t            ";
  ...
  protected final String TEXT_355 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_356 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_357 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_358 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_359 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_371 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_376 = NL + "                                if(!whetherExist_";
  protected final String TEXT_377 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_378 = " = conn_";
  protected final String TEXT_379 = ".createStatement();";
  protected final String TEXT_380 = NL + "                                                      stmtCreate_";
  protected final String TEXT_381 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_397 = NL + "                                if(whetherExist_";
  protected final String TEXT_398 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_404 = NL + "                                    stmtDrop_";
  protected final String TEXT_405 = ".execute(\"";
  protected final String TEXT_406 = "\" ";
  protected final String TEXT_407 = ");";
  protected final String TEXT_408 = NL + "                                    stmtDrop_";
  protected final String TEXT_409 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_417 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_418 = ".";
  protected final String TEXT_419 = ", \"";
  protected final String TEXT_420 = "\")";
  protected final String TEXT_421 = ".toUpperCase()";
  ...
  protected final String TEXT_428 = ".close();";
  protected final String TEXT_429 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_430 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_431 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_437 = NL + "            stmtClear_";
  ...
  protected final String TEXT_445 = NL + "                              stmtTruncCount_";
  protected final String TEXT_446 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_447 = "));";
  protected final String TEXT_448 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_449 = " = stmtTruncCount_";
  protected final String TEXT_450 = ".executeQuery(\"";
  protected final String TEXT_451 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_452 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_453 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_457 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_470 = ".commit();" + NL + "                }";
  protected final String TEXT_471 = NL + "            deletedCount_";
  protected final String TEXT_472 = " += rsTruncCountNumber_";
  protected final String TEXT_473 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_474 = ".close();";
  protected final String TEXT_475 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_476 = " = conn_";
  protected final String TEXT_477 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_478 = " = stmtTruncCount_";
  protected final String TEXT_479 = ".executeQuery(\"";
  protected final String TEXT_480 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_481 = " = conn_";
  protected final String TEXT_482 = ".createStatement();";
  protected final String TEXT_483 = NL + "                conn_";
  protected final String TEXT_484 = ".commit();";
  protected final String TEXT_485 = NL + "            stmtTrunc_";
  protected final String TEXT_486 = ".executeUpdate(\"";
  protected final String TEXT_487 = "\");";
  protected final String TEXT_488 = NL + "            while(rsTruncCount_";
  protected final String TEXT_489 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_490 = " += rsTruncCount_";
  protected final String TEXT_491 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_492 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_493 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_494 = ".close();";
  ...
  protected final String TEXT_499 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_507 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_511 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_519 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_526 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_534 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_535 = " = conn_";
  protected final String TEXT_536 = ".prepareStatement(update_";
  protected final String TEXT_537 = ");" + NL + "\t    String insert_";
  protected final String TEXT_538 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_539 = " + \"\\\" (";
  protected final String TEXT_540 = ") VALUES (";
  protected final String TEXT_541 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_545 = NL + "\t    String delete_";
  protected final String TEXT_546 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_547 = " + \"\\\" WHERE ";
  protected final String TEXT_548 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_549 = " = conn_";
  protected final String TEXT_550 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_582 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_583 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_584 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_585 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_586 = " = true;" + NL + "    \t";
  protected final String TEXT_587 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_588 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_589 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_595 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_596 = " =  null;";
  protected final String TEXT_597 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_598 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_599 = " = null;";
  protected final String TEXT_600 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_601 = " = null;";
  protected final String TEXT_602 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_603 = " = null;";
  protected final String TEXT_604 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_605 = " = null;";
  protected final String TEXT_606 = NL + "\t\t \tString[] insertSQLSplits_";
