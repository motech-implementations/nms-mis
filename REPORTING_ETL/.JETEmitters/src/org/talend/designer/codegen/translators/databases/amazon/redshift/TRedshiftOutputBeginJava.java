...
public class TRedshiftOutputBeginJava {
  ...
  protected final String TEXT_48 = NL + NL + "String dbschema_";
  protected final String TEXT_49 = " = null;";
  protected final String TEXT_50 = NL + "\tdbschema_";
  protected final String TEXT_51 = " = (String)globalMap.get(\"schema_\" + \"";
  ...
  protected final String TEXT_58 = ";" + NL + "String schemaForSearch_";
  protected final String TEXT_59 = " = null;" + NL + "String tableForSearch_";
  protected final String TEXT_60 = " = tableName_";
  protected final String TEXT_61 = ";";
  protected final String TEXT_62 = NL + "    if(tableName_";
  protected final String TEXT_63 = "!=null && tableName_";
  protected final String TEXT_64 = ".trim().length()>0){" + NL + "    \ttableName_";
  protected final String TEXT_65 = " = tableName_";
  protected final String TEXT_66 = ".replace(\"\\\".\\\"\",\".\");" + NL + "    \tString[] names_";
  protected final String TEXT_67 = " = tableName_";
  protected final String TEXT_68 = ".split(\"\\\\.\");" + NL + "    \tif(names_";
  protected final String TEXT_69 = ".length > 0){" + NL + "    \t\ttableForSearch_";
  protected final String TEXT_70 = " = names_";
  protected final String TEXT_71 = "[names_";
  protected final String TEXT_72 = ".length-1];" + NL + "    \t}" + NL + "    \tif(names_";
  protected final String TEXT_73 = ".length > 1){" + NL + "    \t\tschemaForSearch_";
  protected final String TEXT_74 = " = names_";
  protected final String TEXT_75 = "[names_";
  protected final String TEXT_76 = ".length-2];" + NL + "    \t}" + NL + "    \ttableName_";
  protected final String TEXT_77 = " = tableName_";
  protected final String TEXT_78 = ".replace(\".\",\"\\\".\\\"\");" + NL + "    }";
  ...
  protected final String TEXT_83 = " + \"\\\".\\\"\" + tableName_";
  protected final String TEXT_84 = ";" + NL + "    }";
  protected final String TEXT_85 = NL;
  protected final String TEXT_86 = NL + "        int updateKeyCount_";
  protected final String TEXT_87 = " = ";
  protected final String TEXT_88 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_89 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_90 = NL + "        int deleteKeyCount_";
  protected final String TEXT_91 = " = ";
  protected final String TEXT_92 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_93 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_98 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_99 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_100 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_101 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_102 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_103 = "=0;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_104 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_105 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_106 = " = calendar_";
  protected final String TEXT_107 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_108 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_109 = " = calendar_";
  protected final String TEXT_110 = ".getTime().getTime();" + NL + "long date_";
  ...
  protected final String TEXT_116 = "=0;" + NL + "   int tmp_batchUpdateCount_";
  protected final String TEXT_117 = " = 0;";
  protected final String TEXT_118 = NL + NL + "java.sql.Connection conn_";
  protected final String TEXT_119 = " = null;";
  protected final String TEXT_120 = NL + "\tconn_";
  protected final String TEXT_121 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_122 = "\");" + NL + "\t";
  protected final String TEXT_123 = NL + "\t";
  protected final String TEXT_124 = NL + NL + "    java.lang.Class.forName(\"com.amazon.redshift.jdbc41.Driver\");";
  ...
  protected final String TEXT_132 = " = \"jdbc:redshift://\" + ";
  protected final String TEXT_133 = " + \":\" + ";
  protected final String TEXT_134 = " + \"/\" + ";
  protected final String TEXT_135 = " + \"?\" + ";
  protected final String TEXT_136 = ";" + NL + "\t";
  protected final String TEXT_137 = NL + "    " + NL + "    String dbUser_";
  ...
  protected final String TEXT_144 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_145 = " = ";
  protected final String TEXT_146 = "; ";
  protected final String TEXT_147 = NL + NL + "    String dbPwd_";
  protected final String TEXT_148 = " = decryptedPassword_";
  protected final String TEXT_149 = ";";
  protected final String TEXT_150 = NL + "    conn_";
  protected final String TEXT_151 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_152 = ",dbUser_";
  protected final String TEXT_153 = ",dbPwd_";
  protected final String TEXT_154 = ");" + NL + "\t";
  protected final String TEXT_155 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_156 = "\", conn_";
  protected final String TEXT_157 = ");" + NL + "    conn_";
  protected final String TEXT_158 = ".setAutoCommit(false);" + NL + "\t";
  protected final String TEXT_159 = NL + "        int commitEvery_";
  protected final String TEXT_160 = " = ";
  protected final String TEXT_161 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_162 = " = 0;";
  protected final String TEXT_163 = NL + "int count_";
  protected final String TEXT_164 = "=0;";
  protected final String TEXT_165 = NL + "\t";
  protected final String TEXT_166 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_170 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_171 = ")));";
  protected final String TEXT_172 = NL + "            stmtDrop_";
  protected final String TEXT_173 = ".execute(\"";
  protected final String TEXT_174 = "\" ";
  protected final String TEXT_175 = ");";
  protected final String TEXT_176 = NL + "            stmtDrop_";
  protected final String TEXT_177 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_181 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_182 = "));";
  protected final String TEXT_183 = NL + "                    stmtCreate_";
  protected final String TEXT_184 = ".execute(((\"";
  protected final String TEXT_185 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_186 = ".";
  protected final String TEXT_187 = ", \"";
  protected final String TEXT_188 = "\")";
  protected final String TEXT_189 = ".toUpperCase()";
  ...
  protected final String TEXT_197 = NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_218 = NL + "                    String keyCheckTable_";
  protected final String TEXT_219 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_220 = "+\"][\"+";
  protected final String TEXT_221 = "+\"][\"+";
  protected final String TEXT_222 = "+\"][\"+";
  protected final String TEXT_223 = "+\"][\"+";
  protected final String TEXT_224 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_225 = " + \"]\";";
  protected final String TEXT_226 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_227 = " = conn_";
  protected final String TEXT_228 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_229 = " + \"]\";";
  protected final String TEXT_230 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_231 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_232 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_233 = ")== null){//}";
  protected final String TEXT_234 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_235 = " = conn_";
  protected final String TEXT_236 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_237 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_238 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_239 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_240 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_241 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_246 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_247 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_248 = " = tableNameForSearch_";
  protected final String TEXT_249 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_250 = " = tableNameForSearch_";
  protected final String TEXT_251 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_252 = " = dbMetaData_";
  protected final String TEXT_253 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_254 = ", tableNameForSearch_";
  protected final String TEXT_255 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_256 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_257 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_258 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_274 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_278 = ") || dbschema_";
  protected final String TEXT_279 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_290 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_291 = " = rsTable_";
  protected final String TEXT_292 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_293 = ".equals";
  protected final String TEXT_294 = "IgnoreCase";
  protected final String TEXT_295 = "((";
  protected final String TEXT_296 = ")";
  protected final String TEXT_297 = ".toUpperCase()";
  ...
  protected final String TEXT_303 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_304 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_313 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_314 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_315 = " == null || dbschema_";
  protected final String TEXT_316 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_317 = " = conn_";
  protected final String TEXT_318 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_319 = " = stmtSchema_";
  protected final String TEXT_320 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_321 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_322 = " = rsSchema_";
  protected final String TEXT_323 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_324 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_325 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_326 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_327 = " = rsTable_";
  protected final String TEXT_328 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_329 = " = rsTable_";
  protected final String TEXT_330 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_331 = ".equals";
  protected final String TEXT_332 = "IgnoreCase";
  protected final String TEXT_333 = "(";
  protected final String TEXT_334 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_335 = ".equals";
  protected final String TEXT_336 = "IgnoreCase";
  protected final String TEXT_337 = "(dbschema_";
  protected final String TEXT_338 = ") || ((dbschema_";
  protected final String TEXT_339 = " ==null || dbschema_";
  protected final String TEXT_340 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_341 = ".equals";
  protected final String TEXT_342 = "IgnoreCase";
  protected final String TEXT_343 = "(schema_";
  protected final String TEXT_344 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_345 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_346 = ".close();";
  protected final String TEXT_347 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_348 = " = ";
  protected final String TEXT_349 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_350 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_351 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_352 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_353 = " =  tableForSearch_";
  protected final String TEXT_354 = ".substring(1,tableForSearch_";
  protected final String TEXT_355 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_356 = " =  tableForSearch_";
  protected final String TEXT_357 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_361 = ".getTables(null, conn_";
  protected final String TEXT_362 = ".getSchema(), tableForSearch_";
  protected final String TEXT_363 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_364 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_365 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_366 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_370 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_371 = " = dbMetaData_";
  protected final String TEXT_372 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_373 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_374 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_384 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_385 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_393 = NL + "                                if(!whetherExist_";
  protected final String TEXT_394 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_414 = NL + "                                if(whetherExist_";
  protected final String TEXT_415 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_416 = " = conn_";
  protected final String TEXT_417 = ".createStatement();";
  protected final String TEXT_418 = NL + "                                                      stmtDrop_";
  protected final String TEXT_419 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_432 = NL + "                                        stmtCreate_";
  protected final String TEXT_433 = ".execute(((\"";
  protected final String TEXT_434 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_446 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_447 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_448 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_452 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_453 = "));";
  protected final String TEXT_454 = NL + "            stmtClear_";
  protected final String TEXT_455 = ".executeUpdate(\"";
  protected final String TEXT_456 = "\");";
  protected final String TEXT_457 = NL + "            stmtClear_";
  ...
  protected final String TEXT_462 = NL + "                              stmtTruncCount_";
  protected final String TEXT_463 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_464 = "));";
  protected final String TEXT_465 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_466 = " = stmtTruncCount_";
  protected final String TEXT_467 = ".executeQuery(\"";
  protected final String TEXT_468 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_469 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_470 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_471 = " = rsTruncCount_";
  protected final String TEXT_472 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_473 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_474 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_475 = " = conn_";
  protected final String TEXT_476 = ".createStatement();";
  protected final String TEXT_477 = NL + "                              stmtTrunc_";
  protected final String TEXT_478 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_479 = "));";
  protected final String TEXT_480 = NL + "                conn_";
  protected final String TEXT_481 = ".commit();";
  protected final String TEXT_482 = NL + "            stmtTrunc_";
  protected final String TEXT_483 = ".executeUpdate(\"";
  protected final String TEXT_484 = "\");";
  protected final String TEXT_485 = NL + "                if(!conn_";
  protected final String TEXT_486 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_487 = ".commit();" + NL + "                }";
  protected final String TEXT_488 = NL + "            deletedCount_";
  protected final String TEXT_489 = " += rsTruncCountNumber_";
  protected final String TEXT_490 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_491 = ".close();";
  protected final String TEXT_492 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_493 = " = conn_";
  protected final String TEXT_494 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_495 = " = stmtTruncCount_";
  protected final String TEXT_496 = ".executeQuery(\"";
  protected final String TEXT_497 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_498 = " = conn_";
  protected final String TEXT_499 = ".createStatement();";
  protected final String TEXT_500 = NL + "                conn_";
  protected final String TEXT_501 = ".commit();";
  protected final String TEXT_502 = NL + "            stmtTrunc_";
  protected final String TEXT_503 = ".executeUpdate(\"";
  protected final String TEXT_504 = "\");";
  protected final String TEXT_505 = NL + "            while(rsTruncCount_";
  protected final String TEXT_506 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_507 = " += rsTruncCount_";
  protected final String TEXT_508 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_509 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_510 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_514 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_515 = " + \"\\\" (";
  protected final String TEXT_516 = ") VALUES (";
  protected final String TEXT_517 = ")\");";
  protected final String TEXT_518 = NL + "\t\t\tint rowCount";
  protected final String TEXT_519 = " = 0;" + NL + "\t\t\tclass BufferLine_";
  protected final String TEXT_520 = " {";
  protected final String TEXT_521 = NL + "                            ";
  protected final String TEXT_522 = " ";
  protected final String TEXT_523 = ";";
  protected final String TEXT_524 = NL + NL + "\t            public BufferLine_";
  protected final String TEXT_525 = "(";
  protected final String TEXT_526 = NL + "                                ,";
  protected final String TEXT_527 = NL + "                            ";
  protected final String TEXT_528 = " ";
  protected final String TEXT_529 = NL + "\t\t\t\t){";
  protected final String TEXT_530 = NL + "\t\t\t\t\t\t\tthis.";
  protected final String TEXT_531 = " = ";
  protected final String TEXT_532 = ";";
  protected final String TEXT_533 = NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tjava.util.List<BufferLine_";
  protected final String TEXT_534 = "> exInsertColValueList";
  protected final String TEXT_535 = " = new java.util.ArrayList();" + NL + "\t\t\tBufferLine_";
  protected final String TEXT_536 = " exInsertColValue";
  protected final String TEXT_537 = " = null;" + NL + "" + NL + "" + NL + "\t\t\tStringBuilder extendInsertValueStmt_";
  protected final String TEXT_538 = " = new StringBuilder();" + NL + "\t\t\tfor(int i_";
  protected final String TEXT_539 = "=0;i_";
  protected final String TEXT_540 = " < ";
  protected final String TEXT_541 = ";i_";
  protected final String TEXT_542 = "++){" + NL + "\t\t\t\t extendInsertValueStmt_";
  protected final String TEXT_543 = ".append(\"(";
  protected final String TEXT_544 = ")\");" + NL + "\t\t\t\t if (i_";
  protected final String TEXT_545 = "!=";
  protected final String TEXT_546 = "-1) extendInsertValueStmt_";
  protected final String TEXT_547 = ".append(\",\");" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tString insert_";
  protected final String TEXT_548 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_549 = " + \"\\\" (";
  protected final String TEXT_550 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_551 = ".toString();" + NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_557 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_565 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_566 = " = conn_";
  protected final String TEXT_567 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_572 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_573 = " + \"\\\" SET ";
  protected final String TEXT_574 = " WHERE ";
  protected final String TEXT_575 = "\");" + NL + "\t    ";
  protected final String TEXT_576 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_577 = " = conn_";
  protected final String TEXT_578 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_579 = " + \"\\\" SET ";
  protected final String TEXT_580 = " WHERE ";
  protected final String TEXT_581 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_582 = " = conn_";
  protected final String TEXT_583 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_584 = " + \"\\\" (";
  protected final String TEXT_585 = ") VALUES (";
  protected final String TEXT_586 = ")\");" + NL + "\t    ";
  protected final String TEXT_587 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_588 = " = conn_";
  protected final String TEXT_589 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_590 = " + \"\\\" WHERE ";
  protected final String TEXT_591 = "\");" + NL + "\t    ";
  protected final String TEXT_592 = NL + "\tclass BufferLine_";
  protected final String TEXT_593 = " {";
  protected final String TEXT_594 = NL + "            ";
  protected final String TEXT_595 = " ";
  protected final String TEXT_596 = ";";
  protected final String TEXT_597 = NL + "\t\t\troutines.system.Dynamic ";
  protected final String TEXT_598 = ";" + NL + "\t\t";
  protected final String TEXT_599 = NL + NL + "\t    public BufferLine_";
  ...
  protected final String TEXT_607 = " routines.system.Dynamic ";
  protected final String TEXT_608 = NL + "\t\t\t";
  protected final String TEXT_609 = NL + "\t    ){" + NL + "\t        ";
  protected final String TEXT_610 = NL + "\t                this.";
  protected final String TEXT_611 = " = ";
  protected final String TEXT_612 = ";" + NL + "\t                ";
  protected final String TEXT_613 = NL + "\t\t\t\t\tthis.";
  protected final String TEXT_614 = "=";
  protected final String TEXT_615 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_616 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_617 = "> exInsertColValueList";
  protected final String TEXT_618 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_619 = " exInsertColValue";
  protected final String TEXT_620 = " = null;" + NL + "    String insert_";
  protected final String TEXT_621 = " = \"\";" + NL + "    int rowCount";
  protected final String TEXT_622 = " = 0;";
  protected final String TEXT_623 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_624 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_625 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
