...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_56 = NL + "        whetherReject_";
  protected final String TEXT_57 = " = false;";
  protected final String TEXT_58 = NL + "                        ";
  protected final String TEXT_59 = NL + "                    pstmt_";
  protected final String TEXT_60 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_61 = "++;";
  protected final String TEXT_62 = NL + "                    batchSizeCounter_";
  protected final String TEXT_63 = "++;";
  protected final String TEXT_64 = NL + "                try{" + NL + "                    nb_line_";
  protected final String TEXT_65 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_66 = " = insertedCount_";
  protected final String TEXT_67 = " + pstmt_";
  protected final String TEXT_68 = ".executeUpdate();";
  protected final String TEXT_69 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_80 = NL + "                            rejectedCount_";
  protected final String TEXT_81 = " = rejectedCount_";
  protected final String TEXT_82 = " + 1;";
  protected final String TEXT_83 = NL + "                            ";
  protected final String TEXT_84 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_98 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_99 = "++;";
  protected final String TEXT_100 = NL + "            batchSizeCounter_";
  protected final String TEXT_101 = "++;";
  protected final String TEXT_102 = NL + "            try{" + NL + "                nb_line_";
  ...
  protected final String TEXT_106 = ".executeUpdate();";
  protected final String TEXT_107 = NL + "            }catch(java.lang.Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_122 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_123 = NL + "                        ";
  protected final String TEXT_124 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_131 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_132 = " = pstmt_";
  protected final String TEXT_133 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_134 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_135 = ".next())" + NL + "            {" + NL + "                checkCount_";
  protected final String TEXT_136 = " = rs_";
  protected final String TEXT_137 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_145 = NL + "                try{" + NL + "                    updatedCount_";
  protected final String TEXT_146 = " = updatedCount_";
  protected final String TEXT_147 = " + pstmtUpdate_";
  protected final String TEXT_148 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_149 = "++;";
  protected final String TEXT_150 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  protected final String TEXT_151 = " = true;";
  ...
  protected final String TEXT_163 = NL + "                            rejectedCount_";
  protected final String TEXT_164 = " = rejectedCount_";
  protected final String TEXT_165 = " + 1;";
  protected final String TEXT_166 = NL + "                            ";
  protected final String TEXT_167 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_172 = NL + "                }" + NL + "            }" + NL + "            else" + NL + "            {";
  protected final String TEXT_173 = NL + "                        ";
  protected final String TEXT_174 = NL + "                try{" + NL + "                    insertedCount_";
  protected final String TEXT_175 = " = insertedCount_";
  protected final String TEXT_176 = " + pstmtInsert_";
  protected final String TEXT_177 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_178 = "++;";
  protected final String TEXT_179 = NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_192 = NL + "                            rejectedCount_";
  protected final String TEXT_193 = " = rejectedCount_";
  ...
  protected final String TEXT_215 = ";" + NL + "" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_225 = NL + "                }" + NL + "                }catch(java.lang.Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_254 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_255 = "++;";
  protected final String TEXT_256 = NL + "                batchSizeCounter_";
  protected final String TEXT_257 = "++;";
  protected final String TEXT_258 = NL + "        try{" + NL + "            deletedCount_";
  protected final String TEXT_259 = " = deletedCount_";
  protected final String TEXT_260 = " + pstmt_";
  protected final String TEXT_261 = ".executeUpdate();" + NL + "            nb_line_";
  protected final String TEXT_262 = "++;";
  protected final String TEXT_263 = NL + "        }catch(java.lang.Exception e)" + NL + "        {" + NL + "            whetherReject_";
  protected final String TEXT_264 = " = true;";
  protected final String TEXT_265 = NL + "                throw(e);";
  protected final String TEXT_266 = NL + "                nb_line_";
  ...
  protected final String TEXT_276 = NL + "                    rejectedCount_";
  protected final String TEXT_277 = " = rejectedCount_";
  protected final String TEXT_278 = " + 1;";
  protected final String TEXT_279 = NL + "                    ";
  protected final String TEXT_280 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_281 = NL + "                    ";
  protected final String TEXT_282 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_283 = ";";
  protected final String TEXT_284 = NL + "                    System.err.print(e.getMessage());";
  protected final String TEXT_285 = NL + "        }";
  protected final String TEXT_286 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_297 = NL + "                if ((batchSize_";
  protected final String TEXT_298 = " > 0) && (batchSize_";
  protected final String TEXT_299 = " <= batchSizeCounter_";
  protected final String TEXT_300 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_301 = " = 0;";
  protected final String TEXT_302 = NL + "                        pstmt_";
  protected final String TEXT_303 = ".executeBatch();";
  protected final String TEXT_304 = NL + "                        pstmt_";
  protected final String TEXT_305 = ".clearBatch();";
  protected final String TEXT_306 = NL + "                            insertedCount_";
  protected final String TEXT_307 = " += pstmt_";
  protected final String TEXT_308 = ".getUpdateCount();";
  protected final String TEXT_309 = NL + "                            updatedCount_";
  protected final String TEXT_310 = " += pstmt_";
  protected final String TEXT_311 = ". getUpdateCount();";
  protected final String TEXT_312 = NL + "                            deletedCount_";
  protected final String TEXT_313 = " += pstmt_";
  protected final String TEXT_314 = ". getUpdateCount();";
  protected final String TEXT_315 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_316 = NL + "                        throw(e);";
  protected final String TEXT_317 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_318 = NL + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_319 = NL + "                        throw(e);";
  protected final String TEXT_320 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_321 = NL + "                }" + NL + "                }";
  protected final String TEXT_322 = NL + "                commitCounter_";
  protected final String TEXT_323 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_324 = " <= commitCounter_";
  protected final String TEXT_325 = "){";
  protected final String TEXT_326 = NL + "                try {" + NL + "                    if(batchSizeCounter_";
  protected final String TEXT_327 = " >0){" + NL + "                        batchSizeCounter_";
  protected final String TEXT_328 = " = 0;";
  protected final String TEXT_329 = NL + "                        pstmt_";
  protected final String TEXT_330 = ".executeBatch();";
  protected final String TEXT_331 = NL + "                        pstmt_";
  protected final String TEXT_332 = ".clearBatch();" + NL + "          ";
  protected final String TEXT_333 = NL + "                            insertedCount_";
  protected final String TEXT_334 = " += pstmt_";
  protected final String TEXT_335 = ".getUpdateCount();";
  protected final String TEXT_336 = NL + "                            updatedCount_";
  protected final String TEXT_337 = " += pstmt_";
  protected final String TEXT_338 = ".getUpdateCount();";
  protected final String TEXT_339 = NL + "                            deletedCount_";
  protected final String TEXT_340 = " += pstmt_";
  protected final String TEXT_341 = ".getUpdateCount();";
  protected final String TEXT_342 = NL + "                    }    " + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_343 = NL + "                        throw(e);";
  protected final String TEXT_344 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_345 = NL + NL + "                }catch (java.sql.SQLException e){";
  ...
  protected final String TEXT_351 = NL + "                    commitCounter_";
  protected final String TEXT_352 = "=0;" + NL + "" + NL + "                }" + NL;
