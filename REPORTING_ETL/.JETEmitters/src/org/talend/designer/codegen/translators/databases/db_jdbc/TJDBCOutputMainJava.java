...
public class TJDBCOutputMainJava {
  ...
  protected final String TEXT_54 = NL + "                batchSize_";
  protected final String TEXT_55 = " = buffersSize_";
  protected final String TEXT_56 = ";";
  protected final String TEXT_57 = NL + "        whetherReject_";
  protected final String TEXT_58 = " = false;";
  ...
  protected final String TEXT_66 = NL + "            pstmt_";
  protected final String TEXT_67 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_68 = "++;" + NL + "            nb_line_";
  protected final String TEXT_69 = "++;" + NL;
  protected final String TEXT_70 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_71 = " = insertedCount_";
  protected final String TEXT_72 = " + pstmt_";
  protected final String TEXT_73 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_74 = "++;";
  protected final String TEXT_75 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_76 = " = true;";
  protected final String TEXT_77 = NL + "                    throw(e);";
  ...
  protected final String TEXT_86 = NL + "                        rejectedCount_";
  protected final String TEXT_87 = " = rejectedCount_";
  protected final String TEXT_88 = " + 1;";
  protected final String TEXT_89 = NL + "                        ";
  protected final String TEXT_90 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_105 = "_QUERY\", query_";
  protected final String TEXT_106 = ".toString().trim());";
  protected final String TEXT_107 = NL + "            pstmt_";
  protected final String TEXT_108 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_109 = "++;" + NL + "            nb_line_";
  protected final String TEXT_110 = "++;";
  protected final String TEXT_111 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_112 = " = updatedCount_";
  protected final String TEXT_113 = " + pstmt_";
  protected final String TEXT_114 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_127 = NL + "                        rejectedCount_";
  protected final String TEXT_128 = " = rejectedCount_";
  protected final String TEXT_129 = " + 1;";
  protected final String TEXT_130 = NL + "                        ";
  protected final String TEXT_131 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_132 = NL + "                        ";
  protected final String TEXT_133 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_134 = ";";
  protected final String TEXT_135 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_136 = NL + "            }";
  protected final String TEXT_137 = NL + "                    ";
  protected final String TEXT_138 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_139 = " = pstmt_";
  protected final String TEXT_140 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_141 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_142 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_143 = " = rs_";
  protected final String TEXT_144 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_155 = "_QUERY\", query_";
  protected final String TEXT_156 = ".toString().trim());";
  protected final String TEXT_157 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_158 = " = updatedCount_";
  protected final String TEXT_159 = " + pstmtUpdate_";
  protected final String TEXT_160 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_161 = "++;";
  protected final String TEXT_162 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_175 = NL + "                            rejectedCount_";
  protected final String TEXT_176 = " = rejectedCount_";
  ...
  protected final String TEXT_184 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_214 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_215 = NL + "                            ";
  protected final String TEXT_216 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_217 = ";";
  protected final String TEXT_218 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_219 = NL + "                }" + NL + "            }";
  protected final String TEXT_220 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_233 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_234 = " = pstmtUpdate_";
  protected final String TEXT_235 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_236 = " = updatedCount_";
  protected final String TEXT_237 = " + updateFlag_";
  protected final String TEXT_238 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_239 = " == 0) {";
  protected final String TEXT_240 = NL + "                query_";
  protected final String TEXT_241 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_249 = NL + "                    insertedCount_";
  protected final String TEXT_250 = " = insertedCount_";
  protected final String TEXT_251 = " + pstmtInsert_";
  protected final String TEXT_252 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_253 = "++;";
  protected final String TEXT_254 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_255 = "++;";
  protected final String TEXT_256 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_257 = " = true;";
  protected final String TEXT_258 = NL + "                        throw(e);";
  protected final String TEXT_259 = NL + "                        nb_line_";
  protected final String TEXT_260 = "++;";
  protected final String TEXT_261 = NL + "                            ";
  protected final String TEXT_262 = " = new ";
  protected final String TEXT_263 = "Struct();";
  protected final String TEXT_264 = NL + "                                ";
  protected final String TEXT_265 = ".";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = ".";
  protected final String TEXT_268 = ";";
  protected final String TEXT_269 = NL + "                            rejectedCount_";
  protected final String TEXT_270 = " = rejectedCount_";
  ...
  protected final String TEXT_280 = NL + "                        query_";
  protected final String TEXT_281 = " = ";
  protected final String TEXT_282 = ";";
  protected final String TEXT_283 = NL + "                globalMap.put(\"";
  protected final String TEXT_284 = "_QUERY\", query_";
  protected final String TEXT_285 = ".toString().trim());";
  protected final String TEXT_286 = NL + "                pstmt_";
  protected final String TEXT_287 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_288 = "++;" + NL + "                nb_line_";
  protected final String TEXT_289 = "++;";
  protected final String TEXT_290 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_291 = " = deletedCount_";
  protected final String TEXT_292 = " + pstmt_";
  protected final String TEXT_293 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_294 = "++;";
  protected final String TEXT_295 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_296 = " = true;";
  protected final String TEXT_297 = NL + "                    throw(e);";
  ...
  protected final String TEXT_308 = NL + "                        rejectedCount_";
  protected final String TEXT_309 = " = rejectedCount_";
  protected final String TEXT_310 = " + 1;";
  protected final String TEXT_311 = NL + "                        ";
  protected final String TEXT_312 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_313 = NL + "                        ";
  protected final String TEXT_314 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_315 = ";";
  protected final String TEXT_316 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_317 = NL + "            }";
  protected final String TEXT_318 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_329 = NL + "                if ((batchSize_";
  protected final String TEXT_330 = " > 0) && (batchSize_";
  protected final String TEXT_331 = " <= batchSizeCounter_";
  protected final String TEXT_332 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_333 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_334 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_335 = " = 0;";
  protected final String TEXT_336 = NL + "                        status_";
  protected final String TEXT_337 = " = pstmt_";
  protected final String TEXT_338 = ".executeBatch();";
  protected final String TEXT_339 = NL + "                        for(int countEach_";
  protected final String TEXT_340 = ": status_";
  protected final String TEXT_341 = ") {" + NL + "                            countSum_";
  protected final String TEXT_342 = " += (countEach_";
  protected final String TEXT_343 = " < 0 ? 0 : countEach_";
  protected final String TEXT_344 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_345 = NL + "                            throw(e);";
  protected final String TEXT_346 = NL + "                        for(int countEach_";
  protected final String TEXT_347 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_348 = " += (countEach_";
  protected final String TEXT_349 = " < 0 ? 0 : countEach_";
  protected final String TEXT_350 = ");" + NL + "                        }";
  protected final String TEXT_351 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_352 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_353 = " = pstmt_";
  protected final String TEXT_354 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_355 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_356 = " = tmp_batchUpdateCount_";
  protected final String TEXT_357 = " > countSum_";
  protected final String TEXT_358 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_359 = " : countSum_";
  protected final String TEXT_360 = ";";
  protected final String TEXT_361 = NL + "                        insertedCount_";
  protected final String TEXT_362 = " += tmp_batchUpdateCount_";
  protected final String TEXT_363 = ";";
  protected final String TEXT_364 = NL + "                        updatedCount_";
  protected final String TEXT_365 = " += tmp_batchUpdateCount_";
  protected final String TEXT_366 = ";";
  protected final String TEXT_367 = NL + "                        deletedCount_";
  protected final String TEXT_368 = " += tmp_batchUpdateCount_";
  protected final String TEXT_369 = ";";
  protected final String TEXT_370 = NL + "               }";
  protected final String TEXT_371 = NL + "                commitCounter_";
  protected final String TEXT_372 = "++;" + NL + "                if (commitEvery_";
  protected final String TEXT_373 = " <= commitCounter_";
  protected final String TEXT_374 = ") {";
  protected final String TEXT_375 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_376 = " > 0) {" + NL + "                        int countSum_";
  protected final String TEXT_377 = " = 0;";
  protected final String TEXT_378 = NL + "                        for(int countEach_";
  protected final String TEXT_379 = ": pstmt_";
  protected final String TEXT_380 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_381 = " += (countEach_";
  protected final String TEXT_382 = " < 0 ? 0 : countEach_";
  protected final String TEXT_383 = ");" + NL + "                        }";
  protected final String TEXT_384 = NL + "                            insertedCount_";
  protected final String TEXT_385 = " += countSum_";
  protected final String TEXT_386 = ";";
  protected final String TEXT_387 = NL + "                            updatedCount_";
  protected final String TEXT_388 = " += countSum_";
  protected final String TEXT_389 = ";";
  protected final String TEXT_390 = NL + "                            deletedCount_";
  protected final String TEXT_391 = " += countSum_";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = NL + "                        batchSizeCounter_";
  protected final String TEXT_394 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_395 = NL + "                        throw(e);";
  protected final String TEXT_396 = NL + "                        int countSum_";
  protected final String TEXT_397 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_398 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_399 = " += (countEach_";
  protected final String TEXT_400 = " < 0 ? 0 : countEach_";
  protected final String TEXT_401 = ");" + NL + "                        }";
  protected final String TEXT_402 = NL + "                            insertedCount_";
  protected final String TEXT_403 = " += countSum_";
  protected final String TEXT_404 = ";";
  protected final String TEXT_405 = NL + "                            updatedCount_";
  ...
  protected final String TEXT_411 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_412 = NL + "                }";
  protected final String TEXT_413 = NL;
  protected final String TEXT_414 = NL + "                connection_";
  protected final String TEXT_415 = ".commit();";
