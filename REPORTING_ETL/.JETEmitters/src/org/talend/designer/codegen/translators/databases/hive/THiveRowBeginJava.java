...
public class THiveRowBeginJava
{
  ...
  protected final String TEXT_297 = NL + "                \t\t\t\tmaprLogin_";
  protected final String TEXT_298 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_299 = ", ";
  protected final String TEXT_300 = ", decryptedMaprPassword_";
  protected final String TEXT_301 = ", ";
  protected final String TEXT_302 = ");" + NL + "                \t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_304 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_305 = ");";
  protected final String TEXT_306 = NL + "\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  ...
  protected final String TEXT_314 = "+ \";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_315 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  protected final String TEXT_316 = ";";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_318 = " = \"jdbc:";
  protected final String TEXT_319 = "://\" + ";
  protected final String TEXT_320 = " + \":\" + ";
  protected final String TEXT_321 = " + \"/\" + ";
  protected final String TEXT_322 = ";";
  protected final String TEXT_323 = NL + "\t\t\t\tString additionalJdbcSettings_";
  protected final String TEXT_324 = " = ";
  protected final String TEXT_325 = ";" + NL + "\t\t\t\tif(!\"\".equals(additionalJdbcSettings_";
  protected final String TEXT_326 = ".trim())) {" + NL + "\t\t\t\t\tif(!additionalJdbcSettings_";
  protected final String TEXT_327 = ".startsWith(\";\")) {" + NL + "\t\t\t\t\t\tadditionalJdbcSettings_";
  protected final String TEXT_328 = " = \";\" + additionalJdbcSettings_";
  protected final String TEXT_329 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\turl_";
  protected final String TEXT_330 = " += additionalJdbcSettings_";
  protected final String TEXT_331 = ";" + NL + "\t\t\t\t}";
  protected final String TEXT_332 = NL + "\t\tString driverClass_";
  protected final String TEXT_333 = " = \"";
  protected final String TEXT_334 = "\";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_335 = ");" + NL + "\t\t";
  protected final String TEXT_336 = NL + "\t\t";
  protected final String TEXT_337 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_338 = " - Connection attempt to '\" + url_";
  protected final String TEXT_339 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_340 = " + \"'.\");" + NL + "\t\t";
  protected final String TEXT_341 = NL + "\t\t\tconn_";
  protected final String TEXT_342 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_343 = ");";
  protected final String TEXT_344 = NL + "\t\t\tconn_";
  protected final String TEXT_345 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_346 = ", dbUser_";
  protected final String TEXT_347 = ", dbPwd_";
  protected final String TEXT_348 = ");";
  protected final String TEXT_349 = NL + "\t\t";
  protected final String TEXT_350 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_351 = " - Connection to '\" + url_";
  protected final String TEXT_352 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_353 = NL + NL + "\t\tjava.sql.Statement init_";
  ...
  protected final String TEXT_357 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_358 = ");" + NL + "\t    \tinit_";
  protected final String TEXT_359 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_360 = ");";
  protected final String TEXT_361 = NL + "\t\tinit_";
  protected final String TEXT_362 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_363 = ");";
  protected final String TEXT_364 = NL + "\t\t\tinit_";
  protected final String TEXT_365 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_366 = ");";
  protected final String TEXT_367 = NL + "\t\t\tinit_";
  protected final String TEXT_368 = ".execute(\"SET yarn.resourcemanager.principal=\" + ";
  protected final String TEXT_369 = ");";
  protected final String TEXT_370 = NL + "        \t\tinit_";
  protected final String TEXT_371 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "        \t\tinit_";
  protected final String TEXT_372 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_373 = ");";
  protected final String TEXT_374 = NL + "\t\t\t\tinit_";
  protected final String TEXT_375 = ".execute(\"SET mapreduce.jobhistory.address=\" + ";
  protected final String TEXT_376 = ");" + NL + "    \t\t\t";
  protected final String TEXT_377 = NL + "\t\t\t\tinit_";
  protected final String TEXT_378 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_379 = ");";
  protected final String TEXT_380 = NL + "                init_";
  protected final String TEXT_381 = ".execute(\"SET dfs.client.use.datanode.hostname=true\");";
  protected final String TEXT_382 = NL + "\t\t\t\tinit_";
  protected final String TEXT_383 = ".execute(\"SET fs.default.name=\" + ";
  protected final String TEXT_384 = ");";
  protected final String TEXT_385 = NL + "\t\t\t\t\tinit_";
  protected final String TEXT_386 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_387 = NL + "\t\t\t\t\tinit_";
  protected final String TEXT_388 = ".execute(\"SET mapreduce.job.map.output.collector.class=org.apache.hadoop.mapred.MapRFsOutputBuffer\");" + NL + "\t\t\t\t\tinit_";
  protected final String TEXT_389 = ".execute(\"SET mapreduce.job.reduce.shuffle.consumer.plugin.class=org.apache.hadoop.mapreduce.task.reduce.DirectShuffle\");";
  protected final String TEXT_390 = NL + "\t\t\t\t\tinit_";
  protected final String TEXT_391 = ".execute(\"SET mapreduce.application.classpath=";
  protected final String TEXT_392 = "\");";
  protected final String TEXT_393 = NL + "\t\t\t\tinit_";
  protected final String TEXT_394 = ".execute(\"SET yarn.application.classpath=";
  protected final String TEXT_395 = "\");";
  protected final String TEXT_396 = NL + "    \t\t\tinit_";
  protected final String TEXT_397 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_398 = ");" + NL + "    \t\t\tinit_";
  protected final String TEXT_399 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_400 = ");" + NL + "    \t\t\tinit_";
  protected final String TEXT_401 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_402 = ");";
  protected final String TEXT_403 = NL + "\t\t\t\tinit_";
  protected final String TEXT_404 = ".execute(\"SET \"+";
  ...
  protected final String TEXT_411 = ".execute(\"SET hive.execution.engine=tez\");";
  protected final String TEXT_412 = NL + "                        System.err.println(\"Please set the path of Tez lib in 'Tez lib path'!\");";
  protected final String TEXT_413 = NL;
  protected final String TEXT_414 = NL + "        String username_";
  protected final String TEXT_415 = " = (";
  protected final String TEXT_416 = " != null && !\"\".equals(";
  protected final String TEXT_417 = ")) ? ";
  protected final String TEXT_418 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_419 = " = null;";
  protected final String TEXT_420 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_421 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_422 = ".set(\"";
  protected final String TEXT_423 = "\", ";
  protected final String TEXT_424 = ");" + NL + "        ";
  protected final String TEXT_425 = NL + "            conf_";
  protected final String TEXT_426 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_427 = NL + "        \t\tconf_";
  protected final String TEXT_428 = ".set(";
  protected final String TEXT_429 = " ,";
  protected final String TEXT_430 = ");" + NL + "        \t";
  protected final String TEXT_431 = NL + "            username_";
  protected final String TEXT_432 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_433 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_434 = ");" + NL + "    \t\t";
  protected final String TEXT_435 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_436 = ", ";
  protected final String TEXT_437 = ");" + NL + "    \t\t";
  protected final String TEXT_438 = NL + "\t\t\tconf_";
  protected final String TEXT_439 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_440 = "+\",\"+username_";
  protected final String TEXT_441 = ");" + NL + "        \tfs_";
  protected final String TEXT_442 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_443 = ");";
  protected final String TEXT_444 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_445 = " == null || \"\".equals(username_";
  protected final String TEXT_446 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_447 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_448 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_449 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_450 = ".get(\"";
  protected final String TEXT_451 = "\")),conf_";
  protected final String TEXT_452 = ",username_";
  protected final String TEXT_453 = ");" + NL + "        \t}\t";
  protected final String TEXT_454 = NL + "                    String hdfsUserName_";
  protected final String TEXT_455 = " = (";
  protected final String TEXT_456 = " != null && !\"\".equals(";
  protected final String TEXT_457 = ")) ? ";
  protected final String TEXT_458 = " : System.getProperty(\"user.name\");" + NL + "                    String tezLibPath_";
  protected final String TEXT_459 = " = \"/tmp/\" + hdfsUserName_";
  protected final String TEXT_460 = " + \"/talend_tez_libs/";
  protected final String TEXT_461 = "\";";
  protected final String TEXT_462 = NL + "                    String tezLibPath_";
  protected final String TEXT_463 = " = ";
  protected final String TEXT_464 = ";";
  protected final String TEXT_465 = NL + "                fs_";
  protected final String TEXT_466 = ".mkdirs(new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_467 = "));";
  protected final String TEXT_468 = NL + "                String[] classPaths_";
  protected final String TEXT_469 = " = System.getProperty(\"java.class.path\").split(";
  protected final String TEXT_470 = "String.valueOf(globalMap.get(\"current_client_path_separator\"))";
  protected final String TEXT_471 = "System.getProperty(\"path.separator\")";
  protected final String TEXT_472 = ");" + NL + "                String tezLibLocalPath_";
  protected final String TEXT_473 = " = null;" + NL + "                for(String classPath_";
  protected final String TEXT_474 = " : classPaths_";
  protected final String TEXT_475 = "){";
  protected final String TEXT_476 = NL + "                        if(classPath_";
  protected final String TEXT_477 = ".endsWith(\"";
  protected final String TEXT_478 = "\")){" + NL + "                            org.apache.hadoop.fs.Path tezJarPath_";
  protected final String TEXT_479 = " = new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_480 = " + \"/";
  protected final String TEXT_481 = "\");" + NL + "                            if(!fs_";
  protected final String TEXT_482 = ".exists(tezJarPath_";
  protected final String TEXT_483 = ")){" + NL + "                                fs_";
  protected final String TEXT_484 = ".copyFromLocalFile(false, false, new org.apache.hadoop.fs.Path(classPath_";
  protected final String TEXT_485 = "), tezJarPath_";
  protected final String TEXT_486 = ");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_487 = NL + "                }";
  protected final String TEXT_488 = NL + "                String tezLibPath_";
  protected final String TEXT_489 = " = ";
  protected final String TEXT_490 = ";";
  protected final String TEXT_491 = NL + "\t\t\tStringBuilder script_";
  protected final String TEXT_492 = " = new StringBuilder();" + NL + "\t\t\tString[] tezLibPaths_";
  protected final String TEXT_493 = " = tezLibPath_";
  protected final String TEXT_494 = ".split(\",\");" + NL + "\t\t\tscript_";
  protected final String TEXT_495 = ".append(\"SET tez.lib.uris=\");" + NL + "\t\t\tint tezLibPathCount_";
  protected final String TEXT_496 = " = 1;" + NL + "\t\t\tfor(String tezLibPathKey_";
  protected final String TEXT_497 = " : tezLibPaths_";
  protected final String TEXT_498 = "){" + NL + "\t\t\t\t script_";
  protected final String TEXT_499 = ".append(";
  protected final String TEXT_500 = " + \"/\" + tezLibPathKey_";
  protected final String TEXT_501 = ");" + NL + "\t\t\t\t if(tezLibPathCount_";
  protected final String TEXT_502 = " < tezLibPaths_";
  protected final String TEXT_503 = ".length){" + NL + "\t\t\t\t \tscript_";
  protected final String TEXT_504 = ".append(\",\");" + NL + "\t\t\t\t }" + NL + "\t\t\t\t tezLibPathCount_";
  protected final String TEXT_505 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tinit_";
  protected final String TEXT_506 = ".execute(script_";
  protected final String TEXT_507 = ".toString());" + NL + "\t\t";
  protected final String TEXT_508 = NL + "            \t";
  protected final String TEXT_509 = NL + "\t\tinit_";
  protected final String TEXT_510 = ".close();" + NL + "" + NL + "    \tString dbname_";
  protected final String TEXT_511 = " = ";
  protected final String TEXT_512 = ";" + NL + "    \tif(dbname_";
  protected final String TEXT_513 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_514 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_515 = ".trim())) {" + NL + "        \tjava.sql.Statement goToDatabase_";
  protected final String TEXT_516 = " = conn_";
  protected final String TEXT_517 = ".createStatement();" + NL + "        \tgoToDatabase_";
  protected final String TEXT_518 = ".execute(\"use \" + dbname_";
  protected final String TEXT_519 = ");" + NL + "        \tgoToDatabase_";
  protected final String TEXT_520 = ".close();" + NL + "    \t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_521 = NL + "    \t\tjava.sql.Statement statement_";
  ...
  protected final String TEXT_525 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_526 = ");" + NL + "    \t\t";
  protected final String TEXT_527 = NL + NL + "        \t";
  protected final String TEXT_528 = NL + "        \t\tstatement_";
  protected final String TEXT_529 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_530 = ");" + NL + "        \t";
  protected final String TEXT_531 = NL + NL + "\t\t\t";
  protected final String TEXT_532 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_533 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_534 = ");" + NL + "\t\t\t";
  protected final String TEXT_535 = NL + NL + "\t\t\t";
  protected final String TEXT_536 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_537 = ".execute(\"SET hbase.security.authentication=kerberos\");" + NL + "\t\t\t\tstatement_";
  protected final String TEXT_538 = ".execute(\"SET hbase.rpc.engine=org.apache.hadoop.hbase.ipc.SecureRpcEngine\");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_539 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_540 = ".execute(\"SET hbase.master.kerberos.principal=\"+";
  protected final String TEXT_541 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_542 = NL + "\t\t\t\t";
  protected final String TEXT_543 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_544 = ".execute(\"SET hbase.regionserver.kerberos.principal=\"+";
  protected final String TEXT_545 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_546 = NL + "\t\t\t";
  protected final String TEXT_547 = NL + NL + "        \t";
  protected final String TEXT_548 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_549 = ".execute(\"add jar \"+";
  protected final String TEXT_550 = ");" + NL + "    \t\t";
  protected final String TEXT_551 = NL + "    \t\tstatement_";
  protected final String TEXT_552 = ".close();";
  protected final String TEXT_553 = NL + "\t\tif(true) {" + NL + "\t\t\tthrow new java.lang.UnsupportedOperationException(\"Parquet is only supported if the distribution uses embedded Hive version 0.10 or later.\");" + NL + "\t\t}";
  protected final String TEXT_554 = NL + "\t\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_555 = " = new routines.system.GetJarsToRegister();";
  protected final String TEXT_556 = NL + "\t\t\t\t";
  protected final String TEXT_557 = NL + "\tclass GetHiveJarsToRegister_";
  protected final String TEXT_558 = " extends routines.system.GetJarsToRegister {" + NL + "\t\t" + NL + "\t\tprivate String uploadJarToHDFS(String jar) throws Exception {" + NL + "\t\t\t";
  protected final String TEXT_559 = NL;
  protected final String TEXT_560 = NL + "        String username_";
  protected final String TEXT_561 = " = (";
  protected final String TEXT_562 = " != null && !\"\".equals(";
  protected final String TEXT_563 = ")) ? ";
  protected final String TEXT_564 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_565 = " = null;";
  protected final String TEXT_566 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_567 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_568 = ".set(\"";
  protected final String TEXT_569 = "\", ";
  protected final String TEXT_570 = ");" + NL + "        ";
  protected final String TEXT_571 = NL + "            conf_";
  protected final String TEXT_572 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_573 = NL + "        \t\tconf_";
  protected final String TEXT_574 = ".set(";
  protected final String TEXT_575 = " ,";
  protected final String TEXT_576 = ");" + NL + "        \t";
  protected final String TEXT_577 = NL + "            username_";
  protected final String TEXT_578 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_579 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_580 = ");" + NL + "    \t\t";
  protected final String TEXT_581 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_582 = ", ";
  protected final String TEXT_583 = ");" + NL + "    \t\t";
  protected final String TEXT_584 = NL + "\t\t\tconf_";
  protected final String TEXT_585 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_586 = "+\",\"+username_";
  protected final String TEXT_587 = ");" + NL + "        \tfs_";
  protected final String TEXT_588 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_589 = ");";
  protected final String TEXT_590 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_591 = " == null || \"\".equals(username_";
  protected final String TEXT_592 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_593 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_594 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_595 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_596 = ".get(\"";
  protected final String TEXT_597 = "\")),conf_";
  protected final String TEXT_598 = ",username_";
  protected final String TEXT_599 = ");" + NL + "        \t}\t";
  protected final String TEXT_600 = NL + "\t\t\t";
  protected final String TEXT_601 = NL + "\t\t\t" + NL + "\t\t\tString pathUsername_";
  protected final String TEXT_602 = " = username_";
  protected final String TEXT_603 = " == null ? org.apache.hadoop.security.UserGroupInformation.getLoginUser().getShortUserName() : username_";
  protected final String TEXT_604 = ";" + NL + "\t\t\tfs_";
  protected final String TEXT_605 = ".mkdirs(new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_606 = " + \"/tmp\"), new org.apache.hadoop.fs.permission.FsPermission(org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL));" + NL + "\t\t\tfs_";
  protected final String TEXT_607 = ".copyFromLocalFile(false, true, new org.apache.hadoop.fs.Path(jar), new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_608 = " + \"/tmp\"));" + NL + "\t\t\treturn ";
  protected final String TEXT_609 = " + \"/user/\" + pathUsername_";
  protected final String TEXT_610 = " + \"/tmp/\" + new java.io.File(jar).getName();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic String replaceJarPaths(String originalClassPathLine) throws Exception {" + NL + "\t\t\tString classPathLine = super.replaceJarPaths(originalClassPathLine);" + NL + "\t\t\tString hdfsPath = uploadJarToHDFS(classPathLine);" + NL + "\t\t\treturn hdfsPath;" + NL + "\t\t}" + NL + "\t}" + NL + "\t\t\t\tGetHiveJarsToRegister_";
  protected final String TEXT_611 = " getJarsToRegister_";
  protected final String TEXT_612 = " = new GetHiveJarsToRegister_";
  protected final String TEXT_613 = "();";
  protected final String TEXT_614 = NL + "\t\t\tjava.sql.Statement addJar_";
  protected final String TEXT_615 = " = null;";
  protected final String TEXT_616 = NL + "\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_617 = " = conn_";
  protected final String TEXT_618 = ".createStatement();" + NL + "\t\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_619 = ".execute(\"add jar \" + getJarsToRegister_";
  protected final String TEXT_620 = ".replaceJarPaths(\"";
  protected final String TEXT_621 = "\").replace(\"maprfs\", \"hdfs\"));" + NL + "\t\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t\t} finally {" + NL + "\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_622 = ".close();" + NL + "\t\t\t\t\t\t\t}";
  protected final String TEXT_623 = NL + "\t\t\t\t\t\t\tbw_";
  protected final String TEXT_624 = ".write(\"ADD JAR \" + wasbPath_";
  protected final String TEXT_625 = " + new java.io.File(getJarsToRegister_";
  protected final String TEXT_626 = ".replaceJarPaths(\"";
  protected final String TEXT_627 = "\")).getName() + \";\");" + NL + "\t\t\t\t\t\t\tlibjars_";
  protected final String TEXT_628 = ".append(getJarsToRegister_";
  protected final String TEXT_629 = ".replaceJarPaths(\"";
  protected final String TEXT_630 = "\") + \",\");";
  protected final String TEXT_631 = NL + "\t        if(conn_";
  protected final String TEXT_632 = ".getAutoCommit()) {" + NL + "\t            conn_";
  protected final String TEXT_633 = ".setAutoCommit(false);" + NL + "\t        }" + NL + "\t        int commitEvery_";
  protected final String TEXT_634 = " = ";
  protected final String TEXT_635 = ";" + NL + "\t        int commitCounter_";
  protected final String TEXT_636 = " = 0;" + NL + "\t        ";
  protected final String TEXT_637 = NL + "\t\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_638 = " = conn_";
  protected final String TEXT_639 = ".prepareStatement(";
  protected final String TEXT_640 = ");";
  protected final String TEXT_641 = NL + "\t\t\tjava.sql.Statement stmt_";
  protected final String TEXT_642 = " = conn_";
  protected final String TEXT_643 = ".createStatement();";
  protected final String TEXT_644 = NL + NL + "\tString query_";
  protected final String TEXT_645 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_646 = " = false;";
