...
public class TEXAOutputBeginJava {
  ...
  protected final String TEXT_56 = NL + "// schema is mandatory" + NL + "String tableName_";
  protected final String TEXT_57 = " = dbschema_";
  protected final String TEXT_58 = " + \".\" + ";
  protected final String TEXT_59 = ";";
  protected final String TEXT_60 = NL + "        int updateKeyCount_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_63 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_64 = NL + "        int deleteKeyCount_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_67 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_72 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_73 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_74 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_75 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_76 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_77 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_78 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  protected final String TEXT_79 = " = null;" + NL + "String dbUser_";
  protected final String TEXT_80 = " = null;" + NL;
  protected final String TEXT_81 = NL + "    conn_";
  protected final String TEXT_82 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_83 = "\");";
  protected final String TEXT_84 = NL + "        java.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_85 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "        if (null != dataSources_";
  ...
  protected final String TEXT_94 = ").getConnection();" + NL + "\t\t} else {";
  protected final String TEXT_95 = NL + "    java.lang.Class.forName(\"com.exasol.jdbc.EXADriver\");" + NL + "    String url_";
  protected final String TEXT_96 = " = \"jdbc:exa:\" + ";
  protected final String TEXT_97 = " + \":\" + ";
  protected final String TEXT_98 = " + \";schema=\" + ";
  protected final String TEXT_99 = " + \";\" + ";
  protected final String TEXT_100 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_128 = NL + "   int batchSize_";
  protected final String TEXT_129 = " = ";
  protected final String TEXT_130 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_131 = "=0;";
  protected final String TEXT_132 = NL;
  protected final String TEXT_133 = NL + "int count_";
  protected final String TEXT_134 = "=0;";
  protected final String TEXT_135 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_139 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_150 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_151 = "));";
  protected final String TEXT_152 = NL + "                    stmtCreate_";
  protected final String TEXT_153 = ".execute(((\"";
  protected final String TEXT_154 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_155 = ".";
  protected final String TEXT_156 = ", \"";
  protected final String TEXT_157 = "\")";
  protected final String TEXT_158 = ".toUpperCase()";
  ...
  protected final String TEXT_170 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_171 = "));";
  protected final String TEXT_172 = NL + "                    stmtCreate_";
  protected final String TEXT_173 = ".execute(((\"";
  protected final String TEXT_174 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_187 = NL + "                    String keyCheckTable_";
  protected final String TEXT_188 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_195 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_198 = " + \"]\";";
  protected final String TEXT_199 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_200 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_201 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_316 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_317 = " = ";
  protected final String TEXT_318 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_319 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_320 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_321 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_322 = " =  tableForSearch_";
  protected final String TEXT_323 = ".substring(1,tableForSearch_";
  protected final String TEXT_324 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_325 = " =  tableForSearch_";
  protected final String TEXT_326 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_330 = ".getTables(null, conn_";
  protected final String TEXT_331 = ".getSchema(), tableForSearch_";
  protected final String TEXT_332 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_333 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_334 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_335 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_341 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_342 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_343 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_344 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_345 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_346 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_347 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_569 = " =null;" + NL + "    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_570 = " =null;" + NL + "    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_579 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_585 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_586 = " = null;";
  protected final String TEXT_587 = NL + "\t\t \tString[] insertSQLSplits_";
