...
public class TImpalaOutputEndJava {
  ...
  protected final String TEXT_48 = NL + "        if(rowCount";
  protected final String TEXT_49 = " != 0) {" + NL + "            try {" + NL + "                stmt_";
  protected final String TEXT_50 = ".executeUpdate(sbValue_";
  protected final String TEXT_51 = ".toString().substring(0, sbValue_";
  protected final String TEXT_52 = ".toString().length()-1));";
  protected final String TEXT_53 = NL + "            } catch(java.lang.Exception e) {";
  protected final String TEXT_54 = NL + "                    throw e;";
  protected final String TEXT_55 = NL + "                    System.err.print(\"Exception in the component ";
  protected final String TEXT_56 = ":\" + e.getMessage());";
