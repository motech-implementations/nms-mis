...
public class TIngresOutputBeginJava {
  ...
  protected final String TEXT_52 = " = 0;" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_57 = " = 0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_58 = " = ";
  protected final String TEXT_59 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_60 = " = false;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_68 = NL + "        int updateKeyCount_";
  protected final String TEXT_69 = " = ";
  protected final String TEXT_70 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_71 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_72 = NL + "        int deleteKeyCount_";
  protected final String TEXT_73 = " = ";
  protected final String TEXT_74 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_75 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_81 = NL + "\tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "\t";
  protected final String TEXT_82 = NL + "\tString url_";
  protected final String TEXT_83 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_104 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_105 = "\", conn_";
  protected final String TEXT_106 = ");" + NL + "\tconn_";
  protected final String TEXT_107 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_137 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_153 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_168 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_169 = " + \"\\\" (";
  protected final String TEXT_170 = ") VALUES (";
  protected final String TEXT_171 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_172 = " = conn_";
  protected final String TEXT_173 = ".prepareStatement(insert_";
  protected final String TEXT_174 = ");" + NL + "\t    ";
  protected final String TEXT_175 = NL + "\t    String update_";
  protected final String TEXT_176 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_177 = " + \"\\\" SET ";
  protected final String TEXT_178 = " WHERE ";
  protected final String TEXT_179 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".prepareStatement(update_";
  protected final String TEXT_182 = ");" + NL + "\t    ";
  protected final String TEXT_183 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_184 = " = conn_";
  protected final String TEXT_185 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  ...
  protected final String TEXT_191 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = ".prepareStatement(insert_";
  protected final String TEXT_194 = ");" + NL + "\t    String update_";
  protected final String TEXT_195 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_196 = " + \"\\\" SET ";
  protected final String TEXT_197 = " WHERE ";
  protected final String TEXT_198 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_199 = " = conn_";
  protected final String TEXT_200 = ".prepareStatement(update_";
  ...
  protected final String TEXT_217 = NL + "\t    String delete_";
  protected final String TEXT_218 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_219 = " + \"\\\" WHERE ";
  protected final String TEXT_220 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_221 = " = conn_";
  protected final String TEXT_222 = ".prepareStatement(delete_";
  protected final String TEXT_223 = ");" + NL + "\t    ";
  protected final String TEXT_224 = NL + "        StringBuffer query_";
  protected final String TEXT_225 = " = null;" + NL + "       \t";
  protected final String TEXT_226 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_227 = " = insert_";
  ...
  protected final String TEXT_233 = NL + "\t\t\tupdate_";
  protected final String TEXT_234 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_235 = " = update_";
  protected final String TEXT_236 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_237 = " = insert_";
  protected final String TEXT_238 = ".split(\"\\\\?\");";
  protected final String TEXT_239 = NL + "\t\t\tdelete_";
  protected final String TEXT_240 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_241 = " = delete_";
  protected final String TEXT_242 = ".split(\"\\\\?\");";
  protected final String TEXT_243 = NL + "\t\t\treplace_";
  protected final String TEXT_244 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_245 = " = replace_";
  protected final String TEXT_246 = ".split(\"\\\\?\");";
  protected final String TEXT_247 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_248 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_249 = " = insertIgnore_";
  protected final String TEXT_250 = ".split(\"\\\\?\");";
  protected final String TEXT_251 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_252 = " = insert_";
  protected final String TEXT_253 = ".split(\"\\\\?\");";
  protected final String TEXT_254 = NL + NL + "\t        int commitEvery_";
  protected final String TEXT_255 = " = ";
  protected final String TEXT_256 = ";" + NL + "" + NL + "\t        int commitCounter_";
  protected final String TEXT_257 = " = 0;" + NL + "" + NL + "\t    \t";
