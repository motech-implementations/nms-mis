...
public class TAccessRowBeginJava
{
  ...
  protected final String TEXT_118 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_119 = ";           ";
  protected final String TEXT_120 = NL + "\t\t\t\tconn_";
  protected final String TEXT_121 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_122 = "\");" + NL + "\t\t\t";
  protected final String TEXT_123 = NL + "\t\t\t\tString driverClass_";
  protected final String TEXT_124 = " = \"";
  protected final String TEXT_125 = "\";" + NL + "\t\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_126 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_141 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_142 = ", dbUser_";
  protected final String TEXT_143 = ", dbPwd_";
  protected final String TEXT_144 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t\t\tString atnParams_";
  protected final String TEXT_146 = " = ";
  protected final String TEXT_147 = ";" + NL + "\t\t\t\t\tatnParams_";
  protected final String TEXT_148 = " = atnParams_";
  ...
  protected final String TEXT_155 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_156 = ".getBytes()));" + NL + "\t\t\t\t  " + NL + "\t\t\t\t\tconn_";
