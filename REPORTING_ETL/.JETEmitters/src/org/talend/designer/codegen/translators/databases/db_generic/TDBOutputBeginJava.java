...
public class TDBOutputBeginJava {
  ...
  protected final String TEXT_56 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_57 = " = false;" + NL;
  protected final String TEXT_58 = NL + "    String url_";
  protected final String TEXT_59 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_60 = ";";
  protected final String TEXT_61 = NL + "    String url_";
  protected final String TEXT_62 = " = \"jdbc:odbc:\" + ";
  protected final String TEXT_63 = ";";
  protected final String TEXT_64 = NL + "    String url_";
  protected final String TEXT_65 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_66 = " + \":\" + ";
  protected final String TEXT_67 = " + \":\" + ";
  protected final String TEXT_68 = ";";
  protected final String TEXT_69 = NL + "    String url_";
  protected final String TEXT_70 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_71 = " + \":\" + ";
  protected final String TEXT_72 = " + \"/\" + ";
  protected final String TEXT_73 = ";";
  protected final String TEXT_74 = NL + "    String url_";
  protected final String TEXT_75 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_76 = " + \":\" + ";
  protected final String TEXT_77 = " + \"/\" + ";
  protected final String TEXT_78 = ";";
  protected final String TEXT_79 = NL;
  protected final String TEXT_80 = NL + "        int updateKeyCount_";
  protected final String TEXT_81 = " = ";
  protected final String TEXT_82 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_83 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_84 = NL + "        int deleteKeyCount_";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_87 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_102 = ";" + NL + "" + NL + "String dbProperties_";
  protected final String TEXT_103 = " = ";
  protected final String TEXT_104 = ";" + NL + "java.sql.Connection conn_";
  protected final String TEXT_105 = " = null;";
  protected final String TEXT_106 = "\t" + NL + "if(dbProperties_";
  protected final String TEXT_107 = " == null || dbProperties_";
  protected final String TEXT_108 = ".trim().length() == 0) {" + NL + "\tconn_";
  ...
  protected final String TEXT_112 = ");" + NL + "}else{" + NL + "\tdbProperties_";
  protected final String TEXT_113 = " = dbProperties_";
  ...
  protected final String TEXT_120 = ".load(new java.io.ByteArrayInputStream(dbProperties_";
  ...
  protected final String TEXT_125 = NL + "resourceMap.put(\"conn_";
  protected final String TEXT_126 = "\", conn_";
  protected final String TEXT_127 = ");" + NL + "" + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\t\t  \tconn_";
  protected final String TEXT_129 = ".setAutoCommit(false);" + NL + "\t\t\t  ";
  protected final String TEXT_130 = NL;
  protected final String TEXT_131 = NL + "    java.sql.Statement stmtClear_";
  protected final String TEXT_132 = " = conn_";
  protected final String TEXT_133 = ".createStatement();" + NL + "    deletedCount_";
  protected final String TEXT_134 = " = deletedCount_";
  protected final String TEXT_135 = " + stmtClear_";
  protected final String TEXT_136 = ".executeUpdate(\"delete from \" + ";
  ...
  protected final String TEXT_143 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_144 = " = conn_";
  protected final String TEXT_145 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_146 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_147 = " = conn_";
  protected final String TEXT_148 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_155 = NL + "\t    \tjava.sql.Statement pstmt_";
  ...
  protected final String TEXT_162 = NL + "\t    \tString checkExist_";
  protected final String TEXT_163 = " = \"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_174 = NL + "\t    \tString[] checkExistSQLSplits_";
  protected final String TEXT_175 = " = (checkExist_";
  protected final String TEXT_176 = "+\" \").split(\"\\\\?\");" + NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtInsert_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = ".createStatement();" + NL + "\t    \tjava.sql.Statement pstmtUpdate_";
  ...
  protected final String TEXT_185 = ".prepareStatement(checkExist_";
  protected final String TEXT_186 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".prepareStatement(insert_";
  protected final String TEXT_189 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_190 = " = conn_";
  protected final String TEXT_191 = ".prepareStatement(update_";
  ...
  protected final String TEXT_197 = "\";" + NL + "\t    String insert_";
  protected final String TEXT_198 = " = \"INSERT INTO \" + ";
  protected final String TEXT_199 = " + \" (";
  protected final String TEXT_200 = ") VALUES (";
  protected final String TEXT_201 = ")\";" + NL + "\t    ";
  protected final String TEXT_202 = NL + "\t\t    java.sql.Statement pstmtUpdate_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".createStatement();" + NL + "\t\t    java.sql.Statement pstmtInsert_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();\t\t" + NL + "\t    ";
  ...
  protected final String TEXT_210 = ");" + NL + "\t\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".prepareStatement(insert_";
  protected final String TEXT_213 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_214 = NL + "\t    String delete_";
  protected final String TEXT_215 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_216 = " + \" WHERE ";
  protected final String TEXT_217 = "\";" + NL + "\t    ";
  protected final String TEXT_218 = NL + "\t    \tjava.sql.Statement pstmt_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".createStatement();" + NL + "\t    ";
  protected final String TEXT_221 = NL + "\t    \tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_222 = " = conn_";
  protected final String TEXT_223 = ".prepareStatement(delete_";
  protected final String TEXT_224 = ");" + NL + "\t    ";
  protected final String TEXT_225 = NL + "        StringBuffer query_";
  protected final String TEXT_226 = " = null;" + NL + "       \t";
  protected final String TEXT_227 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_228 = " = insert_";
  ...
  protected final String TEXT_237 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_238 = " = insert_";
  protected final String TEXT_239 = ".split(\"\\\\?\");";
  protected final String TEXT_240 = NL + "\t\t\tdelete_";
  protected final String TEXT_241 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_242 = " = delete_";
  protected final String TEXT_243 = ".split(\"\\\\?\");";
  protected final String TEXT_244 = NL + "\t\t\treplace_";
  protected final String TEXT_245 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_246 = " = replace_";
  protected final String TEXT_247 = ".split(\"\\\\?\");";
  protected final String TEXT_248 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_249 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_250 = " = insertIgnore_";
  protected final String TEXT_251 = ".split(\"\\\\?\");";
  protected final String TEXT_252 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_253 = " = insert_";
  protected final String TEXT_254 = ".split(\"\\\\?\");";
  protected final String TEXT_255 = NL + "\t    int commitEvery_";
  protected final String TEXT_256 = " = ";
  protected final String TEXT_257 = ";" + NL + "\t    int commitCounter_";
