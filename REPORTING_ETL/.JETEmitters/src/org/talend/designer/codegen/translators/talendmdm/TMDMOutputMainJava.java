...
public class TMDMOutputMainJava
{
  ...
  protected final String TEXT_198 = "Struct();" + NL;
  ...
  protected final String TEXT_210 = ".xml = input_";
  protected final String TEXT_211 = ";";
  protected final String TEXT_212 = NL + "                           ";
  protected final String TEXT_213 = ".xml = ";
  protected final String TEXT_214 = ".xml;";
  ...
  protected final String TEXT_220 = NL + "          System.err.println(e.getMessage());";
  protected final String TEXT_221 = NL + "    }" + NL + "    nb_line_";
