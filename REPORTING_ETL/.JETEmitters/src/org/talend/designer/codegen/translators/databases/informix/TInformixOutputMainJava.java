...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_475 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_534 = ".prepareStatement(delete_";
  protected final String TEXT_535 = ");" + NL + "\t    ";
  protected final String TEXT_536 = NL + "       \t";
  protected final String TEXT_537 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_559 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_560 = " = insertIgnore_";
  protected final String TEXT_561 = ".split(\"\\\\?\");";
  protected final String TEXT_562 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_573 = NL + "        whetherReject_";
  protected final String TEXT_574 = " = false;";
  ...
  protected final String TEXT_585 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_586 = ".";
  protected final String TEXT_587 = ", pstmt_";
  protected final String TEXT_588 = ", ";
  protected final String TEXT_589 = ", \"";
  protected final String TEXT_590 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_591 = NL + "                globalMap.put(\"";
  protected final String TEXT_592 = "_QUERY\", query_";
  protected final String TEXT_593 = ".toString().trim());";
  protected final String TEXT_594 = NL;
  protected final String TEXT_595 = NL + "    \t\tpstmt_";
  protected final String TEXT_596 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_597 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_598 = "++;";
  protected final String TEXT_599 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_600 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_601 = " = insertedCount_";
  protected final String TEXT_602 = " + pstmt_";
  protected final String TEXT_603 = ".executeUpdate();";
  ...
  protected final String TEXT_619 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_620 = NL + "                        ";
  protected final String TEXT_621 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_622 = ";";
  protected final String TEXT_623 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_629 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_630 = ",";
  protected final String TEXT_631 = ".";
  protected final String TEXT_632 = ", ";
  protected final String TEXT_633 = ",updateSQLSplits_";
  protected final String TEXT_634 = ");";
  protected final String TEXT_635 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_636 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_665 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_666 = "++;" + NL + "    \t\tbatchSizeCounter_";
  protected final String TEXT_667 = "++;";
  protected final String TEXT_668 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_669 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_670 = " = updatedCount_";
  protected final String TEXT_671 = " + pstmt_";
  protected final String TEXT_672 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_673 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_697 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_698 = " = pstmt_";
  protected final String TEXT_699 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_700 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_701 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_702 = " = rs_";
  protected final String TEXT_703 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_704 = " > 0) {";
  protected final String TEXT_705 = NL + "                        ";
  protected final String TEXT_706 = NL + "                            query_";
  protected final String TEXT_707 = " = ";
  protected final String TEXT_708 = ";";
  protected final String TEXT_709 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_710 = ",";
  protected final String TEXT_711 = ".";
  protected final String TEXT_712 = ", ";
  protected final String TEXT_713 = ",updateSQLSplits_";
  protected final String TEXT_714 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_715 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_716 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_717 = ".";
  protected final String TEXT_718 = ", pstmtUpdate_";
  ...
  protected final String TEXT_739 = NL + "                    globalMap.put(\"";
  protected final String TEXT_740 = "_QUERY\", query_";
  protected final String TEXT_741 = ".toString().trim());";
  protected final String TEXT_742 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_743 = " = updatedCount_";
  protected final String TEXT_744 = " + pstmtUpdate_";
  protected final String TEXT_745 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_746 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_747 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_748 = " = true;";
  protected final String TEXT_749 = NL + "                        throw(e);";
  protected final String TEXT_750 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_794 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_795 = " = true;";
  protected final String TEXT_796 = NL + "                        throw(e);";
  ...
  protected final String TEXT_817 = NL + "            int updateFlag_";
  protected final String TEXT_818 = "=0;";
  protected final String TEXT_819 = NL + "                    ";
  protected final String TEXT_820 = NL + "                        query_";
  protected final String TEXT_821 = " = ";
  protected final String TEXT_822 = ";";
  protected final String TEXT_823 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_824 = ",";
  protected final String TEXT_825 = ".";
  protected final String TEXT_826 = ", ";
  protected final String TEXT_827 = ",updateSQLSplits_";
  protected final String TEXT_828 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_829 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_830 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_831 = ".";
  protected final String TEXT_832 = ", pstmtUpdate_";
  ...
  protected final String TEXT_854 = NL + "                globalMap.put(\"";
  protected final String TEXT_855 = "_QUERY\", query_";
  protected final String TEXT_856 = ".toString().trim());";
  protected final String TEXT_857 = NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_858 = "=pstmtUpdate_";
  protected final String TEXT_859 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_860 = " = updatedCount_";
  protected final String TEXT_861 = " + updateFlag_";
  protected final String TEXT_862 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_863 = " == 0) {" + NL + "            \t";
  protected final String TEXT_864 = NL + "\t\t\t\tquery_";
  protected final String TEXT_865 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_866 = NL + "                        ";
  protected final String TEXT_867 = NL + "                            query_";
  protected final String TEXT_868 = " = ";
  protected final String TEXT_869 = ";";
  protected final String TEXT_870 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_871 = ",";
  protected final String TEXT_872 = ".";
  protected final String TEXT_873 = ", ";
  protected final String TEXT_874 = ",insertSQLSplits_";
  protected final String TEXT_875 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_876 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_877 = ".";
  protected final String TEXT_878 = ", pstmtInsert_";
  protected final String TEXT_879 = ", ";
  protected final String TEXT_880 = ", \"";
  protected final String TEXT_881 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_882 = NL + "                    globalMap.put(\"";
  protected final String TEXT_883 = "_QUERY\", query_";
  protected final String TEXT_884 = ".toString().trim());";
  protected final String TEXT_885 = NL + "                    insertedCount_";
  protected final String TEXT_886 = " = insertedCount_";
  protected final String TEXT_887 = " + pstmtInsert_";
  protected final String TEXT_888 = ".executeUpdate();" + NL + "             \t\tnb_line_";
  protected final String TEXT_889 = "++;";
  protected final String TEXT_890 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_891 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_892 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_893 = " = true;";
  protected final String TEXT_894 = NL + "                        throw(e);";
  protected final String TEXT_895 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_905 = NL + "                            rejectedCount_";
  protected final String TEXT_906 = " = rejectedCount_";
  protected final String TEXT_907 = " + 1;";
  protected final String TEXT_908 = NL + "                            ";
  protected final String TEXT_909 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_913 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_924 = NL + "                globalMap.put(\"";
  protected final String TEXT_925 = "_QUERY\", query_";
  protected final String TEXT_926 = ".toString().trim());";
  protected final String TEXT_927 = NL;
  protected final String TEXT_928 = NL + "\t\t    \t\tpstmt_";
  protected final String TEXT_929 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  protected final String TEXT_930 = "++;" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_931 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_932 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_933 = " = deletedCount_";
  protected final String TEXT_934 = " + pstmt_";
  protected final String TEXT_935 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_936 = "++;";
  protected final String TEXT_937 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_938 = " = true;";
  protected final String TEXT_939 = NL + "                    throw(e);";
  ...
  protected final String TEXT_954 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_955 = NL + "                        ";
  protected final String TEXT_956 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_957 = ";";
  protected final String TEXT_958 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_959 = NL + "            }" + NL + "\t\t";
  protected final String TEXT_960 = NL + "            if(!whetherReject_";
  protected final String TEXT_961 = ") {";
  protected final String TEXT_962 = NL + "                            ";
  protected final String TEXT_963 = " = new ";
  protected final String TEXT_964 = "Struct();";
  ...
  protected final String TEXT_971 = NL + "\t\t\t\tif ((batchSize_";
  protected final String TEXT_972 = " > 0) && (batchSize_";
  protected final String TEXT_973 = " <= batchSizeCounter_";
  protected final String TEXT_974 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_975 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_976 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_977 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_978 = ": pstmt_";
  protected final String TEXT_979 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_980 = " += (countEach_";
  protected final String TEXT_981 = " < 0 ? 0 : countEach_";
  protected final String TEXT_982 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_983 = NL + "            \t    \t";
  protected final String TEXT_984 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_985 = " += countSum_";
  protected final String TEXT_986 = ";" + NL + "            \t    \t";
  protected final String TEXT_987 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_988 = " += countSum_";
  protected final String TEXT_989 = ";" + NL + "            \t    \t";
  protected final String TEXT_990 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_991 = " += countSum_";
  protected final String TEXT_992 = ";" + NL + "            \t    \t";
  protected final String TEXT_993 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_994 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_995 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_996 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_997 = NL + "            commitCounter_";
  protected final String TEXT_998 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_999 = "<=commitCounter_";
  protected final String TEXT_1000 = ") {" + NL + "            \t";
  protected final String TEXT_1001 = NL + "                conn_";
  protected final String TEXT_1002 = ".commit();";
  protected final String TEXT_1003 = NL + "                commitCounter_";
  protected final String TEXT_1004 = " = 0;" + NL + "" + NL + "            }" + NL;
