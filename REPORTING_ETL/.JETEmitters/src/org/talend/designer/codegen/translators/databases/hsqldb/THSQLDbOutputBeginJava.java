...
public class THSQLDbOutputBeginJava {
  ...
  protected final String TEXT_49 = NL + "\t\t\turl_";
  protected final String TEXT_50 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_51 = " + \":\" + ";
  protected final String TEXT_52 = " + \"/\" + ";
  protected final String TEXT_53 = ";" + NL + "\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\turl_";
  protected final String TEXT_55 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_56 = " + \":\" + ";
  protected final String TEXT_57 = " + \"/\" + ";
  protected final String TEXT_58 = ";" + NL + "\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\turl_";
  protected final String TEXT_60 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_61 = " + \":\" + ";
  protected final String TEXT_62 = " + \"/\" + ";
  protected final String TEXT_63 = ";" + NL + "\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\turl_";
  protected final String TEXT_65 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_66 = " + \":\" + ";
  protected final String TEXT_67 = " + \"/\" + ";
  protected final String TEXT_68 = ";" + NL + "\t\t\t";
  protected final String TEXT_69 = NL + "\t\turl_";
  protected final String TEXT_70 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_71 = " + \"/\" + ";
  protected final String TEXT_72 = " ;" + NL + "\t\t";
  protected final String TEXT_73 = NL + "\t\turl_";
  protected final String TEXT_74 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_75 = " ;" + NL + "\t\t";
  protected final String TEXT_76 = NL + "\t\turl_";
  protected final String TEXT_77 = " += \";\" + ";
  protected final String TEXT_78 = ";";
  protected final String TEXT_79 = NL + NL + "int nb_line_";
  ...
  protected final String TEXT_83 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_84 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_85 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_86 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_87 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_88 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_89 = " = ";
  protected final String TEXT_90 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_91 = " = false;";
  protected final String TEXT_92 = NL;
  protected final String TEXT_93 = NL + "        int updateKeyCount_";
  protected final String TEXT_94 = " = ";
  protected final String TEXT_95 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_96 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_97 = NL + "        int deleteKeyCount_";
  protected final String TEXT_98 = " = ";
  protected final String TEXT_99 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_100 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_101 = " " + NL + "java.lang.Class.forName(\"org.hsqldb.jdbcDriver\");";
  ...
  protected final String TEXT_150 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_151 = ".equalsIgnoreCase(";
  protected final String TEXT_152 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_153 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_154 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_165 = ".createStatement();";
  protected final String TEXT_166 = NL + "                    stmtDrop_";
  protected final String TEXT_167 = ".execute(\"";
  protected final String TEXT_168 = "\");";
  protected final String TEXT_169 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_176 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_177 = " = conn_";
  protected final String TEXT_178 = ".createStatement();";
  protected final String TEXT_179 = NL + "            deletedCount_";
  protected final String TEXT_180 = " = deletedCount_";
  protected final String TEXT_181 = " + stmtClear_";
  protected final String TEXT_182 = ".executeUpdate(\"";
  protected final String TEXT_183 = "\");";
  protected final String TEXT_184 = NL + "\t    String insert_";
  protected final String TEXT_185 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_190 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_200 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_203 = " + \" WHERE ";
  protected final String TEXT_204 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_205 = " = \"INSERT INTO \" + ";
  protected final String TEXT_206 = " + \" (";
  protected final String TEXT_207 = ") VALUES (";
  protected final String TEXT_208 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_209 = " = conn_";
  protected final String TEXT_210 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_219 = NL + "\t    String update_";
  protected final String TEXT_220 = " = \"UPDATE \" + ";
  protected final String TEXT_221 = " + \" SET ";
  protected final String TEXT_222 = " WHERE ";
  protected final String TEXT_223 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".prepareStatement(update_";
  protected final String TEXT_226 = ");" + NL + "\t    String insert_";
  protected final String TEXT_227 = " = \"INSERT INTO \" + ";
  protected final String TEXT_228 = " + \" (";
  protected final String TEXT_229 = ") VALUES (";
  protected final String TEXT_230 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_231 = " = conn_";
  protected final String TEXT_232 = ".prepareStatement(insert_";
  protected final String TEXT_233 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_234 = NL + "\t    String delete_";
  protected final String TEXT_235 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_239 = ".prepareStatement(delete_";
  protected final String TEXT_240 = ");" + NL + "\t    ";
  protected final String TEXT_241 = NL + "        StringBuffer query_";
  protected final String TEXT_242 = " = null;" + NL + "       \t";
  protected final String TEXT_243 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_244 = " = insert_";
  ...
  protected final String TEXT_250 = NL + "\t\t\tupdate_";
  protected final String TEXT_251 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_252 = " = update_";
  protected final String TEXT_253 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_254 = " = insert_";
  protected final String TEXT_255 = ".split(\"\\\\?\");";
  protected final String TEXT_256 = NL + "\t\t\tdelete_";
  protected final String TEXT_257 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_258 = " = delete_";
  protected final String TEXT_259 = ".split(\"\\\\?\");";
  protected final String TEXT_260 = NL + "\t\t\treplace_";
  protected final String TEXT_261 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_262 = " = replace_";
  protected final String TEXT_263 = ".split(\"\\\\?\");";
  protected final String TEXT_264 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_265 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_266 = " = insertIgnore_";
  protected final String TEXT_267 = ".split(\"\\\\?\");";
  protected final String TEXT_268 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_269 = " = insert_";
  protected final String TEXT_270 = ".split(\"\\\\?\");";
  protected final String TEXT_271 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_272 = " = ";
  protected final String TEXT_273 = ";" + NL + "        " + NL + "        int commitCounter_";
