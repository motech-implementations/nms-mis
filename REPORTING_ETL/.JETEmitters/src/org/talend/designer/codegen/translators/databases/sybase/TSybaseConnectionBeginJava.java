...
public class TSybaseConnectionBeginJava
{
  ...
  protected final String TEXT_152 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_153 = "\", ";
  protected final String TEXT_154 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_155 = "\", ";
  protected final String TEXT_156 = ");" + NL + "\tglobalMap.put(\"db_";
  ...
  protected final String TEXT_162 = ");" + NL + "\tglobalMap.put(\"dbschema_";
