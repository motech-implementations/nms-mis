...
public class TMDMWriteConfMainJava
{
  ...
  protected final String TEXT_225 = "Struct();" + NL;
  protected final String TEXT_226 = NL + "              java.util.Map<String,String> rejectXmlFlow_";
  protected final String TEXT_227 = " = xmlFlowList_";
  protected final String TEXT_228 = ".get(flowNum_";
  protected final String TEXT_229 = ");" + NL + "              String rejectValueStr_";
  protected final String TEXT_230 = ";";
  protected final String TEXT_231 = NL + "                 rejectValueStr_";
  protected final String TEXT_232 = " = rejectXmlFlow_";
  protected final String TEXT_233 = ".get(\"";
  protected final String TEXT_234 = "\");" + NL + "                  if (rejectValueStr_";
  protected final String TEXT_235 = " != null){";
  protected final String TEXT_236 = NL + "                        ";
  protected final String TEXT_237 = ".";
  protected final String TEXT_238 = " = rejectValueStr_";
  protected final String TEXT_239 = ";";
  protected final String TEXT_240 = NL + "                        ";
  protected final String TEXT_241 = ".";
  protected final String TEXT_242 = " = ParserUtils.parseTo_Date(rejectValueStr_";
  protected final String TEXT_243 = ", ";
  protected final String TEXT_244 = ");";
  protected final String TEXT_245 = NL + "                        ";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = " = rejectValueStr_";
  protected final String TEXT_248 = ".getBytes();";
  protected final String TEXT_249 = NL + "                        ";
  protected final String TEXT_250 = ".";
  protected final String TEXT_251 = " = ParserUtils.parseTo_";
  protected final String TEXT_252 = "(rejectValueStr_";
  protected final String TEXT_253 = ");";
  protected final String TEXT_254 = NL + "                } else {";
  ...
  protected final String TEXT_262 = ".peek());";
  protected final String TEXT_263 = NL + "            ";
  protected final String TEXT_264 = ".";
  protected final String TEXT_265 = " = queue_";
  protected final String TEXT_266 = ".peek();";
