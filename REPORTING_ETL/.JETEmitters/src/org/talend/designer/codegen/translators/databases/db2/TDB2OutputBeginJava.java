...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_47 = NL + "class PrintSQLException_";
  protected final String TEXT_48 = "{" + NL + "\tpublic String getSQLException(java.sql.SQLException ex,boolean skipFirst) {" + NL + "\t\tStringBuilder fullErrorMessage = new java.lang.StringBuilder();" + NL + "    \tfor (Throwable e : ex) {" + NL + "    \t\tif(skipFirst){" + NL + "    \t\t    skipFirst=false;" + NL + "    \t\t    continue;" + NL + "    \t\t}" + NL + "        \tif (e instanceof java.sql.SQLException) {" + NL + "                fullErrorMessage.append(\"SQLState: \" +((java.sql.SQLException)e).getSQLState()+'\\n');" + NL + "                fullErrorMessage.append(\"Error Code: \" +((java.sql.SQLException)e).getErrorCode()+'\\n');" + NL + "                fullErrorMessage.append(\"Message: \" + e.getMessage());" + NL + "                Throwable t = ex.getCause();" + NL + "                while(t != null) {" + NL + "                    System.err.println(\"Cause: \" + t);" + NL + "                    fullErrorMessage .append(\"Cause: \" + t);" + NL + "                    t = t.getCause();" + NL + "                }" + NL + "        \t}" + NL + "    \t}" + NL + "    \treturn fullErrorMessage.toString();" + NL + "\t}" + NL + "}" + NL + "PrintSQLException_";
  protected final String TEXT_49 = " printSQLException_";
  protected final String TEXT_50 = " = new PrintSQLException_";
  protected final String TEXT_51 = "();" + NL + "int nb_line_";
  ...
  protected final String TEXT_56 = " = 0;" + NL + "int deletedCount_";
  protected final String TEXT_57 = " = 0;" + NL + "int updatedCount_";
  protected final String TEXT_58 = " = 0;" + NL + "int insertedCount_";
  protected final String TEXT_59 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_60 = " = 0;" + NL + "try{";
  ...
  protected final String TEXT_70 = NL + NL + NL + "boolean whetherReject_";
  protected final String TEXT_71 = " = false;" + NL + "java.sql.Connection conn_";
  protected final String TEXT_72 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_73 = " = null;" + NL + "String dbUser_";
  ...
  protected final String TEXT_79 = "\");" + NL + "    dbUser_";
  ...
  protected final String TEXT_94 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_95 = " + \":\" + ";
  protected final String TEXT_96 = " + \"/\" + ";
  protected final String TEXT_97 = ";";
  protected final String TEXT_98 = NL + "\t\tString url_";
  protected final String TEXT_99 = " = \"jdbc:db2://\" + ";
  protected final String TEXT_100 = " + \":\" + ";
  protected final String TEXT_101 = " + \"/\" + ";
  protected final String TEXT_102 = " + \":\" + ";
  protected final String TEXT_103 = ";";
  protected final String TEXT_104 = NL + "    java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\t";
  protected final String TEXT_105 = NL + "    dbUser_";
  ...
  protected final String TEXT_117 = ";" + NL + "" + NL + "    dbschema_";
  ...
  protected final String TEXT_135 = NL + "   int batchSize_";
  protected final String TEXT_136 = " = ";
  protected final String TEXT_137 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_138 = "=0;";
  protected final String TEXT_139 = NL + "String tableName_";
  protected final String TEXT_140 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_141 = " == null || dbschema_";
  protected final String TEXT_142 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_143 = " = ";
  protected final String TEXT_144 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_145 = " = dbschema_";
  protected final String TEXT_146 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_147 = ";" + NL + "}" + NL;
  protected final String TEXT_148 = NL + "int count_";
  protected final String TEXT_149 = "=0;";
  protected final String TEXT_150 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_154 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_185 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_186 = "));";
  protected final String TEXT_187 = NL + "                    stmtCreate_";
  protected final String TEXT_188 = ".execute(((\"";
  protected final String TEXT_189 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_190 = ".";
  protected final String TEXT_191 = ", \"";
  protected final String TEXT_192 = "\")";
  protected final String TEXT_193 = ".toUpperCase()";
  ...
  protected final String TEXT_218 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_221 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_222 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_223 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_224 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_225 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_230 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_231 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_232 = " = tableNameForSearch_";
  protected final String TEXT_233 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_234 = " = tableNameForSearch_";
  protected final String TEXT_235 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_236 = " = dbMetaData_";
  protected final String TEXT_237 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_238 = ", tableNameForSearch_";
  protected final String TEXT_239 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_240 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_241 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_242 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_249 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_263 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_281 = ".toUpperCase()";
  ...
  protected final String TEXT_287 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_288 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_297 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_298 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_299 = " == null || dbschema_";
  protected final String TEXT_300 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_301 = " = conn_";
  protected final String TEXT_302 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_303 = " = stmtSchema_";
  protected final String TEXT_304 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_305 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_306 = " = rsSchema_";
  protected final String TEXT_307 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_308 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_309 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_310 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_311 = " = rsTable_";
  protected final String TEXT_312 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_313 = " = rsTable_";
  protected final String TEXT_314 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_315 = ".equals";
  protected final String TEXT_316 = "IgnoreCase";
  protected final String TEXT_317 = "(";
  protected final String TEXT_318 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_324 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_325 = ".equals";
  protected final String TEXT_326 = "IgnoreCase";
  protected final String TEXT_327 = "(schema_";
  ...
  protected final String TEXT_331 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_332 = " = ";
  protected final String TEXT_333 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_334 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_335 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_336 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_337 = " =  tableForSearch_";
  protected final String TEXT_338 = ".substring(1,tableForSearch_";
  protected final String TEXT_339 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_340 = " =  tableForSearch_";
  protected final String TEXT_341 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_345 = ".getTables(null, conn_";
  protected final String TEXT_346 = ".getSchema(), tableForSearch_";
  protected final String TEXT_347 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_348 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_349 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_350 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_356 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_357 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_358 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_359 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_360 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_372 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_373 = ".equalsIgnoreCase(";
  protected final String TEXT_374 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_375 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_376 = ".close();";
  protected final String TEXT_377 = NL + "                                if(!whetherExist_";
  protected final String TEXT_378 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_398 = NL + "                                if(whetherExist_";
  protected final String TEXT_399 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_409 = NL + "                                    stmtDrop_";
  protected final String TEXT_410 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_430 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_431 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_432 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_433 = " = conn_";
  protected final String TEXT_434 = ".createStatement();";
  protected final String TEXT_435 = NL + "                              stmtClear_";
  protected final String TEXT_436 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_442 = ".close();";
  ...
  protected final String TEXT_446 = NL + "                              stmtTruncCount_";
  protected final String TEXT_447 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_448 = "));";
  protected final String TEXT_449 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_450 = " = stmtTruncCount_";
  protected final String TEXT_451 = ".executeQuery(\"";
  protected final String TEXT_452 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_453 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_454 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_458 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_465 = ".commit();";
  protected final String TEXT_466 = NL + "            stmtTrunc_";
  protected final String TEXT_467 = ".executeUpdate(\"";
  protected final String TEXT_468 = "\");";
  protected final String TEXT_469 = NL + "                if(!conn_";
  protected final String TEXT_470 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_471 = ".commit();" + NL + "                }";
  protected final String TEXT_472 = NL + "            deletedCount_";
  protected final String TEXT_473 = " += rsTruncCountNumber_";
  protected final String TEXT_474 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_475 = ".close();";
  protected final String TEXT_476 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_477 = " = conn_";
  protected final String TEXT_478 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_479 = " = stmtTruncCount_";
  protected final String TEXT_480 = ".executeQuery(\"";
  protected final String TEXT_481 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_482 = " = conn_";
  protected final String TEXT_483 = ".createStatement();";
  protected final String TEXT_484 = NL + "                conn_";
  protected final String TEXT_485 = ".commit();";
  protected final String TEXT_486 = NL + "            stmtTrunc_";
  protected final String TEXT_487 = ".executeUpdate(\"";
  protected final String TEXT_488 = "\");";
  protected final String TEXT_489 = NL + "            while(rsTruncCount_";
  protected final String TEXT_490 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_491 = " += rsTruncCount_";
  protected final String TEXT_492 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_493 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_494 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_502 = ".prepareStatement(insert_";
  protected final String TEXT_503 = ");" + NL + "\t    ";
  protected final String TEXT_504 = NL + "\t    String update_";
  protected final String TEXT_505 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_506 = " + \"\\\" SET ";
  ...
  protected final String TEXT_510 = ".prepareStatement(update_";
  ...
  protected final String TEXT_514 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_527 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_538 = ");" + NL + "\t    String insert_";
  protected final String TEXT_539 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_540 = " + \"\\\" (";
  protected final String TEXT_541 = ") VALUES (";
  protected final String TEXT_542 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_546 = NL + "\t    String delete_";
  protected final String TEXT_547 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_551 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_583 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_584 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_585 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_586 = " =null;" + NL + "\t";
  protected final String TEXT_587 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_588 = " = null;" + NL + "\t\t";
  protected final String TEXT_589 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_590 = " = null;";
  protected final String TEXT_591 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_592 = " =  null;";
  protected final String TEXT_593 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_594 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_595 = " = null;";
  protected final String TEXT_596 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_597 = " = null;";
  protected final String TEXT_598 = NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_604 = NL + "class SetPrepareStatementUtil_";
  protected final String TEXT_605 = " {";
  protected final String TEXT_606 = NL + "\t\t\tvoid set";
  protected final String TEXT_607 = "_";
  protected final String TEXT_608 = "(" + NL + "\t\t\t\tfinal ";
  protected final String TEXT_609 = "Struct ";
  protected final String TEXT_610 = "," + NL + "\t\t\t\tfinal java.sql.PreparedStatement";
  protected final String TEXT_611 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_612 = NL + "\t\t\t\tpstmtInsert_";
  protected final String TEXT_613 = NL + "\t\t\t\tpstmtUpdate_";
  protected final String TEXT_614 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal StringBuffer query_";
  protected final String TEXT_615 = NL + "\t\t\t\t," + NL + "\t\t\t\tfinal String[] ";
  protected final String TEXT_616 = NL + "\t\t\t) throws java.sql.SQLException {" + NL + "\t\t\t//}";
  ...
  protected final String TEXT_622 = NL + "}" + NL + "" + NL + "SetPrepareStatementUtil_";
  protected final String TEXT_623 = " setPrepareStatementUtil_";
  protected final String TEXT_624 = " = new SetPrepareStatementUtil_";
  protected final String TEXT_625 = "();" + NL;
  protected final String TEXT_626 = NL + NL + "class DataPropagateUtil_";
  protected final String TEXT_627 = " {";
  protected final String TEXT_628 = NL + "\t\t\tvoid assign_";
  protected final String TEXT_629 = "_";
  protected final String TEXT_630 = "(final ";
  protected final String TEXT_631 = "Struct ";
  protected final String TEXT_632 = ",final ";
  ...
  protected final String TEXT_642 = NL + "}" + NL + "" + NL + "DataPropagateUtil_";
  protected final String TEXT_643 = " dataPropagateUtil_";
  protected final String TEXT_644 = " = new DataPropagateUtil_";
