...
public class TSQLiteOutputEndJava {
  ...
  protected final String TEXT_60 = NL + "                    int[] status_";
  protected final String TEXT_61 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_62 = " = 0;" + NL + "                    try {" + NL + "                        if(pstmt_";
  protected final String TEXT_63 = "!=null && batchSizeCounter_";
  protected final String TEXT_64 = " > 0 ){";
  protected final String TEXT_65 = NL + "                            status_";
  protected final String TEXT_66 = " = pstmt_";
  protected final String TEXT_67 = ".executeBatch();";
  protected final String TEXT_68 = NL + "                            for(int countEach_";
  protected final String TEXT_69 = ": status_";
  protected final String TEXT_70 = ") {" + NL + "                                countSum_";
  protected final String TEXT_71 = " += (countEach_";
  protected final String TEXT_72 = " < 0 ? 0 : countEach_";
  protected final String TEXT_73 = ");" + NL + "                            }" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_74 = NL + "                            throw(e);";
  protected final String TEXT_75 = NL + "                        for(int countEach_";
  protected final String TEXT_76 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_77 = " += (countEach_";
  protected final String TEXT_78 = " < 0 ? 0 : countEach_";
  protected final String TEXT_79 = ");" + NL + "                        }" + NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_80 = NL + "                    }" + NL + "                    if(pstmt_";
  protected final String TEXT_81 = "!=null && batchSizeCounter_";
  protected final String TEXT_82 = " > 0 ){" + NL + "                        try {" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_83 = " = pstmt_";
  protected final String TEXT_84 = ".getUpdateCount();" + NL + "                        }catch (java.sql.SQLException e){" + NL + "" + NL + "                        }" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_85 = " = tmp_batchUpdateCount_";
  ...
  protected final String TEXT_90 = NL + "                            insertedCount_";
  protected final String TEXT_91 = " += tmp_batchUpdateCount_";
  protected final String TEXT_92 = ";";
  protected final String TEXT_93 = NL + "                            updatedCount_";
  protected final String TEXT_94 = " += tmp_batchUpdateCount_";
  protected final String TEXT_95 = ";";
  protected final String TEXT_96 = NL + "                            deletedCount_";
  protected final String TEXT_97 = " += tmp_batchUpdateCount_";
  protected final String TEXT_98 = ";";
  protected final String TEXT_99 = NL + "                    }";
  protected final String TEXT_100 = NL + "                    if(pstmt_";
  ...
  protected final String TEXT_111 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_112 = "\", true);";
  protected final String TEXT_113 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_114 = " = 0;";
  protected final String TEXT_115 = NL + "\tnb_line_deleted_";
  protected final String TEXT_116 = "=nb_line_deleted_";
  ...
  protected final String TEXT_121 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_122 = "=nb_line_inserted_";
  protected final String TEXT_123 = " + insertedCount_";
  protected final String TEXT_124 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_125 = "=nb_line_rejected_";
  protected final String TEXT_126 = " + rejectedCount_";
  protected final String TEXT_127 = ";" + NL + "\t";
  protected final String TEXT_128 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_129 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_130 = "_NB_LINE\",nb_line_";
  protected final String TEXT_131 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_132 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_133 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_134 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_136 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_137 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_139 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_140 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_141 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_144 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_147 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_150 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_151 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_152 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_153 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_154 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_155 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_156 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_168 = "_NB_LINE_REJECTED\", nb_line_rejected_";
