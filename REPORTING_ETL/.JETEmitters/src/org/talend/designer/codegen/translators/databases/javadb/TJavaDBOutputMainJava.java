...
public class TJavaDBOutputMainJava {
  ...
  protected final String TEXT_63 = ".toString().trim());";
  protected final String TEXT_64 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_65 = " = insertedCount_";
  protected final String TEXT_66 = " + pstmt_";
  protected final String TEXT_67 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_68 = "++;";
  protected final String TEXT_69 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_98 = "_QUERY\", query_";
  protected final String TEXT_99 = ".toString().trim());";
  ...
  protected final String TEXT_119 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_120 = NL + "                        ";
  protected final String TEXT_121 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_143 = "_QUERY\", query_";
  protected final String TEXT_144 = ".toString().trim());";
  ...
  protected final String TEXT_150 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_200 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_201 = NL + "                            ";
  protected final String TEXT_202 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_203 = ";";
  protected final String TEXT_204 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_205 = NL + "                }" + NL + "            }";
  protected final String TEXT_206 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_218 = ".toString().trim());";
  protected final String TEXT_219 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_220 = "=pstmtUpdate_";
  protected final String TEXT_221 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_222 = " != 0){" + NL + "                \tnb_line_";
  protected final String TEXT_223 = "++;" + NL + "\t\t\t\t\t";
  protected final String TEXT_224 = NL + "                }" + NL + "                updatedCount_";
  protected final String TEXT_225 = " = updatedCount_";
  protected final String TEXT_226 = "+updateFlag_";
  protected final String TEXT_227 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_238 = NL + "                        nb_line_rejected_";
  protected final String TEXT_239 = "++;";
  protected final String TEXT_240 = NL + "                        ";
  protected final String TEXT_241 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_246 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_247 = " == 0) {" + NL + "            \t";
  protected final String TEXT_248 = NL + "\t\t\t\tquery_";
  protected final String TEXT_249 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_250 = NL + "                        ";
  protected final String TEXT_251 = NL + "                            query_";
  protected final String TEXT_252 = " = ";
  protected final String TEXT_253 = ";";
  protected final String TEXT_254 = NL + "                    globalMap.put(\"";
  protected final String TEXT_255 = "_QUERY\", query_";
  protected final String TEXT_256 = ".toString().trim());";
  protected final String TEXT_257 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_258 = " = insertedCount_";
  protected final String TEXT_259 = " + pstmtInsert_";
  ...
  protected final String TEXT_275 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_303 = "Struct();";
  protected final String TEXT_304 = NL + "                            ";
  protected final String TEXT_305 = ".";
  protected final String TEXT_306 = " = ";
  protected final String TEXT_307 = ".";
  protected final String TEXT_308 = ";";
  protected final String TEXT_309 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_329 = NL + "            commitCounter_";
  protected final String TEXT_330 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_331 = " <= commitCounter_";
  protected final String TEXT_332 = ") {" + NL + "            \t";
  protected final String TEXT_333 = NL + "                conn_";
  protected final String TEXT_334 = ".commit();" + NL + "            \t";
  protected final String TEXT_335 = NL + "                commitCounter_";
  protected final String TEXT_336 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
