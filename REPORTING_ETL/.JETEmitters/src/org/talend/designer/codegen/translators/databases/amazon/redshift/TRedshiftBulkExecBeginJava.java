...
public class TRedshiftBulkExecBeginJava {
  ...
  protected final String TEXT_441 = NL + "\t\tStringBuilder avro_builder_";
  protected final String TEXT_442 = " = new StringBuilder();" + NL + "\t\tif(\"auto\".equals(";
  protected final String TEXT_443 = ")) {" + NL + "\t\t\tavro_builder_";
  protected final String TEXT_444 = ".append(\"FORMAT AS AVRO '\").append(\"auto\").append(\"' \");" + NL + "\t\t} else {" + NL + "\t\t\tavro_builder_";
  protected final String TEXT_445 = ".append(\"FORMAT AVRO '\").append(";
  protected final String TEXT_446 = ").append(\"' \");" + NL + "\t\t}";
  protected final String TEXT_447 = NL + "\t\tcommand_";
  protected final String TEXT_448 = ".append(\"s3://\").append(";
  protected final String TEXT_449 = ").append(\"/\").append(";
  protected final String TEXT_450 = ")";
  protected final String TEXT_451 = NL + "\t\tString hdfspath_";
  protected final String TEXT_452 = " = ";
  protected final String TEXT_453 = ";" + NL + "\t\tif(hdfspath_";
  protected final String TEXT_454 = "!=null && hdfspath_";
  protected final String TEXT_455 = ".startsWith(\"/\")) {" + NL + "\t\t\thdfspath_";
  protected final String TEXT_456 = " = hdfspath_";
  protected final String TEXT_457 = ".substring(1);" + NL + "\t\t}" + NL + "\t\tcommand_";
  protected final String TEXT_458 = ".append(\"emr://\").append(";
  protected final String TEXT_459 = ").append(\"/\").append(hdfspath_";
  protected final String TEXT_460 = ")";
  protected final String TEXT_461 = NL + "\t\tcommand_";
  protected final String TEXT_462 = ".append(\"dynamodb://\").append(";
  protected final String TEXT_463 = ")";
  protected final String TEXT_464 = NL + "\t\tcommand_";
  protected final String TEXT_465 = ".append(\"s3://\").append(";
  protected final String TEXT_466 = ").append(\"/\").append(";
  protected final String TEXT_467 = ")";
  protected final String TEXT_468 = NL + "\t.append(\"' \")" + NL + "\t" + NL + "\t.append(\"credentials 'aws_access_key_id=\").append(";
  protected final String TEXT_469 = ").append(\";aws_secret_access_key=\").append(decryptedPwd_";
  protected final String TEXT_470 = ")";
  protected final String TEXT_471 = NL + "\t\t.append(\";master_symmetric_key=\").append(";
  protected final String TEXT_472 = ")";
  protected final String TEXT_473 = NL + "\t.append(\"' \")";
  protected final String TEXT_474 = NL + "\t.append(\"READRATIO \").append(";
  protected final String TEXT_475 = ").append(\" \");";
  protected final String TEXT_476 = NL + "\t.append(\"SSH \")";
  protected final String TEXT_477 = NL + "\t.append(\"DELIMITER '\").append(fieldSeparator_";
  protected final String TEXT_478 = ").append(\"' \")";
  protected final String TEXT_479 = NL + "\t.append(\"JSON '\").append(";
  protected final String TEXT_480 = ").append(\"' \")";
  protected final String TEXT_481 = NL + "\t.append(avro_builder_";
  protected final String TEXT_482 = ")";
  protected final String TEXT_483 = NL + "\t.append(\"FIXEDWIDTH '\").append(";
  protected final String TEXT_484 = ").append(\"' \")";
  protected final String TEXT_485 = NL + "\t;";
  protected final String TEXT_486 = NL + "\tif(textEnclosure_";
  protected final String TEXT_487 = "!='\\0') {" + NL + "\t\tcommand_";
  protected final String TEXT_488 = ".append(\"CSV QUOTE '\").append(textEnclosure_";
  protected final String TEXT_489 = ").append(\"' \");" + NL + "\t}";
  protected final String TEXT_490 = NL + "\t\tcommand_";
  protected final String TEXT_491 = ".append(\"ENCODING \").append(";
  protected final String TEXT_492 = ").append(\" \");";
  protected final String TEXT_493 = NL + "\t\t\tcommand_";
  protected final String TEXT_494 = ".append(\"";
  protected final String TEXT_495 = " '\").append(";
  protected final String TEXT_496 = ").append(\"' \");";
  protected final String TEXT_497 = NL + "\t\t\tcommand_";
  protected final String TEXT_498 = ".append(\"";
  protected final String TEXT_499 = " \");";
  protected final String TEXT_500 = NL + "\t\t\tcommand_";
  protected final String TEXT_501 = ".append(\"";
  protected final String TEXT_502 = " \").append(";
  protected final String TEXT_503 = ").append(\" \");";
  protected final String TEXT_504 = NL + "\t\t\tcommand_";
  protected final String TEXT_505 = ".append(\"MAXERROR \").append(";
  protected final String TEXT_506 = ").append(\" \");";
  protected final String TEXT_507 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_508 = ".append(\"ACCEPTINVCHARS \");";
  protected final String TEXT_509 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_510 = ".append(\"ACCEPTINVCHARS '\").append(";
  protected final String TEXT_511 = ").append(\"' \");";
  protected final String TEXT_512 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_513 = ".append(\"";
  protected final String TEXT_514 = " ON \");";
  protected final String TEXT_515 = NL + "\t\t\t\tcommand_";
  protected final String TEXT_516 = ".append(\"";
  protected final String TEXT_517 = " OFF \");";
  protected final String TEXT_518 = NL + "\t\tcommand_";
  protected final String TEXT_519 = ".append(\"ENCRYPTED \");";
  protected final String TEXT_520 = NL + "\t\tcommand_";
  protected final String TEXT_521 = ".append(\"";
  protected final String TEXT_522 = " \");";
  protected final String TEXT_523 = NL + "\t\tcommand_";
  protected final String TEXT_524 = ".append(\"DATEFORMAT '\").append(";
  protected final String TEXT_525 = ").append(\"' \");";
  protected final String TEXT_526 = NL + "\t\tcommand_";
  protected final String TEXT_527 = ".append(\"DATEFORMAT 'auto' \");";
  protected final String TEXT_528 = NL + "\t\tcommand_";
  protected final String TEXT_529 = ".append(\"TIMEFORMAT '\").append(";
  protected final String TEXT_530 = ").append(\"' \");";
  protected final String TEXT_531 = NL + "\t\tcommand_";
  protected final String TEXT_532 = ".append(\"TIMEFORMAT 'auto' \");";
  protected final String TEXT_533 = NL + "\t\tcommand_";
  protected final String TEXT_534 = ".append(\"TIMEFORMAT 'epochsecs' \");";
  protected final String TEXT_535 = NL + "\t\tcommand_";
  protected final String TEXT_536 = ".append(\"TIMEFORMAT 'epochmillisecs' \");";
  protected final String TEXT_537 = NL + "\t" + NL + "\tjava.sql.Statement stmt_";
  protected final String TEXT_538 = "=conn_";
  protected final String TEXT_539 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_540 = ".execute(command_";
  protected final String TEXT_541 = ".toString());";
  protected final String TEXT_542 = NL + "\t\tif(stmt_";
  protected final String TEXT_543 = ".getWarnings()!=null) {";
  protected final String TEXT_544 = NL + "\t\t\tlog.warn(\"";
  protected final String TEXT_545 = " - \" + stmt_";
  protected final String TEXT_546 = ".getWarnings().getMessage());";
  protected final String TEXT_547 = NL + "\t\t\tSystem.err.println(stmt_";
  protected final String TEXT_548 = ".getWarnings().getMessage());";
  protected final String TEXT_549 = NL + "\t\t}";
  protected final String TEXT_550 = NL + "\t";
  protected final String TEXT_551 = NL + "\t\tlog.info(\"";
  protected final String TEXT_552 = " - Finish loading data to table : \" + tableName2_";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(avro_mapping);
