...
public class TEXABulkExecBeginJava {
  ...
  protected final String TEXT_411 = ".setOnlyBuildSQLCode(";
  protected final String TEXT_412 = ");";
  protected final String TEXT_413 = NL;
  protected final String TEXT_414 = ".setConnection(conn_";
  protected final String TEXT_415 = ");";
  protected final String TEXT_416 = NL;
  protected final String TEXT_417 = ".setTable(tableName_";
  protected final String TEXT_418 = ");";
  protected final String TEXT_419 = NL + "// Source is a file" + NL + "// setup the format of date values if no dedicated pattern is provided for a column ";
  protected final String TEXT_420 = NL;
  protected final String TEXT_421 = ".setDefaultDateFormat(";
  protected final String TEXT_422 = ");";
  protected final String TEXT_423 = NL + "// setup the format of timestamp values if no dedicated pattern is provided for a column";
  protected final String TEXT_424 = NL;
  protected final String TEXT_425 = ".setDefaultTimestampFormat(";
  protected final String TEXT_426 = ");";
  protected final String TEXT_427 = NL + "// setup numeric separators, default if nothing set is the English format";
  protected final String TEXT_428 = NL;
  protected final String TEXT_429 = ".setDefaultNumericCharacters(";
  ...
  protected final String TEXT_439 = ".setFileOptColumnSeparator(";
  protected final String TEXT_440 = ");";
  protected final String TEXT_441 = NL;
  protected final String TEXT_442 = ".setFileOptEncoding(";
  protected final String TEXT_443 = ");";
  protected final String TEXT_444 = NL;
  protected final String TEXT_445 = ".setFileOptRowSeparator(";
  protected final String TEXT_446 = ");";
  protected final String TEXT_447 = NL;
  protected final String TEXT_448 = ".setFileOptTrim(\"";
  protected final String TEXT_449 = "\");";
  protected final String TEXT_450 = NL;
  protected final String TEXT_451 = ".setFileOptSkip(";
  protected final String TEXT_452 = ");";
  protected final String TEXT_453 = NL;
  protected final String TEXT_454 = ".setFileOptNullIdentifier(";
  protected final String TEXT_455 = ");";
  protected final String TEXT_456 = NL + "// add column configurations";
  protected final String TEXT_457 = NL;
  protected final String TEXT_458 = ".addCSVDateColumn(\"";
  protected final String TEXT_459 = "\", null, ";
  protected final String TEXT_460 = ");";
  protected final String TEXT_461 = NL;
  protected final String TEXT_462 = ".addCSVNumberColumn(\"";
  protected final String TEXT_463 = "\", null, ";
  protected final String TEXT_464 = ", ";
  protected final String TEXT_465 = ", ";
  protected final String TEXT_466 = ");";
  protected final String TEXT_467 = NL;
  protected final String TEXT_468 = ".addCSVColumn(\"";
  protected final String TEXT_469 = "\", null);";
  protected final String TEXT_470 = NL;
  protected final String TEXT_471 = ".setRemoteExistingFileConnectionName(";
  protected final String TEXT_472 = ");";
  protected final String TEXT_473 = NL;
  protected final String TEXT_474 = ".setRemoteExistingDBConnectionName(";
  protected final String TEXT_475 = ");";
  protected final String TEXT_476 = NL;
  protected final String TEXT_477 = ".setRemoteUser(";
  protected final String TEXT_478 = ");";
  protected final String TEXT_479 = NL;
  protected final String TEXT_480 = ".setRemotePassword(";
  protected final String TEXT_481 = ");";
  protected final String TEXT_482 = NL;
  protected final String TEXT_483 = ".setLocalFilePath(";
  protected final String TEXT_484 = ");";
  protected final String TEXT_485 = NL;
  protected final String TEXT_486 = ".setTransferSecure(";
  protected final String TEXT_487 = ");";
  protected final String TEXT_488 = NL;
  protected final String TEXT_489 = ".setRemoteFileUrl(";
  protected final String TEXT_490 = ");";
  protected final String TEXT_491 = NL;
  protected final String TEXT_492 = ".setRemoteFileUrlParameters(";
  protected final String TEXT_493 = ");";
  protected final String TEXT_494 = NL;
  protected final String TEXT_495 = ".setRemoteFileName(";
  protected final String TEXT_496 = ");";
  protected final String TEXT_497 = NL;
  protected final String TEXT_498 = ".setDbmsSourceType(\"EXA\");";
  protected final String TEXT_499 = NL;
  protected final String TEXT_500 = ".setRemoteDbmsUrl(";
  protected final String TEXT_501 = ");";
  protected final String TEXT_502 = NL;
  protected final String TEXT_503 = ".setDbmsSourceType(\"JDBC\");";
  protected final String TEXT_504 = NL;
  protected final String TEXT_505 = ".setRemoteDbmsUrl(";
  protected final String TEXT_506 = ");";
  protected final String TEXT_507 = NL;
  protected final String TEXT_508 = ".setDbmsSourceType(\"ORA\");";
  protected final String TEXT_509 = NL;
  protected final String TEXT_510 = ".setRemoteDbmsUrl(";
  protected final String TEXT_511 = ");";
  protected final String TEXT_512 = NL;
  protected final String TEXT_513 = ".setRemoteSourceSelect(";
  protected final String TEXT_514 = ");";
  protected final String TEXT_515 = NL;
  protected final String TEXT_516 = ".setRemoteSourceTable(";
  protected final String TEXT_517 = ", ";
  protected final String TEXT_518 = ");";
  protected final String TEXT_519 = NL;
  protected final String TEXT_520 = ".addRemoteSourceTableColumn(\"";
  protected final String TEXT_521 = "\", ";
  protected final String TEXT_522 = ", null);";
  protected final String TEXT_523 = NL;
  protected final String TEXT_524 = ".setErrorRejectLimit(";
  protected final String TEXT_525 = ");";
  protected final String TEXT_526 = NL + "// setup error monitoring to a log table";
  protected final String TEXT_527 = NL;
  protected final String TEXT_528 = ".setErrorTableWithCurrentTimestamp(";
  protected final String TEXT_529 = ");";
  protected final String TEXT_530 = NL;
  protected final String TEXT_531 = ".setErrorTable(";
  protected final String TEXT_532 = ");";
  protected final String TEXT_533 = NL + "// setup error monitoring to a local log file";
  protected final String TEXT_534 = NL;
  protected final String TEXT_535 = ".setLocalErrorFileWithCurrentTimestamp(";
  protected final String TEXT_536 = ");";
  protected final String TEXT_537 = NL;
  protected final String TEXT_538 = ".setLocalErrorFile(";
  protected final String TEXT_539 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_540 = "_ERROR_LOG_FILE\", ";
  protected final String TEXT_541 = ".getLocalErrorFile());";
  protected final String TEXT_542 = NL + "// execute the import" + NL + "try {";
  protected final String TEXT_543 = NL + "\t globalMap.put(\"";
  protected final String TEXT_544 = "_FILENAME\", ";
  protected final String TEXT_545 = ".getLocalFilePath());";
  protected final String TEXT_546 = NL + "    ";
  protected final String TEXT_547 = ".executeImport();" + NL + "    insertedCount_";
  protected final String TEXT_548 = " = ";
  protected final String TEXT_549 = ".getCountAffectedRows();";
  protected final String TEXT_550 = NL + "    ";
  protected final String TEXT_551 = ".commitAndClose();";
  protected final String TEXT_552 = NL + "    globalMap.put(\"";
  protected final String TEXT_553 = "_NB_LINE_INSERTED\", insertedCount_";
  protected final String TEXT_554 = "); " + NL + "} catch (Exception e) {" + NL + "\t globalMap.put(\"";
  protected final String TEXT_555 = "_ERROR_MESSAGE\", \"Import failed: \" + e.getMessage());";
  protected final String TEXT_556 = NL + "    ";
  protected final String TEXT_557 = ".rollbackAndClose();";
  protected final String TEXT_558 = NL + "\t throw e;" + NL + "}";
