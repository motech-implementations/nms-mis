...
public class TPostgresPlusOutputMainJava {
  ...
  protected final String TEXT_113 = "_QUERY\", query_";
  protected final String TEXT_114 = ".toString().trim());";
  protected final String TEXT_115 = NL;
  protected final String TEXT_116 = NL + "                       pstmt_";
  protected final String TEXT_117 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_118 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_119 = "++;";
  protected final String TEXT_120 = NL + "                       try {" + NL + "                           updatedCount_";
  protected final String TEXT_121 = " = updatedCount_";
  protected final String TEXT_122 = " + pstmt_";
  protected final String TEXT_123 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_124 = "++;";
  protected final String TEXT_125 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_126 = " = true;";
  ...
  protected final String TEXT_136 = NL + "                                   rejectedCount_";
  protected final String TEXT_137 = " = rejectedCount_";
  protected final String TEXT_138 = " + 1;";
  protected final String TEXT_139 = NL + "                                   ";
  protected final String TEXT_140 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_149 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_150 = " = pstmt_";
  protected final String TEXT_151 = ".executeQuery();" + NL + "            int checkCount_";
  ...
  protected final String TEXT_200 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_252 = "_QUERY\", query_";
  protected final String TEXT_253 = ".toString().trim());";
  protected final String TEXT_254 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_255 = "=pstmtUpdate_";
  protected final String TEXT_256 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_257 = " = updatedCount_";
  protected final String TEXT_258 = "+updateFlag_";
  protected final String TEXT_259 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_260 = " == 0) {" + NL + "            \t";
  protected final String TEXT_261 = NL + "\t\t\t\tquery_";
  protected final String TEXT_262 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_263 = NL + "                        ";
  protected final String TEXT_264 = NL + "                            query_";
  protected final String TEXT_265 = " = ";
  protected final String TEXT_266 = ";";
  protected final String TEXT_267 = NL + "                    globalMap.put(\"";
  protected final String TEXT_268 = "_QUERY\", query_";
  protected final String TEXT_269 = ".toString().trim());";
  protected final String TEXT_270 = NL + "                    insertedCount_";
  protected final String TEXT_271 = " = insertedCount_";
  protected final String TEXT_272 = " + pstmtInsert_";
  protected final String TEXT_273 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_274 = "++;";
  protected final String TEXT_275 = NL + "             }else{" + NL + "             \t   nb_line_";
  protected final String TEXT_276 = "++;" + NL + "             \t   ";
  protected final String TEXT_277 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_290 = NL + "                            rejectedCount_";
  protected final String TEXT_291 = " = rejectedCount_";
  protected final String TEXT_292 = " + 1;";
  protected final String TEXT_293 = NL + "                            ";
  protected final String TEXT_294 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_306 = NL + "                        query_";
  protected final String TEXT_307 = " = ";
  protected final String TEXT_308 = ";";
  protected final String TEXT_309 = NL + "                globalMap.put(\"";
  protected final String TEXT_310 = "_QUERY\", query_";
  protected final String TEXT_311 = ".toString().trim());";
  protected final String TEXT_312 = NL + "                       pstmt_";
  protected final String TEXT_313 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_314 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_315 = "++;";
  protected final String TEXT_316 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_317 = " = deletedCount_";
  protected final String TEXT_318 = " + pstmt_";
  protected final String TEXT_319 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_320 = "++;";
  protected final String TEXT_321 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_322 = " = true;";
  protected final String TEXT_323 = NL + "                               throw(e);";
  protected final String TEXT_324 = NL + "                               nb_line_";
  protected final String TEXT_325 = "++;";
  protected final String TEXT_326 = NL + "                                   ";
  protected final String TEXT_327 = " = new ";
  protected final String TEXT_328 = "Struct();";
  protected final String TEXT_329 = NL + "                                       ";
  protected final String TEXT_330 = ".";
  protected final String TEXT_331 = " = ";
  protected final String TEXT_332 = ".";
  protected final String TEXT_333 = ";";
  protected final String TEXT_334 = NL + "                                   rejectedCount_";
  protected final String TEXT_335 = " = rejectedCount_";
  protected final String TEXT_336 = " + 1;";
  protected final String TEXT_337 = NL + "                                   ";
  protected final String TEXT_338 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_339 = NL + "                                   ";
  protected final String TEXT_340 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_341 = ";";
  protected final String TEXT_342 = NL + "                                   System.err.print(e.getMessage());";
