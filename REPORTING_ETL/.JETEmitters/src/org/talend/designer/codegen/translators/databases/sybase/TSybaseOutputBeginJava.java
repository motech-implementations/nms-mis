...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_56 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_59 = " = false;" + NL + "String dbschema_";
  ...
  protected final String TEXT_77 = NL + "    String dbUser_";
  ...
  protected final String TEXT_87 = NL + NL + "    String dbPwd_";
  protected final String TEXT_88 = " = decryptedPassword_";
  protected final String TEXT_89 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\t";
  ...
  protected final String TEXT_111 = ".setAutoCommit(false);";
  protected final String TEXT_112 = NL + "        int commitEvery_";
  protected final String TEXT_113 = " = ";
  protected final String TEXT_114 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_115 = " = 0;";
  protected final String TEXT_116 = NL;
  protected final String TEXT_117 = NL + "   int batchSize_";
  protected final String TEXT_118 = " = ";
  protected final String TEXT_119 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_127 = NL + "int count_";
  ...
  protected final String TEXT_133 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_140 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_144 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_152 = ".toUpperCase()";
  ...
  protected final String TEXT_197 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_200 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_201 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_202 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_203 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_204 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_209 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_210 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_211 = " = tableNameForSearch_";
  protected final String TEXT_212 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_213 = " = tableNameForSearch_";
  protected final String TEXT_214 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_215 = " = dbMetaData_";
  protected final String TEXT_216 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_217 = ", tableNameForSearch_";
  protected final String TEXT_218 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_219 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_220 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_221 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_231 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_232 = " = rsTable_";
  protected final String TEXT_233 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  ...
  protected final String TEXT_242 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_260 = ".toUpperCase()";
  ...
  protected final String TEXT_266 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_267 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_268 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_269 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_270 = ".close();";
  ...
  protected final String TEXT_276 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_277 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_278 = " == null || dbschema_";
  protected final String TEXT_279 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_282 = " = stmtSchema_";
  protected final String TEXT_283 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_284 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_285 = " = rsSchema_";
  protected final String TEXT_286 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_287 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_288 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_303 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_304 = ".equals";
  protected final String TEXT_305 = "IgnoreCase";
  protected final String TEXT_306 = "(schema_";
  protected final String TEXT_307 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_308 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_309 = ".close();";
  protected final String TEXT_310 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_311 = " = ";
  protected final String TEXT_312 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_313 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_314 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_315 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_316 = " =  tableForSearch_";
  protected final String TEXT_317 = ".substring(1,tableForSearch_";
  protected final String TEXT_318 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_319 = " =  tableForSearch_";
  protected final String TEXT_320 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_324 = ".getTables(null, conn_";
  protected final String TEXT_325 = ".getSchema(), tableForSearch_";
  protected final String TEXT_326 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_327 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_328 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_329 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_335 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_336 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_337 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_338 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_339 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_340 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_341 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_476 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_481 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_487 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_491 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_514 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_521 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_532 = NL + "        StringBuffer query_";
  protected final String TEXT_533 = " = null;" + NL + "       \t";
  protected final String TEXT_534 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_535 = " = insert_";
  protected final String TEXT_536 = ".split(\"\\\\?\");";
  protected final String TEXT_537 = NL + "\t\t\tupdate_";
  protected final String TEXT_538 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_539 = " = update_";
  protected final String TEXT_540 = ".split(\"\\\\?\");";
  protected final String TEXT_541 = NL + "\t\t\tupdate_";
  protected final String TEXT_542 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_543 = " = update_";
  protected final String TEXT_544 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_545 = " = insert_";
  protected final String TEXT_546 = ".split(\"\\\\?\");";
  protected final String TEXT_547 = NL + "\t\t\tdelete_";
  protected final String TEXT_548 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_549 = " = delete_";
  protected final String TEXT_550 = ".split(\"\\\\?\");";
  protected final String TEXT_551 = NL + "\t\t\treplace_";
  protected final String TEXT_552 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_553 = " = replace_";
  protected final String TEXT_554 = ".split(\"\\\\?\");";
  protected final String TEXT_555 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_556 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_557 = " = insertIgnore_";
  protected final String TEXT_558 = ".split(\"\\\\?\");";
  protected final String TEXT_559 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_560 = " = insert_";
  protected final String TEXT_561 = ".split(\"\\\\?\");";
  protected final String TEXT_562 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_563 = " = conn_";
  protected final String TEXT_564 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_565 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_566 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_567 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_568 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_569 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_570 = " =null;" + NL + "\t";
  protected final String TEXT_571 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_577 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_578 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_579 = " = null;";
  protected final String TEXT_580 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_581 = " = null;";
  protected final String TEXT_582 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_583 = " = null;";
  protected final String TEXT_584 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_585 = " = null;";
  protected final String TEXT_586 = NL + "\t\t \tString[] insertSQLSplits_";
