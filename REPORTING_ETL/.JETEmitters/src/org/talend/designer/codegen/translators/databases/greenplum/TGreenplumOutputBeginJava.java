...
public class TGreenplumOutputBeginJava {
  ...
  protected final String TEXT_97 = " = \"org.postgresql.Driver\";" + NL + "\t";
  protected final String TEXT_98 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_99 = ");" + NL + "    String url_";
  protected final String TEXT_100 = " = \"jdbc:postgresql://\"+";
  ...
  protected final String TEXT_113 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_124 = ".setAutoCommit(false);" + NL + "\t";
  ...
  protected final String TEXT_148 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_149 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_150 = " == null || dbschema_";
  protected final String TEXT_151 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_152 = " = conn_";
  protected final String TEXT_153 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_154 = " = stmtSchema_";
  protected final String TEXT_155 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_156 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_157 = " = rsSchema_";
  protected final String TEXT_158 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_159 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_160 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  protected final String TEXT_161 = ".next()) {" + NL + "                String table_";
  protected final String TEXT_162 = " = rsTable_";
  protected final String TEXT_163 = ".getString(\"TABLE_NAME\");" + NL + "             \tString schema_";
  protected final String TEXT_164 = " = rsTable_";
  protected final String TEXT_165 = ".getString(\"TABLE_SCHEM\");" + NL + "                if(table_";
  protected final String TEXT_166 = ".equals(";
  protected final String TEXT_167 = ") && (schema_";
  protected final String TEXT_168 = ".equals(dbschema_";
  ...
  protected final String TEXT_172 = ".equals(schema_";
  protected final String TEXT_173 = ")))) {" + NL + "                    whetherExist_";
  protected final String TEXT_174 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_175 = NL + "                if(!whetherExist_";
  protected final String TEXT_176 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_190 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_193 = NL + "                stmtCreate_";
  protected final String TEXT_194 = ".execute(\"";
  protected final String TEXT_195 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_196 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_197 = " = conn_";
  protected final String TEXT_198 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_199 = " = stmtClearCount_";
  protected final String TEXT_200 = ".executeQuery(\"";
  protected final String TEXT_201 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_204 = NL + "            stmtClear_";
  protected final String TEXT_205 = ".executeUpdate(\"";
  protected final String TEXT_206 = "\");" + NL + "\t\t\t";
  protected final String TEXT_207 = NL + "            while(rsClearCount_";
  protected final String TEXT_208 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_209 = " += rsClearCount_";
  protected final String TEXT_210 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_211 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_212 = " = conn_";
  protected final String TEXT_213 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_214 = " + \"\\\" (";
  protected final String TEXT_215 = ") VALUES (";
  protected final String TEXT_216 = ")\");" + NL + "\t    ";
  protected final String TEXT_217 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_218 = " = conn_";
  protected final String TEXT_219 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_220 = " + \"\\\" SET ";
  protected final String TEXT_221 = " WHERE ";
  protected final String TEXT_222 = "\");" + NL + "\t    ";
  protected final String TEXT_223 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_224 = " = conn_";
  protected final String TEXT_225 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_226 = " + \"\\\" WHERE ";
  protected final String TEXT_227 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_228 = " = conn_";
  protected final String TEXT_229 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_230 = " + \"\\\" (";
  protected final String TEXT_231 = ") VALUES (";
  protected final String TEXT_232 = ")\");" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_233 = " = conn_";
  protected final String TEXT_234 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_235 = " + \"\\\" SET ";
  protected final String TEXT_236 = " WHERE ";
  protected final String TEXT_237 = "\");" + NL + "\t    ";
  protected final String TEXT_238 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".prepareStatement(\"UPDATE \\\"\" + tableName_";
  protected final String TEXT_241 = " + \"\\\" SET ";
  protected final String TEXT_242 = " WHERE ";
  protected final String TEXT_243 = "\");" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".prepareStatement(\"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_251 = ".prepareStatement(\"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_252 = " + \"\\\" WHERE ";
  protected final String TEXT_253 = "\");" + NL + "\t    ";
  protected final String TEXT_254 = NL + "            int commitEvery_";
  protected final String TEXT_255 = " = ";
  protected final String TEXT_256 = ";" + NL + "            int commitCounter_";
