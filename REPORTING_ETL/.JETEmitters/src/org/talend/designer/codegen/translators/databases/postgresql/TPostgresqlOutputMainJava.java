...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_525 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_573 = NL + "                            geometryColumnName_";
  protected final String TEXT_574 = " = \"";
  protected final String TEXT_575 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_576 = ") {" + NL + "                                dimension_";
  protected final String TEXT_577 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_578 = ".";
  protected final String TEXT_579 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_580 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_581 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_582 = ".";
  protected final String TEXT_583 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_584 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_585 = " = refSys_";
  protected final String TEXT_586 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_587 = " = refSys_";
  protected final String TEXT_588 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_589 = " == null || ident_";
  protected final String TEXT_590 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_591 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_592 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_593 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_594 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_595 = " = Integer.parseInt(code_";
  protected final String TEXT_596 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_597 = " = \"SRID_";
  protected final String TEXT_598 = " could not be determined\";";
  protected final String TEXT_599 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_600 = ");" + NL + "                                            SRID_";
  protected final String TEXT_601 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_602 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_603 = " = false;" + NL + "                                 }" + NL + "                            }";
  ...
  protected final String TEXT_627 = NL + "                \tsp_";
  protected final String TEXT_628 = " = conn_";
  protected final String TEXT_629 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_630 = NL + "                insertedCount_";
  protected final String TEXT_631 = " = insertedCount_";
  protected final String TEXT_632 = " + pstmt_";
  protected final String TEXT_633 = ".executeUpdate();";
  protected final String TEXT_634 = NL + "\t\t\t\t";
  protected final String TEXT_635 = NL + "\t                conn_";
  protected final String TEXT_636 = ".releaseSavepoint(sp_";
  protected final String TEXT_637 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_638 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_639 = NL + "\t                conn_";
  protected final String TEXT_640 = ".rollback(sp_";
  protected final String TEXT_641 = ");" + NL + "\t            ";
  protected final String TEXT_642 = NL + "                whetherReject_";
  protected final String TEXT_643 = " = true;";
  protected final String TEXT_644 = NL + "                    throw(e);";
  protected final String TEXT_645 = NL + "                        ";
  protected final String TEXT_646 = " = new ";
  protected final String TEXT_647 = "Struct();";
  protected final String TEXT_648 = NL + "                            ";
  protected final String TEXT_649 = ".";
  protected final String TEXT_650 = " = ";
  protected final String TEXT_651 = ".";
  protected final String TEXT_652 = ";";
  protected final String TEXT_653 = NL + "                        rejectedCount_";
  protected final String TEXT_654 = " = rejectedCount_";
  protected final String TEXT_655 = " + 1;";
  protected final String TEXT_656 = NL + "                        ";
  protected final String TEXT_657 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_658 = NL + "                        ";
  protected final String TEXT_659 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_660 = ";";
  protected final String TEXT_661 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_662 = NL + "            }";
  protected final String TEXT_663 = NL + "                    ";
  protected final String TEXT_664 = NL + "                        query_";
  protected final String TEXT_665 = " = ";
  protected final String TEXT_666 = ";";
  protected final String TEXT_667 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_668 = ",";
  protected final String TEXT_669 = ".";
  protected final String TEXT_670 = ", ";
  protected final String TEXT_671 = ",updateSQLSplits_";
  protected final String TEXT_672 = ");";
  protected final String TEXT_673 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_674 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_698 = NL + "                globalMap.put(\"";
  protected final String TEXT_699 = "_QUERY\", query_";
  protected final String TEXT_700 = ".toString().trim());";
  protected final String TEXT_701 = NL + "    \t\tpstmt_";
  protected final String TEXT_702 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_703 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_704 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_705 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_706 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_707 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_708 = NL + "\t                sp_";
  protected final String TEXT_709 = " = conn_";
  protected final String TEXT_710 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_711 = NL + "                updatedCount_";
  protected final String TEXT_712 = " = updatedCount_";
  protected final String TEXT_713 = " + pstmt_";
  protected final String TEXT_714 = ".executeUpdate();";
  protected final String TEXT_715 = NL + "\t\t\t\t";
  protected final String TEXT_716 = NL + "                \tconn_";
  protected final String TEXT_717 = ".releaseSavepoint(sp_";
  protected final String TEXT_718 = ");";
  protected final String TEXT_719 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_720 = NL + "\t                conn_";
  protected final String TEXT_721 = ".rollback(sp_";
  ...
  protected final String TEXT_734 = NL + "                        rejectedCount_";
  protected final String TEXT_735 = " = rejectedCount_";
  protected final String TEXT_736 = " + 1;";
  protected final String TEXT_737 = NL + "                        ";
  protected final String TEXT_738 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_739 = NL + "                        ";
  protected final String TEXT_740 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_741 = ";";
  protected final String TEXT_742 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_743 = NL + "            }";
  protected final String TEXT_744 = NL + "                    \t";
  protected final String TEXT_745 = NL + "                    ";
  protected final String TEXT_746 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_747 = " = pstmt_";
  protected final String TEXT_748 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_749 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_750 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_751 = " = rs_";
  protected final String TEXT_752 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_753 = " > 0) {";
  ...
  protected final String TEXT_790 = ".toString().trim());";
  protected final String TEXT_791 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_792 = NL + "\t                    sp_";
  protected final String TEXT_793 = " = conn_";
  protected final String TEXT_794 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_795 = NL + "                    updatedCount_";
  protected final String TEXT_796 = " = updatedCount_";
  protected final String TEXT_797 = " + pstmtUpdate_";
  protected final String TEXT_798 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_799 = "++;";
  protected final String TEXT_800 = NL + "\t\t\t\t\t";
  protected final String TEXT_801 = NL + "    \t                conn_";
  protected final String TEXT_802 = ".releaseSavepoint(sp_";
  protected final String TEXT_803 = ");" + NL + "    \t            ";
  protected final String TEXT_804 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_805 = NL + "    \t                conn_";
  protected final String TEXT_806 = ".rollback(sp_";
  protected final String TEXT_807 = ");" + NL + "    \t            ";
  protected final String TEXT_808 = NL + "                    whetherReject_";
  protected final String TEXT_809 = " = true;";
  protected final String TEXT_810 = NL + "                        throw(e);";
  protected final String TEXT_811 = NL + "                        nb_line_";
  ...
  protected final String TEXT_830 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_850 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_851 = NL + "\t                    sp_";
  protected final String TEXT_852 = " = conn_";
  protected final String TEXT_853 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_854 = NL + "                    insertedCount_";
  protected final String TEXT_855 = " = insertedCount_";
  protected final String TEXT_856 = " + pstmtInsert_";
  protected final String TEXT_857 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_858 = "++;";
  protected final String TEXT_859 = NL + "\t\t\t\t\t";
  protected final String TEXT_860 = NL + "    \t                conn_";
  protected final String TEXT_861 = ".releaseSavepoint(sp_";
  protected final String TEXT_862 = ");" + NL + "    \t            ";
  protected final String TEXT_863 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_864 = NL + "    \t                conn_";
  protected final String TEXT_865 = ".rollback(sp_";
  protected final String TEXT_866 = ");" + NL + "    \t            ";
  protected final String TEXT_867 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_890 = NL + "            int updateFlag_";
  protected final String TEXT_891 = "=0;";
  protected final String TEXT_892 = NL + "                    ";
  protected final String TEXT_893 = NL + "                        query_";
  protected final String TEXT_894 = " = ";
  protected final String TEXT_895 = ";";
  protected final String TEXT_896 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_897 = ",";
  protected final String TEXT_898 = ".";
  protected final String TEXT_899 = ", ";
  protected final String TEXT_900 = ",updateSQLSplits_";
  protected final String TEXT_901 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_902 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_903 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_904 = ".";
  protected final String TEXT_905 = ", pstmtUpdate_";
  ...
  protected final String TEXT_913 = NL + "\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_930 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_931 = NL + "\t                sp_";
  protected final String TEXT_932 = " = conn_";
  protected final String TEXT_933 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_934 = NL + "                updateFlag_";
  protected final String TEXT_935 = "=pstmtUpdate_";
  protected final String TEXT_936 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_937 = " = updatedCount_";
  protected final String TEXT_938 = "+updateFlag_";
  protected final String TEXT_939 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_940 = NL + "\t                conn_";
  protected final String TEXT_941 = ".releaseSavepoint(sp_";
  protected final String TEXT_942 = ");" + NL + "\t            ";
  protected final String TEXT_943 = NL + "            if(updateFlag_";
  protected final String TEXT_944 = " == 0) {" + NL + "            \t";
  protected final String TEXT_945 = NL + "\t\t\t\tquery_";
  protected final String TEXT_946 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_959 = ", pstmtInsert_";
  ...
  protected final String TEXT_967 = NL + "\t                    sp_";
  protected final String TEXT_968 = " = conn_";
  protected final String TEXT_969 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_976 = NL + "    \t                conn_";
  protected final String TEXT_977 = ".releaseSavepoint(sp_";
  protected final String TEXT_978 = ");" + NL + "    \t            ";
  protected final String TEXT_979 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_980 = "++;" + NL + "     \t\t\t\t\t";
  protected final String TEXT_981 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_982 = NL + "    \t                conn_";
  protected final String TEXT_983 = ".rollback(sp_";
  protected final String TEXT_984 = ");" + NL + "    \t            ";
  protected final String TEXT_985 = NL + "                    whetherReject_";
  protected final String TEXT_986 = " = true;";
  protected final String TEXT_987 = NL + "                        throw(e);";
  protected final String TEXT_988 = NL + "                        nb_line_";
  protected final String TEXT_989 = "++;";
  protected final String TEXT_990 = NL + "                            ";
  protected final String TEXT_991 = " = new ";
  protected final String TEXT_992 = "Struct();";
  protected final String TEXT_993 = NL + "                                ";
  protected final String TEXT_994 = ".";
  protected final String TEXT_995 = " = ";
  protected final String TEXT_996 = ".";
  protected final String TEXT_997 = ";";
  protected final String TEXT_998 = NL + "                            rejectedCount_";
  protected final String TEXT_999 = " = rejectedCount_";
  protected final String TEXT_1000 = " + 1;";
  protected final String TEXT_1001 = NL + "                            ";
  protected final String TEXT_1002 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1003 = NL + "                            ";
  protected final String TEXT_1004 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1005 = ";";
  protected final String TEXT_1006 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_1020 = NL + "    \t\tpstmt_";
  protected final String TEXT_1021 = ".addBatch();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_1022 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_1023 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_1024 = "++;" + NL + "    \t\t";
  protected final String TEXT_1025 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_1026 = NL + "\t                sp_";
  protected final String TEXT_1027 = " = conn_";
  protected final String TEXT_1028 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_1029 = NL + "                deletedCount_";
  protected final String TEXT_1030 = " = deletedCount_";
  protected final String TEXT_1031 = " + pstmt_";
  protected final String TEXT_1032 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1033 = "++;";
  protected final String TEXT_1034 = NL + "\t\t\t\t";
  protected final String TEXT_1035 = NL + "\t                conn_";
  protected final String TEXT_1036 = ".releaseSavepoint(sp_";
  protected final String TEXT_1037 = ");" + NL + "\t            ";
  protected final String TEXT_1038 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_1039 = NL + "\t                conn_";
  protected final String TEXT_1040 = ".rollback(sp_";
  protected final String TEXT_1041 = ");" + NL + "\t            ";
  protected final String TEXT_1042 = NL + "                whetherReject_";
  protected final String TEXT_1043 = " = true;";
  protected final String TEXT_1044 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1059 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1060 = NL + "                        ";
  protected final String TEXT_1061 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1062 = ";";
  protected final String TEXT_1063 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1064 = NL + "            }";
  protected final String TEXT_1065 = NL + "            if(!whetherReject_";
  protected final String TEXT_1066 = ") {";
  protected final String TEXT_1067 = NL + "                            ";
  protected final String TEXT_1068 = " = new ";
  protected final String TEXT_1069 = "Struct();";
  ...
  protected final String TEXT_1076 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1077 = " > 0) && (batchSize_";
  protected final String TEXT_1078 = " <= batchSizeCounter_";
  protected final String TEXT_1079 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1080 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_1081 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1082 = ": pstmt_";
  protected final String TEXT_1083 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1084 = " += (countEach_";
  protected final String TEXT_1085 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1097 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1098 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1099 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1100 = NL + "                \tint countSum_";
  protected final String TEXT_1101 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1102 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1103 = " += (countEach_";
  protected final String TEXT_1104 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1105 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1106 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1107 = " += countSum_";
  protected final String TEXT_1108 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1109 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1110 = " += countSum_";
  protected final String TEXT_1111 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1112 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1113 = " += countSum_";
  protected final String TEXT_1114 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1115 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1116 = NL + "                }" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1117 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1118 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1119 = " <= commitCounter_";
  protected final String TEXT_1120 = ") {";
  protected final String TEXT_1121 = NL + "                if ((batchSize_";
  protected final String TEXT_1122 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1123 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1124 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1125 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1126 = ": pstmt_";
  protected final String TEXT_1127 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1128 = " += (countEach_";
  protected final String TEXT_1129 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1130 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_1131 = NL + "            \t    \t";
  protected final String TEXT_1132 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1133 = " += countSum_";
  protected final String TEXT_1134 = ";" + NL + "            \t    \t";
  protected final String TEXT_1135 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1136 = " += countSum_";
  protected final String TEXT_1137 = ";" + NL + "            \t    \t";
  protected final String TEXT_1138 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1139 = " += countSum_";
  protected final String TEXT_1140 = ";" + NL + "            \t    \t";
  protected final String TEXT_1141 = NL + "                batchSizeCounter_";
  protected final String TEXT_1142 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1143 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1144 = NL + "                \t\tint countSum_";
  protected final String TEXT_1145 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1146 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1147 = " += (countEach_";
  protected final String TEXT_1148 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1159 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1160 = NL + "                }" + NL + "            }";
  protected final String TEXT_1161 = NL + "                \tconn_";
  protected final String TEXT_1162 = ".commit();" + NL + "                \t";
  protected final String TEXT_1163 = NL + "                \tcommitCounter_";
  protected final String TEXT_1164 = "=0;" + NL + "                }";
