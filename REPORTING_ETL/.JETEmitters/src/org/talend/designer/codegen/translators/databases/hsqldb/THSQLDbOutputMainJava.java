...
public class THSQLDbOutputMainJava {
  ...
  protected final String TEXT_65 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_66 = " = insertedCount_";
  protected final String TEXT_67 = " + pstmt_";
  protected final String TEXT_68 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_131 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_132 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_133 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_134 = " = rs_";
  protected final String TEXT_135 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_201 = NL + "                            rejectedCount_";
  protected final String TEXT_202 = " = rejectedCount_";
  protected final String TEXT_203 = " + 1;";
  protected final String TEXT_204 = NL + "                            ";
  protected final String TEXT_205 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_211 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_222 = "_QUERY\", query_";
  protected final String TEXT_223 = ".toString().trim());";
  protected final String TEXT_224 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_225 = "=pstmtUpdate_";
  protected final String TEXT_226 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_227 = " = updatedCount_";
  protected final String TEXT_228 = " + updateFlag_";
  protected final String TEXT_229 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_230 = " == 0) {" + NL + "            \t";
  protected final String TEXT_231 = NL + "\t\t\t\tquery_";
  protected final String TEXT_232 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_233 = NL + "                        ";
  protected final String TEXT_234 = NL + "                            query_";
  protected final String TEXT_235 = " = ";
  protected final String TEXT_236 = ";";
  protected final String TEXT_237 = NL + "                    globalMap.put(\"";
  protected final String TEXT_238 = "_QUERY\", query_";
  protected final String TEXT_239 = ".toString().trim());";
  ...
  protected final String TEXT_243 = ".executeUpdate();  " + NL + "         \t\t\tnb_line_";
  protected final String TEXT_244 = "++;";
  protected final String TEXT_245 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  ...
  protected final String TEXT_250 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_275 = "_QUERY\", query_";
  protected final String TEXT_276 = ".toString().trim());";
  protected final String TEXT_277 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_278 = " = deletedCount_";
  protected final String TEXT_279 = " + pstmt_";
  protected final String TEXT_280 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_281 = "++;";
  protected final String TEXT_282 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_295 = NL + "                        rejectedCount_";
  protected final String TEXT_296 = " = rejectedCount_";
  protected final String TEXT_297 = " + 1;";
  protected final String TEXT_298 = NL + "                        ";
  protected final String TEXT_299 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_317 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  ...
  protected final String TEXT_323 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
