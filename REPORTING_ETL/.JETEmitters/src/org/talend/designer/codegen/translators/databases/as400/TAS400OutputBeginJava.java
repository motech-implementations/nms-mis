...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_61 = " = 0;" + NL + "" + NL + "int nb_line_rejected_";
  protected final String TEXT_62 = " = 0;" + NL + "int rejectedCount_";
  protected final String TEXT_63 = "=0;" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_64 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_65 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_66 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_67 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_70 = " = false;" + NL + NL;
  ...
  protected final String TEXT_80 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_81 = " + \"/\" + ";
  protected final String TEXT_82 = ";" + NL + "    } else {" + NL + "        url_";
  protected final String TEXT_83 = " = \"jdbc:as400://\" + ";
  protected final String TEXT_84 = " + \"/\" + ";
  protected final String TEXT_85 = "+ \";\" + ";
  protected final String TEXT_86 = ";" + NL + "    }" + NL + "    String dbUser_";
  ...
  protected final String TEXT_98 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"com.ibm.as400.access.AS400JDBCDriver\");";
  ...
  protected final String TEXT_104 = NL + NL + "    resourceMap.put(\"conn_";
  protected final String TEXT_105 = "\", conn_";
  protected final String TEXT_106 = ");";
  protected final String TEXT_107 = NL + "            conn_";
  protected final String TEXT_108 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  ...
  protected final String TEXT_129 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_133 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_134 = "));";
  protected final String TEXT_135 = NL + "                    stmtCreate_";
  protected final String TEXT_136 = ".execute(((\"";
  protected final String TEXT_137 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = ", \"";
  protected final String TEXT_140 = "\")";
  protected final String TEXT_141 = ".toUpperCase()";
  ...
  protected final String TEXT_186 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_189 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_190 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_191 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_192 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_193 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_198 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_199 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_200 = " = tableNameForSearch_";
  protected final String TEXT_201 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_202 = " = tableNameForSearch_";
  protected final String TEXT_203 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_204 = " = dbMetaData_";
  protected final String TEXT_205 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_206 = ", tableNameForSearch_";
  protected final String TEXT_207 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_208 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_209 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_210 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_220 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  ...
  protected final String TEXT_231 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_236 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_237 = " = dbMetaData_";
  protected final String TEXT_238 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_239 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_255 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_256 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_265 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_266 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_267 = " == null || dbschema_";
  protected final String TEXT_268 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_271 = " = stmtSchema_";
  protected final String TEXT_272 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_273 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_274 = " = rsSchema_";
  protected final String TEXT_275 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_276 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_277 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_292 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_293 = ".equals";
  protected final String TEXT_294 = "IgnoreCase";
  protected final String TEXT_295 = "(schema_";
  protected final String TEXT_296 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_297 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_298 = ".close();";
  protected final String TEXT_299 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_300 = " = ";
  protected final String TEXT_301 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_302 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_303 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_304 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_305 = " =  tableForSearch_";
  protected final String TEXT_306 = ".substring(1,tableForSearch_";
  protected final String TEXT_307 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_308 = " =  tableForSearch_";
  protected final String TEXT_309 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_313 = ".getTables(null, conn_";
  protected final String TEXT_314 = ".getSchema(), tableForSearch_";
  protected final String TEXT_315 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_316 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_317 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_318 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_319 = ".close();" + NL + "\t\t\t\t            ";
  ...
  protected final String TEXT_324 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_325 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_326 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_327 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_328 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_465 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_471 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_472 = NL + "\t    String update_";
  protected final String TEXT_473 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_482 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_483 = " + \" WHERE ";
  protected final String TEXT_484 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_485 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_500 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_515 = " = \"DELETE FROM \" + ";
