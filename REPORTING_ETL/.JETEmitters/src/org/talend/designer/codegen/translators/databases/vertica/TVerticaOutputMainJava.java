...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_51 = NL + "                java.sql.Statement stmtCreateProjection_";
  protected final String TEXT_52 = " = conn_";
  protected final String TEXT_53 = ".createStatement();" + NL + "                stmtCreateProjection_";
  protected final String TEXT_54 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_55 = " + \"_proj (";
  protected final String TEXT_56 = ") AS SELECT ";
  protected final String TEXT_57 = " FROM \" + tableName_";
  protected final String TEXT_58 = ");" + NL + "                stmtCreateProjection_";
  protected final String TEXT_59 = ".close();";
  protected final String TEXT_60 = NL + "                if(!whetherExist_";
  protected final String TEXT_61 = ") {";
  protected final String TEXT_62 = NL + "                }";
  protected final String TEXT_63 = NL + "                stmtBuilder_";
  protected final String TEXT_64 = " = new StringBuilder();" + NL + "                stmt_";
  protected final String TEXT_65 = " = conn_";
  protected final String TEXT_66 = ".createStatement();" + NL + "                template_";
  ...
  protected final String TEXT_107 = ".getType())) {" + NL + "                                    BigDecimal decimal_";
  protected final String TEXT_108 = " = new BigDecimal((Float)currentValue_";
  protected final String TEXT_109 = ");" + NL + "                                    stmtBuilder_";
  protected final String TEXT_110 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_111 = "), null, '.'));" + NL + "                                } else if(\"id_Double\".equals(metadata_";
  protected final String TEXT_112 = ".getType())) {" + NL + "                                    BigDecimal decimal_";
  protected final String TEXT_113 = " = new BigDecimal((Double)currentValue_";
  protected final String TEXT_114 = ");" + NL + "                                    stmtBuilder_";
  protected final String TEXT_115 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_116 = "), null, '.'));" + NL + "                                } else if(\"id_byte[]\".equals(metadata_";
  protected final String TEXT_117 = ".getType())) {" + NL + "                                    stmtBuilder_";
  protected final String TEXT_118 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap((byte[])currentValue_";
  protected final String TEXT_119 = ")).toString());" + NL + "                                } else {" + NL + "                                    stmtBuilder_";
  protected final String TEXT_120 = ".append(String.valueOf(currentValue_";
  protected final String TEXT_121 = "));" + NL + "                                }" + NL + "                                stmtBuilder_";
  protected final String TEXT_122 = ".append(\"|\");" + NL + "                            }" + NL + "" + NL + "                            if(i_";
  protected final String TEXT_123 = " < (";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = ".getColumnCount() - 1)) {" + NL + "                                stmtBuilder_";
  protected final String TEXT_126 = ".append(\";\");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_127 = NL + "                        stmtBuilder_";
  protected final String TEXT_128 = ".append(\"|\");" + NL + "                        stmtBuilder_";
  protected final String TEXT_129 = ".append(String.valueOf(";
  protected final String TEXT_130 = ".";
  protected final String TEXT_131 = "));" + NL + "                        stmtBuilder_";
  protected final String TEXT_132 = ".append(\"|\");";
  protected final String TEXT_133 = NL + "                        if(";
  protected final String TEXT_134 = ".";
  protected final String TEXT_135 = " == null){" + NL + "                            stmtBuilder_";
  protected final String TEXT_136 = ".append(\"\");" + NL + "                        }else{" + NL + "                            stmtBuilder_";
  ...
  protected final String TEXT_141 = ".replaceAll(\"\\\\|\",\"\\\\\\\\|\"));";
  protected final String TEXT_142 = NL + "                                stmtBuilder_";
  protected final String TEXT_143 = ".append(FormatterUtils.format_Date(";
  protected final String TEXT_144 = ".";
  protected final String TEXT_145 = ", ";
  protected final String TEXT_146 = "));";
  protected final String TEXT_147 = NL + "                                stmtBuilder_";
  protected final String TEXT_148 = ".append(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = ")).toString());";
  protected final String TEXT_151 = NL + "                                    stmtBuilder_";
  protected final String TEXT_152 = ".append(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_153 = "), null, '.'));";
  protected final String TEXT_154 = NL + "                                    if (";
  protected final String TEXT_155 = ".";
  protected final String TEXT_156 = " != null) {" + NL + "                                        BigDecimal decimal_";
  protected final String TEXT_157 = " = new BigDecimal(";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = ");" + NL + "                                        stmtBuilder_";
  protected final String TEXT_160 = ".append(FormatterUtils.format_Number(String.valueOf(";
  ...
  protected final String TEXT_184 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_195 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".createStatement();";
  protected final String TEXT_198 = NL + "                              stmtCreate_";
  protected final String TEXT_199 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_200 = "));";
  protected final String TEXT_201 = NL + "                    stmtCreate_";
  protected final String TEXT_202 = ".execute(((\"";
  protected final String TEXT_203 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_204 = ".";
  protected final String TEXT_205 = ", \"";
  protected final String TEXT_206 = "\")";
  protected final String TEXT_207 = ".toUpperCase()";
  ...
  protected final String TEXT_219 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_252 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_253 = " = conn_";
  protected final String TEXT_254 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_255 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  ...
  protected final String TEXT_259 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_264 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_265 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_266 = " = tableNameForSearch_";
  protected final String TEXT_267 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_268 = " = tableNameForSearch_";
  protected final String TEXT_269 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_286 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_287 = " = rsTable_";
  protected final String TEXT_288 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_289 = ".equals";
  protected final String TEXT_290 = "IgnoreCase";
  protected final String TEXT_291 = "(";
  protected final String TEXT_292 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_293 = ".equals";
  protected final String TEXT_294 = "IgnoreCase";
  protected final String TEXT_295 = "(dbschema_";
  protected final String TEXT_296 = ") || dbschema_";
  protected final String TEXT_297 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  protected final String TEXT_298 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_299 = ".close();";
  protected final String TEXT_300 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_301 = " = conn_";
  protected final String TEXT_302 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_303 = " = dbMetaData_";
  protected final String TEXT_304 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_305 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_315 = ".toUpperCase()";
  protected final String TEXT_316 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_320 = ") || (dbschema_";
  protected final String TEXT_321 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_322 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_323 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_324 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_325 = ".close();";
  protected final String TEXT_326 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_327 = " = conn_";
  protected final String TEXT_328 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_329 = " = dbMetaData_";
  protected final String TEXT_330 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_331 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_332 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_333 = " == null || dbschema_";
  protected final String TEXT_334 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_335 = " = conn_";
  protected final String TEXT_336 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_337 = " = stmtSchema_";
  protected final String TEXT_338 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_339 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_340 = " = rsSchema_";
  protected final String TEXT_341 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_342 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_343 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_344 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_345 = " = rsTable_";
  protected final String TEXT_346 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_347 = " = rsTable_";
  protected final String TEXT_348 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_349 = ".equals";
  protected final String TEXT_350 = "IgnoreCase";
  protected final String TEXT_351 = "(";
  protected final String TEXT_352 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_353 = ".equals";
  protected final String TEXT_354 = "IgnoreCase";
  protected final String TEXT_355 = "(dbschema_";
  protected final String TEXT_356 = ") || ((dbschema_";
  protected final String TEXT_357 = " ==null || dbschema_";
  protected final String TEXT_358 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_359 = ".equals";
  protected final String TEXT_360 = "IgnoreCase";
  protected final String TEXT_361 = "(schema_";
  ...
  protected final String TEXT_365 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_366 = " = ";
  protected final String TEXT_367 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_368 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_369 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_370 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_371 = " =  tableForSearch_";
  protected final String TEXT_372 = ".substring(1,tableForSearch_";
  protected final String TEXT_373 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_374 = " =  tableForSearch_";
  protected final String TEXT_375 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_376 = " = conn_";
  protected final String TEXT_377 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_378 = " = dbMetaData_";
  protected final String TEXT_379 = ".getTables(null, conn_";
  protected final String TEXT_380 = ".getSchema(), tableForSearch_";
  protected final String TEXT_381 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_382 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_383 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_384 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_390 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_391 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_392 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_393 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_394 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_395 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_396 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_397 = ".close();";
  protected final String TEXT_398 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_399 = " = conn_";
  protected final String TEXT_400 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_401 = " = dbMetaData_";
  protected final String TEXT_402 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_403 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_404 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_405 = " = rsTable_";
  protected final String TEXT_406 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_407 = ".equalsIgnoreCase(";
  protected final String TEXT_408 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_409 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_410 = ".close();";
  protected final String TEXT_411 = NL + "                                if(!whetherExist_";
  protected final String TEXT_412 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_418 = NL + "                                            stmtCreate_";
  protected final String TEXT_419 = ".execute(((\"";
  protected final String TEXT_420 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_427 = NL + "                                        stmtCreate_";
  protected final String TEXT_428 = ".execute(\"";
  protected final String TEXT_429 = ")\");";
  protected final String TEXT_430 = NL + "                                    stmtCreate_";
  protected final String TEXT_431 = ".close();" + NL + "                                }";
  protected final String TEXT_432 = NL + "                                if(whetherExist_";
  protected final String TEXT_433 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_434 = " = conn_";
  protected final String TEXT_435 = ".createStatement();";
  protected final String TEXT_436 = NL + "                                                      stmtDrop_";
  protected final String TEXT_437 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_438 = "));";
  protected final String TEXT_439 = NL + "                                    stmtDrop_";
  protected final String TEXT_440 = ".execute(\"";
  protected final String TEXT_441 = "\" ";
  protected final String TEXT_442 = ");";
  protected final String TEXT_443 = NL + "                                    stmtDrop_";
  protected final String TEXT_444 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  protected final String TEXT_445 = " = conn_";
  protected final String TEXT_446 = ".createStatement();";
  protected final String TEXT_447 = NL + "                                                  stmtCreate_";
  ...
  protected final String TEXT_452 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_453 = ".";
  protected final String TEXT_454 = ", \"";
  protected final String TEXT_455 = "\")";
  protected final String TEXT_456 = ".toUpperCase()";
  protected final String TEXT_457 = ")+\")";
  protected final String TEXT_458 = "\"));";
  protected final String TEXT_459 = NL + "                                    stmtCreate_";
  protected final String TEXT_460 = ".execute(\"";
  protected final String TEXT_461 = ")\");";
  protected final String TEXT_462 = NL + "                                stmtCreate_";
  protected final String TEXT_463 = ".close();";
  protected final String TEXT_464 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_465 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_466 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_467 = " = conn_";
  protected final String TEXT_468 = ".createStatement();";
  protected final String TEXT_469 = NL + "                              stmtClear_";
  protected final String TEXT_470 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_471 = "));";
  protected final String TEXT_472 = NL + "            stmtClear_";
  protected final String TEXT_473 = ".executeUpdate(\"";
  protected final String TEXT_474 = "\");";
  protected final String TEXT_475 = NL + "            stmtClear_";
  protected final String TEXT_476 = ".close();";
  protected final String TEXT_477 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_478 = " = conn_";
  protected final String TEXT_479 = ".createStatement();";
  protected final String TEXT_480 = NL + "                              stmtTruncCount_";
  protected final String TEXT_481 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_482 = "));";
  protected final String TEXT_483 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_484 = " = stmtTruncCount_";
  protected final String TEXT_485 = ".executeQuery(\"";
  protected final String TEXT_486 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_487 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_488 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_489 = " = rsTruncCount_";
  protected final String TEXT_490 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_491 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_492 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_493 = " = conn_";
  protected final String TEXT_494 = ".createStatement();";
  protected final String TEXT_495 = NL + "                              stmtTrunc_";
  protected final String TEXT_496 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_497 = "));";
  protected final String TEXT_498 = NL + "                conn_";
  protected final String TEXT_499 = ".commit();";
  protected final String TEXT_500 = NL + "            stmtTrunc_";
  protected final String TEXT_501 = ".executeUpdate(\"";
  protected final String TEXT_502 = "\");";
  protected final String TEXT_503 = NL + "                if(!conn_";
  protected final String TEXT_504 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_505 = ".commit();" + NL + "                }";
  protected final String TEXT_506 = NL + "            deletedCount_";
  protected final String TEXT_507 = " += rsTruncCountNumber_";
  protected final String TEXT_508 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_509 = ".close();";
  protected final String TEXT_510 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_511 = " = conn_";
  protected final String TEXT_512 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_513 = " = stmtTruncCount_";
  protected final String TEXT_514 = ".executeQuery(\"";
  protected final String TEXT_515 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_516 = " = conn_";
  protected final String TEXT_517 = ".createStatement();";
  protected final String TEXT_518 = NL + "                conn_";
  protected final String TEXT_519 = ".commit();";
  protected final String TEXT_520 = NL + "            stmtTrunc_";
  protected final String TEXT_521 = ".executeUpdate(\"";
  protected final String TEXT_522 = "\");";
  protected final String TEXT_523 = NL + "            while(rsTruncCount_";
  protected final String TEXT_524 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_525 = " += rsTruncCount_";
  protected final String TEXT_526 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_527 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_528 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_529 = ".close();";
  ...
  protected final String TEXT_569 = ".prepareStatement(update_";
  protected final String TEXT_570 = ");";
  protected final String TEXT_571 = NL + "                String insert_";
  protected final String TEXT_572 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_573 = " + \" (";
  protected final String TEXT_574 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_575 = ".";
  protected final String TEXT_576 = ", \"";
  protected final String TEXT_577 = "\")+\") VALUES (";
  protected final String TEXT_578 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = ")+\")\";";
  protected final String TEXT_581 = NL + "                String insert_";
  protected final String TEXT_582 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_597 = NL + "                String update_";
  protected final String TEXT_598 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_599 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_606 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_607 = " + \" WHERE ";
  protected final String TEXT_608 = "\");" + NL + "        pstmtInsert_";
  ...
  protected final String TEXT_615 = NL + "                String insert_";
  protected final String TEXT_616 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_617 = " + \" (";
  protected final String TEXT_618 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_619 = ".";
  protected final String TEXT_620 = ", \"";
  protected final String TEXT_621 = "\")+\") VALUES (";
  protected final String TEXT_622 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_623 = ".";
  protected final String TEXT_624 = ")+\")\";";
  protected final String TEXT_625 = NL + "                String insert_";
  protected final String TEXT_626 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_627 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_628 = ".";
  protected final String TEXT_629 = ", \"";
  protected final String TEXT_630 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_636 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_637 = ".";
  protected final String TEXT_638 = ", \"";
  protected final String TEXT_639 = "\")+\" WHERE ";
  protected final String TEXT_640 = "\";";
  protected final String TEXT_641 = NL + "                String update_";
  protected final String TEXT_642 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_643 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_655 = NL + "        String delete_";
  protected final String TEXT_656 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_657 = " + \" WHERE ";
  protected final String TEXT_658 = "\";" + NL + "        pstmt_";
  protected final String TEXT_659 = " = conn_";
  protected final String TEXT_660 = ".prepareStatement(delete_";
  protected final String TEXT_661 = ");";
  protected final String TEXT_662 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_663 = " = insert_";
  protected final String TEXT_664 = ".split(\"\\\\?\");";
  protected final String TEXT_665 = NL + "\t\t\tupdate_";
  protected final String TEXT_666 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_667 = " = update_";
  protected final String TEXT_668 = ".split(\"\\\\?\");";
  protected final String TEXT_669 = NL + "\t\t\tupdate_";
  protected final String TEXT_670 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_671 = " = update_";
  protected final String TEXT_672 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_673 = " = insert_";
  protected final String TEXT_674 = ".split(\"\\\\?\");";
  protected final String TEXT_675 = NL + "\t\t\tdelete_";
  protected final String TEXT_676 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_677 = " = delete_";
  protected final String TEXT_678 = ".split(\"\\\\?\");";
  protected final String TEXT_679 = NL + "\t\t\treplace_";
  protected final String TEXT_680 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_681 = " = replace_";
  protected final String TEXT_682 = ".split(\"\\\\?\");";
  protected final String TEXT_683 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_684 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_685 = " = insertIgnore_";
  protected final String TEXT_686 = ".split(\"\\\\?\");";
  protected final String TEXT_687 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_688 = " = insert_";
  protected final String TEXT_689 = ".split(\"\\\\?\");";
  protected final String TEXT_690 = NL + "        }";
  protected final String TEXT_691 = NL + "                commitEvery_";
  protected final String TEXT_692 = " = buffersSize_";
  protected final String TEXT_693 = ";";
  protected final String TEXT_694 = NL + "                batchSize_";
  protected final String TEXT_695 = " = buffersSize_";
  protected final String TEXT_696 = ";";
  protected final String TEXT_697 = NL + "            whetherReject_";
  protected final String TEXT_698 = " = false;";
  ...
  protected final String TEXT_719 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_720 = "++;";
  protected final String TEXT_721 = NL + "                batchSizeCounter_";
  protected final String TEXT_722 = "++;";
  protected final String TEXT_723 = NL + "        try {" + NL + "            insertedCount_";
  protected final String TEXT_724 = " = insertedCount_";
  protected final String TEXT_725 = " + pstmt_";
  protected final String TEXT_726 = ".executeUpdate();" + NL + "            nb_line_";
  protected final String TEXT_727 = "++;";
  protected final String TEXT_728 = NL + "        } catch(java.lang.Exception e) {" + NL + "            whetherReject_";
  ...
  protected final String TEXT_739 = NL + "                rejectedCount_";
  protected final String TEXT_740 = " = rejectedCount_";
  protected final String TEXT_741 = " + 1;";
  protected final String TEXT_742 = NL + "                ";
  protected final String TEXT_743 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_744 = NL + "                ";
  protected final String TEXT_745 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_746 = ";";
  protected final String TEXT_747 = NL + "                    System.err.print(e.getMessage());";
  ...
  protected final String TEXT_789 = NL + "            batchSizeCounter_";
  protected final String TEXT_790 = "++;";
  protected final String TEXT_791 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_792 = " = updatedCount_";
  protected final String TEXT_793 = " + pstmt_";
  protected final String TEXT_794 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_795 = "++;";
  protected final String TEXT_796 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_811 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_812 = NL + "                        ";
  protected final String TEXT_813 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_814 = ";";
  protected final String TEXT_815 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_816 = NL + "            }";
  protected final String TEXT_817 = NL + "                        ";
  protected final String TEXT_818 = NL + "                    ";
  protected final String TEXT_819 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_820 = " = pstmt_";
  protected final String TEXT_821 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_822 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_823 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_824 = " = rs_";
  protected final String TEXT_825 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_826 = " > 0) {";
  protected final String TEXT_827 = NL + "                        ";
  protected final String TEXT_828 = NL + "                            query_";
  protected final String TEXT_829 = " = ";
  protected final String TEXT_830 = ";";
  protected final String TEXT_831 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_832 = ",";
  protected final String TEXT_833 = ".";
  protected final String TEXT_834 = ", ";
  protected final String TEXT_835 = ",updateSQLSplits_";
  protected final String TEXT_836 = ");";
  protected final String TEXT_837 = NL + NL + "                        int count_";
  protected final String TEXT_838 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_839 = ".";
  protected final String TEXT_840 = ", pstmtUpdate_";
  ...
  protected final String TEXT_856 = NL + "                            query_";
  protected final String TEXT_857 = " = ";
  protected final String TEXT_858 = ";";
  protected final String TEXT_859 = NL + "                    globalMap.put(\"";
  protected final String TEXT_860 = "_QUERY\", query_";
  protected final String TEXT_861 = ".toString().trim());";
  protected final String TEXT_862 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_863 = " = updatedCount_";
  protected final String TEXT_864 = " + pstmtUpdate_";
  protected final String TEXT_865 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_866 = "++;";
  protected final String TEXT_867 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_868 = " = true;";
  protected final String TEXT_869 = NL + "                        throw(e);";
  protected final String TEXT_870 = NL + "                        nb_line_";
  protected final String TEXT_871 = "++;";
  protected final String TEXT_872 = NL + "                            ";
  protected final String TEXT_873 = " = new ";
  protected final String TEXT_874 = "Struct();";
  protected final String TEXT_875 = NL + "                                ";
  protected final String TEXT_876 = ".";
  protected final String TEXT_877 = " = ";
  protected final String TEXT_878 = ".";
  protected final String TEXT_879 = ";";
  protected final String TEXT_880 = NL + "                            rejectedCount_";
  protected final String TEXT_881 = " = rejectedCount_";
  protected final String TEXT_882 = " + 1;";
  protected final String TEXT_883 = NL + "                            ";
  protected final String TEXT_884 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_885 = NL + "                            ";
  protected final String TEXT_886 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_887 = ";";
  protected final String TEXT_888 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_889 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_909 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_914 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_931 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_932 = NL + "                            ";
  protected final String TEXT_933 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_934 = ";";
  protected final String TEXT_935 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_936 = NL + "                }" + NL + "            }";
  protected final String TEXT_937 = NL + "            int updateFlag_";
  protected final String TEXT_938 = " = 0;";
  ...
  protected final String TEXT_947 = ",updateSQLSplits_";
  protected final String TEXT_948 = ");";
  protected final String TEXT_949 = NL + NL + "                    int count_";
  protected final String TEXT_950 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_951 = ".";
  protected final String TEXT_952 = ", pstmtUpdate_";
  protected final String TEXT_953 = ", ";
  protected final String TEXT_954 = ", \"";
  protected final String TEXT_955 = "\");";
  protected final String TEXT_956 = NL + "                        ";
  protected final String TEXT_957 = NL + "                        ";
  protected final String TEXT_958 = NL + "                            query_";
  ...
  protected final String TEXT_980 = " == 0) {";
  protected final String TEXT_981 = NL + "                query_";
  protected final String TEXT_982 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_1040 = NL + "                globalMap.put(\"";
  protected final String TEXT_1041 = "_QUERY\", query_";
  protected final String TEXT_1042 = ".toString().trim());";
  protected final String TEXT_1043 = NL + "            pstmt_";
  protected final String TEXT_1044 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_1045 = "++;";
  protected final String TEXT_1046 = NL + "            batchSizeCounter_";
  protected final String TEXT_1047 = "++;";
  protected final String TEXT_1048 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1049 = " = deletedCount_";
  protected final String TEXT_1050 = " + pstmt_";
  protected final String TEXT_1051 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1052 = "++;";
  protected final String TEXT_1053 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1054 = " = true;";
  protected final String TEXT_1055 = NL + "                    throw(e);";
  protected final String TEXT_1056 = NL + "                    nb_line_";
  ...
  protected final String TEXT_1074 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1075 = NL + "            }";
  protected final String TEXT_1076 = NL + "            if(!whetherReject_";
  protected final String TEXT_1077 = ") {";
  protected final String TEXT_1078 = NL + "                            ";
  protected final String TEXT_1079 = " = new ";
  protected final String TEXT_1080 = "Struct();";
  ...
  protected final String TEXT_1087 = NL + "                if ((batchSize_";
  protected final String TEXT_1088 = " > 0) && (batchSize_";
  protected final String TEXT_1089 = " <= batchSizeCounter_";
  protected final String TEXT_1090 = ")) {" + NL + "                try {";
  protected final String TEXT_1091 = NL + "                        pstmt_";
  protected final String TEXT_1092 = ".executeBatch();";
  protected final String TEXT_1093 = NL + "                        java.io.ByteArrayInputStream bais_";
  protected final String TEXT_1094 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1095 = ".toString().getBytes());";
  protected final String TEXT_1096 = NL + "                            ((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1097 = ").executeCopyIn(template_";
  protected final String TEXT_1098 = ", bais_";
  protected final String TEXT_1099 = ");";
  protected final String TEXT_1100 = NL + "                            com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_1101 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_1102 = ",template_";
  protected final String TEXT_1103 = ");" + NL + "                            vcs_";
  protected final String TEXT_1104 = ".start();" + NL + "                            vcs_";
  protected final String TEXT_1105 = ".addStream(bais_";
  protected final String TEXT_1106 = ");" + NL + "                            vcs_";
  protected final String TEXT_1107 = ".execute();" + NL + "                            vcs_";
  protected final String TEXT_1108 = ".finish();";
  protected final String TEXT_1109 = NL + "                        stmtBuilder_";
  protected final String TEXT_1110 = " = null;" + NL + "                        if (bais_";
  protected final String TEXT_1111 = " != null) {" + NL + "                            bais_";
  protected final String TEXT_1112 = ".close();" + NL + "                            bais_";
  protected final String TEXT_1113 = " = null;" + NL + "                        }" + NL + "                        stmtBuilder_";
  protected final String TEXT_1114 = " = new StringBuilder();";
  protected final String TEXT_1115 = NL + "                            insertedCount_";
  protected final String TEXT_1116 = " += pstmt_";
  protected final String TEXT_1117 = ". getUpdateCount();";
  protected final String TEXT_1118 = NL + "                            updatedCount_";
  protected final String TEXT_1119 = " += pstmt_";
  protected final String TEXT_1120 = ". getUpdateCount();";
  protected final String TEXT_1121 = NL + "                            deletedCount_";
  protected final String TEXT_1122 = " += pstmt_";
  protected final String TEXT_1123 = ". getUpdateCount();";
  protected final String TEXT_1124 = NL + "                                copiedCount_";
  protected final String TEXT_1125 = " += stmt_";
  protected final String TEXT_1126 = ".getUpdateCount();";
  protected final String TEXT_1127 = " " + NL + "                                copiedCount_";
  protected final String TEXT_1128 = " += vcs_";
  protected final String TEXT_1129 = ".getRowCount();";
  protected final String TEXT_1130 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1131 = " = 0;" + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_1132 = NL + "                        throw(e);";
  protected final String TEXT_1133 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1134 = NL + "                }" + NL + "            }";
  protected final String TEXT_1135 = NL + "                commitCounter_";
  protected final String TEXT_1136 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1137 = " <= commitCounter_";
  protected final String TEXT_1138 = ") {" + NL;
  protected final String TEXT_1139 = NL + "                try {";
  protected final String TEXT_1140 = NL + "                            boolean isCountResult_";
  protected final String TEXT_1141 = " = false;" + NL + "                            if(batchSizeCounter_";
  protected final String TEXT_1142 = " > 0){";
  protected final String TEXT_1143 = NL + "                                pstmt_";
  protected final String TEXT_1144 = ".executeBatch();";
  protected final String TEXT_1145 = NL + "                                isCountResult_";
  protected final String TEXT_1146 = " = true;" + NL + "                                batchSizeCounter_";
  protected final String TEXT_1147 = " = 0;" + NL + "                            }";
  protected final String TEXT_1148 = NL + "                        if(isCountResult_";
  ...
  protected final String TEXT_1152 = ".getUpdateCount();";
  protected final String TEXT_1153 = NL + "                        updatedCount_";
  protected final String TEXT_1154 = " += pstmt_";
  protected final String TEXT_1155 = ".getUpdateCount();";
  protected final String TEXT_1156 = NL + "                        deletedCount_";
  protected final String TEXT_1157 = " += pstmt_";
  protected final String TEXT_1158 = ".getUpdateCount();";
  protected final String TEXT_1159 = NL + "                        }";
  protected final String TEXT_1160 = NL + "                        if (stmtBuilder_";
  protected final String TEXT_1161 = " != null && stmtBuilder_";
  protected final String TEXT_1162 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_1163 = " start" + NL + "                            java.io.ByteArrayInputStream bais_";
  protected final String TEXT_1164 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1165 = ".toString().getBytes());";
  protected final String TEXT_1166 = NL + "                            ((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1167 = ").executeCopyIn(template_";
  protected final String TEXT_1168 = ", bais_";
  protected final String TEXT_1169 = ");";
  protected final String TEXT_1170 = NL + "                            stmtBuilder_";
  protected final String TEXT_1171 = " = null;" + NL + "                            if (bais_";
  protected final String TEXT_1172 = " != null) {" + NL + "                                bais_";
  protected final String TEXT_1173 = ".close();" + NL + "                                bais_";
  protected final String TEXT_1174 = " = null;" + NL + "                            }" + NL + "                            stmtBuilder_";
  protected final String TEXT_1175 = " = new StringBuilder();" + NL + "                            copiedCount_";
  protected final String TEXT_1176 = " += stmt_";
  protected final String TEXT_1177 = ".getUpdateCount();" + NL + "                        } // stmtBuilder_";
  protected final String TEXT_1178 = " end";
  protected final String TEXT_1179 = NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_1180 = NL + "                        throw(e);";
  protected final String TEXT_1181 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1182 = NL + NL + "                }";
  protected final String TEXT_1183 = NL + "                    conn_";
  protected final String TEXT_1184 = ".commit();";
  protected final String TEXT_1185 = NL + "                    commitCounter_";
  protected final String TEXT_1186 = "=0;" + NL + "                }";
