...
public class TNetezzaOutputEndJava {
  ...
  protected final String TEXT_59 = NL + "\t    try {" + NL + "\t    \tif(pstmt_";
  protected final String TEXT_60 = " != null && batchSizeCounter_";
  ...
  protected final String TEXT_78 = NL + "\t\t}catch (java.sql.SQLException e){" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\tthrow(e);" + NL + "\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t}" + NL + "\t    ";
  protected final String TEXT_82 = NL + NL + "\t        if(pstmt_";
  protected final String TEXT_83 = " != null) {" + NL + "\t            pstmt_";
  protected final String TEXT_84 = ".close();" + NL + "" + NL + "\t        }" + NL + "\t        ";
  protected final String TEXT_85 = NL;
  protected final String TEXT_86 = NL + "\t\t\tif(commitCounter_";
  ...
  protected final String TEXT_98 = "=nb_line_deleted_";
  protected final String TEXT_99 = "+ deletedCount_";
  protected final String TEXT_100 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_101 = "=nb_line_update_";
  protected final String TEXT_102 = " + updatedCount_";
  protected final String TEXT_103 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_104 = "=nb_line_inserted_";
  protected final String TEXT_105 = " + insertedCount_";
  protected final String TEXT_106 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_107 = "=nb_line_rejected_";
  protected final String TEXT_108 = " + rejectedCount_";
  protected final String TEXT_109 = ";" + NL + "\t";
  protected final String TEXT_110 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_111 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_112 = "_NB_LINE\",nb_line_";
  protected final String TEXT_113 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_114 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_115 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_116 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_117 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_118 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_119 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_120 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_121 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_122 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_123 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_124 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_125 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_126 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_129 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  ...
  protected final String TEXT_132 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_133 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_134 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_135 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_136 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_137 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_138 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_139 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  ...
  protected final String TEXT_144 = "_NB_LINE_UPDATED\",nb_line_update_";
