...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_52 = " = 0;" + NL + "int nb_line_copied_";
  ...
  protected final String TEXT_57 = "=0;" + NL + "int copiedCount_";
  protected final String TEXT_58 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_59 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_60 = " = null;" + NL + "boolean whetherReject_";
  ...
  protected final String TEXT_79 = NL + "\t\t   \t\t dbschema_";
  ...
  protected final String TEXT_85 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_90 = " = \"jdbc:vertica://\" + ";
  ...
  protected final String TEXT_100 = NL + NL + "\t\t\t\tString dbUser_";
  ...
  protected final String TEXT_115 = ",dbUser_";
  protected final String TEXT_116 = ",dbPwd_";
  protected final String TEXT_117 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\tresourceMap.put(\"conn_";
  protected final String TEXT_119 = "\", conn_";
  protected final String TEXT_120 = ");" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + NL + "if(dbschema_";
  protected final String TEXT_122 = " == null || dbschema_";
  protected final String TEXT_123 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_126 = " = dbschema_";
  protected final String TEXT_127 = " + \".\" + ";
  protected final String TEXT_128 = ";" + NL + "}";
  protected final String TEXT_129 = NL + "conn_";
  protected final String TEXT_130 = ".setAutoCommit(false);" + NL + "" + NL + "int commitEvery_";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = ";" + NL + "" + NL + "int commitCounter_";
  protected final String TEXT_133 = " = 0;";
  protected final String TEXT_134 = NL + "   int batchSize_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_137 = "=0;";
  protected final String TEXT_138 = NL;
  protected final String TEXT_139 = NL + "\tint count_";
  protected final String TEXT_140 = "=0;";
  protected final String TEXT_141 = NL + "\t";
  protected final String TEXT_142 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_146 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_157 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_173 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".createStatement();";
  protected final String TEXT_176 = NL + "                              stmtCreate_";
  protected final String TEXT_177 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_178 = "));";
  protected final String TEXT_179 = NL + "                    stmtCreate_";
  protected final String TEXT_180 = ".execute(((\"";
  protected final String TEXT_181 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_202 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_205 = " + \"]\";";
  protected final String TEXT_206 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_207 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_208 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_209 = ")== null){//}";
  protected final String TEXT_210 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_213 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_214 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_215 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_216 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_217 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_222 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_223 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_224 = " = tableNameForSearch_";
  protected final String TEXT_225 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_226 = " = tableNameForSearch_";
  protected final String TEXT_227 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_228 = " = dbMetaData_";
  protected final String TEXT_229 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_230 = ", tableNameForSearch_";
  protected final String TEXT_231 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_232 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_233 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_234 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_241 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_242 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_243 = " = rsTable_";
  protected final String TEXT_244 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_245 = " = rsTable_";
  protected final String TEXT_246 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_247 = ".equals";
  protected final String TEXT_248 = "IgnoreCase";
  protected final String TEXT_249 = "(";
  protected final String TEXT_250 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_266 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  ...
  protected final String TEXT_279 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_280 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_289 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_290 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_291 = " == null || dbschema_";
  protected final String TEXT_292 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_293 = " = conn_";
  protected final String TEXT_294 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_295 = " = stmtSchema_";
  protected final String TEXT_296 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_297 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_298 = " = rsSchema_";
  protected final String TEXT_299 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_300 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_301 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_316 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_317 = ".equals";
  protected final String TEXT_318 = "IgnoreCase";
  protected final String TEXT_319 = "(schema_";
  protected final String TEXT_320 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_321 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_322 = ".close();";
  protected final String TEXT_323 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_324 = " = ";
  protected final String TEXT_325 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_326 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_327 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_328 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_329 = " =  tableForSearch_";
  protected final String TEXT_330 = ".substring(1,tableForSearch_";
  protected final String TEXT_331 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_332 = " =  tableForSearch_";
  protected final String TEXT_333 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_337 = ".getTables(null, conn_";
  protected final String TEXT_338 = ".getSchema(), tableForSearch_";
  protected final String TEXT_339 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_340 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_341 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_342 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_343 = ".close();" + NL + "\t\t\t\t            ";
  protected final String TEXT_344 = NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_348 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_349 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_350 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_351 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_352 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_488 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_489 = " = conn_";
  protected final String TEXT_490 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_491 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_492 = " + \"_proj (";
  protected final String TEXT_493 = ") AS SELECT ";
  protected final String TEXT_494 = " FROM \" + tableName_";
  protected final String TEXT_495 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_496 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_497 = NL + "\t\t\t\tif(!whetherExist_";
  ...
  protected final String TEXT_508 = NL + "        int batchCount_";
  ...
  protected final String TEXT_516 = ".prepareStatement(update_";
  protected final String TEXT_517 = ");";
  protected final String TEXT_518 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_529 = ");" + NL + "        String update_";
  protected final String TEXT_530 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_531 = " + \" SET ";
  ...
  protected final String TEXT_540 = " WHERE ";
  ...
  protected final String TEXT_548 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_549 = " = conn_";
  protected final String TEXT_550 = ".prepareStatement(insert_";
  protected final String TEXT_551 = ");";
  protected final String TEXT_552 = NL + "        String delete_";
  protected final String TEXT_553 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_559 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_560 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_561 = " = conn_";
  protected final String TEXT_562 = ".createStatement();" + NL + "        String template_";
  protected final String TEXT_563 = " = \"COPY \" + tableName_";
  protected final String TEXT_564 = " +\" (";
  protected final String TEXT_565 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_566 = "DIRECT";
  protected final String TEXT_567 = "\";" + NL + "\t\t";
  protected final String TEXT_568 = NL + "        StringBuffer query_";
  protected final String TEXT_569 = " = null;" + NL + "       \t";
  protected final String TEXT_570 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_571 = " = insert_";
  protected final String TEXT_572 = ".split(\"\\\\?\");";
  protected final String TEXT_573 = NL + "\t\t\tupdate_";
  protected final String TEXT_574 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_575 = " = update_";
  ...
  protected final String TEXT_580 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_581 = " = insert_";
  protected final String TEXT_582 = ".split(\"\\\\?\");";
  protected final String TEXT_583 = NL + "\t\t\tdelete_";
  protected final String TEXT_584 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_585 = " = delete_";
  protected final String TEXT_586 = ".split(\"\\\\?\");";
  protected final String TEXT_587 = NL + "\t\t\treplace_";
  protected final String TEXT_588 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_589 = " = replace_";
  protected final String TEXT_590 = ".split(\"\\\\?\");";
  protected final String TEXT_591 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_592 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_593 = " = insertIgnore_";
  ...
  protected final String TEXT_598 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_599 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_600 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_601 = " =null;";
  protected final String TEXT_602 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_603 = " = null;" + NL + "\t\t";
  protected final String TEXT_604 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_608 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_609 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_610 = " = null;";
  protected final String TEXT_611 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_617 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_618 = " = null;";
  protected final String TEXT_619 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_620 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_621 = " = null;" + NL + "\t\tString template_";
