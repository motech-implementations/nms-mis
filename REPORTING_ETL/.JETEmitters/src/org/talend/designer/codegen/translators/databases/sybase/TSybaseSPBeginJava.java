...
public class TSybaseSPBeginJava
{
  ...
  protected final String TEXT_47 = NL + "    java.sql.Connection connection_";
  ...
  protected final String TEXT_53 = NL + "    java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");";
  protected final String TEXT_54 = NL + "\t\t String connectionString_";
  protected final String TEXT_55 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_56 = " + \":\" + ";
  protected final String TEXT_57 = " + \"/\" + ";
  protected final String TEXT_58 = ";";
  protected final String TEXT_59 = NL + "\t\t String connectionString_";
  protected final String TEXT_60 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_74 = NL + "    java.sql.Connection connection_";
  protected final String TEXT_75 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_76 = ", ";
  protected final String TEXT_77 = ", decryptedPassword_";
  protected final String TEXT_78 = ");" + NL + "\t";
  protected final String TEXT_79 = NL + NL + "\tString dbschema_";
  protected final String TEXT_80 = "= ";
  protected final String TEXT_81 = "; ";
  protected final String TEXT_82 = NL + "String spName_";
  protected final String TEXT_83 = " = ";
  protected final String TEXT_84 = ";" + NL + "if(dbschema_";
  protected final String TEXT_85 = " != null && dbschema_";
  protected final String TEXT_86 = ".trim().length() != 0) {" + NL + "\tspName_";
  protected final String TEXT_87 = " = dbschema_";
  protected final String TEXT_88 = " + \".\" + spName_";
  protected final String TEXT_89 = ";" + NL + "} ";
  protected final String TEXT_90 = NL + "java.sql.PreparedStatement statement_";
  protected final String TEXT_91 = " = connection_";
  protected final String TEXT_92 = ".prepareStatement(\"select \" + spName_";
  protected final String TEXT_93 = " + \"(";
  protected final String TEXT_94 = NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_95 = " = connection_";
  protected final String TEXT_96 = ".prepareCall(\"{call \" + ";
  ...
  protected final String TEXT_103 = NL + "    statement_";
  protected final String TEXT_104 = ".setQueryTimeout(";
  protected final String TEXT_105 = ");";
  protected final String TEXT_106 = NL + NL + "java.sql.Date tmpDate_";
  protected final String TEXT_107 = ";" + NL + "String tmpString_";
