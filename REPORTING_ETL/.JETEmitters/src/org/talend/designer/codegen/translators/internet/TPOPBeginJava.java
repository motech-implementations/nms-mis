...
public class TPOPBeginJava
{
  ...
  protected final String TEXT_251 = ".setFlag(javax.mail.Flags.Flag.DELETED, true);" + NL + "    \t\t";
  protected final String TEXT_252 = NL + "\t\t\t    String filename_";
  protected final String TEXT_253 = " = ";
  protected final String TEXT_254 = ";" + NL + "\t\t\t    java.io.File file_";
  protected final String TEXT_255 = " = new java.io.File(";
  protected final String TEXT_256 = ", filename_";
  protected final String TEXT_257 = ");" + NL + "\t\t\t    java.io.OutputStream os_";
  protected final String TEXT_258 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_259 = ");" + NL + "\t\t\t    ";
  protected final String TEXT_260 = " " + NL + "\t\t\t    message_";
  protected final String TEXT_261 = ".writeTo(os_";
  protected final String TEXT_262 = ");" + NL + "\t\t\t    os_";
  protected final String TEXT_263 = ".close();" + NL + "\t\t\t    nb_email_";
  protected final String TEXT_264 = "++;" + NL + "\t\t\t    globalMap.put(\"";
  protected final String TEXT_265 = "_CURRENT_FILE\", filename_";
  protected final String TEXT_266 = ");" + NL + "\t\t\t    globalMap.put(\"";
  protected final String TEXT_267 = "_CURRENT_FILEPATH\", file_";
  protected final String TEXT_268 = ".getAbsolutePath());";
