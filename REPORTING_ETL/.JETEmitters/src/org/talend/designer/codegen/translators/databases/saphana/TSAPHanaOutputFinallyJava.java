...
public class TSAPHanaOutputFinallyJava
{
  ...
  protected final String TEXT_48 = NL + "\t\tif(resourceMap.get(\"finish_";
  protected final String TEXT_49 = "\")==null){" + NL + "\t\t\tif(resourceMap.get(\"conn_";
  protected final String TEXT_50 = "\")!=null){" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\t\t((java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_52 = "\")).close();" + NL + "\t\t\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\t\t} catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_54 = ") {" + NL + "\t\t\t\t\tString errorMessage_";
  protected final String TEXT_55 = " = \"failed to close the connection in ";
  protected final String TEXT_56 = " :\" + sqlEx_";
  protected final String TEXT_57 = ".getMessage();" + NL + "\t\t\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t\tSystem.err.println(errorMessage_";
