...
public class TAccessOutputMainJava {
  ...
  protected final String TEXT_54 = " = new StringBuffer(\"\");";
  protected final String TEXT_55 = NL + "\t\t\t\t\tcommitEvery_";
  ...
  protected final String TEXT_114 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_115 = " = true;";
  protected final String TEXT_116 = NL + "                    throw(e);";
  ...
  protected final String TEXT_128 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_161 = ".toString().trim());";
  protected final String TEXT_162 = NL + "                try {" + NL + "    \t\t\t\tupdatedCount_";
  protected final String TEXT_163 = " = updatedCount_";
  protected final String TEXT_164 = " + pstmtUpdate_";
  protected final String TEXT_165 = ".executeUpdate();" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_166 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_167 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_174 = "Struct();";
  protected final String TEXT_175 = NL + "                                ";
  protected final String TEXT_176 = ".";
  protected final String TEXT_177 = " = ";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = ";";
  protected final String TEXT_180 = NL + "                            nb_line_rejected_";
  protected final String TEXT_181 = "++;";
  protected final String TEXT_182 = NL + "                            ";
  protected final String TEXT_183 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_188 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_189 = NL + "                        ";
  protected final String TEXT_190 = NL + "                            query_";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";";
  protected final String TEXT_193 = NL + "                    globalMap.put(\"";
  protected final String TEXT_194 = "_QUERY\", query_";
  protected final String TEXT_195 = ".toString().trim());";
  protected final String TEXT_196 = NL + "                try{" + NL + "        \t\t\tinsertedCount_";
  protected final String TEXT_197 = " = insertedCount_";
  protected final String TEXT_198 = " + pstmtInsert_";
  protected final String TEXT_199 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_200 = "++;";
  protected final String TEXT_201 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_243 = ".executeUpdate();" + NL + "                 if(updateFlag_";
  protected final String TEXT_244 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_245 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_246 = NL + "                 }" + NL + "                 updatedCount_";
  ...
  protected final String TEXT_313 = NL + "                        query_";
  protected final String TEXT_314 = " = ";
  protected final String TEXT_315 = ";";
  protected final String TEXT_316 = NL + "                globalMap.put(\"";
  protected final String TEXT_317 = "_QUERY\", query_";
  protected final String TEXT_318 = ".toString().trim());";
  ...
  protected final String TEXT_337 = NL + "                        nb_line_rejected_";
  protected final String TEXT_338 = "++;";
  protected final String TEXT_339 = NL + "                        ";
  protected final String TEXT_340 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_341 = NL + "                        ";
  protected final String TEXT_342 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_343 = ";";
  protected final String TEXT_344 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_345 = NL + "            }";
  protected final String TEXT_346 = NL + "            if(!whetherReject_";
  protected final String TEXT_347 = ") {";
  protected final String TEXT_348 = NL + "                            ";
  protected final String TEXT_349 = " = new ";
  protected final String TEXT_350 = "Struct();";
  ...
  protected final String TEXT_357 = NL + "\t            commitCounter_";
  protected final String TEXT_358 = "++;" + NL + "\t            " + NL + "\t            if(commitEvery_";
  protected final String TEXT_359 = "<=commitCounter_";
  protected final String TEXT_360 = ") {" + NL + "\t            \t";
  protected final String TEXT_361 = NL + "\t            \tconn_";
  protected final String TEXT_362 = ".commit();" + NL + "\t            \t";
  protected final String TEXT_363 = "    " + NL + "\t            \tcommitCounter_";
  protected final String TEXT_364 = "=0;\t" + NL + "\t            }\t" + NL + "\t            ";
