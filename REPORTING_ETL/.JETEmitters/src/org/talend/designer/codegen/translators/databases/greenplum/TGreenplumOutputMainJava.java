...
public class TGreenplumOutputMainJava {
  ...
  protected final String TEXT_52 = NL + "            batchSize_";
  ...
  protected final String TEXT_59 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_60 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_61 = "++;";
  protected final String TEXT_62 = NL + "                        try {" + NL + "                            insertedCount_";
  protected final String TEXT_63 = " = insertedCount_";
  protected final String TEXT_64 = " + pstmt_";
  protected final String TEXT_65 = ".executeUpdate();" + NL + "                            nb_line_";
  protected final String TEXT_66 = "++;";
  protected final String TEXT_67 = NL + "                        } catch(java.lang.Exception e) {" + NL + "                            whetherReject_";
  ...
  protected final String TEXT_78 = NL + "                                    rejectedCount_";
  ...
  protected final String TEXT_96 = NL + "                       pstmt_";
  protected final String TEXT_97 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_98 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_99 = "++;";
  protected final String TEXT_100 = NL + "                    try {" + NL + "                        updatedCount_";
  protected final String TEXT_101 = " = updatedCount_";
  protected final String TEXT_102 = " + pstmt_";
  protected final String TEXT_103 = ".executeUpdate();" + NL + "                        nb_line_";
  protected final String TEXT_104 = "++;";
  protected final String TEXT_105 = NL + "                    } catch(java.lang.Exception e) {" + NL + "                        whetherReject_";
  ...
  protected final String TEXT_116 = NL + "                                rejectedCount_";
  protected final String TEXT_117 = " =  rejectedCount_";
  protected final String TEXT_118 = " + 1;";
  protected final String TEXT_119 = NL + "                                ";
  protected final String TEXT_120 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_134 = ".next()) {" + NL + "                checkCount_";
  ...
  protected final String TEXT_173 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_174 = " = insertedCount_";
  protected final String TEXT_175 = " + pstmtInsert_";
  ...
  protected final String TEXT_201 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_210 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_211 = "=pstmtUpdate_";
  protected final String TEXT_212 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_213 = " = updatedCount_";
  protected final String TEXT_214 = "+updateFlag_";
  protected final String TEXT_215 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_216 = " == 0) {";
  protected final String TEXT_217 = NL + "                        ";
  protected final String TEXT_218 = NL + "                    insertedCount_";
  protected final String TEXT_219 = " = insertedCount_";
  protected final String TEXT_220 = " + pstmtInsert_";
  protected final String TEXT_221 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_222 = "++;";
  protected final String TEXT_223 = NL + "                }else{" + NL + "                    nb_line_";
  ...
  protected final String TEXT_238 = NL + "                            rejectedCount_";
  protected final String TEXT_239 = " =  rejectedCount_";
  protected final String TEXT_240 = " + 1;";
  protected final String TEXT_241 = NL + "                            ";
  protected final String TEXT_242 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_253 = NL + "                       pstmt_";
  protected final String TEXT_254 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_255 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_256 = "++;";
  protected final String TEXT_257 = NL + "                    try {" + NL + "                        deletedCount_";
  protected final String TEXT_258 = " = deletedCount_";
  protected final String TEXT_259 = " + pstmt_";
  protected final String TEXT_260 = ".executeUpdate();" + NL + "                        nb_line_";
  protected final String TEXT_261 = "++;";
  protected final String TEXT_262 = NL + "                    } catch(java.lang.Exception e) {" + NL + "                        whetherReject_";
  protected final String TEXT_263 = " = true;";
  protected final String TEXT_264 = NL + "                            throw(e);";
  ...
  protected final String TEXT_275 = NL + "                                rejectedCount_";
  protected final String TEXT_276 = " =  rejectedCount_";
  protected final String TEXT_277 = " + 1;";
  protected final String TEXT_278 = NL + "                                ";
  protected final String TEXT_279 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_280 = NL + "                                ";
  protected final String TEXT_281 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_282 = ";";
  protected final String TEXT_283 = NL + "                                System.err.print(e.getMessage());";
  protected final String TEXT_284 = NL + "                    }";
  protected final String TEXT_285 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_296 = NL + "                if ((batchSize_";
  protected final String TEXT_297 = " > 0) && (batchSize_";
  protected final String TEXT_298 = " <= batchSizeCounter_";
  protected final String TEXT_299 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_300 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_301 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_302 = " = 0;";
  protected final String TEXT_303 = NL + "                        status_";
  protected final String TEXT_304 = " = pstmt_";
  protected final String TEXT_305 = ".executeBatch();";
  protected final String TEXT_306 = NL + "                        for(int countEach_";
  protected final String TEXT_307 = ": status_";
  protected final String TEXT_308 = ") {" + NL + "                            countSum_";
  protected final String TEXT_309 = " += (countEach_";
  protected final String TEXT_310 = " < 0 ? 0 : countEach_";
  protected final String TEXT_311 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_312 = NL + "                            throw(e);";
  protected final String TEXT_313 = NL + "                        for(int countEach_";
  protected final String TEXT_314 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_315 = " += (countEach_";
  protected final String TEXT_316 = " < 0 ? 0 : countEach_";
  protected final String TEXT_317 = ");" + NL + "                        }";
  protected final String TEXT_318 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_319 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_320 = " = pstmt_";
  protected final String TEXT_321 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_322 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_323 = " = tmp_batchUpdateCount_";
  protected final String TEXT_324 = " > countSum_";
  protected final String TEXT_325 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_326 = " : countSum_";
  protected final String TEXT_327 = ";";
  protected final String TEXT_328 = NL + "                        insertedCount_";
  protected final String TEXT_329 = " += tmp_batchUpdateCount_";
  protected final String TEXT_330 = ";";
  protected final String TEXT_331 = NL + "                        updatedCount_";
  protected final String TEXT_332 = " += tmp_batchUpdateCount_";
  protected final String TEXT_333 = ";";
  protected final String TEXT_334 = NL + "                        deletedCount_";
  protected final String TEXT_335 = " += tmp_batchUpdateCount_";
  protected final String TEXT_336 = ";";
  protected final String TEXT_337 = NL + "               }";
  protected final String TEXT_338 = NL + "                commitCounter_";
  protected final String TEXT_339 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_340 = " <= commitCounter_";
  protected final String TEXT_341 = ") {";
  protected final String TEXT_342 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_343 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_344 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_345 = NL + "\t                    for(int countEach_";
  protected final String TEXT_346 = ": pstmt_";
  protected final String TEXT_347 = ".executeBatch()) {" + NL + "\t                        countSum_";
  ...
  protected final String TEXT_352 = NL + "\t                        insertedCount_";
  protected final String TEXT_353 = " += countSum_";
  protected final String TEXT_354 = ";" + NL + "\t                    ";
  protected final String TEXT_355 = NL + "\t                        updatedCount_";
  protected final String TEXT_356 = " += countSum_";
  ...
  protected final String TEXT_362 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_363 = NL + "                        throw(e);";
  protected final String TEXT_364 = NL + "                        int countSum_";
  protected final String TEXT_365 = " = 0;" + NL + "                        for(int countEach_";
  ...
  protected final String TEXT_370 = NL + "                            insertedCount_";
  protected final String TEXT_371 = " += countSum_";
  protected final String TEXT_372 = ";";
  protected final String TEXT_373 = NL + "                            updatedCount_";
  protected final String TEXT_374 = " += countSum_";
  protected final String TEXT_375 = ";";
  protected final String TEXT_376 = NL + "                            deletedCount_";
  protected final String TEXT_377 = " += countSum_";
  protected final String TEXT_378 = ";";
  protected final String TEXT_379 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_380 = NL + "                }";
  protected final String TEXT_381 = NL + "                ";
  protected final String TEXT_382 = NL + "                conn_";
  protected final String TEXT_383 = ".commit();";
  protected final String TEXT_384 = NL + "                commitCounter_";
