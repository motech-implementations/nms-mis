...
public class TFTPPutBeginJava
{
  ...
  protected final String TEXT_331 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPS); " + NL + "\t\t\t\t\t";
  protected final String TEXT_332 = " " + NL + "\t\t\t\t        \tftp_";
  protected final String TEXT_333 = ".setSecurity(it.sauronsoftware.ftp4j.FTPClient.SECURITY_FTPES); " + NL + "\t\t\t\t\t";
  protected final String TEXT_334 = "  " + NL + "\t\t\t\t  \t";
  protected final String TEXT_335 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_336 = " - FTPS security Mode is (";
  protected final String TEXT_337 = ").\");" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_338 = " - Attempt to connect to '\" + ";
  protected final String TEXT_339 = " + \"' with username '\" + ";
  protected final String TEXT_340 = "+ \"'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_341 = NL + "\t                ftp_";
  protected final String TEXT_342 = ".connect(";
  protected final String TEXT_343 = ",";
  protected final String TEXT_344 = "); " + NL + "\t\t\t\t\t";
  protected final String TEXT_345 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_346 = " - Connect to '\" + ";
  protected final String TEXT_347 = " +  \"' has succeeded.\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_356 = NL + "\t\t\t\t\t" + NL + "\t                ftp_";
  protected final String TEXT_357 = ".login(";
  protected final String TEXT_358 = ", decryptedPassword_";
  protected final String TEXT_359 = "); ";
  protected final String TEXT_360 = " " + NL + "                ftp_";
  protected final String TEXT_361 = " = (it.sauronsoftware.ftp4j.FTPClient)globalMap.get(\"";
  protected final String TEXT_362 = "\"); " + NL + "\t\t\t\t";
  protected final String TEXT_363 = NL + "\t\t\t\t\tif(ftp_";
  protected final String TEXT_364 = "!=null) {" + NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_365 = " - Uses an existing connection. Connection hostname: \" + ftp_";
  protected final String TEXT_366 = ".getHost() + \", Connection port: \" + ftp_";
  protected final String TEXT_367 = ".getPort() + \".\"); " + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\trootDir_";
  protected final String TEXT_369 = " = ftp_";
  protected final String TEXT_370 = ".currentDirectory();";
  protected final String TEXT_371 = " " + NL + "            remotedir_";
  protected final String TEXT_372 = " = ";
  protected final String TEXT_373 = "; " + NL + "            ftp_";
  protected final String TEXT_374 = ".changeDirectory(remotedir_";
  protected final String TEXT_375 = "); " + NL + "\t\t    } catch (java.lang.IllegalStateException e) { " + NL + "\t\t        e.printStackTrace();" + NL + "\t\t        String errMsg_";
  protected final String TEXT_376 = " = e.getMessage();" + NL + "\t\t        ";
  protected final String TEXT_377 = " " + NL + "\t\t    } catch (java.io.IOException e) { " + NL + "\t\t        e.printStackTrace();" + NL + "\t\t        String errMsg_";
  protected final String TEXT_378 = " = e.getMessage();" + NL + "\t\t        ";
  protected final String TEXT_379 = " " + NL + "\t\t    } catch (it.sauronsoftware.ftp4j.FTPIllegalReplyException e) { " + NL + "\t\t        e.printStackTrace(); " + NL + "\t\t        String errMsg_";
  protected final String TEXT_380 = " = e.getMessage();" + NL + "\t\t        ";
  protected final String TEXT_381 = NL + "\t\t    } catch (it.sauronsoftware.ftp4j.FTPException e) { " + NL + "\t\t        e.printStackTrace();" + NL + "\t\t        String errMsg_";
  protected final String TEXT_382 = " = e.getMessage();" + NL + "\t\t        ";
  protected final String TEXT_383 = " " + NL + "\t\t    } " + NL + "  \t\t\tjava.util.List<java.util.Map<String,String>> list";
  protected final String TEXT_384 = " = new java.util.ArrayList<java.util.Map<String,String>>();" + NL + "  " + NL + "  \t\t\t";
  protected final String TEXT_385 = NL + "    \t\tjava.util.Map<String,String> map";
  protected final String TEXT_386 = " = new java.util.HashMap<String,String>();" + NL + "   \t\t\t map";
  protected final String TEXT_387 = ".put(";
  protected final String TEXT_388 = ", ";
  protected final String TEXT_389 = ");    " + NL + "    \t\t\tlist";
  protected final String TEXT_390 = ".add(map";
  protected final String TEXT_391 = ");       " + NL + "  \t\t\t";
  protected final String TEXT_392 = "  " + NL + "\t\t\tString localdir";
  protected final String TEXT_393 = " = ";
  protected final String TEXT_394 = ";" + NL + "\t\t\t";
  protected final String TEXT_395 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_396 = " - Uploading files to the server.\");" + NL + "\t\t\t";
  protected final String TEXT_397 = NL + "\t     \tfor (java.util.Map<String, String> map";
