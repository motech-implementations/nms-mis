...
public class TOracleOutputEndJava
{
  ...
  protected final String TEXT_109 = NL + "                \tSystem.err.println(e_";
  protected final String TEXT_110 = ".getMessage());" + NL + "            \t";
  protected final String TEXT_111 = NL + "        \t}" + NL + "        \tif (pstmt_";
  protected final String TEXT_112 = " != null) {" + NL + "            \ttmp_batchUpdateCount_";
  protected final String TEXT_113 = " = pstmt_";
  protected final String TEXT_114 = ".getUpdateCount();" + NL + "    \t    \t";
  protected final String TEXT_115 = NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_116 = NL + "    \t    \t";
  protected final String TEXT_117 = NL + "    \t    \t\tupdatedCount_";
  protected final String TEXT_118 = NL + "    \t    \t";
  protected final String TEXT_119 = NL + "    \t    \t    deletedCount_";
  ...
  protected final String TEXT_124 = NL + "        if(pstmt_";
  protected final String TEXT_125 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_127 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_129 = ");" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "        }";
  protected final String TEXT_131 = NL + "\t\tif(commitCounter_";
