...
public class TNetezzaOutputBeginJava {
  ...
  protected final String TEXT_84 = " = \"org.netezza.Driver\";" + NL + "\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_85 = ");" + NL + "\t";
  protected final String TEXT_86 = NL + "\t";
  protected final String TEXT_87 = NL + "\t    String url_";
  protected final String TEXT_88 = " = \"jdbc:netezza://\" + ";
  ...
  protected final String TEXT_170 = NL + "            java.sql.Statement stmtClearCount_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "            java.sql.ResultSet rsClearCount_";
  protected final String TEXT_173 = " = stmtClearCount_";
  protected final String TEXT_174 = ".executeQuery(\"";
  protected final String TEXT_175 = "\");" + NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".createStatement();";
  protected final String TEXT_178 = NL + "            stmtClear_";
  protected final String TEXT_179 = ".executeUpdate(\"";
  protected final String TEXT_180 = "\");";
  protected final String TEXT_181 = NL + "            while(rsClearCount_";
  protected final String TEXT_182 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_183 = " += rsClearCount_";
  protected final String TEXT_184 = ".getInt(1);" + NL + "            }";
  protected final String TEXT_185 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_186 = " = conn_";
  protected final String TEXT_187 = ".createStatement();";
  protected final String TEXT_188 = NL + "            deletedCount_";
  protected final String TEXT_189 = " = deletedCount_";
  protected final String TEXT_190 = " + stmtClear_";
  protected final String TEXT_191 = ".executeUpdate(\"";
  protected final String TEXT_192 = "\");";
  protected final String TEXT_193 = NL + "            stmtClear_";
  protected final String TEXT_194 = ".close();";
  protected final String TEXT_195 = NL + "    \tconn_";
  protected final String TEXT_196 = ".setAutoCommit(false);";
  protected final String TEXT_197 = NL + "\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".prepareStatement(\"INSERT INTO \"+";
  protected final String TEXT_200 = "+\" (";
  protected final String TEXT_201 = ") VALUES (";
  protected final String TEXT_202 = ")\");" + NL + "\t        ";
  protected final String TEXT_203 = NL + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_204 = " = conn_";
  protected final String TEXT_205 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_206 = " + \" SET ";
  protected final String TEXT_207 = " WHERE ";
  protected final String TEXT_208 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_209 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_212 = " + \" WHERE ";
  protected final String TEXT_213 = "\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_216 = " + \" (";
  protected final String TEXT_217 = ") VALUES (";
  protected final String TEXT_218 = ")\");" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_219 = " = conn_";
  protected final String TEXT_220 = ".prepareStatement(\"UPDATE \" + ";
  ...
  protected final String TEXT_226 = ".prepareStatement(\"UPDATE \" + ";
  protected final String TEXT_227 = " + \" SET ";
  protected final String TEXT_228 = " WHERE ";
  protected final String TEXT_229 = "\");" + NL + "" + NL + "" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".prepareStatement(\"INSERT INTO \" + ";
  protected final String TEXT_232 = " + \" (";
  protected final String TEXT_233 = ") VALUES (";
  protected final String TEXT_234 = ")\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_235 = NL + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_236 = " = conn_";
  protected final String TEXT_237 = ".prepareStatement(\"DELETE  FROM \" + ";
  protected final String TEXT_238 = " + \" WHERE ";
  protected final String TEXT_239 = "\");" + NL + "" + NL + "\t    ";
  protected final String TEXT_240 = NL + NL + "\t    int commitEvery_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = ";" + NL + "" + NL + "\t    int commitCounter_";
  protected final String TEXT_243 = " = 0;" + NL + "" + NL + "\t";
  protected final String TEXT_244 = NL + "\t   int batchSize_";
  protected final String TEXT_245 = " = ";
  protected final String TEXT_246 = ";" + NL + "\t   int batchSizeCounter_";
