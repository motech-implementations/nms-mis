...
public class TAmazonMysqlOutputEndJava {
  ...
  protected final String TEXT_189 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  ...
  protected final String TEXT_193 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_194 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_195 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_196 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_197 = ": pstmt_";
  protected final String TEXT_198 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_199 = " += (countEach_";
  protected final String TEXT_200 = " < 0 ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_201 = NL + "\t            \t    \t";
  protected final String TEXT_202 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_203 = " += countSum_";
  protected final String TEXT_204 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_205 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_206 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_207 = NL + "                \tint countSum_";
  protected final String TEXT_208 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_209 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_210 = " += (countEach_";
  protected final String TEXT_211 = " < 0 ? 0 : countEach_";
  protected final String TEXT_212 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_213 = NL + "            \t    insertedCount_";
  ...
  protected final String TEXT_218 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_219 = " = 0;";
  protected final String TEXT_220 = NL + "    \t\t";
  protected final String TEXT_221 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_222 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_223 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_224 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_225 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_226 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_227 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_228 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_229 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_230 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_231 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_232 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_233 = NL + "    try {" + NL + "\t\t\tint countSum_";
  ...
  protected final String TEXT_239 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_269 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_270 = NL + "\t}";
  protected final String TEXT_271 = NL + "            if(pstmt_";
  protected final String TEXT_272 = " != null) {" + NL + "    \t\t\tpstmt_";
  protected final String TEXT_273 = ".close();" + NL + "            }";
  protected final String TEXT_274 = NL;
  protected final String TEXT_275 = NL + "    \t\tif (commitCounter_";
  protected final String TEXT_276 = " > 0) {" + NL + "        \t\t";
  protected final String TEXT_277 = NL + "        \t\tconn_";
  protected final String TEXT_278 = ".commit();" + NL + "        \t\t";
  ...
  protected final String TEXT_283 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_284 = "\", true);" + NL + "    \t";
  protected final String TEXT_285 = NL;
  protected final String TEXT_286 = NL + "\tnb_line_deleted_";
  protected final String TEXT_287 = "=nb_line_deleted_";
  protected final String TEXT_288 = "+ deletedCount_";
  protected final String TEXT_289 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_290 = "=nb_line_update_";
  protected final String TEXT_291 = " + updatedCount_";
  protected final String TEXT_292 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_293 = "=nb_line_inserted_";
  protected final String TEXT_294 = " + insertedCount_";
  protected final String TEXT_295 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_296 = "=nb_line_rejected_";
  protected final String TEXT_297 = " + rejectedCount_";
  protected final String TEXT_298 = ";" + NL + "\t";
  protected final String TEXT_299 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_300 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_301 = "_NB_LINE\",nb_line_";
  protected final String TEXT_302 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_303 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_304 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_305 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_306 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_307 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_308 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_309 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_310 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_311 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_312 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_313 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_314 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_315 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_316 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_317 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_318 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_319 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_320 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_321 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_322 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_323 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_324 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_325 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_326 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_327 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_331 = "_NB_LINE\",nb_line_";
  protected final String TEXT_332 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_333 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_334 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_335 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_336 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_337 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_338 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_339 = "_NB_LINE_REJECTED\", nb_line_rejected_";
