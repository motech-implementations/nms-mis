...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_418 = "+\") VALUES (";
  protected final String TEXT_419 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_420 = ".";
  protected final String TEXT_421 = ")+\")\";";
  protected final String TEXT_422 = NL + "                            String insert_";
  protected final String TEXT_423 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_424 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_425 = ".";
  protected final String TEXT_426 = ", \"";
  protected final String TEXT_427 = "\")";
  protected final String TEXT_428 = ".toUpperCase()";
  protected final String TEXT_429 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_447 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_448 = " = conn_";
  protected final String TEXT_449 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_450 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_451 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".prepareStatement(insert_";
  protected final String TEXT_454 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_455 = ", pstmt_";
  protected final String TEXT_456 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_457 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_463 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_464 = ".";
  protected final String TEXT_465 = ", \"";
  protected final String TEXT_466 = "\")";
  protected final String TEXT_467 = ".toUpperCase()";
  ...
  protected final String TEXT_472 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_491 = NL + "                    pstmt_";
  protected final String TEXT_492 = " = conn_";
  protected final String TEXT_493 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_503 = ".toUpperCase()";
  protected final String TEXT_504 = "+\") VALUES (";
  protected final String TEXT_505 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_514 = ".toUpperCase()";
  protected final String TEXT_515 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_521 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_522 = ".";
  protected final String TEXT_523 = ", \"";
  protected final String TEXT_524 = "\")";
  protected final String TEXT_525 = ".toUpperCase()";
  ...
  protected final String TEXT_530 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_549 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_550 = " = new StringBuffer(update_";
  protected final String TEXT_551 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_552 = ".insert(update_";
  protected final String TEXT_553 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_554 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_555 = " =updateStringBuffer_";
  ...
  protected final String TEXT_564 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_565 = ".";
  protected final String TEXT_566 = ", \"";
  protected final String TEXT_567 = "\")";
  protected final String TEXT_568 = ".toUpperCase()";
  ...
  protected final String TEXT_579 = ".toUpperCase()";
  ...
  protected final String TEXT_590 = ".toUpperCase()";
  ...
  protected final String TEXT_599 = ".toUpperCase()";
  protected final String TEXT_600 = "+\" WHERE ";
  protected final String TEXT_601 = "\";";
  protected final String TEXT_602 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_603 = " = new StringBuffer(update_";
  protected final String TEXT_604 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_605 = ".insert(update_";
  protected final String TEXT_606 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_607 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_608 = " =updateStringBuffer_";
  protected final String TEXT_609 = ".toString(); ";
  ...
  protected final String TEXT_622 = "    " + NL + "                    pstmtInsert_";
  ...
  protected final String TEXT_627 = " = \"DELETE FROM \" + tableName_";
  ...
  protected final String TEXT_642 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_652 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_653 = " = insert_";
  protected final String TEXT_654 = ".split(\"\\\\?\");";
  protected final String TEXT_655 = NL + "\t\t\tdelete_";
  protected final String TEXT_656 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_657 = " = delete_";
  protected final String TEXT_658 = ".split(\"\\\\?\");";
  protected final String TEXT_659 = NL + "\t\t\treplace_";
  protected final String TEXT_660 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_661 = " = replace_";
  protected final String TEXT_662 = ".split(\"\\\\?\");";
  protected final String TEXT_663 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_664 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_665 = " = insertIgnore_";
  protected final String TEXT_666 = ".split(\"\\\\?\");";
  protected final String TEXT_667 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_672 = " = new StringBuffer(\"\");";
  protected final String TEXT_673 = NL + "                commitEvery_";
  protected final String TEXT_674 = " = buffersSize_";
  protected final String TEXT_675 = ";";
  protected final String TEXT_676 = NL + "            batchSize_";
  protected final String TEXT_677 = " = buffersSize_";
  protected final String TEXT_678 = ";";
  protected final String TEXT_679 = NL + "        whetherReject_";
  protected final String TEXT_680 = " = false;";
  protected final String TEXT_681 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_682 = NL + "                            // TODO error: ";
  protected final String TEXT_683 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_684 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_685 = ".";
  protected final String TEXT_686 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_687 = " = tGeometry_";
  protected final String TEXT_688 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_689 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_690 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_691 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_692 = "\", geometry_";
  protected final String TEXT_693 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_694 = ".expandToInclude(geometry_";
  protected final String TEXT_695 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_696 = " = geometry_";
  protected final String TEXT_697 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_698 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_699 = " = oracle_wkt_";
  protected final String TEXT_700 = ".toJGeometry(wkt_";
  protected final String TEXT_701 = ".getBytes());" + NL;
  protected final String TEXT_702 = NL + "                            jgeometry_";
  protected final String TEXT_703 = ".setSRID(";
  protected final String TEXT_704 = ");";
  protected final String TEXT_705 = NL + "                        pstmt_";
  protected final String TEXT_706 = ".setObject(";
  protected final String TEXT_707 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_714 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_715 = ",";
  protected final String TEXT_716 = ".";
  protected final String TEXT_717 = ", ";
  protected final String TEXT_718 = ",insertSQLSplits_";
  protected final String TEXT_719 = ");";
  protected final String TEXT_720 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_721 = ".";
  protected final String TEXT_722 = ", pstmt_";
  protected final String TEXT_723 = ", ";
  protected final String TEXT_724 = ", \"";
  protected final String TEXT_725 = "\");";
  protected final String TEXT_726 = NL + "                globalMap.put(\"";
  protected final String TEXT_727 = "_QUERY\", query_";
  protected final String TEXT_728 = ".toString().trim());";
  protected final String TEXT_729 = NL + "                pstmt_";
  protected final String TEXT_730 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_731 = "++;";
  protected final String TEXT_732 = NL + "                batchSizeCounter_";
  protected final String TEXT_733 = "++;";
  protected final String TEXT_734 = NL + "                try {" + NL + "                    nb_line_";
  ...
  protected final String TEXT_738 = ".executeUpdate();";
  protected final String TEXT_739 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_740 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_741 = " = true;";
  protected final String TEXT_742 = NL + "                        throw(e_";
  protected final String TEXT_743 = ");";
  protected final String TEXT_744 = NL + "                            ";
  protected final String TEXT_745 = " = new ";
  protected final String TEXT_746 = "Struct();";
  protected final String TEXT_747 = NL + "                                ";
  protected final String TEXT_748 = ".";
  protected final String TEXT_749 = " = ";
  protected final String TEXT_750 = ".";
  protected final String TEXT_751 = ";";
  protected final String TEXT_752 = NL + "                            rejectedCount_";
  protected final String TEXT_753 = " = rejectedCount_";
  protected final String TEXT_754 = " + 1;";
  protected final String TEXT_755 = NL + "                            ";
  protected final String TEXT_756 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_757 = ").getSQLState();";
  protected final String TEXT_758 = NL + "                            ";
  protected final String TEXT_759 = ".errorMessage = e_";
  protected final String TEXT_760 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_761 = ";";
  protected final String TEXT_762 = NL + "                            System.err.print(e_";
  protected final String TEXT_763 = ".getMessage());";
  ...
  protected final String TEXT_775 = NL + "                    int count_";
  ...
  protected final String TEXT_795 = NL + "                           query_";
  protected final String TEXT_796 = " = ";
  protected final String TEXT_797 = ";";
  protected final String TEXT_798 = NL + "                globalMap.put(\"";
  protected final String TEXT_799 = "_QUERY\", query_";
  protected final String TEXT_800 = ".toString().trim());";
  ...
  protected final String TEXT_806 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_807 = "++;" + NL + "                    updatedCount_";
  protected final String TEXT_808 = " = updatedCount_";
  protected final String TEXT_809 = " + pstmt_";
  protected final String TEXT_810 = ".executeUpdate();";
  protected final String TEXT_811 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_812 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_813 = " = true;";
  protected final String TEXT_814 = NL + "                        throw(e_";
  protected final String TEXT_815 = ");";
  protected final String TEXT_816 = NL + "                            ";
  protected final String TEXT_817 = " = new ";
  protected final String TEXT_818 = "Struct();";
  protected final String TEXT_819 = NL + "                                ";
  protected final String TEXT_820 = ".";
  protected final String TEXT_821 = " = ";
  protected final String TEXT_822 = ".";
  protected final String TEXT_823 = ";";
  protected final String TEXT_824 = NL + "                            rejectedCount_";
  protected final String TEXT_825 = " = rejectedCount_";
  protected final String TEXT_826 = " + 1;";
  protected final String TEXT_827 = NL + "                            ";
  protected final String TEXT_828 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_829 = ").getSQLState();";
  protected final String TEXT_830 = NL + "                            ";
  protected final String TEXT_831 = ".errorMessage = e_";
  protected final String TEXT_832 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_833 = ";";
  protected final String TEXT_834 = NL + "                            System.err.print(e_";
  protected final String TEXT_835 = ".getMessage());";
  protected final String TEXT_836 = NL + "                }";
  protected final String TEXT_837 = NL + "                        ";
  protected final String TEXT_838 = NL + "                    ";
  protected final String TEXT_839 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_840 = " = pstmt_";
  protected final String TEXT_841 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_842 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_843 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_844 = " = rs_";
  protected final String TEXT_845 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_846 = " > 0) {";
  protected final String TEXT_847 = NL + "                        ";
  protected final String TEXT_848 = NL + "                            query_";
  protected final String TEXT_849 = " = ";
  protected final String TEXT_850 = ";";
  protected final String TEXT_851 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_852 = ",";
  protected final String TEXT_853 = ".";
  protected final String TEXT_854 = ", ";
  protected final String TEXT_855 = ",updateSQLSplits_";
  protected final String TEXT_856 = ");";
  protected final String TEXT_857 = NL + "                        int count_";
  protected final String TEXT_858 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_859 = ".";
  protected final String TEXT_860 = ", pstmtUpdate_";
  ...
  protected final String TEXT_876 = NL + "                                query_";
  protected final String TEXT_877 = " = ";
  protected final String TEXT_878 = ";";
  protected final String TEXT_879 = NL + "                    globalMap.put(\"";
  protected final String TEXT_880 = "_QUERY\", query_";
  protected final String TEXT_881 = ".toString().trim());";
  protected final String TEXT_882 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_883 = " = updatedCount_";
  protected final String TEXT_884 = " + pstmtUpdate_";
  protected final String TEXT_885 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_886 = "++;";
  protected final String TEXT_887 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_888 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_889 = " = true;";
  protected final String TEXT_890 = NL + "                        throw(e_";
  protected final String TEXT_891 = ");";
  protected final String TEXT_892 = NL + "                        nb_line_";
  ...
  protected final String TEXT_902 = NL + "                            rejectedCount_";
  protected final String TEXT_903 = " = rejectedCount_";
  protected final String TEXT_904 = " + 1;";
  protected final String TEXT_905 = NL + "                            ";
  protected final String TEXT_906 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_907 = ").getSQLState();";
  protected final String TEXT_908 = NL + "                            ";
  protected final String TEXT_909 = ".errorMessage = e_";
  protected final String TEXT_910 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_911 = ";";
  protected final String TEXT_912 = NL + "                            System.err.print(e_";
  protected final String TEXT_913 = ".getMessage());";
  protected final String TEXT_914 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_915 = NL + "                        ";
  protected final String TEXT_916 = NL + "                            query_";
  protected final String TEXT_917 = " = ";
  protected final String TEXT_918 = ";";
  protected final String TEXT_919 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_920 = ",";
  protected final String TEXT_921 = ".";
  protected final String TEXT_922 = ", ";
  protected final String TEXT_923 = ",insertSQLSplits_";
  protected final String TEXT_924 = ");";
  protected final String TEXT_925 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_926 = ".";
  protected final String TEXT_927 = ", pstmtInsert_";
  protected final String TEXT_928 = ", ";
  protected final String TEXT_929 = ", \"";
  protected final String TEXT_930 = "\");";
  protected final String TEXT_931 = NL + "                    globalMap.put(\"";
  protected final String TEXT_932 = "_QUERY\", query_";
  protected final String TEXT_933 = ".toString().trim());";
  protected final String TEXT_934 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_935 = " = insertedCount_";
  protected final String TEXT_936 = " + pstmtInsert_";
  protected final String TEXT_937 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_938 = "++;";
  protected final String TEXT_939 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_940 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_941 = " = true;";
  protected final String TEXT_942 = NL + "                        throw(e_";
  ...
  protected final String TEXT_954 = NL + "                            rejectedCount_";
  protected final String TEXT_955 = " = rejectedCount_";
  protected final String TEXT_956 = " + 1;";
  protected final String TEXT_957 = NL + "                            ";
  protected final String TEXT_958 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_959 = ").getSQLState();";
  protected final String TEXT_960 = NL + "                            ";
  protected final String TEXT_961 = ".errorMessage = e_";
  protected final String TEXT_962 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_963 = ";";
  protected final String TEXT_964 = NL + "                            System.err.print(e_";
  protected final String TEXT_965 = ".getMessage());";
  protected final String TEXT_966 = NL + "                }" + NL + "            }";
  protected final String TEXT_967 = NL + "            int updateFlag_";
  protected final String TEXT_968 = " = 0;";
  protected final String TEXT_969 = NL + "                    ";
  protected final String TEXT_970 = NL + "                        query_";
  protected final String TEXT_971 = " = ";
  protected final String TEXT_972 = ";";
  protected final String TEXT_973 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_974 = ",";
  protected final String TEXT_975 = ".";
  protected final String TEXT_976 = ", ";
  protected final String TEXT_977 = ",updateSQLSplits_";
  protected final String TEXT_978 = ");";
  protected final String TEXT_979 = NL + NL + "                    int count_";
  protected final String TEXT_980 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_981 = ".";
  protected final String TEXT_982 = ", pstmtUpdate_";
  protected final String TEXT_983 = ", ";
  protected final String TEXT_984 = ", \"";
  protected final String TEXT_985 = "\");";
  protected final String TEXT_986 = NL + "                            ";
  protected final String TEXT_987 = NL + "                            ";
  protected final String TEXT_988 = NL + "                            query_";
  protected final String TEXT_989 = " = ";
  protected final String TEXT_990 = ";";
  protected final String TEXT_991 = NL + "                            query_";
  ...
  protected final String TEXT_1002 = NL + "                globalMap.put(\"";
  protected final String TEXT_1003 = "_QUERY\", query_";
  protected final String TEXT_1004 = ".toString().trim());";
  protected final String TEXT_1005 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_1006 = " = pstmtUpdate_";
  protected final String TEXT_1007 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_1008 = " = updatedCount_";
  protected final String TEXT_1009 = "+updateFlag_";
  protected final String TEXT_1010 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_1011 = " == 0) {";
  protected final String TEXT_1012 = NL + "                        query_";
  protected final String TEXT_1013 = " = new StringBuffer(\"\");";
  protected final String TEXT_1014 = NL + "                            ";
  protected final String TEXT_1015 = NL + "                                query_";
  protected final String TEXT_1016 = " = ";
  protected final String TEXT_1017 = ";";
  protected final String TEXT_1018 = NL + "                                routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_1019 = ",";
  protected final String TEXT_1020 = ".";
  protected final String TEXT_1021 = ", ";
  protected final String TEXT_1022 = ",insertSQLSplits_";
  protected final String TEXT_1023 = ");";
  protected final String TEXT_1024 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_1025 = ".";
  protected final String TEXT_1026 = ", pstmtInsert_";
  protected final String TEXT_1027 = ", ";
  protected final String TEXT_1028 = ", \"";
  protected final String TEXT_1029 = "\");";
  protected final String TEXT_1030 = NL + "                        globalMap.put(\"";
  protected final String TEXT_1031 = "_QUERY\", query_";
  protected final String TEXT_1032 = ".toString().trim());";
  protected final String TEXT_1033 = NL + "                    insertedCount_";
  protected final String TEXT_1034 = " = insertedCount_";
  protected final String TEXT_1035 = " + pstmtInsert_";
  protected final String TEXT_1036 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1037 = "++;";
  protected final String TEXT_1038 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1039 = "++;";
  protected final String TEXT_1040 = NL + "                }" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_1041 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_1042 = " = true;";
  protected final String TEXT_1043 = NL + "                    throw(e_";
  protected final String TEXT_1044 = ");";
  protected final String TEXT_1045 = NL + "                    nb_line_";
  ...
  protected final String TEXT_1055 = NL + "                        rejectedCount_";
  protected final String TEXT_1056 = " = rejectedCount_";
  protected final String TEXT_1057 = " + 1;";
  protected final String TEXT_1058 = NL + "                        ";
  protected final String TEXT_1059 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1060 = ").getSQLState();";
  protected final String TEXT_1061 = NL + "                        ";
  protected final String TEXT_1062 = ".errorMessage = e_";
  protected final String TEXT_1063 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1064 = ";";
  protected final String TEXT_1065 = NL + "                        System.err.print(e_";
  protected final String TEXT_1066 = ".getMessage());";
  ...
  protected final String TEXT_1076 = NL + "                globalMap.put(\"";
  protected final String TEXT_1077 = "_QUERY\", query_";
  protected final String TEXT_1078 = ".toString().trim());";
  ...
  protected final String TEXT_1084 = NL + "                try {" + NL + "                    deletedCount_";
  protected final String TEXT_1085 = " = deletedCount_";
  protected final String TEXT_1086 = " + pstmt_";
  protected final String TEXT_1087 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1088 = "++;";
  protected final String TEXT_1089 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_1090 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_1091 = " = true;";
  protected final String TEXT_1092 = NL + "                        throw(e_";
  protected final String TEXT_1093 = ");";
  protected final String TEXT_1094 = NL + "                        nb_line_";
  protected final String TEXT_1095 = "++;";
  protected final String TEXT_1096 = NL + "                            ";
  protected final String TEXT_1097 = " = new ";
  protected final String TEXT_1098 = "Struct();";
  ...
  protected final String TEXT_1104 = NL + "                            rejectedCount_";
  protected final String TEXT_1105 = " = rejectedCount_";
  protected final String TEXT_1106 = " + 1;";
  protected final String TEXT_1107 = NL + "                            ";
  protected final String TEXT_1108 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_1109 = ").getSQLState();";
  protected final String TEXT_1110 = NL + "                            ";
  protected final String TEXT_1111 = ".errorMessage = e_";
  protected final String TEXT_1112 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1113 = ";";
  protected final String TEXT_1114 = NL + "                            System.err.print(e_";
  protected final String TEXT_1115 = ".getMessage());";
  protected final String TEXT_1116 = NL + "                }";
  protected final String TEXT_1117 = NL + "            if(!whetherReject_";
  protected final String TEXT_1118 = ") {";
  protected final String TEXT_1119 = NL + "                            ";
  protected final String TEXT_1120 = " = new ";
  protected final String TEXT_1121 = "Struct();";
  ...
  protected final String TEXT_1128 = NL + "            if (batchSize_";
  protected final String TEXT_1129 = " > 0 &&  batchSize_";
  protected final String TEXT_1130 = " <= batchSizeCounter_";
  protected final String TEXT_1131 = ") {" + NL + "                try {";
  protected final String TEXT_1132 = NL + "                    pstmt_";
  protected final String TEXT_1133 = ".executeBatch();";
  protected final String TEXT_1134 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1135 = "){";
  protected final String TEXT_1136 = NL + "                        throw(e_";
  protected final String TEXT_1137 = ");";
  protected final String TEXT_1138 = NL + "                        System.err.println(e_";
  protected final String TEXT_1139 = ".getMessage());";
  protected final String TEXT_1140 = NL + "                }" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_1141 = " = pstmt_";
  protected final String TEXT_1142 = ".getUpdateCount();";
  protected final String TEXT_1143 = NL + "                    insertedCount_";
  protected final String TEXT_1144 = NL + "                    updatedCount_";
  protected final String TEXT_1145 = NL + "                    deletedCount_";
  protected final String TEXT_1146 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_1147 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1148 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_1149 = " = 0;" + NL + "            }";
  protected final String TEXT_1150 = NL + "                commitCounter_";
  protected final String TEXT_1151 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1152 = " <= commitCounter_";
  protected final String TEXT_1153 = ") {" + NL;
  protected final String TEXT_1154 = NL + "                        try {";
  protected final String TEXT_1155 = NL + "                            pstmt_";
  protected final String TEXT_1156 = ".executeBatch();";
  protected final String TEXT_1157 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1158 = "){";
  protected final String TEXT_1159 = NL + "                                throw(e_";
  protected final String TEXT_1160 = ");";
  protected final String TEXT_1161 = NL + "                                System.err.println(e_";
  protected final String TEXT_1162 = ".getMessage());";
  ...
  protected final String TEXT_1171 = ":0);";
  protected final String TEXT_1172 = NL + "                    conn_";
  protected final String TEXT_1173 = ".commit();";
  protected final String TEXT_1174 = NL + "                    commitCounter_";
  protected final String TEXT_1175 = "=0;" + NL + "                }";
