...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_80 = NL + "    \tclass BytesLimit65535_";
  protected final String TEXT_81 = "{" + NL + "    \t\tpublic void limitLog4jByte() throws Exception{" + NL + "    \t\t\t";
  protected final String TEXT_82 = NL + "            StringBuilder ";
  protected final String TEXT_83 = " = new StringBuilder();";
  protected final String TEXT_84 = NL + "            ";
  protected final String TEXT_85 = ".append(\"Parameters:\");";
  protected final String TEXT_86 = NL + "                    ";
  protected final String TEXT_87 = ".append(\"";
  protected final String TEXT_88 = "\" + \" = \" + String.valueOf(";
  protected final String TEXT_89 = ").substring(0, 4) + \"...\");     ";
  ...
  protected final String TEXT_96 = NL + "    \t\t}" + NL + "    \t}" + NL + "    \t" + NL + "        new BytesLimit65535_";
  protected final String TEXT_97 = "().limitLog4jByte();";
  protected final String TEXT_98 = NL + "            StringBuilder ";
  ...
  protected final String TEXT_108 = ".append(\"<null>\");" + NL + "                    }else{";
  ...
  protected final String TEXT_116 = NL + NL + "int nb_line_";
  protected final String TEXT_117 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_118 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_119 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_120 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_121 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_122 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_123 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_124 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_125 = "=0;" + NL + "" + NL + "String tableName_";
  ...
  protected final String TEXT_133 = NL + NL + NL;
  protected final String TEXT_134 = NL + "        int updateKeyCount_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_137 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_138 = NL + "        int deleteKeyCount_";
  protected final String TEXT_139 = " = ";
  protected final String TEXT_140 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_141 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_142 = NL + "\t String dbname_";
  protected final String TEXT_143 = " = (String)globalMap.get(\"";
  protected final String TEXT_144 = "\");" + NL + "\t String dbUser_";
  protected final String TEXT_145 = " = (String)globalMap.get(\"";
  protected final String TEXT_146 = "\");" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_147 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_148 = "\");" + NL + "\t";
  protected final String TEXT_149 = NL + "\t";
  protected final String TEXT_150 = NL + "    String dbname_";
  protected final String TEXT_151 = " = ";
  protected final String TEXT_152 = ";" + NL + "    String driverClass_";
  protected final String TEXT_153 = " = \"com.teradata.jdbc.TeraDriver\";";
  protected final String TEXT_154 = NL + NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_155 = ");" + NL + "    String dbProperties_";
  protected final String TEXT_156 = " = ";
  protected final String TEXT_157 = ";" + NL + "\tString url_";
  protected final String TEXT_158 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_159 = " == null || dbProperties_";
  protected final String TEXT_160 = ".trim().length() == 0) {" + NL + "\t\turl_";
  protected final String TEXT_161 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_162 = ";" + NL + "\t} else {" + NL + "\t    url_";
  protected final String TEXT_163 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_164 = " + \"/\" + ";
  protected final String TEXT_165 = ";" + NL + "\t}" + NL + "    String dbUser_";
  ...
  protected final String TEXT_178 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_179 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_180 = ",dbUser_";
  protected final String TEXT_181 = ",dbPwd_";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL;
  protected final String TEXT_184 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_185 = " =  conn_";
  protected final String TEXT_186 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_187 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_188 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_189 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_190 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_191 = NL + "                 conn_";
  protected final String TEXT_192 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_193 = NL + "               ";
  protected final String TEXT_194 = " + \"=\" + ";
  protected final String TEXT_195 = " + \";\" +";
  protected final String TEXT_196 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_197 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_198 = ");";
  protected final String TEXT_199 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_200 = "\", conn_";
  protected final String TEXT_201 = ");";
  protected final String TEXT_202 = NL + "        conn_";
  protected final String TEXT_203 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_206 = " = 0;";
  protected final String TEXT_207 = NL + "String dbschema_";
  protected final String TEXT_208 = " = dbname_";
  protected final String TEXT_209 = ";" + NL + "if(dbname_";
  protected final String TEXT_210 = " == null || dbname_";
  protected final String TEXT_211 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_212 = " = ";
  protected final String TEXT_213 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_214 = " = dbname_";
  protected final String TEXT_215 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_216 = ";" + NL + "}";
  protected final String TEXT_217 = NL + "int count_";
  protected final String TEXT_218 = "=0;";
  protected final String TEXT_219 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_223 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_230 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_234 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_235 = "));";
  protected final String TEXT_236 = NL + "                    stmtCreate_";
  protected final String TEXT_237 = ".execute(((\"";
  protected final String TEXT_238 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_250 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_251 = " = conn_";
  protected final String TEXT_252 = ".createStatement();";
  protected final String TEXT_253 = NL + "                              stmtCreate_";
  protected final String TEXT_254 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_271 = NL + "                    String keyCheckTable_";
  protected final String TEXT_272 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_279 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_282 = " + \"]\";";
  protected final String TEXT_283 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_284 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_285 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_286 = ")== null){//}";
  protected final String TEXT_287 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_290 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_291 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_292 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_293 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_294 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_299 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_300 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_301 = " = tableNameForSearch_";
  protected final String TEXT_302 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_303 = " = tableNameForSearch_";
  protected final String TEXT_304 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_305 = " = dbMetaData_";
  protected final String TEXT_306 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_307 = ", tableNameForSearch_";
  protected final String TEXT_308 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_309 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_310 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_311 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_318 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_332 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_343 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_344 = " = rsTable_";
  protected final String TEXT_345 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_346 = ".equals";
  protected final String TEXT_347 = "IgnoreCase";
  protected final String TEXT_348 = "((";
  protected final String TEXT_349 = ")";
  protected final String TEXT_350 = ".toUpperCase()";
  protected final String TEXT_351 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_352 = ".equals";
  protected final String TEXT_353 = "IgnoreCase";
  protected final String TEXT_354 = "(dbschema_";
  protected final String TEXT_355 = ") || (dbschema_";
  protected final String TEXT_356 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_357 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_425 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_426 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_427 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_428 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_429 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_430 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_431 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_432 = ".close();";
  protected final String TEXT_433 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_434 = " = conn_";
  protected final String TEXT_435 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_436 = " = dbMetaData_";
  protected final String TEXT_437 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_438 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_439 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_440 = " = rsTable_";
  protected final String TEXT_441 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_442 = ".equalsIgnoreCase(";
  protected final String TEXT_443 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_444 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_445 = ".close();";
  protected final String TEXT_446 = NL + "                                if(!whetherExist_";
  protected final String TEXT_447 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_451 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_452 = "));";
  protected final String TEXT_453 = NL + "                                            stmtCreate_";
  protected final String TEXT_454 = ".execute(((\"";
  protected final String TEXT_455 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_456 = ".";
  protected final String TEXT_457 = ", \"";
  protected final String TEXT_458 = "\")";
  protected final String TEXT_459 = ".toUpperCase()";
  ...
  protected final String TEXT_467 = NL + "                                if(whetherExist_";
  protected final String TEXT_468 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_469 = " = conn_";
  protected final String TEXT_470 = ".createStatement();";
  protected final String TEXT_471 = NL + "                                                      stmtDrop_";
  protected final String TEXT_472 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_473 = "));";
  protected final String TEXT_474 = NL + "                                    stmtDrop_";
  protected final String TEXT_475 = ".execute(\"";
  protected final String TEXT_476 = "\" ";
  protected final String TEXT_477 = ");";
  protected final String TEXT_478 = NL + "                                    stmtDrop_";
  protected final String TEXT_479 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_487 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_494 = NL + "                                    stmtCreate_";
  protected final String TEXT_495 = ".execute(\"";
  protected final String TEXT_496 = ")\");";
  protected final String TEXT_497 = NL + "                                stmtCreate_";
  protected final String TEXT_498 = ".close();";
  protected final String TEXT_499 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_500 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_501 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_502 = " = conn_";
  protected final String TEXT_503 = ".createStatement();";
  protected final String TEXT_504 = NL + "                              stmtClear_";
  protected final String TEXT_505 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_506 = "));";
  protected final String TEXT_507 = NL + "            stmtClear_";
  protected final String TEXT_508 = ".executeUpdate(\"";
  protected final String TEXT_509 = "\");";
  protected final String TEXT_510 = NL + "            stmtClear_";
  protected final String TEXT_511 = ".close();";
  protected final String TEXT_512 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_513 = " = conn_";
  protected final String TEXT_514 = ".createStatement();";
  protected final String TEXT_515 = NL + "                              stmtTruncCount_";
  protected final String TEXT_516 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_517 = "));";
  protected final String TEXT_518 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_519 = " = stmtTruncCount_";
  protected final String TEXT_520 = ".executeQuery(\"";
  protected final String TEXT_521 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_522 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_523 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_524 = " = rsTruncCount_";
  protected final String TEXT_525 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_526 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_527 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_528 = " = conn_";
  protected final String TEXT_529 = ".createStatement();";
  protected final String TEXT_530 = NL + "                              stmtTrunc_";
  protected final String TEXT_531 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_532 = "));";
  protected final String TEXT_533 = NL + "                conn_";
  protected final String TEXT_534 = ".commit();";
  protected final String TEXT_535 = NL + "            stmtTrunc_";
  protected final String TEXT_536 = ".executeUpdate(\"";
  protected final String TEXT_537 = "\");";
  protected final String TEXT_538 = NL + "                if(!conn_";
  protected final String TEXT_539 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_540 = ".commit();" + NL + "                }";
  protected final String TEXT_541 = NL + "            deletedCount_";
  protected final String TEXT_542 = " += rsTruncCountNumber_";
  protected final String TEXT_543 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_544 = ".close();";
  protected final String TEXT_545 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_546 = " = conn_";
  protected final String TEXT_547 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_548 = " = stmtTruncCount_";
  protected final String TEXT_549 = ".executeQuery(\"";
  protected final String TEXT_550 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_551 = " = conn_";
  protected final String TEXT_552 = ".createStatement();";
  protected final String TEXT_553 = NL + "                conn_";
  protected final String TEXT_554 = ".commit();";
  protected final String TEXT_555 = NL + "            stmtTrunc_";
  protected final String TEXT_556 = ".executeUpdate(\"";
  protected final String TEXT_557 = "\");";
  protected final String TEXT_558 = NL + "            while(rsTruncCount_";
  protected final String TEXT_559 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_560 = " += rsTruncCount_";
  protected final String TEXT_561 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_562 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_563 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_564 = ".close();";
  ...
  protected final String TEXT_577 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_578 = " = conn_";
  protected final String TEXT_579 = ".prepareStatement(update_";
  protected final String TEXT_580 = ");" + NL + "\t    ";
  protected final String TEXT_581 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_582 = " = conn_";
  protected final String TEXT_583 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_588 = ") VALUES (";
  protected final String TEXT_589 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_596 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_597 = " = conn_";
  protected final String TEXT_598 = ".prepareStatement(update_";
  ...
  protected final String TEXT_604 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_605 = " = conn_";
  protected final String TEXT_606 = ".prepareStatement(update_";
  protected final String TEXT_607 = ");" + NL + "\t    String insert_";
  protected final String TEXT_608 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_609 = " + \"\\\" (";
  protected final String TEXT_610 = ") VALUES (";
  protected final String TEXT_611 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_653 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_654 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_655 = " =null;" + NL + "\t";
  protected final String TEXT_656 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_657 = " = null;" + NL + "\t\t";
  protected final String TEXT_658 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_659 = " = null;";
  protected final String TEXT_660 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_661 = " =  null;";
  protected final String TEXT_662 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_663 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_664 = " = null;";
  protected final String TEXT_665 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_666 = " = null;";
  protected final String TEXT_667 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_668 = " = null;";
  protected final String TEXT_669 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
