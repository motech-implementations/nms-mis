...
public class TVerticaBulkExecBeginJava {
  ...
  protected final String TEXT_83 = " = \"com.vertica.jdbc.Driver\";" + NL + "\t\t";
  ...
  protected final String TEXT_479 = ".createStatement();" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_480 = " = stmt_";
  protected final String TEXT_481 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_482 = ");" + NL + "\t    int nbLineBeforeLoad_";
  protected final String TEXT_483 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_484 = ".next()) {" + NL + "\t    \tnbLineBeforeLoad_";
  protected final String TEXT_485 = " = rs_";
  protected final String TEXT_486 = ".getInt(1);" + NL + "\t\t}" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_487 = ").startCopyIn(sql_";
  protected final String TEXT_488 = ", fis_";
  protected final String TEXT_489 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_490 = ").addStreamToCopyIn(fis_";
  protected final String TEXT_491 = ");" + NL + "\t    ((com.vertica.PGStatement) stmt_";
  protected final String TEXT_492 = ").finishCopyIn();" + NL + "\t    ";
  protected final String TEXT_493 = NL + "            log.info(\"";
  protected final String TEXT_494 = " - Bulk insert data into ";
  protected final String TEXT_495 = "\" + tableName_";
  protected final String TEXT_496 = " + \"";
  protected final String TEXT_497 = " has finished.\");";
  protected final String TEXT_498 = NL + "\t\trs_";
  protected final String TEXT_499 = " = stmt_";
  protected final String TEXT_500 = ".executeQuery(\"select count(*) from \" + tableName_";
  protected final String TEXT_501 = ");" + NL + "\t    int nbLineAfterLoad_";
  protected final String TEXT_502 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_503 = ".next()) {" + NL + "\t    \tnbLineAfterLoad_";
  protected final String TEXT_504 = " = rs_";
  protected final String TEXT_505 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\tstmt_";
  protected final String TEXT_506 = ".close();" + NL + "\t\tif(";
  protected final String TEXT_507 = " && nbLineBeforeLoad_";
  protected final String TEXT_508 = " >= nbLineAfterLoad_";
  protected final String TEXT_509 = "){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted in component ";
  protected final String TEXT_510 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_511 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_512 = " - Number of records inserted to table ";
  protected final String TEXT_513 = "\" + tableName_";
  protected final String TEXT_514 = " + \"";
  protected final String TEXT_515 = " by ";
  protected final String TEXT_516 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_517 = " - nbLineBeforeLoad_";
  protected final String TEXT_518 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_519 = NL + "\t\t\tSystem.out.println(\"Number of records inserted to table ";
  protected final String TEXT_520 = "\" + tableName_";
  protected final String TEXT_521 = " + \"";
  protected final String TEXT_522 = " by ";
  protected final String TEXT_523 = ": \" + (nbLineAfterLoad_";
  protected final String TEXT_524 = " - nbLineBeforeLoad_";
  protected final String TEXT_525 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_526 = "_ACCEPTED_ROW_NUMBER\",nbLineAfterLoad_";
  protected final String TEXT_527 = " - nbLineBeforeLoad_";
  protected final String TEXT_528 = ");\t" + NL + "\t\t";
  protected final String TEXT_529 = NL + "\t\t com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_530 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_531 = ",sql_";
  protected final String TEXT_532 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_533 = ".start();" + NL + "\t\tvcs_";
  protected final String TEXT_534 = ".addStream(fis_";
  protected final String TEXT_535 = ");" + NL + "\t\tvcs_";
  protected final String TEXT_536 = ".execute();" + NL + "\t\tvcs_";
  protected final String TEXT_537 = ".finish();" + NL + "\t\t";
  protected final String TEXT_538 = NL + "            log.info(\"";
  protected final String TEXT_539 = " - Bulk insert data into ";
  protected final String TEXT_540 = "\" + tableName_";
  protected final String TEXT_541 = " + \"";
  protected final String TEXT_542 = " has finished.\");";
  protected final String TEXT_543 = NL + "\t\tlong copyNumber_";
  protected final String TEXT_544 = " = vcs_";
  protected final String TEXT_545 = ".getRowCount();" + NL + "\t\t" + NL + "\t\t//get rejected and accepted row number" + NL + "\t\tjava.sql.Statement stmt_accept_reject_";
  protected final String TEXT_546 = " = conn_";
  protected final String TEXT_547 = ".createStatement();" + NL + "\t\t" + NL + "\t    java.sql.ResultSet rs_";
  protected final String TEXT_548 = " = stmt_accept_reject_";
  protected final String TEXT_549 = ".executeQuery(\"select get_num_accepted_rows()\");" + NL + "\t    int accetpedRowNumber_";
  protected final String TEXT_550 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_551 = ".next()) {" + NL + "\t    \taccetpedRowNumber_";
  protected final String TEXT_552 = " = rs_";
  protected final String TEXT_553 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    rs_";
  protected final String TEXT_554 = " = stmt_accept_reject_";
  protected final String TEXT_555 = ".executeQuery(\"select get_num_rejected_rows()\");" + NL + "\t    int rejectedRowNumber_";
  protected final String TEXT_556 = " = 0;" + NL + "\t    while (rs_";
  protected final String TEXT_557 = ".next()) {" + NL + "\t    \trejectedRowNumber_";
  protected final String TEXT_558 = " = rs_";
  protected final String TEXT_559 = ".getInt(1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tstmt_accept_reject_";
  protected final String TEXT_560 = ".close();" + NL + "\t\t" + NL + "\t\tif(";
  protected final String TEXT_561 = " && copyNumber_";
  protected final String TEXT_562 = " <= 0){" + NL + "\t\t\tthrow new RuntimeException(\"No record was inserted into component ";
  protected final String TEXT_563 = "\");" + NL + "\t\t}else{" + NL + "\t\t\t";
  protected final String TEXT_564 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_565 = " - Number of records inserted into table ";
  protected final String TEXT_566 = "\" + tableName_";
  protected final String TEXT_567 = " + \"";
  protected final String TEXT_568 = " by ";
  protected final String TEXT_569 = ": \" + (copyNumber_";
  protected final String TEXT_570 = ")+\".\");" + NL + "\t\t\t";
  protected final String TEXT_571 = NL + "\t\t\tSystem.out.println(\"Number of records inserted into table ";
  protected final String TEXT_572 = "\" + tableName_";
  protected final String TEXT_573 = " + \"";
  protected final String TEXT_574 = " by ";
  protected final String TEXT_575 = ": \" + (copyNumber_";
  protected final String TEXT_576 = "));" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_577 = "_ACCEPTED_ROW_NUMBER\",accetpedRowNumber_";
  protected final String TEXT_578 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_579 = "_REJECTED_ROW_NUMBER\",rejectedRowNumber_";
