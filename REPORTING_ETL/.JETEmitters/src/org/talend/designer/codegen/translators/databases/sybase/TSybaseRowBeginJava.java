...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_118 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_119 = " + \":\" + ";
  protected final String TEXT_120 = " + \"/\" + ";
  protected final String TEXT_121 = "; " + NL + "\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tString url_";
  protected final String TEXT_123 = " = \"jdbc:sybase:Tds:\" + ";
  protected final String TEXT_124 = " + \":\" + ";
  protected final String TEXT_125 = " + \"/\" + ";
  protected final String TEXT_126 = " + \"?\" + ";
  protected final String TEXT_127 = ";" + NL + "\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\tString tableName_";
  protected final String TEXT_129 = " = ";
  protected final String TEXT_130 = " ;" + NL + "\t\t\t\tString dbschema_";
  protected final String TEXT_131 = " = ";
  protected final String TEXT_132 = ";" + NL + "\t\t\t\tif (dbschema_";
  protected final String TEXT_133 = " != null && dbschema_";
  protected final String TEXT_134 = ".trim().length() != 0) {" + NL + "\t\t\t\t\ttableName_";
  protected final String TEXT_135 = " = dbschema_";
  protected final String TEXT_136 = " + \".\" + ";
  protected final String TEXT_137 = ";" + NL + "\t\t\t\t}" + NL + "\t\t\t\tstmt_";
  protected final String TEXT_138 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_139 = " +\" ON\");" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_141 = " = null;" + NL + "\tString query_";
  protected final String TEXT_142 = " = \"\";" + NL + "\tboolean whetherReject_";
  protected final String TEXT_143 = " = false;";
