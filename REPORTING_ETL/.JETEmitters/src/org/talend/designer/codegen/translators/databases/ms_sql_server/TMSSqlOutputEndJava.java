...
public class TMSSqlOutputEndJava {
  ...
  protected final String TEXT_47 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_48 = " ) {" + NL + "\t\t\tString setIdentityInsertONSQL_";
  protected final String TEXT_49 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_50 = " +\"] ON\";" + NL + "\t\t\t";
  protected final String TEXT_51 = NL + "        \tstmt_";
  protected final String TEXT_52 = ".execute(setIdentityInsertONSQL_";
  protected final String TEXT_53 = ");" + NL + "\t\t\t";
  protected final String TEXT_54 = NL + "        }";
  protected final String TEXT_55 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_56 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_57 = ".close();" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_58 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_59 = ".close();" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_60 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_61 = ".close();" + NL + "        }";
  protected final String TEXT_62 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_63 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_64 = ".close();" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_65 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_66 = ".close();" + NL + "        }";
  protected final String TEXT_67 = NL + "        if(pstmtInsert_";
  protected final String TEXT_68 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_69 = ".close();" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_70 = " != null) {" + NL + "            pstmt_";
  ...
  protected final String TEXT_78 = ",java.sql.Types.CHAR);" + NL + "\t\t";
  ...
  protected final String TEXT_83 = ",java.sql.Types.DATE);" + NL + "\t\t";
  ...
  protected final String TEXT_88 = ",java.sql.Types.ARRAY);" + NL + "\t\t";
  protected final String TEXT_89 = NL + "\t\t        if(bufferL";
  protected final String TEXT_90 = ".";
  protected final String TEXT_91 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_92 = ".setNull(count";
  protected final String TEXT_93 = ",java.sql.Types.INTEGER);" + NL + "\t\t";
  protected final String TEXT_94 = NL + "\t\t        if(bufferL";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_97 = ".setNull(count";
  protected final String TEXT_98 = ",java.sql.Types.VARCHAR);" + NL + "\t\t";
  protected final String TEXT_99 = NL + "\t\t        if(bufferL";
  protected final String TEXT_100 = ".";
  protected final String TEXT_101 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_102 = ".setNull(count";
  protected final String TEXT_103 = ",java.sql.Types.OTHER);" + NL + "\t\t";
  protected final String TEXT_104 = NL + "\t\t        if(bufferL";
  protected final String TEXT_105 = ".";
  protected final String TEXT_106 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_107 = ".setNull(count";
  protected final String TEXT_108 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t";
  protected final String TEXT_109 = NL + "\t\t        if(bufferL";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_112 = ".setNull(count";
  protected final String TEXT_113 = ",java.sql.Types.DOUBLE);" + NL + "\t\t";
  protected final String TEXT_114 = NL + "\t\t        if(bufferL";
  protected final String TEXT_115 = ".";
  protected final String TEXT_116 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_117 = ".setNull(count";
  protected final String TEXT_118 = ",java.sql.Types.FLOAT);" + NL + "\t\t";
  protected final String TEXT_119 = NL + NL + "\t\t        }else{" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\t";
  protected final String TEXT_121 = NL + "\t\t        if(bufferL";
  protected final String TEXT_122 = ".";
  protected final String TEXT_123 = "==null){" + NL + "\t\t";
  protected final String TEXT_124 = NL + "\t\t        if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_125 = ".";
  protected final String TEXT_126 = ").toLowerCase())){" + NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t    ";
  protected final String TEXT_128 = ".setNull(count";
  protected final String TEXT_129 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t    } else if(bufferL";
  protected final String TEXT_130 = ".";
  protected final String TEXT_131 = " == '\\0') {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_132 = ".setString(count";
  protected final String TEXT_133 = ",\"\");" + NL + "" + NL + "\t\t    } else {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_134 = ".setString(count";
  protected final String TEXT_135 = ",String.valueOf(bufferL";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = "));" + NL + "\t\t    }" + NL + "\t\t";
  protected final String TEXT_138 = NL + "\t\t        if(bufferL";
  protected final String TEXT_139 = ".";
  protected final String TEXT_140 = "!=null){" + NL + "\t\t            // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t            date_";
  protected final String TEXT_141 = " = bufferL";
  protected final String TEXT_142 = ".";
  protected final String TEXT_143 = ".getTime();" + NL + "\t\t            if (date_";
  protected final String TEXT_144 = " < year1_";
  protected final String TEXT_145 = " || date_";
  protected final String TEXT_146 = " >= year10000_";
  protected final String TEXT_147 = ") {" + NL + "\t\t                ";
  protected final String TEXT_148 = ".setString(count";
  protected final String TEXT_149 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  protected final String TEXT_150 = NL + "                    \t";
  protected final String TEXT_151 = ".setString(count";
  protected final String TEXT_152 = ",TalendDate.formatDate(";
  protected final String TEXT_153 = ", ";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_157 = ".setString(count";
  protected final String TEXT_158 = ",TalendDate.formatDatetimeoffset(";
  protected final String TEXT_159 = ".";
  protected final String TEXT_160 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t                ";
  protected final String TEXT_162 = ".setTimestamp(count";
  protected final String TEXT_163 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_164 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_165 = NL + "\t\t         ";
  protected final String TEXT_166 = NL + "\t\t                ";
  protected final String TEXT_167 = ".setTimestamp(count";
  protected final String TEXT_168 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_169 = "),calendar_datetimeoffset_";
  protected final String TEXT_170 = ");" + NL + "\t\t         ";
  protected final String TEXT_171 = NL + "\t\t         \t\t";
  protected final String TEXT_172 = ".setTimestamp(count";
  protected final String TEXT_173 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_174 = "));" + NL + "\t\t         ";
  protected final String TEXT_175 = NL + "\t\t\t\t";
  protected final String TEXT_176 = NL + "\t\t            }" + NL + "\t\t        }else{" + NL + "\t\t            ";
  protected final String TEXT_177 = ".setNull(count";
  protected final String TEXT_178 = ",java.sql.Types.DATE);" + NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_179 = NL + "\t\t        ";
  protected final String TEXT_180 = ".set";
  protected final String TEXT_181 = "(count";
  protected final String TEXT_182 = ",bufferL";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = ");" + NL + "\t\t        ";
  protected final String TEXT_185 = NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\tif(rowCount";
  protected final String TEXT_187 = "!=0){" + NL + "" + NL + "\t\tStringBuilder singleQueryInsertValueStmt = new StringBuilder();" + NL + "\t\tfor(int i=0 ; i < rowCount";
  protected final String TEXT_188 = " ; i++){" + NL + "\t\t     singleQueryInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_189 = "+\")\");" + NL + "\t\t     if (i != rowCount";
  protected final String TEXT_190 = " - 1)" + NL + "\t\t    \t singleQueryInsertValueStmt.append(\",\");" + NL + "\t\t}" + NL + "" + NL + "\t\tinsert_";
  protected final String TEXT_191 = " = \"INSERT INTO \"+";
  protected final String TEXT_192 = "+\" (\"+insertColName";
  protected final String TEXT_193 = "+\") VALUES \"+singleQueryInsertValueStmt.toString();" + NL + "" + NL + "\t\tpstmt_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".prepareStatement(insert_";
  protected final String TEXT_196 = ");" + NL + "\t\tint row2Count";
  protected final String TEXT_197 = " = 0;" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t\t\tint count";
  protected final String TEXT_199 = " = 1;" + NL + "\t\t";
  protected final String TEXT_200 = NL + "\t\tint count";
  protected final String TEXT_201 = " = 0;" + NL + "\t\t";
  protected final String TEXT_202 = NL + NL + "\t\tfor(BufferLine_";
  protected final String TEXT_203 = " bufferL";
  protected final String TEXT_204 = " : sInsertColValueList";
  ...
  protected final String TEXT_211 = " = row2Count";
  protected final String TEXT_212 = "*";
  protected final String TEXT_213 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_214 = NL + "\t\t            count";
  protected final String TEXT_215 = "++;" + NL + "\t\t            ";
  protected final String TEXT_216 = NL + "\t\t\t\tint count_dyn_";
  protected final String TEXT_217 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_218 = ".";
  protected final String TEXT_219 = ", pstmt_";
  protected final String TEXT_220 = ", count";
  protected final String TEXT_221 = "-1, \"";
  protected final String TEXT_222 = "\");" + NL + "\t\t\t\tcount";
  protected final String TEXT_223 = "+=count_dyn_";
  protected final String TEXT_224 = ";" + NL + "\t\t\t";
  protected final String TEXT_225 = NL + NL + "\t\t    row2Count";
  protected final String TEXT_226 = "++;" + NL + "\t\t}" + NL + "\t\tinsertedCount_";
  protected final String TEXT_227 = " = insertedCount_";
  protected final String TEXT_228 = " + pstmt_";
  protected final String TEXT_229 = ".executeUpdate();" + NL + "\t\t}";
  protected final String TEXT_230 = NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_231 = " = 0;" + NL + "\t\t\t\t\t\tif (pstmt_";
  protected final String TEXT_232 = " != null && batchSizeCounter_";
  protected final String TEXT_233 = " > 0) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_235 = ": pstmt_";
  protected final String TEXT_236 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_237 = " == -2 || countEach_";
  protected final String TEXT_238 = " == -3) {" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_239 = " += countEach_";
  protected final String TEXT_240 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_241 = NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_242 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_243 = " += countSum_";
  protected final String TEXT_244 = ";" + NL + "            \t    \t";
  protected final String TEXT_245 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_246 = " += countSum_";
  protected final String TEXT_247 = ";" + NL + "            \t    \t";
  protected final String TEXT_248 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_249 = " += countSum_";
  protected final String TEXT_250 = ";" + NL + "            \t    \t";
  protected final String TEXT_251 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_252 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_253 = NL + "                \tint countSum_";
  protected final String TEXT_254 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_255 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_256 = " += (countEach_";
  protected final String TEXT_257 = " < 0 ? 0 : countEach_";
  protected final String TEXT_258 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_259 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_260 = " += countSum_";
  protected final String TEXT_261 = ";" + NL + "            \t    \t";
  protected final String TEXT_262 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_263 = " += countSum_";
  protected final String TEXT_264 = ";" + NL + "            \t    \t";
  protected final String TEXT_265 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_266 = " += countSum_";
  protected final String TEXT_267 = ";" + NL + "            \t    \t";
  protected final String TEXT_268 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_269 = NL + "            \t}";
  protected final String TEXT_270 = NL + "        if(pstmt_";
  protected final String TEXT_271 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_272 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_273 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_275 = ");" + NL + "\t\t\t";
  protected final String TEXT_276 = NL + "        }";
  protected final String TEXT_277 = NL + "    String setIdentityInsertOFFSQL_";
  protected final String TEXT_278 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_279 = " +\"] OFF\";";
  protected final String TEXT_280 = NL + "    stmt_";
  protected final String TEXT_281 = ".execute(setIdentityInsertOFFSQL_";
  protected final String TEXT_282 = ");";
  protected final String TEXT_283 = NL + "    stmt_";
  protected final String TEXT_284 = ".close();";
  protected final String TEXT_285 = NL;
  protected final String TEXT_286 = NL + "            conn_";
  protected final String TEXT_287 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_288 = NL + "        conn_";
  protected final String TEXT_289 = " .close();";
  protected final String TEXT_290 = NL + "        resourceMap.put(\"finish_";
  protected final String TEXT_291 = "\", true);";
  protected final String TEXT_292 = NL;
  protected final String TEXT_293 = NL + "\tnb_line_deleted_";
  protected final String TEXT_294 = "=nb_line_deleted_";
  protected final String TEXT_295 = "+ deletedCount_";
  protected final String TEXT_296 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_297 = "=nb_line_update_";
  protected final String TEXT_298 = " + updatedCount_";
  protected final String TEXT_299 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_300 = "=nb_line_inserted_";
  protected final String TEXT_301 = " + insertedCount_";
  protected final String TEXT_302 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_303 = "=nb_line_rejected_";
  protected final String TEXT_304 = " + rejectedCount_";
  protected final String TEXT_305 = ";" + NL + "\t";
  protected final String TEXT_306 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_307 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_308 = "_NB_LINE\",nb_line_";
  protected final String TEXT_309 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_310 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_311 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_312 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_313 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_314 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_315 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_316 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_317 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_318 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_319 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_320 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_321 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_322 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_323 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_324 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_325 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_326 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_327 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_328 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_329 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_330 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_331 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_332 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_333 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_334 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_338 = "_NB_LINE\",nb_line_";
  protected final String TEXT_339 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_340 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_341 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_342 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_343 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_344 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_345 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_346 = "_NB_LINE_REJECTED\", nb_line_rejected_";
