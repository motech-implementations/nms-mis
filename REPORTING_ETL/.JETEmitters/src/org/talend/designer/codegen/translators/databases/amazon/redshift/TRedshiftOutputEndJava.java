...
public class TRedshiftOutputEndJava {
  ...
  protected final String TEXT_47 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_48 = ".";
  protected final String TEXT_49 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_50 = ".setNull(count";
  protected final String TEXT_51 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_53 = ".";
  protected final String TEXT_54 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_55 = ".setNull(count";
  protected final String TEXT_56 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t";
  protected final String TEXT_57 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_58 = ".";
  protected final String TEXT_59 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_60 = ".setNull(count";
  protected final String TEXT_61 = ",java.sql.Types.ARRAY);" + NL + "\t\t\t\t\t";
  protected final String TEXT_62 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_63 = ".";
  protected final String TEXT_64 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_65 = ".setNull(count";
  protected final String TEXT_66 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_68 = ".";
  protected final String TEXT_69 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_70 = ".setNull(count";
  protected final String TEXT_71 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_75 = ".setNull(count";
  protected final String TEXT_76 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_78 = ".";
  protected final String TEXT_79 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_80 = ".setNull(count";
  protected final String TEXT_81 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_85 = ".setNull(count";
  protected final String TEXT_86 = ",java.sql.Types.DOUBLE);" + NL + "\t\t\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_88 = ".";
  protected final String TEXT_89 = "==null){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = ".setNull(count";
  protected final String TEXT_91 = ",java.sql.Types.FLOAT);" + NL + "\t\t\t\t\t";
  protected final String TEXT_92 = NL + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_95 = ".";
  protected final String TEXT_96 = "==null){" + NL + "\t\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\t\t\tif((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_98 = ".";
  protected final String TEXT_99 = ").toLowerCase())){" + NL + "\t\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\t";
  protected final String TEXT_101 = ".setNull(count";
  protected final String TEXT_102 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t\t\t} else if(bufferL";
  protected final String TEXT_103 = ".";
  protected final String TEXT_104 = " == '\\0') {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_105 = ".setString(count";
  protected final String TEXT_106 = ",\"\");" + NL + "" + NL + "\t\t\t\t} else {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_107 = ".setString(count";
  protected final String TEXT_108 = ",String.valueOf(bufferL";
  protected final String TEXT_109 = ".";
  protected final String TEXT_110 = "));" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_111 = NL + "\t\t\t\t\tif(bufferL";
  protected final String TEXT_112 = ".";
  protected final String TEXT_113 = "!=null){" + NL + "\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\tdate_";
  protected final String TEXT_114 = " = bufferL";
  protected final String TEXT_115 = ".";
  protected final String TEXT_116 = ".getTime();" + NL + "\t\t\t\t\t\tif (date_";
  protected final String TEXT_117 = " < year1_";
  protected final String TEXT_118 = " || date_";
  protected final String TEXT_119 = " >= year10000_";
  protected final String TEXT_120 = ") {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_121 = ".setString(count";
  protected final String TEXT_122 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_123 = ".setTimestamp(count";
  protected final String TEXT_124 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_125 = "));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_126 = ".setNull(count";
  protected final String TEXT_127 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\t";
  protected final String TEXT_129 = ".set";
  protected final String TEXT_130 = "(count";
  protected final String TEXT_131 = ",bufferL";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_134 = NL + NL + "\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_135 = NL + NL + NL + "\t    if(rowCount";
  protected final String TEXT_136 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValue_";
  protected final String TEXT_137 = " = new StringBuilder();" + NL + "\t        for(int i_";
  protected final String TEXT_138 = "=0 ; i_";
  protected final String TEXT_139 = " < rowCount";
  protected final String TEXT_140 = " ; i_";
  protected final String TEXT_141 = "++){";
  protected final String TEXT_142 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_143 = ".append(\"(";
  protected final String TEXT_144 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = ")+\")\");";
  protected final String TEXT_147 = NL + "        \t\t\textendInsertValue_";
  protected final String TEXT_148 = ".append(\"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_149 = ".";
  protected final String TEXT_150 = ")+\")\");";
  protected final String TEXT_151 = NL + "\t\t\t\textendInsertValue_";
  protected final String TEXT_152 = ".append(\"(";
  protected final String TEXT_153 = ")\");";
  protected final String TEXT_154 = NL + "     \t\t\tif (i_";
  protected final String TEXT_155 = " != rowCount";
  protected final String TEXT_156 = " - 1) extendInsertValue_";
  protected final String TEXT_157 = ".append(\",\");" + NL + "\t        }" + NL;
  protected final String TEXT_158 = NL + "                \tinsert_";
  protected final String TEXT_159 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_160 = " + \"\\\" (";
  protected final String TEXT_161 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_162 = ".";
  protected final String TEXT_163 = ", \"";
  protected final String TEXT_164 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_165 = ".toString();";
  protected final String TEXT_166 = NL + "                \tinsert_";
  protected final String TEXT_167 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_168 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_169 = ".";
  protected final String TEXT_170 = ", \"";
  protected final String TEXT_171 = "\")+\") VALUES \" + extendInsertValue_";
  protected final String TEXT_172 = ".toString();";
  protected final String TEXT_173 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_174 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_175 = " + \"\\\" (";
  protected final String TEXT_176 = ") VALUES \"+extendInsertValue_";
  protected final String TEXT_177 = ".toString();";
  protected final String TEXT_178 = NL + "        \tpstmt_";
  protected final String TEXT_179 = " =  conn_";
  protected final String TEXT_180 = ".prepareStatement(insert_";
  protected final String TEXT_181 = ");";
  protected final String TEXT_182 = NL + "\t\t\trowCount";
  protected final String TEXT_183 = " = 0;" + NL + "\t        for(BufferLine_";
  protected final String TEXT_184 = " bufferL";
  protected final String TEXT_185 = " : exInsertColValueList";
  protected final String TEXT_186 = "){" + NL + "\t\t\t\tint count";
  protected final String TEXT_187 = " = rowCount";
  protected final String TEXT_188 = " *" + NL + "\t\t\t\t\t(";
  protected final String TEXT_189 = NL + "\t\t\t\t\t\t+ bufferL";
  protected final String TEXT_190 = ".";
  protected final String TEXT_191 = ".getColumnCount()";
  protected final String TEXT_192 = NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_193 = NL + "\t                    count";
  protected final String TEXT_194 = "++;" + NL + "\t                    ";
  protected final String TEXT_195 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(bufferL";
  protected final String TEXT_196 = ".";
  protected final String TEXT_197 = ", pstmt_";
  protected final String TEXT_198 = ", count";
  protected final String TEXT_199 = "-1, \"";
  protected final String TEXT_200 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_201 = NL + NL + "\t            rowCount";
  protected final String TEXT_202 = "++;" + NL + "\t        }" + NL + "\t        insertedCount_";
  protected final String TEXT_203 = " = insertedCount_";
  protected final String TEXT_204 = " + pstmt_";
  protected final String TEXT_205 = ".executeUpdate();" + NL + "\t    }" + NL + "\t";
  protected final String TEXT_206 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_207 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_208 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_209 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_210 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_211 = " != null) {" + NL + "" + NL + "            pstmt_";
  protected final String TEXT_212 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_213 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_214 = " != null){" + NL + "" + NL + "            pstmtUpdate_";
  protected final String TEXT_215 = ".close();" + NL + "" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_216 = " != null){" + NL + "" + NL + "            pstmtInsert_";
  protected final String TEXT_217 = ".close();" + NL + "" + NL + "        }";
  protected final String TEXT_218 = NL + "                        int[] status_";
  protected final String TEXT_219 = " = null;" + NL + "                        int countSum_";
  protected final String TEXT_220 = " = 0;" + NL + "                        try {" + NL + "                            if(pstmt_";
  protected final String TEXT_221 = "!=null && batchSizeCounter_";
  protected final String TEXT_222 = " > 0 ){";
  protected final String TEXT_223 = NL + "                                status_";
  protected final String TEXT_224 = " = pstmt_";
  protected final String TEXT_225 = ".executeBatch();";
  protected final String TEXT_226 = NL + "                                for(int countEach_";
  protected final String TEXT_227 = ": status_";
  protected final String TEXT_228 = ") {" + NL + "                                    countSum_";
  protected final String TEXT_229 = " += (countEach_";
  protected final String TEXT_230 = " < 0 ? 0 : countEach_";
  protected final String TEXT_231 = ");" + NL + "                                }" + NL + "                            }" + NL + "                        }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_232 = NL + "                                throw(e);";
  protected final String TEXT_233 = NL + "                            for(int countEach_";
  protected final String TEXT_234 = ": e.getUpdateCounts()) {" + NL + "                                countSum_";
  protected final String TEXT_235 = " += (countEach_";
  protected final String TEXT_236 = " < 0 ? 0 : countEach_";
  protected final String TEXT_237 = ");" + NL + "                            }" + NL + "                            System.err.println(e.getMessage());";
  protected final String TEXT_238 = NL + "                        }" + NL + "                        if(pstmt_";
  protected final String TEXT_239 = "!=null && batchSizeCounter_";
  protected final String TEXT_240 = " > 0 ){" + NL + "                            try {" + NL + "                                tmp_batchUpdateCount_";
  protected final String TEXT_241 = " = pstmt_";
  protected final String TEXT_242 = ".getUpdateCount();" + NL + "                            }catch (java.sql.SQLException e){" + NL + "" + NL + "                            }" + NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_243 = " = tmp_batchUpdateCount_";
  protected final String TEXT_244 = " > countSum_";
  ...
  protected final String TEXT_249 = " += tmp_batchUpdateCount_";
  protected final String TEXT_250 = ";";
  protected final String TEXT_251 = NL + "                                updatedCount_";
  protected final String TEXT_252 = " += tmp_batchUpdateCount_";
  protected final String TEXT_253 = ";";
  protected final String TEXT_254 = NL + "                                deletedCount_";
  protected final String TEXT_255 = " += tmp_batchUpdateCount_";
  protected final String TEXT_256 = ";";
  protected final String TEXT_257 = NL + "                        }";
  protected final String TEXT_258 = NL + "                        if(pstmt_";
  protected final String TEXT_259 = " != null) {" + NL + "                            pstmt_";
  protected final String TEXT_260 = ".close();" + NL + "                        }";
  protected final String TEXT_261 = NL;
  protected final String TEXT_262 = NL + "\t\tif (commitCounter_";
  protected final String TEXT_263 = " > 0) {" + NL + "\t\t\t";
  protected final String TEXT_264 = NL + "\t\t\tconn_";
  protected final String TEXT_265 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_266 = NL + "\t\t}";
  protected final String TEXT_267 = NL + "\t\t";
  protected final String TEXT_268 = NL + "    \tconn_";
  protected final String TEXT_269 = " .close();" + NL + "\t\t";
  protected final String TEXT_270 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_271 = "\", true);" + NL + "    \t";
  protected final String TEXT_272 = NL + "\tnb_line_deleted_";
  protected final String TEXT_273 = "=nb_line_deleted_";
  protected final String TEXT_274 = "+ deletedCount_";
  protected final String TEXT_275 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_276 = "=nb_line_update_";
  protected final String TEXT_277 = " + updatedCount_";
  protected final String TEXT_278 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_279 = "=nb_line_inserted_";
  protected final String TEXT_280 = " + insertedCount_";
  protected final String TEXT_281 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_282 = "=nb_line_rejected_";
  protected final String TEXT_283 = " + rejectedCount_";
  protected final String TEXT_284 = ";" + NL + "\t";
  protected final String TEXT_285 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_286 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_287 = "_NB_LINE\",nb_line_";
  protected final String TEXT_288 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_289 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_290 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_291 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_292 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_293 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_294 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_295 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_296 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_297 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_298 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_299 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_300 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_301 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_302 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_303 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_304 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_305 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_306 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_307 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_308 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_309 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_310 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_311 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_312 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_313 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_314 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_315 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_316 = NL + "        globalMap.put(\"";
  protected final String TEXT_317 = "_NB_LINE\",nb_line_";
  protected final String TEXT_318 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_319 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_320 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_321 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_322 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_323 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_324 = ");" + NL + "        globalMap.put(\"";
