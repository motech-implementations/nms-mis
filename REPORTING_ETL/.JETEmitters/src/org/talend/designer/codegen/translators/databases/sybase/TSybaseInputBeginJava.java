...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_186 = " = \"jdbc:sybase:Tds:\" + ";
  ...
  protected final String TEXT_295 = NL + "\t\t    \tlog.debug(\"";
  ...
  protected final String TEXT_367 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_368 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_369 = ".getColumnTypeName(i_";
  protected final String TEXT_370 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_371 = ".add(rs_";
  protected final String TEXT_372 = ".getString(i_";
  protected final String TEXT_373 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_374 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
