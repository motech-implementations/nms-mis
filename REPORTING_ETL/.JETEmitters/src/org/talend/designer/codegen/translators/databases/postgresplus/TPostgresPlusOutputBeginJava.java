...
public class TPostgresPlusOutputBeginJava {
  ...
  protected final String TEXT_49 = NL + NL + "String dbschema_";
  protected final String TEXT_50 = " = null;";
  protected final String TEXT_51 = NL + "\tdbschema_";
  protected final String TEXT_52 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_53 = "\");" + NL + "\t";
  protected final String TEXT_54 = NL + "\tdbschema_";
  protected final String TEXT_55 = " = ";
  protected final String TEXT_56 = ";" + NL + "\t";
  protected final String TEXT_57 = NL + NL + "String tableName_";
  protected final String TEXT_58 = " = null;" + NL + "if(dbschema_";
  protected final String TEXT_59 = " == null || dbschema_";
  protected final String TEXT_60 = ".trim().length() == 0) {" + NL + "\ttableName_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "} else {" + NL + "\ttableName_";
  protected final String TEXT_63 = " = dbschema_";
  ...
  protected final String TEXT_75 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_76 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_77 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_78 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_79 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_80 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_81 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_82 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_83 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_84 = " = false;" + NL;
  protected final String TEXT_85 = NL + "       int batchSize_";
  protected final String TEXT_86 = " = ";
  protected final String TEXT_87 = ";" + NL + "       int batchSizeCounter_";
  protected final String TEXT_88 = "=0;" + NL + "       int tmp_batchUpdateCount_";
  protected final String TEXT_89 = " = 0;";
  protected final String TEXT_90 = NL + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_97 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");" + NL + "    String url_";
  ...
  protected final String TEXT_123 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_124 = " = ";
  protected final String TEXT_125 = ";" + NL + "        int commitCounter_";
  ...
  protected final String TEXT_135 = ".close();" + NL + "" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_156 = " = false;" + NL + "            String defaultSchema_";
  protected final String TEXT_157 = " = \"public\";" + NL + "            if(dbschema_";
  protected final String TEXT_158 = " == null || dbschema_";
  protected final String TEXT_159 = ".trim().length() == 0) {" + NL + "            \tjava.sql.Statement stmtSchema_";
  protected final String TEXT_160 = " = conn_";
  protected final String TEXT_161 = ".createStatement();" + NL + "            \tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_162 = " = stmtSchema_";
  protected final String TEXT_163 = ".executeQuery(\"select current_schema() \");" + NL + "            \twhile(rsSchema_";
  protected final String TEXT_164 = ".next()){" + NL + "            \t\tdefaultSchema_";
  protected final String TEXT_165 = " = rsSchema_";
  protected final String TEXT_166 = ".getString(\"current_schema\");" + NL + "            \t}" + NL + "            \trsSchema_";
  protected final String TEXT_167 = ".close();" + NL + "            \tstmtSchema_";
  protected final String TEXT_168 = ".close();" + NL + "            }" + NL + "            while(rsTable_";
  ...
  protected final String TEXT_176 = ".equals(dbschema_";
  protected final String TEXT_177 = ") || ((dbschema_";
  protected final String TEXT_178 = " == null || dbschema_";
  protected final String TEXT_179 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_180 = ".equals(schema_";
  ...
  protected final String TEXT_184 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_194 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_201 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_209 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".createStatement();";
  protected final String TEXT_212 = NL + "            deletedCount_";
  protected final String TEXT_213 = " = deletedCount_";
  protected final String TEXT_214 = " + stmtClear_";
  ...
  protected final String TEXT_219 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_222 = " = stmtTruncCount_";
  protected final String TEXT_223 = ".executeQuery(\"";
  protected final String TEXT_224 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_225 = " = conn_";
  protected final String TEXT_226 = ".createStatement();";
  protected final String TEXT_227 = NL + "            stmtTrunc_";
  protected final String TEXT_228 = ".executeUpdate(\"";
  protected final String TEXT_229 = "\");";
  protected final String TEXT_230 = NL + "            while(rsTruncCount_";
  protected final String TEXT_231 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_232 = " += rsTruncCount_";
  protected final String TEXT_233 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_234 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_235 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_236 = ".close();";
  protected final String TEXT_237 = NL + "\t    String insert_";
  protected final String TEXT_238 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_239 = " + \"\\\" (";
  protected final String TEXT_240 = ") VALUES (";
  protected final String TEXT_241 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_242 = " = conn_";
  protected final String TEXT_243 = ".prepareStatement(insert_";
  protected final String TEXT_244 = ");" + NL + "\t    ";
  protected final String TEXT_245 = NL + "\t    String update_";
  protected final String TEXT_246 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_251 = ".prepareStatement(update_";
  protected final String TEXT_252 = ");" + NL + "\t    ";
  protected final String TEXT_253 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_254 = " = conn_";
  protected final String TEXT_255 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_256 = " + \"\\\" WHERE ";
  protected final String TEXT_257 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_258 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_259 = " + \"\\\" (";
  protected final String TEXT_260 = ") VALUES (";
  protected final String TEXT_261 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".prepareStatement(insert_";
  protected final String TEXT_264 = ");" + NL + "\t    String update_";
  protected final String TEXT_265 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_266 = " + \"\\\" SET ";
  protected final String TEXT_267 = " WHERE ";
  protected final String TEXT_268 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_269 = " = conn_";
  protected final String TEXT_270 = ".prepareStatement(update_";
  protected final String TEXT_271 = ");" + NL + "\t    ";
  protected final String TEXT_272 = NL + "\t    String update_";
  protected final String TEXT_273 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_274 = " + \"\\\" SET ";
  protected final String TEXT_275 = " WHERE ";
  protected final String TEXT_276 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_277 = " = conn_";
  protected final String TEXT_278 = ".prepareStatement(update_";
  protected final String TEXT_279 = ");" + NL + "\t    String insert_";
  protected final String TEXT_280 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_281 = " + \"\\\" (";
  protected final String TEXT_282 = ") VALUES (";
  protected final String TEXT_283 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".prepareStatement(insert_";
  protected final String TEXT_286 = ");" + NL + "\t    ";
  protected final String TEXT_287 = NL + "\t    String delete_";
  protected final String TEXT_288 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_289 = " + \"\\\" WHERE ";
  protected final String TEXT_290 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_291 = " = conn_";
  protected final String TEXT_292 = ".prepareStatement(delete_";
  protected final String TEXT_293 = ");" + NL + "\t    ";
  protected final String TEXT_294 = NL + "        StringBuffer query_";
  protected final String TEXT_295 = " = null;" + NL + "       \t";
  protected final String TEXT_296 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_297 = " = insert_";
  ...
  protected final String TEXT_302 = ".split(\"\\\\?\");";
  protected final String TEXT_303 = NL + "\t\t\tupdate_";
  protected final String TEXT_304 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_305 = " = update_";
  protected final String TEXT_306 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_307 = " = insert_";
  protected final String TEXT_308 = ".split(\"\\\\?\");";
  protected final String TEXT_309 = NL + "\t\t\tdelete_";
  protected final String TEXT_310 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_311 = " = delete_";
  protected final String TEXT_312 = ".split(\"\\\\?\");";
  protected final String TEXT_313 = NL + "\t\t\treplace_";
  protected final String TEXT_314 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_315 = " = replace_";
  protected final String TEXT_316 = ".split(\"\\\\?\");";
  protected final String TEXT_317 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_318 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_319 = " = insertIgnore_";
  protected final String TEXT_320 = ".split(\"\\\\?\");";
  protected final String TEXT_321 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_322 = " = insert_";
  protected final String TEXT_323 = ".split(\"\\\\?\");";
