...
public class TMemSQLOutputMainJava {
  ...
  protected final String TEXT_58 = ".addBatch();" + NL + "                    batchSizeCounter_";
  protected final String TEXT_59 = "++;" + NL + "                    nb_line_";
  protected final String TEXT_60 = "++;";
  protected final String TEXT_61 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_65 = ".executeUpdate();";
  ...
  protected final String TEXT_107 = NL + NL + "           try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_134 = "_QUERY\", query_";
  protected final String TEXT_135 = ".toString().trim());";
  protected final String TEXT_136 = NL + "\t\t\t\t\t";
  protected final String TEXT_137 = NL + "                    \t";
  protected final String TEXT_138 = NL + "                    ";
  protected final String TEXT_139 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_140 = " = pstmt_";
  protected final String TEXT_141 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_142 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_143 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_144 = " = rs_";
  protected final String TEXT_145 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_146 = " > 0) {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_246 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_247 = "=pstmtUpdate_";
  protected final String TEXT_248 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_249 = " = updatedCount_";
  protected final String TEXT_250 = " + updateFlag_";
  protected final String TEXT_251 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_252 = " == 0) {" + NL + "            \t";
  protected final String TEXT_253 = NL + "\t\t\t\tquery_";
  protected final String TEXT_254 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_262 = NL + "                \tinsertedCount_";
  protected final String TEXT_263 = " = insertedCount_";
  protected final String TEXT_264 = " + pstmtInsert_";
  protected final String TEXT_265 = ".executeUpdate();" + NL + "                     nb_line_";
  protected final String TEXT_266 = "++;";
  protected final String TEXT_267 = NL + "             }else{" + NL + "                nb_line_";
  protected final String TEXT_268 = "++;";
  protected final String TEXT_269 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_270 = " = true;";
  protected final String TEXT_271 = NL + "                        throw(e);";
  protected final String TEXT_272 = NL + "                       nb_line_";
  ...
  protected final String TEXT_286 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_287 = NL + "                            ";
  protected final String TEXT_288 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_289 = ";";
  protected final String TEXT_290 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_291 = NL + "                }";
  protected final String TEXT_292 = NL + "\t\t\t\t\t";
  protected final String TEXT_293 = NL + "                    \t";
  protected final String TEXT_294 = NL + "\t                        query_";
  ...
  protected final String TEXT_303 = ".addBatch();" + NL + "                    batchSizeCounter_";
  protected final String TEXT_304 = "++;" + NL + "                    nb_line_";
  protected final String TEXT_305 = "++;";
  protected final String TEXT_306 = NL + "        try {" + NL + "                deletedCount_";
  protected final String TEXT_307 = " = deletedCount_";
  protected final String TEXT_308 = " + pstmt_";
  protected final String TEXT_309 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_310 = "++;";
  protected final String TEXT_311 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_312 = " = true;";
  protected final String TEXT_313 = NL + "                    throw(e);";
  ...
  protected final String TEXT_324 = NL + "                        rejectedCount_";
  protected final String TEXT_325 = " = rejectedCount_";
  protected final String TEXT_326 = " + 1;";
  protected final String TEXT_327 = NL + "                        ";
  protected final String TEXT_328 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_329 = NL + "                        ";
  protected final String TEXT_330 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_331 = ";";
  protected final String TEXT_332 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_337 = NL + "                if ( batchSize_";
  protected final String TEXT_338 = " == batchSizeCounter_";
  protected final String TEXT_339 = ") {" + NL + "                    long countSum_";
  protected final String TEXT_340 = " = 0;" + NL + "                    int[] resultStatus = {};" + NL + "                    try {";
  protected final String TEXT_341 = NL + "                        resultStatus = pstmt_";
  protected final String TEXT_342 = ".executeBatch();";
  protected final String TEXT_343 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_344 = "){";
  protected final String TEXT_345 = NL + "                        throw(e_";
  protected final String TEXT_346 = ");";
  protected final String TEXT_347 = NL + "                        System.err.println(e_";
  protected final String TEXT_348 = ".getMessage());" + NL + "                        for(int countEach_";
  protected final String TEXT_349 = ": e_";
  protected final String TEXT_350 = ".getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_351 = " += (countEach_";
  protected final String TEXT_352 = " < 0 ? 0 : countEach_";
  protected final String TEXT_353 = ");" + NL + "                        }";
  protected final String TEXT_354 = NL + "                    }" + NL + "" + NL + "                    long tmp_batchUpdateCount_";
  protected final String TEXT_355 = " = 0;" + NL + "                    for(int i : resultStatus){" + NL + "                          if(i==-3){//EXECUTE_FAILED ";
  protected final String TEXT_356 = NL + "                                System.err.println(\"Query failed to execute.\");" + NL + "                          }else if(i==-2){//SUCCESS_NO_INFO";
  protected final String TEXT_357 = NL + "                                System.err.println(\"Query was processed successfully but that the number of rows affected is unknown.\");" + NL + "                          }else{" + NL + "                               tmp_batchUpdateCount_";
  protected final String TEXT_358 = " += (i<0 ? 0 : i);" + NL + "                          }" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_359 = " += countSum_";
  protected final String TEXT_360 = ";";
  protected final String TEXT_361 = NL + "                        insertedCount_";
  protected final String TEXT_362 = NL + "                        updatedCount_";
  protected final String TEXT_363 = NL + "                        deletedCount_";
  protected final String TEXT_364 = NL + "                    += tmp_batchUpdateCount_";
  protected final String TEXT_365 = ";" + NL + "                    batchSizeCounter_";
  protected final String TEXT_366 = " = 0;" + NL + "                }";
  protected final String TEXT_367 = NL + "            if(!whetherReject_";
  protected final String TEXT_368 = ") {";
  protected final String TEXT_369 = NL + "                            ";
  protected final String TEXT_370 = " = new ";
  protected final String TEXT_371 = "Struct();";
