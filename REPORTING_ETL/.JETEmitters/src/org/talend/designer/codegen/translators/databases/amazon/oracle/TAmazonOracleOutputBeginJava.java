...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_48 = NL + "\t \t// TODO unable to parse integer: ";
  protected final String TEXT_49 = NL + "\t \t// TODO error: ";
  protected final String TEXT_50 = NL + "\t";
  protected final String TEXT_51 = NL + "\t/* initialize feature count */" + NL + "\tint nbFeature_";
  protected final String TEXT_52 = " = 0;" + NL + "" + NL + "\tjava.util.Map<String, com.vividsolutions.jts.geom.Envelope> geometryColumnToExtends = new java.util.HashMap<String, com.vividsolutions.jts.geom.Envelope>();" + NL + "\t";
  ...
  protected final String TEXT_61 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_62 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_67 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_68 = " = 0;" + NL + "" + NL + "int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_75 = " = null;" + NL + "" + NL + "//optional table" + NL + "String dbschema_";
  protected final String TEXT_76 = " = null;" + NL + "String tableName_";
  ...
  protected final String TEXT_85 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.OracleDriver\");" + NL + "\t\t";
  protected final String TEXT_86 = NL + "\t";
  protected final String TEXT_87 = NL + "\t\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");" + NL + "\t\t";
  ...
  protected final String TEXT_98 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_99 = " + \")(port=\" + ";
  protected final String TEXT_100 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_101 = " + \")))\";" + NL + "\t\t";
  protected final String TEXT_102 = NL + "\t    url_";
  protected final String TEXT_103 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_120 = ";" + NL + "    dbschema_";
  ...
  protected final String TEXT_127 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_128 = ")) //get schema from connection" + NL + "\t\t\t{" + NL + "\t\t\tdbschema_";
  protected final String TEXT_129 = "=conn_";
  protected final String TEXT_130 = ".getMetaData().getUserName();" + NL + "\t\t\t}" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_136 = NL + "\tString atnParams_";
  protected final String TEXT_137 = " = ";
  protected final String TEXT_138 = ";" + NL + "\tatnParams_";
  protected final String TEXT_139 = " = atnParams_";
  protected final String TEXT_140 = ".replaceAll(\"&\", \"\\n\");" + NL + "\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_141 = " = new java.util.Properties();" + NL + "\tatnParamsPrope_";
  protected final String TEXT_142 = ".put(\"user\",dbUser_";
  protected final String TEXT_143 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_144 = ".put(\"password\",dbPwd_";
  protected final String TEXT_145 = ");" + NL + "\tatnParamsPrope_";
  protected final String TEXT_146 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_147 = ".getBytes()));" + NL + "\tconn_";
  protected final String TEXT_148 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_149 = ", atnParamsPrope_";
  ...
  protected final String TEXT_165 = NL + "int count_";
  protected final String TEXT_166 = "=0;";
  protected final String TEXT_167 = NL + NL + "if(dbschema_";
  protected final String TEXT_168 = " == null || dbschema_";
  protected final String TEXT_169 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_170 = " = ";
  protected final String TEXT_171 = ";" + NL + "} else {" + NL + "    tableName_";
  ...
  protected final String TEXT_178 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_182 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_189 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_193 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_194 = "));";
  protected final String TEXT_195 = NL + "                    stmtCreate_";
  protected final String TEXT_196 = ".execute(((\"";
  protected final String TEXT_197 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_198 = ".";
  protected final String TEXT_199 = ", \"";
  protected final String TEXT_200 = "\")";
  protected final String TEXT_201 = ".toUpperCase()";
  ...
  protected final String TEXT_213 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_221 = ".toUpperCase()";
  ...
  protected final String TEXT_230 = NL + "                    String keyCheckTable_";
  protected final String TEXT_231 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_238 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_241 = " + \"]\";";
  protected final String TEXT_242 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_243 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_244 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_245 = ")== null){//}";
  protected final String TEXT_246 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_247 = " = conn_";
  protected final String TEXT_248 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_249 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_250 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_251 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_252 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_253 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_258 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_259 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_260 = " = tableNameForSearch_";
  protected final String TEXT_261 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_262 = " = tableNameForSearch_";
  protected final String TEXT_263 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_264 = " = dbMetaData_";
  protected final String TEXT_265 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_266 = ", tableNameForSearch_";
  protected final String TEXT_267 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_268 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_269 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_270 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_302 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  ...
  protected final String TEXT_310 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_314 = ") || (dbschema_";
  protected final String TEXT_315 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_316 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_317 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_318 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_319 = ".close();";
  protected final String TEXT_320 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_321 = " = conn_";
  protected final String TEXT_322 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_323 = " = dbMetaData_";
  protected final String TEXT_324 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_325 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_326 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_327 = " == null || dbschema_";
  protected final String TEXT_328 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_329 = " = conn_";
  protected final String TEXT_330 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_331 = " = stmtSchema_";
  protected final String TEXT_332 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_333 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_334 = " = rsSchema_";
  protected final String TEXT_335 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_336 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_337 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_359 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_360 = " = ";
  protected final String TEXT_361 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_362 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_363 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_364 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_365 = " =  tableForSearch_";
  protected final String TEXT_366 = ".substring(1,tableForSearch_";
  protected final String TEXT_367 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_368 = " =  tableForSearch_";
  protected final String TEXT_369 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_370 = " = conn_";
  protected final String TEXT_371 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_375 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_376 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_377 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_378 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_382 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_383 = " = dbMetaData_";
  protected final String TEXT_384 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_385 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_386 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_387 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_388 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_389 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_390 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_391 = ".close();";
  ...
  protected final String TEXT_396 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_397 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_403 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_404 = ".close();";
  protected final String TEXT_405 = NL + "                                if(!whetherExist_";
  protected final String TEXT_406 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_433 = NL + "                                    stmtDrop_";
  protected final String TEXT_434 = ".execute(\"";
  protected final String TEXT_435 = "\" ";
  protected final String TEXT_436 = ");";
  protected final String TEXT_437 = NL + "                                    stmtDrop_";
  protected final String TEXT_438 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_460 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_470 = ".close();";
  ...
  protected final String TEXT_477 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_478 = " = stmtTruncCount_";
  protected final String TEXT_479 = ".executeQuery(\"";
  protected final String TEXT_480 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_481 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_482 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_486 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_487 = " = conn_";
  protected final String TEXT_488 = ".createStatement();";
  protected final String TEXT_489 = NL + "                              stmtTrunc_";
  protected final String TEXT_490 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_491 = "));";
  protected final String TEXT_492 = NL + "                conn_";
  protected final String TEXT_493 = ".commit();";
  protected final String TEXT_494 = NL + "            stmtTrunc_";
  protected final String TEXT_495 = ".executeUpdate(\"";
  protected final String TEXT_496 = "\");";
  protected final String TEXT_497 = NL + "                if(!conn_";
  protected final String TEXT_498 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_499 = ".commit();" + NL + "                }";
  protected final String TEXT_500 = NL + "            deletedCount_";
  protected final String TEXT_501 = " += rsTruncCountNumber_";
  protected final String TEXT_502 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_503 = ".close();";
  protected final String TEXT_504 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_507 = " = stmtTruncCount_";
  protected final String TEXT_508 = ".executeQuery(\"";
  protected final String TEXT_509 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".createStatement();";
  protected final String TEXT_512 = NL + "                conn_";
  protected final String TEXT_513 = ".commit();";
  protected final String TEXT_514 = NL + "            stmtTrunc_";
  protected final String TEXT_515 = ".executeUpdate(\"";
  protected final String TEXT_516 = "\");";
  protected final String TEXT_517 = NL + "            while(rsTruncCount_";
  protected final String TEXT_518 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_519 = " += rsTruncCount_";
  protected final String TEXT_520 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_521 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_522 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_537 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_541 = NL + "\t    String update_";
  protected final String TEXT_542 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_543 = " + \" SET ";
  protected final String TEXT_544 = " WHERE ";
  protected final String TEXT_545 = "\";" + NL + "    \t";
  protected final String TEXT_546 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_547 = " = new StringBuffer(update_";
  protected final String TEXT_548 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_549 = ".insert(update_";
  protected final String TEXT_550 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_551 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_552 = " =updateStringBuffer_";
  ...
  protected final String TEXT_558 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_559 = " = conn_";
  protected final String TEXT_560 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_561 = " + \" WHERE ";
  protected final String TEXT_562 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_563 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_564 = " + \" (";
  protected final String TEXT_565 = ") VALUES (";
  protected final String TEXT_566 = ")\";" + NL + "\t   \t";
  protected final String TEXT_567 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_568 = " = new StringBuffer(insert_";
  protected final String TEXT_569 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_570 = ".insert(insert_";
  protected final String TEXT_571 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_572 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_573 = " =insertStringBuffer_";
  protected final String TEXT_574 = ".toString(); ";
  protected final String TEXT_575 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_576 = " = conn_";
  protected final String TEXT_577 = ".prepareStatement(insert_";
  protected final String TEXT_578 = ");" + NL + "\t    String update_";
  protected final String TEXT_579 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_580 = " + \" SET ";
  protected final String TEXT_581 = " WHERE ";
  protected final String TEXT_582 = "\";" + NL + "\t    ";
  protected final String TEXT_583 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_584 = " = new StringBuffer(update_";
  protected final String TEXT_585 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_586 = ".insert(update_";
  protected final String TEXT_587 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_588 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_589 = " =updateStringBuffer_";
  protected final String TEXT_590 = ".toString(); ";
  protected final String TEXT_591 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_592 = " = conn_";
  protected final String TEXT_593 = ".prepareStatement(update_";
  ...
  protected final String TEXT_600 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_601 = " = new StringBuffer(update_";
  protected final String TEXT_602 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_603 = ".insert(update_";
  protected final String TEXT_604 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_605 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_606 = " =updateStringBuffer_";
  protected final String TEXT_607 = ".toString(); ";
  protected final String TEXT_608 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_609 = " = conn_";
  protected final String TEXT_610 = ".prepareStatement(update_";
  ...
  protected final String TEXT_616 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_617 = " = new StringBuffer(insert_";
  protected final String TEXT_618 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_619 = ".insert(insert_";
  protected final String TEXT_620 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_621 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_622 = " =insertStringBuffer_";
  protected final String TEXT_623 = ".toString(); ";
  protected final String TEXT_624 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_625 = " = conn_";
  protected final String TEXT_626 = ".prepareStatement(insert_";
  protected final String TEXT_627 = ");" + NL + "\t    ";
  protected final String TEXT_628 = NL + "\t    String delete_";
  protected final String TEXT_629 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_630 = " + \" WHERE ";
  protected final String TEXT_631 = "\";" + NL + "\t    ";
  protected final String TEXT_632 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_633 = " = new StringBuffer(delete_";
  protected final String TEXT_634 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_635 = ".insert(delete_";
  protected final String TEXT_636 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_637 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_638 = " =deleteStringBuffer_";
  protected final String TEXT_639 = ".toString();  ";
  protected final String TEXT_640 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_641 = " = conn_";
  protected final String TEXT_642 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_675 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_676 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_677 = " = 0;" + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_678 = " = true;" + NL + "    \t";
  protected final String TEXT_679 = NL + NL + "\tclass ClobTypeUtil_";
  protected final String TEXT_680 = " {" + NL + "\t\tpublic Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "\t\t\toracle.sql.CLOB tempClob = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t// If the temporary CLOB has not yet been created, create one" + NL + "\t\t\t\ttempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "\t\t\t\t// Open the temporary CLOB in readwrite mode, to enable writing" + NL + "\t\t\t\ttempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "\t\t\t\t// Get the output stream to write" + NL + "\t\t\t\tjava.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "\t\t\t\tif(data instanceof oracle.sql.CLOB) {" + NL + "\t\t\t\t\toracle.sql.CLOB inClob = (oracle.sql.CLOB) data;" + NL + "\t\t\t        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "\t\t\t        char[] chs = new char[128];" + NL + "\t\t\t       \tint len = 0;" + NL + "\t\t\t\t\twhile ((len = inReader.read(chs)) != -1) {" + NL + "\t\t\t        \ttempClobWriter.write(chs, 0, len);" + NL + "\t\t\t        }" + NL + "\t\t\t    }else if(data instanceof String) {" + NL + "\t\t\t       // Write the data into the temporary CLOB" + NL + "\t\t\t\t\ttempClobWriter.write((String)data);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t// Flush and close the stream" + NL + "\t\t\t\ttempClobWriter.flush();" + NL + "\t\t\t\ttempClobWriter.close();" + NL + "\t\t\t\t// Close the temporary CLOB" + NL + "\t\t\t\ttempClob.close();" + NL + "\t\t\t} catch( java.sql.SQLException sqlexp){" + NL + "\t  \t\t\t";
  protected final String TEXT_681 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t  \t\t\t";
  protected final String TEXT_682 = NL + "\t\t\t\ttempClob.freeTemporary();" + NL + "\t\t\t\texp.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t\treturn tempClob;" + NL + "\t\t}" + NL + "\t}" + NL + "\tClobTypeUtil_";
  protected final String TEXT_683 = " clobTypeUtil_";
  protected final String TEXT_684 = "=new ClobTypeUtil_";
  protected final String TEXT_685 = "();";
  protected final String TEXT_686 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_687 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_688 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_689 = " =null;" + NL + "\t";
  protected final String TEXT_690 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_691 = " = null;" + NL + "\t\t";
  protected final String TEXT_692 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_693 = " = null;";
  protected final String TEXT_694 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_695 = " =  null;";
  protected final String TEXT_696 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_697 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_698 = " = null;";
  protected final String TEXT_699 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_700 = " = null;";
  protected final String TEXT_701 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_702 = " = null;";
  protected final String TEXT_703 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_704 = " = null;";
  protected final String TEXT_705 = NL + "\t\t \tString[] insertSQLSplits_";
