...
public class TVectorWiseOutputMainJava {
  ...
  protected final String TEXT_67 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_68 = "++;" + NL + "\t\t  \t\t";
  protected final String TEXT_69 = NL + " \t\t \t\t\tbatchSizeCounter_";
  ...
  protected final String TEXT_89 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_110 = "_QUERY\", query_";
  protected final String TEXT_111 = ".toString().trim());";
  protected final String TEXT_112 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_113 = " = updatedCount_";
  protected final String TEXT_114 = " + pstmt_";
  protected final String TEXT_115 = ".executeUpdate();" + NL + "                nb_line_";
  ...
  protected final String TEXT_128 = NL + "                        nb_line_rejected_";
  ...
  protected final String TEXT_163 = "_QUERY\", query_";
  protected final String TEXT_164 = ".toString().trim());";
  protected final String TEXT_165 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_166 = " = updatedCount_";
  protected final String TEXT_167 = " + pstmtUpdate_";
  protected final String TEXT_168 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_169 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_170 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_171 = " = true;";
  protected final String TEXT_172 = NL + "                        throw(e);";
  protected final String TEXT_173 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_183 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_220 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_226 = NL + "            int updateFlag_";
  protected final String TEXT_227 = "=0;";
  protected final String TEXT_228 = NL + "                    ";
  protected final String TEXT_229 = NL + "                        query_";
  ...
  protected final String TEXT_250 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_251 = " != 0){" + NL + "            \t\tnb_line_";
  protected final String TEXT_252 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_253 = NL + "                }" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_272 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_273 = " == 0) {" + NL + "            \t";
  protected final String TEXT_274 = NL + "\t\t\t\tquery_";
  protected final String TEXT_275 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_276 = NL + "                        ";
  protected final String TEXT_277 = NL + "                            query_";
  protected final String TEXT_278 = " = ";
  protected final String TEXT_279 = ";";
  protected final String TEXT_280 = NL + "                    globalMap.put(\"";
  protected final String TEXT_281 = "_QUERY\", query_";
  protected final String TEXT_282 = ".toString().trim());";
  protected final String TEXT_283 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_284 = " = insertedCount_";
  protected final String TEXT_285 = " + pstmtInsert_";
  protected final String TEXT_286 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_287 = "++;";
  protected final String TEXT_288 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_289 = " = true;";
  protected final String TEXT_290 = NL + "                        throw(e);";
  ...
  protected final String TEXT_301 = NL + "                            nb_line_rejected_";
  protected final String TEXT_302 = "++;";
  protected final String TEXT_303 = NL + "                            ";
  protected final String TEXT_304 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_305 = NL + "                            ";
  protected final String TEXT_306 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_307 = ";";
  protected final String TEXT_308 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_316 = NL + "                        query_";
  protected final String TEXT_317 = " = ";
  protected final String TEXT_318 = ";";
  protected final String TEXT_319 = NL + "                globalMap.put(\"";
  protected final String TEXT_320 = "_QUERY\", query_";
  protected final String TEXT_321 = ".toString().trim());";
  protected final String TEXT_322 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_323 = " = deletedCount_";
  protected final String TEXT_324 = " + pstmt_";
  protected final String TEXT_325 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_326 = "++;";
  protected final String TEXT_327 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_328 = " = true;";
  protected final String TEXT_329 = NL + "                    throw(e);";
  ...
  protected final String TEXT_340 = NL + "                        nb_line_rejected_";
  protected final String TEXT_341 = "++;";
  protected final String TEXT_342 = NL + "                        ";
  protected final String TEXT_343 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_344 = NL + "                        ";
  protected final String TEXT_345 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_346 = ";";
  protected final String TEXT_347 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_348 = NL + "            }";
  protected final String TEXT_349 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_360 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_361 = " > 0) && (batchSize_";
  protected final String TEXT_362 = " <= batchSizeCounter_";
  protected final String TEXT_363 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_367 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_368 = " == -2 || countEach_";
  protected final String TEXT_369 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_370 = " += countEach_";
  protected final String TEXT_371 = ";" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_372 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_373 = " += countSum_";
  protected final String TEXT_374 = ";" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_375 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_376 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_377 = NL + "                \tint countSum_";
  protected final String TEXT_378 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_379 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_380 = " += (countEach_";
  protected final String TEXT_381 = " < 0 ? 0 : countEach_";
  protected final String TEXT_382 = ");" + NL + "\t\t\t\t\t}" + NL + "" + NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_383 = " += countSum_";
  protected final String TEXT_384 = ";" + NL + "    \t    \t\t";
  protected final String TEXT_385 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_391 = NL + "                if ((batchSize_";
  protected final String TEXT_392 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_393 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_394 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_395 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_396 = ": pstmt_";
  protected final String TEXT_397 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_398 = " == -2 || countEach_";
  protected final String TEXT_399 = " == -3) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_400 = " += countEach_";
  ...
  protected final String TEXT_404 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_405 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_406 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_407 = NL + "                \tint countSum_";
  protected final String TEXT_408 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_409 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_410 = " += (countEach_";
  protected final String TEXT_411 = " < 0 ? 0 : countEach_";
  protected final String TEXT_412 = ");" + NL + "\t\t\t\t\t}" + NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_413 = " += countSum_";
  protected final String TEXT_414 = ";" + NL + "\t    \t\t\t";
  protected final String TEXT_415 = NL + "                    System.err.println(e.getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_420 = NL + "                \tcommitCounter_";
  protected final String TEXT_421 = "=0;" + NL + "                }";
