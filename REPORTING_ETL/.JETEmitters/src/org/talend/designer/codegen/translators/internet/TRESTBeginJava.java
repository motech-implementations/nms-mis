...
public class TRESTBeginJava
{
  ...
  protected final String TEXT_99 = ");" + NL + "\tcom.sun.jersey.api.client.WebResource restResource_";
  protected final String TEXT_100 = ";" + NL + "\tif(endpoint_";
  protected final String TEXT_101 = "!=null && !(\"\").equals(endpoint_";
  protected final String TEXT_102 = ")){" + NL + "\t\trestResource_";
  protected final String TEXT_103 = " = restClient_";
  protected final String TEXT_104 = ".resource(endpoint_";
  protected final String TEXT_105 = ");" + NL + "\t}else{" + NL + "\t\tthrow new IllegalArgumentException(\"url can't be empty!\");" + NL + "\t}" + NL + "\t" + NL + "\tcom.sun.jersey.api.client.ClientResponse errorResponse_";
  protected final String TEXT_106 = " = null;" + NL + "\tString restResponse_";
  protected final String TEXT_107 = " = \"\";" + NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_108 = NL + "\t\trestResponse_";
  protected final String TEXT_109 = " = restResource_";
  protected final String TEXT_110 = NL + "\t\t";
  protected final String TEXT_111 = NL + "        \t.header(";
  protected final String TEXT_112 = ",";
  protected final String TEXT_113 = ")" + NL + "\t\t";
  protected final String TEXT_114 = "  " + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\t\t.get(String.class);" + NL + "\t\t";
  protected final String TEXT_116 = NL + "\t\t\t.post(String.class,";
  protected final String TEXT_117 = ");" + NL + "\t\t";
  protected final String TEXT_118 = NL + "\t\t\t.put(String.class,";
  protected final String TEXT_119 = ");" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\t\t.delete(String.class);" + NL + "\t\t";
  protected final String TEXT_121 = NL + "\t}catch (com.sun.jersey.api.client.UniformInterfaceException ue) {" + NL + "        errorResponse_";
  protected final String TEXT_122 = " = ue.getResponse();" + NL + "    }" + NL + "\t";
  protected final String TEXT_123 = NL + "\t// for output" + NL + "\t";
  protected final String TEXT_124 = "\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_125 = " = new ";
  protected final String TEXT_126 = "Struct();" + NL + "\t\t\t\tif(errorResponse_";
  protected final String TEXT_127 = "!=null){" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = ".ERROR_CODE = errorResponse_";
  protected final String TEXT_129 = ".getStatus();" + NL + "\t\t\t\t\tif(";
  protected final String TEXT_130 = ".ERROR_CODE!=204){" + NL + "\t\t\t\t\t    ";
  protected final String TEXT_131 = ".Body = errorResponse_";
  protected final String TEXT_132 = ".getEntity(String.class);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_133 = ".Body = restResponse_";
