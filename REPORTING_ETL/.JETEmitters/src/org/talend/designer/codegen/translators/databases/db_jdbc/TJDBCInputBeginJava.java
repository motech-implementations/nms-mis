...
public class TJDBCInputBeginJava
{
  ...
  protected final String TEXT_182 = NL + "\t\t\t\tstmt_";
  protected final String TEXT_183 = " = conn_";
  protected final String TEXT_184 = ".createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY," + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjava.sql.ResultSet.CONCUR_READ_ONLY);" + NL + "\t\t\t\t((com.mysql.jdbc.Statement)stmt_";
  protected final String TEXT_185 = ").enableStreamingResults();";
  protected final String TEXT_186 = NL + "                stmt_";
  protected final String TEXT_187 = ".setFetchSize(";
  protected final String TEXT_188 = ");";
  protected final String TEXT_189 = NL + "\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_190 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\tif (null != dataSources_";
  protected final String TEXT_191 = ") {" + NL + "        \t\t\tString dsAlias_";
  protected final String TEXT_192 = " = ";
  protected final String TEXT_193 = ";" + NL + "            \t\tif (dataSources_";
  protected final String TEXT_194 = ".get(dsAlias_";
  protected final String TEXT_195 = ") == null) {" + NL + "               \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_196 = " + \" available!\");" + NL + "                  \t}" + NL + "            \t\tconn_";
  protected final String TEXT_197 = " = dataSources_";
  protected final String TEXT_198 = ".get(dsAlias_";
  protected final String TEXT_199 = ").getConnection();" + NL + "        \t\t} else {";
  ...
  protected final String TEXT_218 = NL + "            java.util.Date date_";
  protected final String TEXT_219 = " = null;" + NL + "            try{" + NL + "            \tdate_";
  ...
  protected final String TEXT_223 = ");" + NL + "            }catch(java.lang.Exception e){" + NL + "            \tdate_";
  protected final String TEXT_224 = " = rs_";
  protected final String TEXT_225 = ".getDate(";
  protected final String TEXT_226 = "column_index_";
  protected final String TEXT_227 = ");" + NL + "            }";
  protected final String TEXT_228 = NL + "            ";
  protected final String TEXT_229 = ".";
  protected final String TEXT_230 = " = date_";
