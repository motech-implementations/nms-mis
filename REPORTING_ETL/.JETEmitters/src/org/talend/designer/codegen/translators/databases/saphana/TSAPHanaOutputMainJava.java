...
public class TSAPHanaOutputMainJava {
  ...
  protected final String TEXT_51 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_58 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_59 = ")));";
  protected final String TEXT_60 = NL + "            stmtDrop_";
  protected final String TEXT_61 = ".execute(\"";
  protected final String TEXT_62 = "\" ";
  protected final String TEXT_63 = ");";
  protected final String TEXT_64 = NL + "            stmtDrop_";
  protected final String TEXT_65 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_89 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_106 = NL + "                    String keyCheckTable_";
  protected final String TEXT_107 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_114 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_115 = " = conn_";
  protected final String TEXT_116 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_117 = " + \"]\";";
  protected final String TEXT_118 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_119 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_120 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_121 = ")== null){//}";
  protected final String TEXT_122 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_123 = " = conn_";
  protected final String TEXT_124 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_125 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_126 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_127 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_128 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_129 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_134 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_135 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_136 = " = tableNameForSearch_";
  protected final String TEXT_137 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_138 = " = tableNameForSearch_";
  protected final String TEXT_139 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_140 = " = dbMetaData_";
  protected final String TEXT_141 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_142 = ", tableNameForSearch_";
  protected final String TEXT_143 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_144 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_145 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_146 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_147 = ".close();" + NL;
  protected final String TEXT_148 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_151 = " = dbMetaData_";
  protected final String TEXT_152 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_153 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_154 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_155 = " = rsTable_";
  protected final String TEXT_156 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_157 = " = rsTable_";
  protected final String TEXT_158 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_159 = ".equals";
  protected final String TEXT_160 = "IgnoreCase";
  protected final String TEXT_161 = "(";
  protected final String TEXT_162 = ")" + NL + "                                        && (schema_";
  protected final String TEXT_163 = ".equals";
  protected final String TEXT_164 = "IgnoreCase";
  ...
  protected final String TEXT_178 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_179 = " = rsTable_";
  protected final String TEXT_180 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_181 = ".equals";
  protected final String TEXT_182 = "IgnoreCase";
  protected final String TEXT_183 = "((";
  protected final String TEXT_184 = ")";
  protected final String TEXT_185 = ".toUpperCase()";
  protected final String TEXT_186 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_191 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_192 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_201 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_202 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_203 = " == null || dbschema_";
  protected final String TEXT_204 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_207 = " = stmtSchema_";
  protected final String TEXT_208 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_209 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_210 = " = rsSchema_";
  protected final String TEXT_211 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_212 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_213 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_227 = " ==null || dbschema_";
  protected final String TEXT_228 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_229 = ".equals";
  protected final String TEXT_230 = "IgnoreCase";
  protected final String TEXT_231 = "(schema_";
  ...
  protected final String TEXT_235 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_236 = " = ";
  protected final String TEXT_237 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_238 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_239 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_240 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_241 = " =  tableForSearch_";
  protected final String TEXT_242 = ".substring(1,tableForSearch_";
  protected final String TEXT_243 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_244 = " =  tableForSearch_";
  protected final String TEXT_245 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_249 = ".getTables(null, conn_";
  protected final String TEXT_250 = ".getSchema(), tableForSearch_";
  protected final String TEXT_251 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_252 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_253 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_254 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_260 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_261 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_282 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  protected final String TEXT_283 = " = conn_";
  protected final String TEXT_284 = ".createStatement();";
  protected final String TEXT_285 = NL + "                                                      stmtCreate_";
  protected final String TEXT_286 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_287 = "));";
  protected final String TEXT_288 = NL + "                                            stmtCreate_";
  protected final String TEXT_289 = ".execute(((\"";
  protected final String TEXT_290 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_291 = ".";
  protected final String TEXT_292 = ", \"";
  protected final String TEXT_293 = "\")";
  protected final String TEXT_294 = ".toUpperCase()";
  ...
  protected final String TEXT_303 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_316 = ".createStatement();";
  protected final String TEXT_317 = NL + "                                                  stmtCreate_";
  protected final String TEXT_318 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_326 = ".toUpperCase()";
  protected final String TEXT_327 = ")+\")";
  protected final String TEXT_328 = "\"));";
  protected final String TEXT_329 = NL + "                                    stmtCreate_";
  protected final String TEXT_330 = ".execute(\"";
  protected final String TEXT_331 = ")\");";
  protected final String TEXT_332 = NL + "                                stmtCreate_";
  protected final String TEXT_333 = ".close();";
  protected final String TEXT_334 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_335 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_336 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_347 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_348 = " = conn_";
  protected final String TEXT_349 = ".createStatement();";
  protected final String TEXT_350 = NL + "                              stmtTruncCount_";
  protected final String TEXT_351 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_352 = "));";
  protected final String TEXT_353 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_354 = " = stmtTruncCount_";
  protected final String TEXT_355 = ".executeQuery(\"";
  protected final String TEXT_356 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_357 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_358 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_359 = " = rsTruncCount_";
  protected final String TEXT_360 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_361 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_362 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_363 = " = conn_";
  protected final String TEXT_364 = ".createStatement();";
  protected final String TEXT_365 = NL + "                              stmtTrunc_";
  protected final String TEXT_366 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_367 = "));";
  protected final String TEXT_368 = NL + "                conn_";
  protected final String TEXT_369 = ".commit();";
  protected final String TEXT_370 = NL + "            stmtTrunc_";
  protected final String TEXT_371 = ".executeUpdate(\"";
  protected final String TEXT_372 = "\");";
  protected final String TEXT_373 = NL + "                if(!conn_";
  protected final String TEXT_374 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_375 = ".commit();" + NL + "                }";
  protected final String TEXT_376 = NL + "            deletedCount_";
  protected final String TEXT_377 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_388 = NL + "                conn_";
  protected final String TEXT_389 = ".commit();";
  protected final String TEXT_390 = NL + "            stmtTrunc_";
  protected final String TEXT_391 = ".executeUpdate(\"";
  protected final String TEXT_392 = "\");";
  protected final String TEXT_393 = NL + "            while(rsTruncCount_";
  protected final String TEXT_394 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_395 = " += rsTruncCount_";
  protected final String TEXT_396 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_397 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_398 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_399 = ".close();";
  protected final String TEXT_400 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_401 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_402 = " + \" (";
  protected final String TEXT_403 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  ...
  protected final String TEXT_415 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_435 = "\")+\" WHERE ";
  ...
  protected final String TEXT_441 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_442 = " = \"INSERT INTO \" + tableName_";
  ...
  protected final String TEXT_456 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_462 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_469 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_476 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_477 = " + \" WHERE ";
  protected final String TEXT_478 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_479 = " = conn_";
  protected final String TEXT_480 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_518 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_519 = " = conn_";
  protected final String TEXT_520 = ".prepareStatement(update_";
  protected final String TEXT_521 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_522 = " = conn_";
  protected final String TEXT_523 = ".prepareStatement(insert_";
  protected final String TEXT_524 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_525 = NL + "\t    String delete_";
  protected final String TEXT_526 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_527 = " + \" WHERE ";
  protected final String TEXT_528 = "\";" + NL + "\t    pstmt_";
  ...
  protected final String TEXT_533 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_534 = " = insert_";
  protected final String TEXT_535 = ".split(\"\\\\?\");";
  protected final String TEXT_536 = NL + "\t\t\tupdate_";
  protected final String TEXT_537 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_538 = " = update_";
  protected final String TEXT_539 = ".split(\"\\\\?\");";
  protected final String TEXT_540 = NL + "\t\t\tupdate_";
  protected final String TEXT_541 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_542 = " = update_";
  protected final String TEXT_543 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_544 = " = insert_";
  protected final String TEXT_545 = ".split(\"\\\\?\");";
  protected final String TEXT_546 = NL + "\t\t\tdelete_";
  protected final String TEXT_547 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_548 = " = delete_";
  protected final String TEXT_549 = ".split(\"\\\\?\");";
  protected final String TEXT_550 = NL + "\t\t\treplace_";
  protected final String TEXT_551 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_552 = " = replace_";
  protected final String TEXT_553 = ".split(\"\\\\?\");";
  protected final String TEXT_554 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_555 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_556 = " = insertIgnore_";
  ...
  protected final String TEXT_562 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_563 = " = buffersSize_";
  protected final String TEXT_564 = ";";
  protected final String TEXT_565 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_566 = " = buffersSize_";
  protected final String TEXT_567 = ";";
  protected final String TEXT_568 = NL + "        whetherReject_";
  protected final String TEXT_569 = " = false;";
  ...
  protected final String TEXT_578 = ",insertSQLSplits_";
  protected final String TEXT_579 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_580 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_581 = ".";
  protected final String TEXT_582 = ", pstmt_";
  protected final String TEXT_583 = ", ";
  protected final String TEXT_584 = ", \"";
  protected final String TEXT_585 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_586 = NL + "                globalMap.put(\"";
  protected final String TEXT_587 = "_QUERY\", query_";
  protected final String TEXT_588 = ".toString().trim());";
  protected final String TEXT_589 = NL + "    \t\t";
  protected final String TEXT_590 = NL + "    \t\tpstmt_";
  protected final String TEXT_591 = ".addBatch();" + NL + "    \t\tnb_line_";
  ...
  protected final String TEXT_596 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_597 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_598 = " = insertedCount_";
  protected final String TEXT_599 = " + pstmt_";
  protected final String TEXT_600 = ".executeUpdate();";
  protected final String TEXT_601 = NL + "            } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_618 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_619 = ").getSQLState();";
  protected final String TEXT_620 = NL + "                        ";
  protected final String TEXT_621 = ".errorMessage = e_";
  protected final String TEXT_622 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_623 = ";";
  protected final String TEXT_624 = NL + "                        System.err.print(e_";
  protected final String TEXT_625 = ".getMessage());";
  ...
  protected final String TEXT_631 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_632 = ",";
  protected final String TEXT_633 = ".";
  protected final String TEXT_634 = ", ";
  protected final String TEXT_635 = ",updateSQLSplits_";
  protected final String TEXT_636 = ");";
  protected final String TEXT_637 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_638 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_639 = ".";
  protected final String TEXT_640 = ", pstmt_";
  ...
  protected final String TEXT_667 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_668 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_669 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_670 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_671 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_672 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_673 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_674 = " = updatedCount_";
  protected final String TEXT_675 = " + pstmt_";
  protected final String TEXT_676 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_677 = "                " + NL + "            } catch(java.lang.Exception e_";
  ...
  protected final String TEXT_694 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_695 = ").getSQLState();";
  protected final String TEXT_696 = NL + "                        ";
  protected final String TEXT_697 = ".errorMessage = e_";
  protected final String TEXT_698 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_699 = ";";
  protected final String TEXT_700 = NL + "                        System.err.print(e_";
  protected final String TEXT_701 = ".getMessage());";
  ...
  protected final String TEXT_706 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_707 = " = pstmt_";
  protected final String TEXT_708 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_709 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_710 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_711 = " = rs_";
  protected final String TEXT_712 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_718 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_719 = ",";
  protected final String TEXT_720 = ".";
  protected final String TEXT_721 = ", ";
  protected final String TEXT_722 = ",updateSQLSplits_";
  protected final String TEXT_723 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_724 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_725 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_726 = ".";
  protected final String TEXT_727 = ", pstmtUpdate_";
  ...
  protected final String TEXT_738 = NL + "\t\t\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_751 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_752 = " = updatedCount_";
  protected final String TEXT_753 = " + pstmtUpdate_";
  protected final String TEXT_754 = ".executeUpdate(); " + NL + "                    nb_line_";
  protected final String TEXT_755 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_756 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_757 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_758 = " = true;";
  protected final String TEXT_759 = NL + "                        throw(e_";
  ...
  protected final String TEXT_783 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_784 = NL + "                        ";
  protected final String TEXT_785 = NL + "                            query_";
  protected final String TEXT_786 = " = ";
  protected final String TEXT_787 = ";";
  protected final String TEXT_788 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_789 = ",";
  protected final String TEXT_790 = ".";
  protected final String TEXT_791 = ", ";
  protected final String TEXT_792 = ",insertSQLSplits_";
  ...
  protected final String TEXT_806 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_807 = "++;";
  protected final String TEXT_808 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_809 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_810 = " = true;";
  protected final String TEXT_811 = NL + "                        throw(e_";
  protected final String TEXT_812 = ");";
  protected final String TEXT_813 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_836 = NL + "    \t    int updateFlag_";
  protected final String TEXT_837 = "=0;" + NL + "    \t    ";
  ...
  protected final String TEXT_848 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_884 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_885 = NL + "                        ";
  protected final String TEXT_886 = NL + "                            query_";
  protected final String TEXT_887 = " = ";
  protected final String TEXT_888 = ";";
  protected final String TEXT_889 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_890 = ",";
  protected final String TEXT_891 = ".";
  protected final String TEXT_892 = ", ";
  protected final String TEXT_893 = ",insertSQLSplits_";
  ...
  protected final String TEXT_901 = NL + "                    globalMap.put(\"";
  protected final String TEXT_902 = "_QUERY\", query_";
  protected final String TEXT_903 = ".toString().trim());";
  ...
  protected final String TEXT_909 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_910 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_911 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_912 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_913 = " = true;";
  protected final String TEXT_914 = NL + "                        throw(e_";
  ...
  protected final String TEXT_930 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_931 = ").getSQLState();";
  protected final String TEXT_932 = NL + "                            ";
  protected final String TEXT_933 = ".errorMessage = e_";
  protected final String TEXT_934 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_935 = ";";
  protected final String TEXT_936 = NL + "                            System.err.print(e_";
  ...
  protected final String TEXT_953 = NL + "    \t\t\tpstmt_";
  protected final String TEXT_954 = ".addBatch();" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_955 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_956 = NL + "\t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_957 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_958 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_959 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_960 = " = deletedCount_";
  protected final String TEXT_961 = " + pstmt_";
  protected final String TEXT_962 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_963 = "++;";
  protected final String TEXT_964 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_965 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_966 = " = true;";
  protected final String TEXT_967 = NL + "                    throw(e_";
  ...
  protected final String TEXT_983 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_984 = ").getSQLState();";
  protected final String TEXT_985 = NL + "                        ";
  protected final String TEXT_986 = ".errorMessage = e_";
  protected final String TEXT_987 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_988 = ";";
  protected final String TEXT_989 = NL + "                        System.err.print(e_";
  protected final String TEXT_990 = ".getMessage());";
  ...
  protected final String TEXT_1008 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1009 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1010 = ": pstmt_";
  protected final String TEXT_1011 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1016 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1017 = " += countSum_";
  protected final String TEXT_1018 = ";" + NL + "            \t    \t";
  protected final String TEXT_1019 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1020 = " += countSum_";
  protected final String TEXT_1021 = ";" + NL + "            \t    \t";
  protected final String TEXT_1022 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1023 = " += countSum_";
  protected final String TEXT_1024 = ";" + NL + "            \t    \t";
  protected final String TEXT_1025 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1026 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1027 = "){" + NL + "                \t";
  protected final String TEXT_1028 = NL + "                \t\tthrow(e_";
  protected final String TEXT_1029 = ");" + NL + "                \t";
  protected final String TEXT_1030 = NL + "                \tint countSum_";
  protected final String TEXT_1031 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1032 = ": e_";
  protected final String TEXT_1033 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1037 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1038 = " += countSum_";
  protected final String TEXT_1039 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_1040 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_1041 = " += countSum_";
  protected final String TEXT_1042 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1043 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_1044 = " += countSum_";
  protected final String TEXT_1045 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1046 = " " + NL + "                \tSystem.err.println(e_";
  protected final String TEXT_1047 = ".getMessage());" + NL + "                \t";
  ...
  protected final String TEXT_1055 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1056 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1057 = ": pstmt_";
  protected final String TEXT_1058 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1059 = " += (countEach_";
  protected final String TEXT_1060 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1061 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1062 = NL + "            \t    \t";
  protected final String TEXT_1063 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1064 = " += countSum_";
  protected final String TEXT_1065 = ";" + NL + "            \t    \t";
  protected final String TEXT_1066 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1067 = " += countSum_";
  protected final String TEXT_1068 = ";" + NL + "            \t    \t";
  protected final String TEXT_1069 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1070 = " += countSum_";
  protected final String TEXT_1071 = ";" + NL + "            \t    \t";
  protected final String TEXT_1072 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1073 = "){" + NL + "                \t";
  protected final String TEXT_1074 = NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1075 = ");" + NL + "                \t";
  protected final String TEXT_1076 = NL + "                \t\tint countSum_";
  protected final String TEXT_1077 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1078 = ": e_";
  protected final String TEXT_1079 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1080 = " += (countEach_";
  protected final String TEXT_1081 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1082 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1083 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1084 = " += countSum_";
  protected final String TEXT_1085 = ";" + NL + "            \t    \t";
  protected final String TEXT_1086 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1087 = " += countSum_";
  protected final String TEXT_1088 = ";" + NL + "            \t    \t";
  protected final String TEXT_1089 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1090 = " += countSum_";
  protected final String TEXT_1091 = ";" + NL + "            \t    \t";
  protected final String TEXT_1092 = NL + "                        System.err.println(e_";
  protected final String TEXT_1093 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1094 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1095 = NL + "                \t";
  protected final String TEXT_1096 = NL + "                \tconn_";
  protected final String TEXT_1097 = ".commit();                " + NL + "                \t";
