...
public class TFirebirdOutputMainJava {
  ...
  protected final String TEXT_55 = NL + "            batchSize_";
  protected final String TEXT_56 = " = buffersSize_";
  protected final String TEXT_57 = ";";
  protected final String TEXT_58 = NL + "        whetherReject_";
  ...
  protected final String TEXT_65 = "_QUERY\", query_";
  protected final String TEXT_66 = ".toString().trim());";
  protected final String TEXT_67 = NL;
  protected final String TEXT_68 = NL + "                       pstmt_";
  protected final String TEXT_69 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_70 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_71 = "++;";
  protected final String TEXT_72 = NL + "                       try {" + NL + "                           insertedCount_";
  protected final String TEXT_73 = " = insertedCount_";
  protected final String TEXT_74 = " + pstmt_";
  protected final String TEXT_75 = ".executeUpdate();" + NL + "                           nb_line_";
  ...
  protected final String TEXT_92 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_93 = NL + "                                   ";
  protected final String TEXT_94 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_95 = ";";
  protected final String TEXT_96 = NL + "                                   System.err.print(e.getMessage());";
  ...
  protected final String TEXT_112 = "_QUERY\", query_";
  protected final String TEXT_113 = ".toString().trim());";
  protected final String TEXT_114 = NL;
  protected final String TEXT_115 = NL + "                           pstmt_";
  protected final String TEXT_116 = ".addBatch();" + NL + "                           batchSizeCounter_";
  protected final String TEXT_117 = "++;" + NL + "                           nb_line_";
  protected final String TEXT_118 = "++;";
  protected final String TEXT_119 = NL + "                           try {" + NL + "                               updatedCount_";
  protected final String TEXT_120 = " = updatedCount_";
  protected final String TEXT_121 = " + pstmt_";
  protected final String TEXT_122 = ".executeUpdate();" + NL + "                               nb_line_";
  ...
  protected final String TEXT_135 = NL + "                                       rejectedCount_";
  protected final String TEXT_136 = " = rejectedCount_";
  protected final String TEXT_137 = " + 1;";
  protected final String TEXT_138 = NL + "                                       ";
  protected final String TEXT_139 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_148 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_149 = " = pstmt_";
  protected final String TEXT_150 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_151 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_152 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_153 = " = rs_";
  protected final String TEXT_154 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_171 = "_QUERY\", query_";
  protected final String TEXT_172 = ".toString().trim());";
  protected final String TEXT_173 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_174 = " = updatedCount_";
  protected final String TEXT_175 = " + pstmtUpdate_";
  protected final String TEXT_176 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_177 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_178 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_179 = " = true;";
  protected final String TEXT_180 = NL + "                        throw(e);";
  protected final String TEXT_181 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_191 = NL + "                            rejectedCount_";
  protected final String TEXT_192 = " = rejectedCount_";
  protected final String TEXT_193 = " + 1;";
  protected final String TEXT_194 = NL + "                            ";
  protected final String TEXT_195 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_196 = NL + "                            ";
  protected final String TEXT_197 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_198 = ";";
  protected final String TEXT_199 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_211 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_212 = "++;";
  protected final String TEXT_213 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_214 = " = true;";
  protected final String TEXT_215 = NL + "                        throw(e);";
  ...
  protected final String TEXT_226 = NL + "                            rejectedCount_";
  protected final String TEXT_227 = " = rejectedCount_";
  protected final String TEXT_228 = " + 1;";
  protected final String TEXT_229 = NL + "                            ";
  protected final String TEXT_230 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_236 = NL + "    \t    int updateFlag_";
  protected final String TEXT_237 = "=0;" + NL + "    \t    ";
  ...
  protected final String TEXT_253 = "_QUERY\", query_";
  protected final String TEXT_254 = ".toString().trim());";
  protected final String TEXT_255 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_256 = "=pstmtUpdate_";
  protected final String TEXT_257 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_258 = " = updatedCount_";
  protected final String TEXT_259 = " + updateFlag_";
  protected final String TEXT_260 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_261 = " == 0) {" + NL + "            \t";
  protected final String TEXT_262 = NL + "\t\t\t\tquery_";
  protected final String TEXT_263 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_264 = NL + "                        ";
  protected final String TEXT_265 = NL + "                            query_";
  protected final String TEXT_266 = " = ";
  protected final String TEXT_267 = ";";
  protected final String TEXT_268 = NL + "                    globalMap.put(\"";
  protected final String TEXT_269 = "_QUERY\", query_";
  protected final String TEXT_270 = ".toString().trim());";
  protected final String TEXT_271 = NL + "                \tinsertedCount_";
  protected final String TEXT_272 = " = insertedCount_";
  protected final String TEXT_273 = " + pstmtInsert_";
  protected final String TEXT_274 = ".executeUpdate();" + NL + "                \tnb_line_";
  protected final String TEXT_275 = "++;";
  protected final String TEXT_276 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_277 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_278 = NL + "             \t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_312 = "_QUERY\", query_";
  protected final String TEXT_313 = ".toString().trim());";
  protected final String TEXT_314 = NL;
  protected final String TEXT_315 = NL + "                       pstmt_";
  protected final String TEXT_316 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_317 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_318 = "++;";
  protected final String TEXT_319 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_320 = " = deletedCount_";
  protected final String TEXT_321 = " + pstmt_";
  protected final String TEXT_322 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_323 = "++;";
  protected final String TEXT_324 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_337 = NL + "                                   rejectedCount_";
  protected final String TEXT_338 = " = rejectedCount_";
  protected final String TEXT_339 = " + 1;";
  protected final String TEXT_340 = NL + "                                   ";
  protected final String TEXT_341 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_342 = NL + "                                   ";
  protected final String TEXT_343 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_344 = ";";
  protected final String TEXT_345 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_346 = NL + "                       }";
  protected final String TEXT_347 = NL + "    \t";
  protected final String TEXT_348 = NL + "            if(!whetherReject_";
  protected final String TEXT_349 = ") {";
  protected final String TEXT_350 = NL + "                            ";
  protected final String TEXT_351 = " = new ";
  protected final String TEXT_352 = "Struct();";
  ...
  protected final String TEXT_359 = NL + "                if ((batchSize_";
  protected final String TEXT_360 = " > 0) && (batchSize_";
  protected final String TEXT_361 = " <= batchSizeCounter_";
  protected final String TEXT_362 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_363 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_364 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_365 = " = 0;";
  protected final String TEXT_366 = NL + "                        status_";
  protected final String TEXT_367 = " = pstmt_";
  protected final String TEXT_368 = ".executeBatch();";
  protected final String TEXT_369 = NL + "                        for(int countEach_";
  protected final String TEXT_370 = ": status_";
  protected final String TEXT_371 = ") {" + NL + "                            countSum_";
  protected final String TEXT_372 = " += (countEach_";
  protected final String TEXT_373 = " < 0 ? 0 : countEach_";
  protected final String TEXT_374 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_375 = NL + "                            throw(e);";
  protected final String TEXT_376 = NL + "                        for(int countEach_";
  protected final String TEXT_377 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_378 = " += (countEach_";
  protected final String TEXT_379 = " < 0 ? 0 : countEach_";
  protected final String TEXT_380 = ");" + NL + "                        }";
  protected final String TEXT_381 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_382 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_383 = " = pstmt_";
  protected final String TEXT_384 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_385 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_386 = " = tmp_batchUpdateCount_";
  protected final String TEXT_387 = " > countSum_";
  protected final String TEXT_388 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_389 = " : countSum_";
  ...
  protected final String TEXT_395 = " += tmp_batchUpdateCount_";
  protected final String TEXT_396 = ";";
  protected final String TEXT_397 = NL + "                        deletedCount_";
  protected final String TEXT_398 = " += tmp_batchUpdateCount_";
  protected final String TEXT_399 = ";";
  protected final String TEXT_400 = NL + "               }";
  protected final String TEXT_401 = NL + "                commitCounter_";
  protected final String TEXT_402 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_403 = " <= commitCounter_";
  protected final String TEXT_404 = ") {";
  protected final String TEXT_405 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_406 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_407 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_408 = NL + "\t                    for(int countEach_";
  protected final String TEXT_409 = ": pstmt_";
  protected final String TEXT_410 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_411 = " += (countEach_";
  protected final String TEXT_412 = " < 0 ? 0 : countEach_";
  protected final String TEXT_413 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_414 = NL + "\t                    ";
  protected final String TEXT_415 = NL + "\t                        insertedCount_";
  protected final String TEXT_416 = " += countSum_";
  protected final String TEXT_417 = ";" + NL + "\t                    ";
  protected final String TEXT_418 = NL + "\t                        updatedCount_";
  protected final String TEXT_419 = " += countSum_";
  protected final String TEXT_420 = ";" + NL + "\t                    ";
  protected final String TEXT_421 = NL + "\t                        deletedCount_";
  protected final String TEXT_422 = " += countSum_";
  protected final String TEXT_423 = ";" + NL + "\t                    ";
  protected final String TEXT_424 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_425 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_426 = NL + "                        throw(e);";
  protected final String TEXT_427 = NL + "                        int countSum_";
  protected final String TEXT_428 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_429 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_430 = " += (countEach_";
  protected final String TEXT_431 = " < 0 ? 0 : countEach_";
  protected final String TEXT_432 = ");" + NL + "                        }";
  protected final String TEXT_433 = NL + "                            insertedCount_";
  protected final String TEXT_434 = " += countSum_";
  protected final String TEXT_435 = ";";
  protected final String TEXT_436 = NL + "                            updatedCount_";
  protected final String TEXT_437 = " += countSum_";
  protected final String TEXT_438 = ";";
  protected final String TEXT_439 = NL + "                            deletedCount_";
  protected final String TEXT_440 = " += countSum_";
  protected final String TEXT_441 = ";";
  protected final String TEXT_442 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_443 = NL + "                }";
  protected final String TEXT_444 = NL + "                ";
  protected final String TEXT_445 = NL + "                conn_";
  protected final String TEXT_446 = ".commit();";
  protected final String TEXT_447 = NL + "                commitCounter_";
