...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_180 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_181 = ";";
  protected final String TEXT_182 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_183 = " = \"";
  protected final String TEXT_184 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_185 = ");" + NL + "\t\t\t";
  protected final String TEXT_186 = NL + "\t        String dbUser_";
  ...
  protected final String TEXT_200 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_201 = ",dbUser_";
  protected final String TEXT_202 = ",dbPwd_";
  protected final String TEXT_203 = ");";
  protected final String TEXT_204 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_205 = " = ";
  protected final String TEXT_206 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_207 = " = atnParams_";
  protected final String TEXT_208 = ".replaceAll(\"&\", \"\\n\");" + NL + "\t\t\tjava.util.Properties atnParamsPrope_";
  protected final String TEXT_209 = " = new java.util.Properties();" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_210 = ".put(\"user\",dbUser_";
  protected final String TEXT_211 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_212 = ".put(\"password\",dbPwd_";
  protected final String TEXT_213 = ");" + NL + "\t\t\tatnParamsPrope_";
  protected final String TEXT_214 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_215 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_216 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_217 = ", atnParamsPrope_";
  protected final String TEXT_218 = ");";
  protected final String TEXT_219 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_220 = " = rs_";
  protected final String TEXT_221 = ".getTimestamp(";
  protected final String TEXT_222 = "column_index_";
  protected final String TEXT_223 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_224 = " != null) {";
  protected final String TEXT_225 = NL + "                ";
  protected final String TEXT_226 = ".";
  protected final String TEXT_227 = " = new java.util.Date(timestamp_";
  protected final String TEXT_228 = ".getTime());" + NL + "            } else {";
  ...
  protected final String TEXT_234 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_235 = " = null;";
  protected final String TEXT_236 = NL + "\t\t        conn_";
  protected final String TEXT_237 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_298 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_368 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_369 = ".getObject(";
  protected final String TEXT_370 = "column_index_";
  protected final String TEXT_371 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_372 = NL + "                                    ";
  protected final String TEXT_373 = ".";
  protected final String TEXT_374 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_383 = ".setEPSG(";
  protected final String TEXT_384 = ");" + NL + "                                        }";
  protected final String TEXT_385 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_386 = NL + "                                  ";
  protected final String TEXT_387 = ".";
  protected final String TEXT_388 = "=dcg_";
  protected final String TEXT_389 = ";";
  protected final String TEXT_390 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_391 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_392 = " = ";
  protected final String TEXT_393 = "; i_";
  protected final String TEXT_394 = "  <= rsmd_";
  protected final String TEXT_395 = ".getColumnCount(); i_";
  protected final String TEXT_396 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_397 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_398 = ".getColumnTypeName(i_";
  protected final String TEXT_399 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_400 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_401 = ".getClob(i_";
  protected final String TEXT_402 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_403 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_404 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_405 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_406 = ".add(tNTextImpl_";
  protected final String TEXT_407 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_408 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_409 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_410 = ".getColumnTypeName(i_";
  protected final String TEXT_411 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_412 = ".add(rs_";
  protected final String TEXT_413 = ".getString(i_";
  protected final String TEXT_414 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_415 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  ...
  protected final String TEXT_422 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_423 = ".";
  protected final String TEXT_424 = ", rs_";
  protected final String TEXT_425 = ", fixedColumnCount_";
  protected final String TEXT_426 = ",";
  protected final String TEXT_427 = ");";
  protected final String TEXT_428 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_429 = ".";
  protected final String TEXT_430 = ", rs_";
  protected final String TEXT_431 = ", fixedColumnCount_";
  protected final String TEXT_432 = ",";
  protected final String TEXT_433 = ");";
  protected final String TEXT_434 = NL + "                                  Object geom = rs_";
  protected final String TEXT_435 = ".getObject(";
  protected final String TEXT_436 = "column_index_";
  protected final String TEXT_437 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_438 = ".";
  protected final String TEXT_439 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_440 = ".";
  protected final String TEXT_441 = " = null;" + NL + "                                  }";
  protected final String TEXT_442 = NL + "\t\t                          ";
  protected final String TEXT_443 = NL + "\t\t                    }";
  protected final String TEXT_444 = NL + "\t\t\t\t\t";
  protected final String TEXT_445 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_446 = " - Retrieving the record \" + nb_line_";
