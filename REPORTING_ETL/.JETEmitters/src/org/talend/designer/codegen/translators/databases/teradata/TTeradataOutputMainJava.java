...
public class TTeradataOutputMainJava {
  ...
  protected final String TEXT_535 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_536 = " = update_";
  protected final String TEXT_537 = ".split(\"\\\\?\");";
  protected final String TEXT_538 = NL + "\t\t\tupdate_";
  protected final String TEXT_539 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_540 = " = update_";
  protected final String TEXT_541 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_542 = " = insert_";
  protected final String TEXT_543 = ".split(\"\\\\?\");";
  protected final String TEXT_544 = NL + "\t\t\tdelete_";
  protected final String TEXT_545 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_546 = " = delete_";
  protected final String TEXT_547 = ".split(\"\\\\?\");";
  protected final String TEXT_548 = NL + "\t\t\treplace_";
  protected final String TEXT_549 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_550 = " = replace_";
  protected final String TEXT_551 = ".split(\"\\\\?\");";
  protected final String TEXT_552 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_553 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_554 = " = insertIgnore_";
  ...
  protected final String TEXT_560 = NL + "                commitEvery_";
  protected final String TEXT_561 = " = buffersSize_";
  protected final String TEXT_562 = ";";
  protected final String TEXT_563 = NL + "                batchSize_";
  protected final String TEXT_564 = " = buffersSize_";
  protected final String TEXT_565 = ";";
  protected final String TEXT_566 = NL + "        whetherReject_";
  protected final String TEXT_567 = " = false;";
  protected final String TEXT_568 = NL + "                    ";
  protected final String TEXT_569 = NL + "                        query_";
  protected final String TEXT_570 = " = ";
  protected final String TEXT_571 = ";";
  protected final String TEXT_572 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_573 = ",";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = ", ";
  protected final String TEXT_576 = ",insertSQLSplits_";
  protected final String TEXT_577 = ");";
  protected final String TEXT_578 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_579 = ".";
  protected final String TEXT_580 = ", pstmt_";
  protected final String TEXT_581 = ", ";
  protected final String TEXT_582 = ", \"";
  protected final String TEXT_583 = "\");";
  protected final String TEXT_584 = NL + "                globalMap.put(\"";
  protected final String TEXT_585 = "_QUERY\", query_";
  protected final String TEXT_586 = ".toString().trim());";
  ...
  protected final String TEXT_591 = NL + "            ////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_595 = ".executeUpdate();";
  protected final String TEXT_596 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_597 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_598 = " = true;";
  protected final String TEXT_599 = NL + "                    throw(e_";
  ...
  protected final String TEXT_613 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_614 = ").getSQLState();";
  ...
  protected final String TEXT_626 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_627 = ",";
  protected final String TEXT_628 = ".";
  protected final String TEXT_629 = ", ";
  protected final String TEXT_630 = ",updateSQLSplits_";
  protected final String TEXT_631 = ");";
  protected final String TEXT_632 = NL + "                    int count_";
  protected final String TEXT_633 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_634 = ".";
  protected final String TEXT_635 = ", pstmt_";
  ...
  protected final String TEXT_657 = NL + "                pstmt_";
  protected final String TEXT_658 = ".addBatch();" + NL + "                batchSizeCounter_";
  protected final String TEXT_659 = "++;" + NL + "                nb_line_";
  protected final String TEXT_660 = "++;";
  protected final String TEXT_661 = NL + "            //////////////////////////////////////" + NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_662 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_663 = " = updatedCount_";
  protected final String TEXT_664 = " + pstmt_";
  protected final String TEXT_665 = ".executeUpdate();";
  protected final String TEXT_666 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_667 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_668 = " = true;";
  protected final String TEXT_669 = NL + "                    throw(e_";
  ...
  protected final String TEXT_683 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_684 = ").getSQLState();";
  protected final String TEXT_685 = NL + "                        ";
  protected final String TEXT_686 = ".errorMessage = e_";
  protected final String TEXT_687 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_688 = ";";
  protected final String TEXT_689 = NL + "                        System.err.print(e_";
  protected final String TEXT_690 = ".getMessage());";
  ...
  protected final String TEXT_706 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_707 = ",";
  protected final String TEXT_708 = ".";
  protected final String TEXT_709 = ", ";
  protected final String TEXT_710 = ",updateSQLSplits_";
  protected final String TEXT_711 = ");";
  protected final String TEXT_712 = NL + NL + "                        int count_";
  protected final String TEXT_713 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_714 = ".";
  protected final String TEXT_715 = ", pstmtUpdate_";
  ...
  protected final String TEXT_742 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_743 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_744 = " = true;";
  protected final String TEXT_745 = NL + "                        throw(e_";
  ...
  protected final String TEXT_761 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_762 = ").getSQLState();";
  protected final String TEXT_763 = NL + "                            ";
  protected final String TEXT_764 = ".errorMessage = e_";
  protected final String TEXT_765 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_766 = ";";
  protected final String TEXT_767 = NL + "                            System.err.print(e_";
  protected final String TEXT_768 = ".getMessage());";
  protected final String TEXT_769 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_770 = NL + "                        ";
  protected final String TEXT_771 = NL + "                            query_";
  protected final String TEXT_772 = " = ";
  protected final String TEXT_773 = ";";
  protected final String TEXT_774 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_775 = ",";
  protected final String TEXT_776 = ".";
  protected final String TEXT_777 = ", ";
  protected final String TEXT_778 = ",insertSQLSplits_";
  protected final String TEXT_779 = ");";
  protected final String TEXT_780 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_781 = ".";
  protected final String TEXT_782 = ", pstmtInsert_";
  protected final String TEXT_783 = ", ";
  protected final String TEXT_784 = ", \"";
  protected final String TEXT_785 = "\");";
  protected final String TEXT_786 = NL + "                    globalMap.put(\"";
  protected final String TEXT_787 = "_QUERY\", query_";
  protected final String TEXT_788 = ".toString().trim());";
  protected final String TEXT_789 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_790 = " = insertedCount_";
  protected final String TEXT_791 = " + pstmtInsert_";
  protected final String TEXT_792 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_793 = "++;";
  protected final String TEXT_794 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_795 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_796 = " = true;";
  protected final String TEXT_797 = NL + "                        throw(e_";
  protected final String TEXT_798 = ");";
  protected final String TEXT_799 = NL + "                          nb_line_";
  protected final String TEXT_800 = "++;";
  protected final String TEXT_801 = NL + "                            ";
  protected final String TEXT_802 = " = new ";
  protected final String TEXT_803 = "Struct();";
  protected final String TEXT_804 = NL + "                                ";
  protected final String TEXT_805 = ".";
  protected final String TEXT_806 = " = ";
  protected final String TEXT_807 = ".";
  protected final String TEXT_808 = ";";
  protected final String TEXT_809 = NL + "                            rejectedCount_";
  protected final String TEXT_810 = " = rejectedCount_";
  protected final String TEXT_811 = " + 1;";
  protected final String TEXT_812 = NL + "                            ";
  protected final String TEXT_813 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_814 = ").getSQLState();";
  ...
  protected final String TEXT_821 = NL + "                }" + NL + "            }" + NL;
  protected final String TEXT_822 = NL + "            int updateFlag_";
  protected final String TEXT_823 = "=0;";
  protected final String TEXT_824 = NL + "                    ";
  protected final String TEXT_825 = NL + "                        query_";
  protected final String TEXT_826 = " = ";
  protected final String TEXT_827 = ";";
  protected final String TEXT_828 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_829 = ",";
  protected final String TEXT_830 = ".";
  protected final String TEXT_831 = ", ";
  protected final String TEXT_832 = ",updateSQLSplits_";
  protected final String TEXT_833 = ");";
  protected final String TEXT_834 = NL + NL + "                    int count_";
  protected final String TEXT_835 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_859 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_860 = "=pstmtUpdate_";
  protected final String TEXT_861 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_862 = " = updatedCount_";
  protected final String TEXT_863 = " + updateFlag_";
  protected final String TEXT_864 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_865 = " == 0) {";
  protected final String TEXT_866 = NL + "                query_";
  protected final String TEXT_867 = " = new StringBuffer(\"\");";
  protected final String TEXT_868 = NL + "                        ";
  protected final String TEXT_869 = NL + "                            query_";
  protected final String TEXT_870 = " = ";
  protected final String TEXT_871 = ";";
  protected final String TEXT_872 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_873 = ",";
  protected final String TEXT_874 = ".";
  protected final String TEXT_875 = ", ";
  protected final String TEXT_876 = ",insertSQLSplits_";
  protected final String TEXT_877 = ");";
  protected final String TEXT_878 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_879 = ".";
  protected final String TEXT_880 = ", pstmtInsert_";
  protected final String TEXT_881 = ", ";
  protected final String TEXT_882 = ", \"";
  protected final String TEXT_883 = "\");";
  protected final String TEXT_884 = NL + "                    globalMap.put(\"";
  protected final String TEXT_885 = "_QUERY\", query_";
  protected final String TEXT_886 = ".toString().trim());";
  protected final String TEXT_887 = NL + "                    insertedCount_";
  protected final String TEXT_888 = " = insertedCount_";
  protected final String TEXT_889 = " + pstmtInsert_";
  protected final String TEXT_890 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_891 = "++;";
  protected final String TEXT_892 = NL + "             }else{" + NL + "                nb_line_";
  protected final String TEXT_893 = "++;";
  protected final String TEXT_894 = NL + "             }" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_895 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_896 = " = true;";
  protected final String TEXT_897 = NL + "                        throw(e_";
  protected final String TEXT_898 = ");";
  protected final String TEXT_899 = NL + "                       nb_line_";
  ...
  protected final String TEXT_913 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_914 = ").getSQLState();";
  protected final String TEXT_915 = NL + "                            ";
  protected final String TEXT_916 = ".errorMessage = e_";
  protected final String TEXT_917 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_918 = ";";
  protected final String TEXT_919 = NL + "                            System.err.print(e_";
  protected final String TEXT_920 = ".getMessage());";
  ...
  protected final String TEXT_930 = NL + "                globalMap.put(\"";
  protected final String TEXT_931 = "_QUERY\", query_";
  protected final String TEXT_932 = ".toString().trim());";
  protected final String TEXT_933 = NL + "              pstmt_";
  protected final String TEXT_934 = ".addBatch();" + NL + "              batchSizeCounter_";
  protected final String TEXT_935 = "++;" + NL + "              nb_line_";
  protected final String TEXT_936 = "++;";
  protected final String TEXT_937 = NL + "            //////////////////////////////" + NL + "            try {" + NL + "              deletedCount_";
  protected final String TEXT_938 = " = deletedCount_";
  protected final String TEXT_939 = " + pstmt_";
  protected final String TEXT_940 = ".executeUpdate();" + NL + "              nb_line_";
  protected final String TEXT_941 = "++;";
  protected final String TEXT_942 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_943 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_944 = " = true;";
  protected final String TEXT_945 = NL + "                    throw(e_";
  ...
  protected final String TEXT_951 = "Struct();";
  protected final String TEXT_952 = NL + "                            ";
  protected final String TEXT_953 = ".";
  protected final String TEXT_954 = " = ";
  protected final String TEXT_955 = ".";
  protected final String TEXT_956 = ";";
  protected final String TEXT_957 = NL + "                        rejectedCount_";
  protected final String TEXT_958 = " = rejectedCount_";
  protected final String TEXT_959 = " + 1;";
  protected final String TEXT_960 = NL + "                        ";
  protected final String TEXT_961 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_962 = ").getSQLState();";
  protected final String TEXT_963 = NL + "                        ";
  protected final String TEXT_964 = ".errorMessage = e_";
  protected final String TEXT_965 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_966 = ";";
  protected final String TEXT_967 = NL + "                        System.err.print(e_";
  protected final String TEXT_968 = ".getMessage());";
  protected final String TEXT_969 = NL + "            }" + NL + "            //////////////////////////////////////";
  protected final String TEXT_970 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_981 = NL + "                if ((batchSize_";
  protected final String TEXT_982 = " > 0) && (batchSize_";
  protected final String TEXT_983 = " <= batchSizeCounter_";
  protected final String TEXT_984 = ")) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_985 = " = 0;" + NL + "                        int countSum_";
  protected final String TEXT_986 = " = 0;" + NL;
  protected final String TEXT_987 = NL + "                        for(int countEach_";
  protected final String TEXT_988 = ":pstmt_";
  protected final String TEXT_989 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_990 = " += (countEach_";
  protected final String TEXT_991 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1003 = NL + "                }catch(java.sql.SQLException e_";
  protected final String TEXT_1004 = "){";
  protected final String TEXT_1005 = NL + "                    java.sql.SQLException e2_";
  protected final String TEXT_1006 = " = e_";
  protected final String TEXT_1007 = ";" + NL + "                    while (e2_";
  protected final String TEXT_1008 = " != null) {";
  protected final String TEXT_1009 = NL + "                        System.err.println(e_";
  protected final String TEXT_1010 = ".getMessage());" + NL + "                        e2_";
  protected final String TEXT_1011 = " = e2_";
  protected final String TEXT_1012 = ".getNextException();" + NL + "                    }";
  protected final String TEXT_1013 = NL + "            java.sql.SQLException e3_";
  protected final String TEXT_1014 = " = e_";
  protected final String TEXT_1015 = ";" + NL + "                    boolean isFailure = false;" + NL + "            while(e_";
  protected final String TEXT_1016 = " != null){" + NL + "                if(e_";
  protected final String TEXT_1017 = ".getErrorCode() == -2801){";
  protected final String TEXT_1018 = NL + "                    System.out.println(\" Message: \" + e_";
  protected final String TEXT_1019 = ".getMessage());" + NL + "                    e_";
  protected final String TEXT_1020 = ".printStackTrace();" + NL + "                    System.out.println();" + NL + "                }" + NL + "                else if(e_";
  protected final String TEXT_1021 = ".getErrorCode() == 1339){" + NL + "                    isFailure = true;" + NL + "                }" + NL + "                else{";
  protected final String TEXT_1022 = NL + "                    System.out.println(\" Message: \" + e_";
  protected final String TEXT_1023 = ".getMessage());" + NL + "                    e_";
  protected final String TEXT_1024 = ".printStackTrace();" + NL + "                }" + NL + "                e_";
  protected final String TEXT_1025 = " = e_";
  protected final String TEXT_1026 = ".getNextException();" + NL + "            }" + NL + "            if(isFailure && e_";
  protected final String TEXT_1027 = " != null){";
  protected final String TEXT_1028 = NL + "                System.out.println(\" Message: \" + e_";
  protected final String TEXT_1029 = ".getMessage());" + NL + "                e_";
  protected final String TEXT_1030 = ".printStackTrace();" + NL + "            }";
  protected final String TEXT_1031 = NL + "                throw (e3_";
  protected final String TEXT_1032 = ");";
  protected final String TEXT_1033 = NL + "                System.err.println(e3_";
  protected final String TEXT_1034 = ".getMessage());";
  protected final String TEXT_1035 = NL + "                }" + NL + "              }";
  protected final String TEXT_1036 = NL + "                commitCounter_";
  protected final String TEXT_1037 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1038 = " <= commitCounter_";
  protected final String TEXT_1039 = ") {" + NL + "                        try {";
  protected final String TEXT_1040 = NL + "                                       if (batchSizeCounter_";
  protected final String TEXT_1041 = " > 0) {" + NL + "                                           int countSum_";
  protected final String TEXT_1042 = " = 0;" + NL;
  protected final String TEXT_1043 = NL + "                                           for(int countEach_";
  protected final String TEXT_1044 = ": pstmt_";
  protected final String TEXT_1045 = ".executeBatch()) {" + NL + "                                               countSum_";
  ...
  protected final String TEXT_1059 = NL + "                                           batchSizeCounter_";
  protected final String TEXT_1060 = " = 0;" + NL + "                                       }";
  protected final String TEXT_1061 = NL + "                            conn_";
  protected final String TEXT_1062 = ".commit();" + NL + "                            commitCounter_";
  protected final String TEXT_1063 = " = 0;";
  protected final String TEXT_1064 = NL + "                        }catch(java.sql.SQLException e_";
  protected final String TEXT_1065 = "){";
  protected final String TEXT_1066 = NL + "                            java.sql.SQLException e2_";
  protected final String TEXT_1067 = " = e_";
  protected final String TEXT_1068 = ";" + NL + "                            while (e2_";
  protected final String TEXT_1069 = " != null) {";
  protected final String TEXT_1070 = NL + "                                System.err.println(e_";
  protected final String TEXT_1071 = ".getMessage());" + NL + "                                e2_";
  protected final String TEXT_1072 = " = e2_";
  protected final String TEXT_1073 = ".getNextException();" + NL + "                            }";
  protected final String TEXT_1074 = NL + "                    java.sql.SQLException e3_";
  protected final String TEXT_1075 = " = e_";
  protected final String TEXT_1076 = ";" + NL + "                            boolean isFailure = false;" + NL + "                    while(e_";
  protected final String TEXT_1077 = " != null){" + NL + "                        if(e_";
  protected final String TEXT_1078 = ".getErrorCode() == -2801){";
  protected final String TEXT_1079 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1080 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1081 = ".printStackTrace();" + NL + "                            System.out.println();" + NL + "                        }" + NL + "                        else if(e_";
  protected final String TEXT_1082 = ".getErrorCode() == 1339){" + NL + "                            isFailure = true;" + NL + "                        }" + NL + "                        else{";
  protected final String TEXT_1083 = NL + "                            System.out.println(\" Message: \" + e_";
  protected final String TEXT_1084 = ".getMessage());" + NL + "                            e_";
  protected final String TEXT_1085 = ".printStackTrace();" + NL + "                        }" + NL + "                        e_";
  protected final String TEXT_1086 = " = e_";
  protected final String TEXT_1087 = ".getNextException();" + NL + "                    }" + NL + "                    if(isFailure && e_";
  protected final String TEXT_1088 = " != null){";
  protected final String TEXT_1089 = NL + "                        System.out.println(\" Message: \" + e_";
  protected final String TEXT_1090 = ".getMessage());" + NL + "                        e_";
  protected final String TEXT_1091 = ".printStackTrace();" + NL + "                    }";
  protected final String TEXT_1092 = NL + "                        throw (e3_";
  protected final String TEXT_1093 = ");";
  protected final String TEXT_1094 = NL + "                        System.err.println(e3_";
  protected final String TEXT_1095 = ".getMessage());";
