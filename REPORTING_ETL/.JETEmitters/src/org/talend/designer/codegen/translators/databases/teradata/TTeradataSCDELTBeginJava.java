...
public class TTeradataSCDELTBeginJava {
  ...
  protected final String TEXT_51 = ";" + NL + "    String tableName_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "    String sourceTable_";
  protected final String TEXT_54 = " = dbschema_";
  protected final String TEXT_55 = " + \".\" + ";
  protected final String TEXT_56 = ";";
  protected final String TEXT_57 = NL + "        java.sql.Connection conn_";
  protected final String TEXT_58 = " = (java.sql.Connection) globalMap.get(\"";
  protected final String TEXT_59 = "\");";
  protected final String TEXT_60 = NL + "        java.lang.Class.forName(\"com.teradata.jdbc.TeraDriver\");";
  ...
  protected final String TEXT_66 = " = \"jdbc:teradata://\" + ";
  protected final String TEXT_67 = " + \"/DATABASE=\" + ";
  ...
  protected final String TEXT_76 = NL + "        String dbPwd_";
  protected final String TEXT_77 = " = decryptedPassword_";
  protected final String TEXT_78 = ";" + NL + "" + NL + "        java.sql.Connection conn_";
  ...
  protected final String TEXT_88 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  protected final String TEXT_89 = ")));";
  protected final String TEXT_90 = NL + "            stmtDrop_";
  protected final String TEXT_91 = ".execute(\"";
  protected final String TEXT_92 = "\" ";
  protected final String TEXT_93 = ");";
  protected final String TEXT_94 = NL + "            stmtDrop_";
  protected final String TEXT_95 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_119 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_120 = "));";
  protected final String TEXT_121 = NL + "                    stmtCreate_";
  protected final String TEXT_122 = ".execute(((\"";
  protected final String TEXT_123 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = ", \"";
  protected final String TEXT_126 = "\")";
  protected final String TEXT_127 = ".toUpperCase()";
  ...
  protected final String TEXT_222 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_290 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_291 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_292 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_293 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_294 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_307 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_336 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_364 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_365 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_375 = NL + "            stmtClear_";
  ...
  protected final String TEXT_380 = NL + "                              stmtTruncCount_";
  protected final String TEXT_381 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_382 = "));";
  protected final String TEXT_383 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_395 = NL + "                              stmtTrunc_";
  ...
  protected final String TEXT_403 = NL + "                if(!conn_";
  protected final String TEXT_404 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_405 = ".commit();" + NL + "                }";
  protected final String TEXT_406 = NL + "            deletedCount_";
  protected final String TEXT_407 = " += rsTruncCountNumber_";
  protected final String TEXT_408 = ";" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_415 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_431 = NL + "        String updateForType1_";
  protected final String TEXT_432 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_433 = " +\" FROM \"+ sourceTable_";
  protected final String TEXT_434 = " + \" t SET ";
  protected final String TEXT_435 = " WHERE ";
  protected final String TEXT_436 = " AND (";
  protected final String TEXT_437 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_440 = ".executeUpdate(updateForType1_";
  protected final String TEXT_441 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_442 = ".close();";
  protected final String TEXT_443 = NL + "        String updateForType2_";
  protected final String TEXT_444 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_445 = NL + "                                        + \" FROM \" + sourceTable_";
  protected final String TEXT_446 = " + \" t\"" + NL + "                                        + \" SET ";
  protected final String TEXT_447 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_448 = "\")))" + NL + "                                        + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')";
  protected final String TEXT_449 = ", ";
  protected final String TEXT_450 = " = 0";
  protected final String TEXT_451 = " \"" + NL + "                                        + \" WHERE ";
  protected final String TEXT_452 = " AND (";
  protected final String TEXT_453 = ") AND \" + tableName_";
  protected final String TEXT_454 = " + \".";
  protected final String TEXT_455 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_456 = " = conn_";
  protected final String TEXT_457 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_458 = ".executeUpdate(updateForType2_";
  protected final String TEXT_459 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_460 = ".close();";
  protected final String TEXT_461 = NL + "        String insertForType2_";
  protected final String TEXT_462 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_463 = " + \"(";
  protected final String TEXT_464 = ", ";
  protected final String TEXT_465 = ") SELECT ";
  protected final String TEXT_466 = "\" + ";
  protected final String TEXT_467 = " + \".NEXTVAL, ";
  protected final String TEXT_468 = "t.";
  protected final String TEXT_469 = ", cast('\" +" + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_470 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL";
  protected final String TEXT_471 = ", 1";
  protected final String TEXT_472 = ", d.";
  protected final String TEXT_473 = " + 1";
  protected final String TEXT_474 = " FROM \" +" + NL + "        sourceTable_";
  protected final String TEXT_475 = " + \" t, \" + tableName_";
  protected final String TEXT_476 = " + \" d WHERE ";
  protected final String TEXT_477 = " AND (";
  protected final String TEXT_478 = ") AND d.";
  protected final String TEXT_479 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_480 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_481 = " = conn_";
  protected final String TEXT_482 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_483 = ".executeUpdate(insertForType2_";
  protected final String TEXT_484 = ");" + NL + "        stmtType2Insert_";
  ...
  protected final String TEXT_490 = ") SELECT ";
  protected final String TEXT_491 = "\" + ";
  protected final String TEXT_492 = " + \".NEXTVAL, ";
  protected final String TEXT_493 = "t.";
  protected final String TEXT_494 = "\"";
  protected final String TEXT_495 = " + \", cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_496 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL\"";
  protected final String TEXT_497 = NL + "    + \"";
  protected final String TEXT_498 = ", 1";
  protected final String TEXT_499 = ", 1";
  protected final String TEXT_500 = " FROM \" +" + NL + "    sourceTable_";
  protected final String TEXT_501 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_502 = " + \" d ON ";
  protected final String TEXT_503 = " WHERE (";
  protected final String TEXT_504 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_507 = ".executeUpdate(insert_";
  protected final String TEXT_508 = ");" + NL + "    stmtInsert_";
