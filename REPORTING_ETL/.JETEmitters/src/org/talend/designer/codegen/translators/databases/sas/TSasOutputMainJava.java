...
public class TSasOutputMainJava {
  ...
  protected final String TEXT_113 = NL + "                        nb_line_rejected_";
  protected final String TEXT_114 = "++;";
  protected final String TEXT_115 = NL + "                        ";
  protected final String TEXT_116 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_117 = NL + "                        ";
  protected final String TEXT_118 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_166 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_192 = NL + "                        \tnb_line_rejected_";
  ...
  protected final String TEXT_200 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_213 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_214 = " = pstmtUpdate_";
  protected final String TEXT_215 = ".executeUpdate();" + NL + "                if(updateFlag_";
  protected final String TEXT_216 = " != 0) {" + NL + "            \t\tnb_line_";
  protected final String TEXT_217 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_218 = NL + "                }" + NL + "                updatedCount_";
  protected final String TEXT_219 = " = updatedCount_";
  protected final String TEXT_220 = " + updateFlag_";
  protected final String TEXT_221 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_232 = NL + "                        nb_line_rejected_";
  protected final String TEXT_233 = "++;";
  protected final String TEXT_234 = NL + "                        ";
  protected final String TEXT_235 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_236 = NL + "                        ";
  protected final String TEXT_237 = ".errorMessage = e.getMessage();";
  protected final String TEXT_238 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_239 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_240 = " == 0) {" + NL + "            \t";
  protected final String TEXT_241 = NL + "\t\t\t\tquery_";
  protected final String TEXT_242 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_253 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_254 = "++;" + NL + "                \t";
  protected final String TEXT_255 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_273 = ".errorMessage = e.getMessage();";
  ...
  protected final String TEXT_283 = NL + "            try {" + NL + "                deletedCount_";
  ...
  protected final String TEXT_306 = ".errorMessage = e.getMessage();";
  protected final String TEXT_307 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_308 = NL + "            }";
  protected final String TEXT_309 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_320 = NL + "                commitCounter_";
  protected final String TEXT_321 = "++;            " + NL + "                if (commitEvery_";
  protected final String TEXT_322 = " <= commitCounter_";
  protected final String TEXT_323 = ") {" + NL + "    \t\t\t\t";
  protected final String TEXT_324 = NL + "                    connection_";
  protected final String TEXT_325 = ".commit();";
  protected final String TEXT_326 = " " + NL + "                    commitCounter_";
