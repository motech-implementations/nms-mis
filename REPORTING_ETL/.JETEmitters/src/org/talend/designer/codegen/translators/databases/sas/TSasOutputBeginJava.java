...
public class TSasOutputBeginJava {
  ...
  protected final String TEXT_47 = NL + "        int updateKeyCount_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_50 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_51 = NL + "        int deleteKeyCount_";
  ...
  protected final String TEXT_63 = " = 0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_64 = " = false;" + NL;
  protected final String TEXT_65 = NL + "\tjava.sql.Connection connection_";
  protected final String TEXT_66 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_67 = "\");" + NL + "\t";
  protected final String TEXT_68 = NL + "\t";
  protected final String TEXT_69 = NL + "    java.lang.Class.forName(";
  ...
  protected final String TEXT_85 = ";" + NL + "\tjava.util.Properties property_";
  protected final String TEXT_86 = " = new java.util.Properties();" + NL + "\t" + NL + "\t";
  protected final String TEXT_87 = NL + "\t\tString librefs_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "\t\tproperty_";
  protected final String TEXT_90 = ".setProperty(\"librefs\", librefs_";
  protected final String TEXT_91 = ");" + NL + "\t";
  protected final String TEXT_92 = NL + "\tproperty_";
  protected final String TEXT_93 = ".setProperty(\"username\", dbUser_";
  protected final String TEXT_94 = ");" + NL + "\tproperty_";
  protected final String TEXT_95 = ".setProperty(\"password\", dbPwd_";
  protected final String TEXT_96 = ");" + NL + "\t";
  protected final String TEXT_97 = NL + "\t\t\tproperty_";
  protected final String TEXT_98 = ".setProperty(String.valueOf(";
  protected final String TEXT_99 = "), String.valueOf(";
  protected final String TEXT_100 = "));" + NL + "\t\t";
  protected final String TEXT_101 = "\t" + NL + "    java.sql.Connection connection_";
  protected final String TEXT_102 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_103 = ", property_";
  protected final String TEXT_104 = ");" + NL + "\t";
  protected final String TEXT_105 = "    " + NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_106 = "\", connection_";
  protected final String TEXT_107 = ");";
  protected final String TEXT_108 = NL + "//        connection_";
  ...
  protected final String TEXT_113 = NL + "\tjava.sql.Statement statementClear_";
  protected final String TEXT_114 = " = connection_";
  protected final String TEXT_115 = ".createStatement();" + NL + "\tdeletedCount_";
  protected final String TEXT_116 = " = deletedCount_";
  protected final String TEXT_117 = " + statementClear_";
  protected final String TEXT_118 = ".executeUpdate(\"delete from \" + ";
  ...
  protected final String TEXT_126 = ".prepareStatement(insert_";
  protected final String TEXT_127 = ");" + NL + "\t\t";
  protected final String TEXT_128 = NL + "\t\tString update_";
  protected final String TEXT_129 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_134 = ".prepareStatement(update_";
  protected final String TEXT_135 = ");" + NL + "\t\t";
  protected final String TEXT_136 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_137 = " = connection_";
  protected final String TEXT_138 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_139 = " + \" WHERE ";
  protected final String TEXT_140 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_141 = " = \"INSERT INTO \" + ";
  protected final String TEXT_142 = " + \" (";
  protected final String TEXT_143 = ") VALUES (";
  protected final String TEXT_144 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_145 = " = connection_";
  protected final String TEXT_146 = ".prepareStatement(insert_";
  protected final String TEXT_147 = ");" + NL + "\t\tString update_";
  protected final String TEXT_148 = " = \"UPDATE \" + ";
  protected final String TEXT_149 = " + \" SET ";
  protected final String TEXT_150 = " WHERE ";
  protected final String TEXT_151 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_152 = " = connection_";
  protected final String TEXT_153 = ".prepareStatement(update_";
  protected final String TEXT_154 = ");" + NL + "\t\t";
  protected final String TEXT_155 = NL + "\t\tString update_";
  protected final String TEXT_156 = " = \"UPDATE \" + ";
  protected final String TEXT_157 = " + \" SET ";
  protected final String TEXT_158 = " WHERE ";
  protected final String TEXT_159 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_160 = " = connection_";
  protected final String TEXT_161 = ".prepareStatement(update_";
  protected final String TEXT_162 = ");" + NL + "\t\tString insert_";
  protected final String TEXT_163 = " = \"INSERT INTO \" + ";
  protected final String TEXT_164 = " + \" (";
  protected final String TEXT_165 = ") VALUES (";
  protected final String TEXT_166 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_167 = " = connection_";
  protected final String TEXT_168 = ".prepareStatement(insert_";
  protected final String TEXT_169 = ");" + NL + "\t\t";
  protected final String TEXT_170 = NL + "\t\tString delete_";
  protected final String TEXT_171 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_175 = ".prepareStatement(delete_";
  protected final String TEXT_176 = ");" + NL + "\t\t";
  protected final String TEXT_177 = NL + "        StringBuffer query_";
  protected final String TEXT_178 = " = null;" + NL + "       \t";
  protected final String TEXT_179 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_180 = " = insert_";
  ...
  protected final String TEXT_186 = NL + "\t\t\tupdate_";
  protected final String TEXT_187 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_188 = " = update_";
  protected final String TEXT_189 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_190 = " = insert_";
  protected final String TEXT_191 = ".split(\"\\\\?\");";
  protected final String TEXT_192 = NL + "\t\t\tdelete_";
  protected final String TEXT_193 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_194 = " = delete_";
  protected final String TEXT_195 = ".split(\"\\\\?\");";
  protected final String TEXT_196 = NL + "\t\t\treplace_";
  protected final String TEXT_197 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_198 = " = replace_";
  protected final String TEXT_199 = ".split(\"\\\\?\");";
  protected final String TEXT_200 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_201 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_202 = " = insertIgnore_";
  protected final String TEXT_203 = ".split(\"\\\\?\");";
  protected final String TEXT_204 = NL + "\t\t \tString[] insertSQLSplits_";
