...
public class TSAPHanaOutputBeginJava {
  ...
  protected final String TEXT_52 = " < 1) {" + NL + "\t\t\tthrow new RuntimeException(\"For update, Schema must have a key\");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_53 = NL + "\t\tint deleteKeyCount_";
  protected final String TEXT_54 = " = ";
  protected final String TEXT_55 = ";" + NL + "\t\tif(deleteKeyCount_";
  protected final String TEXT_56 = " < 1) {" + NL + "\t\t\tthrow new RuntimeException(\"For delete, Schema must have a key\");" + NL + "\t\t}" + NL + "\t\t";
  ...
  protected final String TEXT_62 = " = 0;" + NL + "int tmp_batchUpdateCount_";
  protected final String TEXT_63 = " = 0;" + NL + "int deletedCount_";
  ...
  protected final String TEXT_67 = " = 0;" + NL + "boolean whetherReject_";
  protected final String TEXT_68 = " = false;" + NL + "String tableName_";
  ...
  protected final String TEXT_75 = NL + "\tjava.lang.Class.forName(\"com.sap.db.jdbc.Driver\");" + NL + "\t";
  ...
  protected final String TEXT_88 = ";" + NL + "" + NL + "\tString dbschema_";
  protected final String TEXT_89 = "= ";
  protected final String TEXT_90 = ";\t" + NL + "\tString dbProperties_";
  protected final String TEXT_91 = " = ";
  protected final String TEXT_92 = ";" + NL + "\tString url_";
  protected final String TEXT_93 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_94 = " + \":\" + ";
  protected final String TEXT_95 = ";" + NL + "\tif(dbProperties_";
  protected final String TEXT_96 = " != null && dbProperties_";
  protected final String TEXT_97 = ".trim().length() > 0) {" + NL + "\t\turl_";
  protected final String TEXT_98 = " = \"jdbc:sap://\" + ";
  protected final String TEXT_99 = " + \":\" + ";
  protected final String TEXT_100 = " + \"/?\" + dbProperties_";
  protected final String TEXT_101 = ";" + NL + "\t}" + NL + "\t";
  protected final String TEXT_102 = "\t" + NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_113 = ";" + NL + "\t\tint commitCounter_";
  protected final String TEXT_114 = " = 0;" + NL + "\t\t";
  protected final String TEXT_115 = NL;
  protected final String TEXT_116 = NL + "   int batchSize_";
  protected final String TEXT_117 = " = ";
  protected final String TEXT_118 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_119 = "=0;";
  protected final String TEXT_120 = NL + "tableName_";
  protected final String TEXT_121 = " = ";
  protected final String TEXT_122 = ";" + NL + "if(dbschema_";
  protected final String TEXT_123 = " != null && dbschema_";
  protected final String TEXT_124 = ".trim().length() > 0) {" + NL + "\ttableName_";
  protected final String TEXT_125 = " = dbschema_";
  protected final String TEXT_126 = " + \".\" + tableName_";
  ...
  protected final String TEXT_135 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_142 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_146 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_147 = "));";
  protected final String TEXT_148 = NL + "                    stmtCreate_";
  protected final String TEXT_149 = ".execute(((\"";
  protected final String TEXT_150 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_151 = ".";
  protected final String TEXT_152 = ", \"";
  protected final String TEXT_153 = "\")";
  protected final String TEXT_154 = ".toUpperCase()";
  ...
  protected final String TEXT_162 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_163 = " = conn_";
  protected final String TEXT_164 = ".createStatement();";
  protected final String TEXT_165 = NL + "                              stmtCreate_";
  protected final String TEXT_166 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_167 = "));";
  protected final String TEXT_168 = NL + "                    stmtCreate_";
  protected final String TEXT_169 = ".execute(((\"";
  protected final String TEXT_170 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_171 = ".";
  protected final String TEXT_172 = ", \"";
  protected final String TEXT_173 = "\")";
  protected final String TEXT_174 = ".toUpperCase()";
  ...
  protected final String TEXT_183 = NL + "                    String keyCheckTable_";
  protected final String TEXT_184 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_191 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_192 = " = conn_";
  protected final String TEXT_193 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_194 = " + \"]\";";
  protected final String TEXT_195 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_196 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_197 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_263 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_268 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_269 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_270 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_271 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_272 = ".close();";
  protected final String TEXT_273 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_274 = " = conn_";
  protected final String TEXT_275 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_276 = " = dbMetaData_";
  protected final String TEXT_277 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_278 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_279 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_280 = " == null || dbschema_";
  protected final String TEXT_281 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_284 = " = stmtSchema_";
  protected final String TEXT_285 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_286 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_287 = " = rsSchema_";
  protected final String TEXT_288 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_289 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_290 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_304 = " ==null || dbschema_";
  protected final String TEXT_305 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_306 = ".equals";
  protected final String TEXT_307 = "IgnoreCase";
  protected final String TEXT_308 = "(schema_";
  protected final String TEXT_309 = ")))) {" + NL + "                                        whetherExist_";
  protected final String TEXT_310 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_311 = ".close();";
  protected final String TEXT_312 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_313 = " = ";
  protected final String TEXT_314 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_315 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_316 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_317 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_318 = " =  tableForSearch_";
  protected final String TEXT_319 = ".substring(1,tableForSearch_";
  protected final String TEXT_320 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_321 = " =  tableForSearch_";
  protected final String TEXT_322 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_326 = ".getTables(null, conn_";
  protected final String TEXT_327 = ".getSchema(), tableForSearch_";
  protected final String TEXT_328 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_329 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_330 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_331 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_337 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_338 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_339 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_340 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_341 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_353 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_354 = ".equalsIgnoreCase(";
  protected final String TEXT_355 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_356 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_357 = ".close();";
  protected final String TEXT_358 = NL + "                                if(!whetherExist_";
  protected final String TEXT_359 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_366 = ".execute(((\"";
  protected final String TEXT_367 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_368 = ".";
  protected final String TEXT_369 = ", \"";
  protected final String TEXT_370 = "\")";
  protected final String TEXT_371 = ".toUpperCase()";
  ...
  protected final String TEXT_379 = NL + "                                if(whetherExist_";
  protected final String TEXT_380 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_381 = " = conn_";
  protected final String TEXT_382 = ".createStatement();";
  protected final String TEXT_383 = NL + "                                                      stmtDrop_";
  protected final String TEXT_384 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_391 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_399 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_407 = ".execute(\"";
  protected final String TEXT_408 = ")\");";
  protected final String TEXT_409 = NL + "                                stmtCreate_";
  protected final String TEXT_410 = ".close();";
  protected final String TEXT_411 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_412 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_413 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_423 = ".close();";
  protected final String TEXT_424 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_425 = " = conn_";
  protected final String TEXT_426 = ".createStatement();";
  protected final String TEXT_427 = NL + "                              stmtTruncCount_";
  protected final String TEXT_428 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_429 = "));";
  protected final String TEXT_430 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_431 = " = stmtTruncCount_";
  protected final String TEXT_432 = ".executeQuery(\"";
  protected final String TEXT_433 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_434 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_435 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_436 = " = rsTruncCount_";
  protected final String TEXT_437 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_438 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_439 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_450 = NL + "                if(!conn_";
  protected final String TEXT_451 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_452 = ".commit();" + NL + "                }";
  protected final String TEXT_453 = NL + "            deletedCount_";
  protected final String TEXT_454 = " += rsTruncCountNumber_";
  protected final String TEXT_455 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_456 = ".close();";
  protected final String TEXT_457 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_458 = " = conn_";
  protected final String TEXT_459 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_460 = " = stmtTruncCount_";
  protected final String TEXT_461 = ".executeQuery(\"";
  protected final String TEXT_462 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_463 = " = conn_";
  protected final String TEXT_464 = ".createStatement();";
  protected final String TEXT_465 = NL + "                conn_";
  protected final String TEXT_466 = ".commit();";
  protected final String TEXT_467 = NL + "            stmtTrunc_";
  protected final String TEXT_468 = ".executeUpdate(\"";
  protected final String TEXT_469 = "\");";
  protected final String TEXT_470 = NL + "            while(rsTruncCount_";
  protected final String TEXT_471 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_472 = " += rsTruncCount_";
  protected final String TEXT_473 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_474 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_475 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_566 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_567 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_568 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_569 = " =null;" + NL + "\t";
  protected final String TEXT_570 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_571 = " = null;" + NL + "\t\t";
  protected final String TEXT_572 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_577 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_581 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_582 = " = null;";
  protected final String TEXT_583 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_584 = " = null;";
  protected final String TEXT_585 = NL + "\t\t \tString[] insertSQLSplits_";
