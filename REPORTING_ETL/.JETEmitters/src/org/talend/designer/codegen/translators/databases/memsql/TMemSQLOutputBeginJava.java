...
public class TMemSQLOutputBeginJava {
  ...
  protected final String TEXT_47 = NL + "           int batchSize_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";" + NL + "           int batchSizeCounter_";
  protected final String TEXT_50 = "=0;";
  protected final String TEXT_51 = NL + "            java.util.Calendar calendar_";
  protected final String TEXT_52 = " = java.util.Calendar.getInstance();" + NL + "            calendar_";
  protected final String TEXT_53 = ".set(1, 0, 1, 0, 0, 0);" + NL + "            long year1_";
  protected final String TEXT_54 = " = calendar_";
  protected final String TEXT_55 = ".getTime().getTime();" + NL + "            calendar_";
  protected final String TEXT_56 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "            long year10000_";
  protected final String TEXT_57 = " = calendar_";
  protected final String TEXT_58 = ".getTime().getTime();" + NL + "            long date_";
  protected final String TEXT_59 = ";";
  protected final String TEXT_60 = NL + NL + "int nb_line_";
  protected final String TEXT_61 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_62 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_63 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_64 = " = 0;" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_69 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_70 = " = ";
  protected final String TEXT_71 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_72 = " = false;";
  protected final String TEXT_73 = NL;
  protected final String TEXT_74 = NL + "        int updateKeyCount_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_77 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_78 = NL + "        int deleteKeyCount_";
  protected final String TEXT_79 = " = ";
  protected final String TEXT_80 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_81 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_82 = NL;
  protected final String TEXT_83 = NL + "    java.sql.Connection conn_";
  protected final String TEXT_84 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_85 = "\");";
  protected final String TEXT_86 = NL + "    String url_";
  protected final String TEXT_87 = " =\"jdbc:mysql://\" + ";
  ...
  protected final String TEXT_106 = ";" + NL + "" + NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_107 = "\");";
  protected final String TEXT_108 = NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_113 = NL + "    resourceMap.put(\"conn_";
  ...
  protected final String TEXT_123 = NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".createStatement();";
  ...
  protected final String TEXT_146 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  protected final String TEXT_147 = NL + "                if(!whetherExist_";
  protected final String TEXT_148 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_156 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_162 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_168 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();";
  protected final String TEXT_171 = NL + "            deletedCount_";
  protected final String TEXT_172 = " = deletedCount_";
  protected final String TEXT_173 = " + stmtClear_";
  protected final String TEXT_174 = ".executeUpdate(\"";
  protected final String TEXT_175 = "\");";
  protected final String TEXT_176 = NL + "\t    String insert_";
  protected final String TEXT_177 = " = \"INSERT INTO \" + ";
  protected final String TEXT_178 = " + \" (";
  protected final String TEXT_179 = ") VALUES (";
  protected final String TEXT_180 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_181 = " = conn_";
  protected final String TEXT_182 = ".prepareStatement(insert_";
  protected final String TEXT_183 = ");" + NL + "\t    ";
  protected final String TEXT_184 = NL + "\t    String update_";
  protected final String TEXT_185 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_190 = ".prepareStatement(update_";
  protected final String TEXT_191 = ");" + NL + "\t    ";
  protected final String TEXT_192 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_195 = " + \" WHERE ";
  protected final String TEXT_196 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_197 = " = \"INSERT INTO \" + ";
  protected final String TEXT_198 = " + \" (";
  protected final String TEXT_199 = ") VALUES (";
  protected final String TEXT_200 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_201 = " = conn_";
  protected final String TEXT_202 = ".prepareStatement(insert_";
  protected final String TEXT_203 = ");" + NL + "\t    String update_";
  protected final String TEXT_204 = " = \"UPDATE \" + ";
  protected final String TEXT_205 = " + \" SET ";
  protected final String TEXT_206 = " WHERE ";
  protected final String TEXT_207 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".prepareStatement(update_";
  protected final String TEXT_210 = ");" + NL + "\t    ";
  protected final String TEXT_211 = NL + "\t    String update_";
  protected final String TEXT_212 = " = \"UPDATE \" + ";
  protected final String TEXT_213 = " + \" SET ";
  protected final String TEXT_214 = " WHERE ";
  protected final String TEXT_215 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_216 = " = conn_";
  protected final String TEXT_217 = ".prepareStatement(update_";
  protected final String TEXT_218 = ");" + NL + "\t    String insert_";
  protected final String TEXT_219 = " = \"INSERT INTO \" + ";
  protected final String TEXT_220 = " + \" (";
  protected final String TEXT_221 = ") VALUES (";
  protected final String TEXT_222 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_223 = " = conn_";
  protected final String TEXT_224 = ".prepareStatement(insert_";
  protected final String TEXT_225 = ");" + NL + "\t    ";
  protected final String TEXT_226 = NL + "\t    String delete_";
  protected final String TEXT_227 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_228 = " + \" WHERE ";
  protected final String TEXT_229 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".prepareStatement(delete_";
  protected final String TEXT_232 = ");" + NL + "\t    ";
  protected final String TEXT_233 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_234 = " = null;" + NL + "       \t";
  protected final String TEXT_235 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_245 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_246 = " = insert_";
  protected final String TEXT_247 = ".split(\"\\\\?\");";
  protected final String TEXT_248 = NL + "\t\t\tdelete_";
  protected final String TEXT_249 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_250 = " = delete_";
  protected final String TEXT_251 = ".split(\"\\\\?\");";
  protected final String TEXT_252 = NL + "\t\t\treplace_";
  protected final String TEXT_253 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_254 = " = replace_";
  protected final String TEXT_255 = ".split(\"\\\\?\");";
  protected final String TEXT_256 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_257 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_258 = " = insertIgnore_";
  protected final String TEXT_259 = ".split(\"\\\\?\");";
  protected final String TEXT_260 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_261 = " = insert_";
