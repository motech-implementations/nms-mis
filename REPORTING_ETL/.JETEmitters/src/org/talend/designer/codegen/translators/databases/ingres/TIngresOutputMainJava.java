...
public class TIngresOutputMainJava {
  ...
  protected final String TEXT_68 = ".addBatch();" + NL + "                      batchSizeCounter_";
  protected final String TEXT_69 = "++;" + NL + "                      nb_line_";
  protected final String TEXT_70 = "++;";
  protected final String TEXT_71 = NL + "                      try {" + NL + "                          insertedCount_";
  protected final String TEXT_72 = " = insertedCount_";
  protected final String TEXT_73 = " + pstmt_";
  protected final String TEXT_74 = ".executeUpdate();" + NL + "                          nb_line_";
  ...
  protected final String TEXT_87 = NL + "                                  rejectedCount_";
  protected final String TEXT_88 = " = rejectedCount_";
  ...
  protected final String TEXT_169 = "_QUERY\", query_";
  protected final String TEXT_170 = ".toString().trim());";
  protected final String TEXT_171 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_172 = " = updatedCount_";
  protected final String TEXT_173 = " + pstmtUpdate_";
  ...
  protected final String TEXT_198 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_199 = NL + "                        ";
  protected final String TEXT_200 = NL + "                            query_";
  protected final String TEXT_201 = " = ";
  protected final String TEXT_202 = ";";
  protected final String TEXT_203 = NL + "                    globalMap.put(\"";
  protected final String TEXT_204 = "_QUERY\", query_";
  protected final String TEXT_205 = ".toString().trim());";
  protected final String TEXT_206 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_207 = " = insertedCount_";
  protected final String TEXT_208 = " + pstmtInsert_";
  protected final String TEXT_209 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_210 = "++;";
  protected final String TEXT_211 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_224 = NL + "                            rejectedCount_";
  protected final String TEXT_225 = " = rejectedCount_";
  protected final String TEXT_226 = " + 1;";
  protected final String TEXT_227 = NL + "                            ";
  protected final String TEXT_228 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_229 = NL + "                            ";
  protected final String TEXT_230 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_231 = ";";
  protected final String TEXT_232 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_233 = NL + "                }" + NL + "            }";
  protected final String TEXT_234 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_246 = NL + "                        query_";
  protected final String TEXT_247 = " = ";
  protected final String TEXT_248 = ";";
  protected final String TEXT_249 = NL + "                globalMap.put(\"";
  protected final String TEXT_250 = "_QUERY\", query_";
  protected final String TEXT_251 = ".toString().trim());";
  ...
  protected final String TEXT_257 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_258 = " == 0) {";
  protected final String TEXT_259 = NL + "                query_";
  ...
  protected final String TEXT_266 = "_QUERY\", query_";
  protected final String TEXT_267 = ".toString().trim());";
  protected final String TEXT_268 = NL + "                    insertedCount_";
  protected final String TEXT_269 = " = insertedCount_";
  protected final String TEXT_270 = " + pstmtInsert_";
  protected final String TEXT_271 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_272 = "++;";
  protected final String TEXT_273 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_274 = "++;";
  protected final String TEXT_275 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_276 = " = true;";
  protected final String TEXT_277 = NL + "                        throw(e);";
  ...
  protected final String TEXT_288 = NL + "                            rejectedCount_";
  protected final String TEXT_289 = " = rejectedCount_";
  protected final String TEXT_290 = " + 1;";
  protected final String TEXT_291 = NL + "                            ";
  protected final String TEXT_292 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_293 = NL + "                            ";
  protected final String TEXT_294 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_295 = ";";
  protected final String TEXT_296 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_306 = NL + "                globalMap.put(\"";
  protected final String TEXT_307 = "_QUERY\", query_";
  protected final String TEXT_308 = ".toString().trim());";
  protected final String TEXT_309 = NL;
  protected final String TEXT_310 = NL + "                       pstmt_";
  protected final String TEXT_311 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_312 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_313 = "++;";
  protected final String TEXT_314 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_315 = " = deletedCount_";
  protected final String TEXT_316 = " + pstmt_";
  protected final String TEXT_317 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_318 = "++;";
  protected final String TEXT_319 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  protected final String TEXT_320 = " = true;";
  protected final String TEXT_321 = NL + "                               throw(e);";
  protected final String TEXT_322 = NL + "                               nb_line_";
  ...
  protected final String TEXT_332 = NL + "                                   rejectedCount_";
  protected final String TEXT_333 = " = rejectedCount_";
  protected final String TEXT_334 = " + 1;";
  ...
  protected final String TEXT_353 = NL + "                if ((batchSize_";
  protected final String TEXT_354 = " > 0) && (batchSize_";
  protected final String TEXT_355 = " <= batchSizeCounter_";
  protected final String TEXT_356 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_357 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_358 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_359 = " = 0;";
  protected final String TEXT_360 = NL + "                        status_";
  protected final String TEXT_361 = " = pstmt_";
  protected final String TEXT_362 = ".executeBatch();";
  protected final String TEXT_363 = NL + "                        for(int countEach_";
  protected final String TEXT_364 = ": status_";
  protected final String TEXT_365 = ") {" + NL + "                            countSum_";
  protected final String TEXT_366 = " += (countEach_";
  protected final String TEXT_367 = " < 0 ? 0 : countEach_";
  protected final String TEXT_368 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_369 = NL + "                            throw(e);";
  protected final String TEXT_370 = NL + "                        for(int countEach_";
  protected final String TEXT_371 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_376 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_377 = " = pstmt_";
  protected final String TEXT_378 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_379 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  ...
  protected final String TEXT_385 = NL + "                        insertedCount_";
  protected final String TEXT_386 = " += tmp_batchUpdateCount_";
  protected final String TEXT_387 = ";";
  protected final String TEXT_388 = NL + "                        updatedCount_";
  protected final String TEXT_389 = " += tmp_batchUpdateCount_";
  protected final String TEXT_390 = ";";
  protected final String TEXT_391 = NL + "                        deletedCount_";
  protected final String TEXT_392 = " += tmp_batchUpdateCount_";
  protected final String TEXT_393 = ";";
  protected final String TEXT_394 = NL + "               }";
  protected final String TEXT_395 = NL + "                commitCounter_";
  protected final String TEXT_396 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_397 = " <= commitCounter_";
  protected final String TEXT_398 = ") {";
  protected final String TEXT_399 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_400 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_401 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_402 = NL + "\t                    for(int countEach_";
  protected final String TEXT_403 = ": pstmt_";
  protected final String TEXT_404 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_405 = " += (countEach_";
  protected final String TEXT_406 = " < 0 ? 0 : countEach_";
  protected final String TEXT_407 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_408 = NL + "\t                    ";
  protected final String TEXT_409 = NL + "\t                        insertedCount_";
  protected final String TEXT_410 = " += countSum_";
  protected final String TEXT_411 = ";" + NL + "\t                    ";
  protected final String TEXT_412 = NL + "\t                        updatedCount_";
  protected final String TEXT_413 = " += countSum_";
  protected final String TEXT_414 = ";" + NL + "\t                    ";
  protected final String TEXT_415 = NL + "\t                        deletedCount_";
  ...
  protected final String TEXT_419 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_420 = NL + "                        throw(e);";
  protected final String TEXT_421 = NL + "                        int countSum_";
  protected final String TEXT_422 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_423 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_424 = " += (countEach_";
  protected final String TEXT_425 = " < 0 ? 0 : countEach_";
  protected final String TEXT_426 = ");" + NL + "                        }";
  protected final String TEXT_427 = NL + "                            insertedCount_";
  protected final String TEXT_428 = " += countSum_";
  protected final String TEXT_429 = ";";
  protected final String TEXT_430 = NL + "                            updatedCount_";
  protected final String TEXT_431 = " += countSum_";
  protected final String TEXT_432 = ";";
  protected final String TEXT_433 = NL + "                            deletedCount_";
  protected final String TEXT_434 = " += countSum_";
  protected final String TEXT_435 = ";";
  protected final String TEXT_436 = NL + "                        System.err.println(e.getMessage());";
  ...
  protected final String TEXT_441 = NL + "                commitCounter_";
  protected final String TEXT_442 = "=0;" + NL + "            }";
