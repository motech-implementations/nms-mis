...
public class TMaxDBOutputMainJava {
  ...
  protected final String TEXT_100 = "_QUERY\", query_";
  protected final String TEXT_101 = ".toString().trim());";
  ...
  protected final String TEXT_107 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_129 = " = pstmt_";
  protected final String TEXT_130 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_131 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_132 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_133 = " = rs_";
  protected final String TEXT_134 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_152 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_153 = " = updatedCount_";
  protected final String TEXT_154 = " + pstmtUpdate_";
  protected final String TEXT_155 = ".executeUpdate();" + NL + "        \t\t\tnb_line_";
  protected final String TEXT_156 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_157 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_158 = " = true;";
  protected final String TEXT_159 = NL + "                        throw(e);";
  ...
  protected final String TEXT_167 = NL + "                            nb_line_rejected_";
  protected final String TEXT_168 = "++;";
  protected final String TEXT_169 = NL + "                            ";
  protected final String TEXT_170 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_175 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_198 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_230 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_246 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_272 = NL + "                            nb_line_rejected_";
  ...
  protected final String TEXT_280 = NL + "                }" + NL + "            }else{" + NL + "                 nb_line_";
  ...
  protected final String TEXT_293 = "_QUERY\", query_";
  protected final String TEXT_294 = ".toString().trim());";
  protected final String TEXT_295 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_296 = " = deletedCount_";
  protected final String TEXT_297 = " + pstmt_";
  protected final String TEXT_298 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_299 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_300 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_301 = " = true;";
  protected final String TEXT_302 = NL + "                    throw(e);";
  ...
  protected final String TEXT_313 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_314 = NL + "                        ";
  protected final String TEXT_315 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_316 = ";";
  protected final String TEXT_317 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_318 = NL + "            }           " + NL + "    \t";
  protected final String TEXT_319 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_327 = NL + "            commitCounter_";
  protected final String TEXT_328 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_329 = " <= commitCounter_";
  protected final String TEXT_330 = ") {" + NL + "            " + NL + "            \t";
  protected final String TEXT_331 = NL + "            \tconn_";
  protected final String TEXT_332 = ".commit();" + NL + "            \t";
  protected final String TEXT_333 = NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_334 = "=0;" + NL + "            " + NL + "            }\t" + NL + "    \t";
