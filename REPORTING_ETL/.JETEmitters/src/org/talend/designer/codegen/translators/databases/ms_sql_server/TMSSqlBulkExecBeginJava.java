...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_47 = NL + "int deletedCount_";
  protected final String TEXT_48 = "=0;";
  protected final String TEXT_49 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_50 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_52 = " - Retrieved records count: \"+ nb_line_";
  protected final String TEXT_53 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_54 = NL + "\t\t\t\tlog.debug(\"";
  protected final String TEXT_55 = " - Retrieved records count: \"+ globalMap.get(\"";
  protected final String TEXT_56 = "_NB_LINE\") + \" .\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_61 = " - Written records count: \" + nb_line_";
  ...
  protected final String TEXT_75 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_76 = " + \" .\");" + NL + "\t\t\t";
  protected final String TEXT_77 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_78 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_79 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_81 = " - Uses an existing connection ";
  protected final String TEXT_82 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_84 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_85 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_86 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_90 = ", dbUser_";
  protected final String TEXT_91 = ", dbPwd_";
  protected final String TEXT_92 = ");" + NL + "\t\t\t";
  protected final String TEXT_93 = NL + "\t\t\tconn_";
  protected final String TEXT_94 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\tconn_";
  protected final String TEXT_96 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\tconn_";
  protected final String TEXT_98 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\tconn_";
  protected final String TEXT_100 = ".setAutoCommit(";
  ...
  protected final String TEXT_110 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_111 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_112 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_113 = ": pstmt_";
  protected final String TEXT_114 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_115 = " += (countEach_";
  protected final String TEXT_116 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_126 = NL + "\t" + NL + "\tStringBuffer command_";
  protected final String TEXT_127 = " = new StringBuffer();" + NL + "\tcommand_";
  protected final String TEXT_128 = ".append(";
  protected final String TEXT_129 = ")" + NL + "\t\t.append(\" \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_130 = ")" + NL + "\t\t.append(\"\\\" queryout \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_131 = ")" + NL + "\t\t.append(\"\\\" \")" + NL + "\t\t.append(\"";
  protected final String TEXT_132 = "\")" + NL + "\t";
  protected final String TEXT_133 = NL + "\t\t.append(\" -S\")" + NL + "\t\t.append(";
  protected final String TEXT_134 = ")" + NL + "\t";
  protected final String TEXT_135 = NL + "\t\t.append(\" -T\")" + NL + "\t";
  protected final String TEXT_136 = NL + "\t\t.append(\" -U\")" + NL + "\t\t.append(";
  protected final String TEXT_137 = ")" + NL + "\t\t.append(\" -P\")" + NL + "\t\t.append(decryptedPassword_";
  protected final String TEXT_138 = ")" + NL + "\t";
  protected final String TEXT_139 = NL + "\t\t.append(\" -t\")" + NL + "\t\t.append(";
  protected final String TEXT_140 = ")" + NL + "\t\t.append(\" -r\")" + NL + "\t\t.append(";
  protected final String TEXT_141 = ");" + NL + "\t" + NL + "\tRuntime runtime_";
  protected final String TEXT_142 = " = Runtime.getRuntime();" + NL + "\t";
  protected final String TEXT_143 = NL + "\tfinal Process ps";
  protected final String TEXT_144 = " = runtime_";
  protected final String TEXT_145 = ".exec(command_";
  protected final String TEXT_146 = ".toString());" + NL + "\tThread normal_";
  protected final String TEXT_147 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_148 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_151 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_152 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_155 = ".start();" + NL + "\tThread error_";
  protected final String TEXT_156 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_157 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_160 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_161 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_162 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_163 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_164 = ".start();" + NL + "\tps";
  protected final String TEXT_165 = ".waitFor();" + NL + "\tnormal_";
  protected final String TEXT_166 = ".interrupt();" + NL + "\terror_";
  protected final String TEXT_167 = ".interrupt();" + NL + "\t";
  protected final String TEXT_168 = NL + "\tString dbschema_";
  protected final String TEXT_169 = " = \"\";" + NL + "\t";
  protected final String TEXT_170 = NL + "java.sql.Connection conn_";
  protected final String TEXT_171 = " = null;";
  protected final String TEXT_172 = NL + "String dbUser_";
  protected final String TEXT_173 = " = null;";
  protected final String TEXT_174 = NL + "\tdbschema_";
  protected final String TEXT_175 = " = (String)globalMap.get(\"";
  protected final String TEXT_176 = "\");" + NL + "\tconn_";
  protected final String TEXT_177 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_178 = "\");" + NL + "\t";
  protected final String TEXT_179 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_180 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_181 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_182 = " = ";
  protected final String TEXT_183 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_184 = ".get(dsAlias_";
  protected final String TEXT_185 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_186 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_187 = " = dataSources_";
  protected final String TEXT_188 = ".get(dsAlias_";
  protected final String TEXT_189 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_190 = NL + "    dbschema_";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";";
  protected final String TEXT_193 = NL + "    String driverClass_";
  protected final String TEXT_194 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_195 = NL + "    String driverClass_";
  protected final String TEXT_196 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_197 = NL + "\t";
  protected final String TEXT_198 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_199 = ");" + NL + "    String port_";
  protected final String TEXT_200 = " = ";
  protected final String TEXT_201 = ";" + NL + "    String dbname_";
  protected final String TEXT_202 = " = ";
  protected final String TEXT_203 = " ;";
  protected final String TEXT_204 = NL + "    String url_";
  protected final String TEXT_205 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_206 = " ;";
  protected final String TEXT_207 = NL + "    String url_";
  protected final String TEXT_208 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_209 = " ;";
  protected final String TEXT_210 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_211 = ")) {" + NL + "    \turl_";
  protected final String TEXT_212 = " += \":\" + ";
  protected final String TEXT_213 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_214 = ")) {";
  protected final String TEXT_215 = NL + "\t\t\t\turl_";
  protected final String TEXT_216 = " += \"//\" + ";
  protected final String TEXT_217 = "; " + NL + "\t";
  protected final String TEXT_218 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_219 = " += \";databaseName=\" + ";
  protected final String TEXT_220 = "; " + NL + "\t";
  protected final String TEXT_221 = NL + "    }" + NL + "    url_";
  protected final String TEXT_222 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_223 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_233 = NL + NL + "    String dbPwd_";
  protected final String TEXT_234 = " = decryptedPassword_";
  protected final String TEXT_235 = ";";
  protected final String TEXT_236 = "\t" + NL + "    conn_";
  protected final String TEXT_237 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_238 = ",dbUser_";
  protected final String TEXT_239 = ",dbPwd_";
  protected final String TEXT_240 = ");";
  protected final String TEXT_241 = NL + "\t";
  protected final String TEXT_242 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_243 = NL + "\tString tableName_";
  protected final String TEXT_244 = " = null;\t" + NL + "\tif(dbschema_";
  protected final String TEXT_245 = " == null || dbschema_";
  protected final String TEXT_246 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_247 = " = ";
  protected final String TEXT_248 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_257 = " - Droping table ";
  protected final String TEXT_258 = "\" + tableName_";
  ...
  protected final String TEXT_265 = " - Drop table ";
  protected final String TEXT_266 = "\" + tableName_";
  protected final String TEXT_267 = " + \"";
  protected final String TEXT_268 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_270 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_274 = " - Creating table ";
  protected final String TEXT_275 = "\" + tableName_";
  ...
  protected final String TEXT_282 = " - Create table ";
  protected final String TEXT_283 = "\" + tableName_";
  ...
  protected final String TEXT_292 = " - Creating table ";
  protected final String TEXT_293 = "\" + tableName_";
  ...
  protected final String TEXT_300 = " - Create table ";
  protected final String TEXT_301 = "\" + tableName_";
  ...
  protected final String TEXT_309 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_310 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_311 = " = tableNameForSearch_";
  protected final String TEXT_312 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_313 = " = tableNameForSearch_";
  protected final String TEXT_314 = ".replaceAll(\"\\\"\",\"\");" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_315 = " = dbMetaData_";
  protected final String TEXT_316 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_317 = ", tableNameForSearch_";
  protected final String TEXT_318 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_319 = " = false;" + NL + "\t\t\t\tif(rsTable_";
  protected final String TEXT_320 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_321 = " = true;" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_322 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_323 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_324 = " = conn_";
  protected final String TEXT_325 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_326 = " = dbMetaData_";
  protected final String TEXT_327 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_328 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_335 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_336 = ".equalsIgnoreCase(dbschema_";
  protected final String TEXT_337 = ") || dbschema_";
  protected final String TEXT_338 = ".trim().length() ==0)) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_339 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_340 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_341 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_342 = " = conn_";
  protected final String TEXT_343 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_344 = " = dbMetaData_";
  protected final String TEXT_345 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_346 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_347 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_348 = " = rsTable_";
  protected final String TEXT_349 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  protected final String TEXT_350 = " = rsTable_";
  protected final String TEXT_351 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_352 = ".equals(";
  protected final String TEXT_353 = ") " + NL + "\t\t\t\t\t\t&& (bkSchema_";
  protected final String TEXT_354 = ".equals(schema_";
  protected final String TEXT_355 = ") || (schema_";
  protected final String TEXT_356 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_357 = ".equalsIgnoreCase(bkSchema_";
  ...
  protected final String TEXT_366 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_367 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_368 = " == null || dbschema_";
  protected final String TEXT_369 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_370 = " = conn_";
  protected final String TEXT_371 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_372 = " = stmtSchema_";
  protected final String TEXT_373 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_374 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_375 = " = rsSchema_";
  protected final String TEXT_376 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_377 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_378 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_379 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_380 = " = rsTable_";
  protected final String TEXT_381 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString schema_";
  protected final String TEXT_382 = " = rsTable_";
  protected final String TEXT_383 = ".getString(\"TABLE_SCHEM\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_384 = ".equals";
  protected final String TEXT_385 = "IgnoreCase";
  protected final String TEXT_386 = "(";
  protected final String TEXT_387 = ") " + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_388 = ".equals";
  protected final String TEXT_389 = "IgnoreCase";
  protected final String TEXT_390 = "(dbschema_";
  protected final String TEXT_391 = ") || ((dbschema_";
  protected final String TEXT_392 = " ==null || dbschema_";
  protected final String TEXT_393 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_394 = ".equals";
  protected final String TEXT_395 = "IgnoreCase";
  protected final String TEXT_396 = "(schema_";
  protected final String TEXT_397 = ")))) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_398 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_399 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_400 = NL + "            \tString tableForSearch_";
  protected final String TEXT_401 = " = ";
  protected final String TEXT_402 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_403 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_404 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_405 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_406 = " =  tableForSearch_";
  protected final String TEXT_407 = ".substring(1,tableForSearch_";
  protected final String TEXT_408 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_409 = " =  tableForSearch_";
  protected final String TEXT_410 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_414 = ".getTables(null, conn_";
  protected final String TEXT_415 = ".getSchema(), tableForSearch_";
  protected final String TEXT_416 = ", new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_417 = " = false;" + NL + "               \tif(rsTable_";
  protected final String TEXT_418 = ".next()) {" + NL + "\t\t\t\t\twhetherExist_";
  protected final String TEXT_419 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_420 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_421 = NL + "\t\t\t\tjava.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_422 = " = conn_";
  protected final String TEXT_423 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  protected final String TEXT_424 = " = dbMetaData_";
  protected final String TEXT_425 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_426 = " = false;" + NL + "\t\t\t\twhile(rsTable_";
  protected final String TEXT_427 = ".next()) {" + NL + "\t\t\t\t\tString table_";
  protected final String TEXT_428 = " = rsTable_";
  protected final String TEXT_429 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tif(table_";
  protected final String TEXT_430 = ".equals";
  protected final String TEXT_431 = "IgnoreCase";
  protected final String TEXT_432 = "(";
  protected final String TEXT_433 = ")) {" + NL + "\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_434 = " = true;" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\trsTable_";
  protected final String TEXT_435 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_437 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_438 = " = conn_";
  protected final String TEXT_439 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_440 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_441 = " - Creating table ";
  ...
  protected final String TEXT_449 = " - Create table ";
  ...
  protected final String TEXT_454 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_455 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_456 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_460 = " - Droping table ";
  protected final String TEXT_461 = "\" + tableName_";
  protected final String TEXT_462 = " + \"";
  protected final String TEXT_463 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_464 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_465 = ".execute(\"";
  protected final String TEXT_466 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_467 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_468 = " - Drop table ";
  protected final String TEXT_469 = "\" + tableName_";
  protected final String TEXT_470 = " + \"";
  protected final String TEXT_471 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_472 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_473 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_477 = " - Creating table ";
  protected final String TEXT_478 = "\" + tableName_";
  protected final String TEXT_479 = " + \"";
  protected final String TEXT_480 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_481 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_482 = ".execute(\"";
  protected final String TEXT_483 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_484 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_485 = " - Create table ";
  ...
  protected final String TEXT_490 = ".close();" + NL + "\t\t\t";
  ...
  protected final String TEXT_495 = " - Clearing table ";
  protected final String TEXT_496 = "\" + tableName_";
  protected final String TEXT_497 = " + \"";
  protected final String TEXT_498 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_499 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_500 = ".executeUpdate(\"";
  protected final String TEXT_501 = "\");" + NL + "\t\t\t";
  protected final String TEXT_502 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_503 = "- Clear table ";
  protected final String TEXT_504 = "\" + tableName_";
  protected final String TEXT_505 = " + \"";
  protected final String TEXT_506 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_507 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_508 = ".close();" + NL + "\t\t";
  protected final String TEXT_509 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_510 = " = conn_";
  protected final String TEXT_511 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_512 = " = stmtTruncCount_";
  protected final String TEXT_513 = ".executeQuery(\"";
  protected final String TEXT_514 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_515 = " = conn_";
  protected final String TEXT_516 = ".createStatement();" + NL + "\t\t\t";
  protected final String TEXT_517 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_518 = " - Trancating table ";
  protected final String TEXT_519 = "\" + tableName_";
  ...
  protected final String TEXT_526 = " - Truncate table ";
  protected final String TEXT_527 = "\" + tableName_";
  protected final String TEXT_528 = " + \"";
  protected final String TEXT_529 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_530 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_531 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_532 = " += rsTruncCount_";
  protected final String TEXT_533 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_534 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_535 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_536 = ".close();" + NL + "\t\t";
  protected final String TEXT_537 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_538 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_539 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_540 = NL + "    \t";
  protected final String TEXT_541 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_542 = " = conn_";
  protected final String TEXT_543 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_544 = " = \"BULK INSERT ";
  protected final String TEXT_545 = "\" + tableName_";
  protected final String TEXT_546 = " + \"";
  protected final String TEXT_547 = " FROM '\" + ";
  protected final String TEXT_548 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_549 = " + \"',DATAFILETYPE='";
  protected final String TEXT_550 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_551 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_552 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_553 = "+\"')\";" + NL + "    \t\t";
  protected final String TEXT_554 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_555 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_556 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_557 = " - Bulk inserting data into ";
  protected final String TEXT_558 = "\" + tableName_";
  protected final String TEXT_559 = " + \"";
  protected final String TEXT_560 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_561 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_562 = ".execute(bulkSQL_";
  protected final String TEXT_563 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_564 = ".close();" + NL + "    \t\t";
  protected final String TEXT_565 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_566 = " - Bulk insert data into ";
  protected final String TEXT_567 = "\" + tableName_";
  protected final String TEXT_568 = " + \"";
  protected final String TEXT_569 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_570 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_571 = " = ";
  protected final String TEXT_572 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_573 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_574 = " = tableName_";
  protected final String TEXT_575 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_576 = " = \"tmp_";
  protected final String TEXT_577 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_578 = " = conn_";
  protected final String TEXT_579 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_580 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_581 = " - Creating temp table ";
  protected final String TEXT_582 = "\" + tableName_";
  protected final String TEXT_583 = " + \"";
  protected final String TEXT_584 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_585 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_586 = ".execute(\"";
  protected final String TEXT_587 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_588 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_589 = " - Create temp table ";
  protected final String TEXT_590 = "\" + tableName_";
  protected final String TEXT_591 = " + \"";
  protected final String TEXT_592 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_593 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_594 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_595 = " = conn_";
  protected final String TEXT_596 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_597 = " = \"BULK INSERT ";
  protected final String TEXT_598 = "\" + tableName_";
  protected final String TEXT_599 = " + \"";
  protected final String TEXT_600 = " FROM '\" + ";
  protected final String TEXT_601 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_602 = " + \"',DATAFILETYPE='";
  protected final String TEXT_603 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_604 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_605 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_606 = "+\"')\";" + NL + "    \t\t\t";
  protected final String TEXT_607 = NL + "    \t\t\t\tlog.debug(\"";
  protected final String TEXT_608 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_609 = "+\".\");" + NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_610 = " - Bulk inserting data into ";
  protected final String TEXT_611 = "\" + tableName_";
  protected final String TEXT_612 = " + \"";
  protected final String TEXT_613 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_614 = NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_615 = ".execute(bulkSQL_";
  protected final String TEXT_616 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_617 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_618 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_619 = " - Bulk insert data into ";
  protected final String TEXT_620 = "\" + tableName_";
  protected final String TEXT_621 = " + \"";
  protected final String TEXT_622 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_623 = NL + "    \t\t\ttableName_";
  protected final String TEXT_624 = " = tmpTableName_";
  protected final String TEXT_625 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_626 = " = \"tmp_";
  protected final String TEXT_627 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_628 = " = conn_";
  protected final String TEXT_629 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_630 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_631 = " - Updating ";
  protected final String TEXT_632 = "\" + tableName_";
  protected final String TEXT_633 = " + \"";
  protected final String TEXT_634 = " from ";
  protected final String TEXT_635 = "\"+tmpTableName_";
  protected final String TEXT_636 = "+\"";
  protected final String TEXT_637 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_638 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_639 = ".executeUpdate(\"";
  protected final String TEXT_640 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_641 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_642 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_643 = " = \"tmp_";
  protected final String TEXT_644 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_645 = " = conn_";
  protected final String TEXT_646 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_647 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_648 = " - Droping temp table ";
  protected final String TEXT_649 = "\" + tableName_";
  protected final String TEXT_650 = " + \"";
  protected final String TEXT_651 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_652 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_653 = ".execute(\"";
  protected final String TEXT_654 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_655 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_656 = " - Drop temp table ";
  protected final String TEXT_657 = "\" + tableName_";
  protected final String TEXT_658 = "+ \"";
  protected final String TEXT_659 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_660 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_661 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_662 = NL + "\t\tif(conn_";
  protected final String TEXT_663 = " != null && !conn_";
  protected final String TEXT_664 = ".isClosed()) {" + NL + "\t\t   ";
