...
public class TImpalaOutputMainJava {
  ...
  protected final String TEXT_50 = NL + "        if(needInitialization_";
  protected final String TEXT_51 = ") {";
  protected final String TEXT_52 = NL + "                needInitialization_";
  protected final String TEXT_53 = " = false;";
  protected final String TEXT_54 = NL + "            sbValue_";
  protected final String TEXT_55 = " = new java.lang.StringBuilder(insertPrefix_";
  protected final String TEXT_56 = ");" + NL + "        }" + NL + "        sbValue_";
  protected final String TEXT_57 = ".append(\"(\");";
  protected final String TEXT_58 = NL + "                    if(true) {" + NL + "                        throw new java.lang.Exception(\"The component tImpalaOutput does not the support the type ";
  protected final String TEXT_59 = ".\");" + NL + "                    }";
  protected final String TEXT_60 = NL + "                    if(";
  protected final String TEXT_61 = ".";
  protected final String TEXT_62 = "==null) {" + NL + "                        sbValue_";
  protected final String TEXT_63 = ".append(\"";
  protected final String TEXT_64 = "null\");" + NL + "                    } else {";
  protected final String TEXT_65 = NL + "                    sbValue_";
  protected final String TEXT_66 = ".append(\"";
  protected final String TEXT_67 = "'\" + ";
  protected final String TEXT_68 = ".";
  protected final String TEXT_69 = ".replaceAll(\"\\'\", \"\\\\\\\\'\") + \"'\");";
  protected final String TEXT_70 = NL + "\t\t\t\t\tsbValue_";
  protected final String TEXT_71 = ".append(\"";
  protected final String TEXT_72 = "'\" + ";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = " + \"'\");";
  protected final String TEXT_75 = NL + "                    sbValue_";
  protected final String TEXT_76 = ".append(\"";
  protected final String TEXT_77 = "'\" + FormatterUtils.format_Date(";
  protected final String TEXT_78 = ".";
  protected final String TEXT_79 = ", \"yyyy-MM-dd\") + \"'\");";
  protected final String TEXT_80 = NL + "                    sbValue_";
  protected final String TEXT_81 = ".append(\"";
  protected final String TEXT_82 = "\" + ";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = ");";
  protected final String TEXT_85 = NL + "                    }";
  protected final String TEXT_86 = NL + "        sbValue_";
  protected final String TEXT_87 = ".append(\")\");" + NL + "        rowCount";
  protected final String TEXT_88 = "++;" + NL + "\t\ttry {" + NL + "\t\t\tnb_line_";
  protected final String TEXT_89 = "++;";
  protected final String TEXT_90 = NL + "                if(rowCount";
  protected final String TEXT_91 = " == ";
  protected final String TEXT_92 = ") {";
  protected final String TEXT_93 = NL + "\t\t\tstmt_";
  protected final String TEXT_94 = ".executeUpdate(sbValue_";
  protected final String TEXT_95 = ".toString());" + NL + "\t\t\tinsertPrefix_";
  protected final String TEXT_96 = " = insertPrefix_";
  protected final String TEXT_97 = ".replace(\"INSERT OVERWRITE\", \"INSERT INTO\");" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "                    rowCount";
  protected final String TEXT_99 = " = 0;" + NL + "                    needInitialization_";
  protected final String TEXT_100 = " = true;" + NL + "                } else {" + NL + "                    sbValue_";
  protected final String TEXT_101 = ".append(\",\");                    " + NL + "                }";
  protected final String TEXT_102 = NL + "\t\t} catch(java.lang.Exception e) {";
  protected final String TEXT_103 = NL + "\t\t\t\tthrow e;";
  protected final String TEXT_104 = NL + "\t\t\t\tSystem.err.print(\"Exception in the component ";
