...
public class TJavaDBOutputBeginJava {
  ...
  protected final String TEXT_57 = " " + NL + "" + NL + "String jdbcDriver_";
  protected final String TEXT_58 = " = null;" + NL + "String url_";
  protected final String TEXT_59 = " = null;";
  protected final String TEXT_60 = NL + "\tjdbcDriver_";
  protected final String TEXT_61 = " = \"org.apache.derby.jdbc.EmbeddedDriver\";" + NL + "\turl_";
  protected final String TEXT_62 = " = \"jdbc:derby:\" + ";
  protected final String TEXT_63 = ";" + NL + "\t//set the root path of the database" + NL + "\tSystem.setProperty(\"derby.system.home\",";
  protected final String TEXT_64 = ");" + NL + "\t";
  protected final String TEXT_65 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_66 = " = \"com.ibm.db2.jcc.DB2Driver\";" + NL + "\t\turl_";
  protected final String TEXT_67 = " = \"jdbc:derby:net://\" + ";
  protected final String TEXT_68 = " + \":\" + ";
  protected final String TEXT_69 = " + \"/\" + ";
  protected final String TEXT_70 = ";" + NL + "\t\t";
  protected final String TEXT_71 = NL + "\t\tjdbcDriver_";
  protected final String TEXT_72 = " = \"org.apache.derby.jdbc.ClientDriver\";" + NL + "\t\turl_";
  protected final String TEXT_73 = " = \"jdbc:derby://\" + ";
  protected final String TEXT_74 = " + \":\" + ";
  protected final String TEXT_75 = " + \"/\" + ";
  protected final String TEXT_76 = ";" + NL + "\t\t";
  protected final String TEXT_77 = NL + "\t";
  protected final String TEXT_78 = NL + "    \torg.apache.derby.drda.NetworkServerControl serverControl_";
  protected final String TEXT_79 = ";" + NL + "    \tserverControl_";
  protected final String TEXT_80 = " = new org.apache.derby.drda.NetworkServerControl(java.net.InetAddress.getByName(";
  protected final String TEXT_81 = "),Integer.parseInt(";
  protected final String TEXT_82 = "));" + NL + "    \t//start server" + NL + "    \tserverControl_";
  protected final String TEXT_83 = ".start(new java.io.PrintWriter(System.out,true));" + NL + "    \tboolean isServerUp_";
  protected final String TEXT_84 = " = false;" + NL + "    \tint timeOut_";
  protected final String TEXT_85 = " = 5;" + NL + "    \twhile(!isServerUp_";
  protected final String TEXT_86 = " && timeOut_";
  protected final String TEXT_87 = " > 0) {" + NL + "    \t\ttry {" + NL + "    \t\t\ttimeOut_";
  protected final String TEXT_88 = "--;" + NL + "    \t\t\t/*" + NL + "    \t\t\t* testing for connection to see if the network server is up and running." + NL + "    \t\t\t* if server is not ready yet, this method will throw an exception.\t\t" + NL + "    \t\t\t*/" + NL + "    \t\t\tserverControl_";
  protected final String TEXT_89 = ".ping();" + NL + "    \t\t\tisServerUp_";
  protected final String TEXT_90 = " = true;" + NL + "    \t\t} catch(java.lang.Exception e) {" + NL + "    \t\t\t//Unable to obtain a connection to network server, trying again after 3000 ms." + NL + "    \t\t\tThread.currentThread().sleep(3000);" + NL + "    \t\t}    \t\t\t\t" + NL + "    \t}" + NL + "    \tif(!isServerUp_";
  protected final String TEXT_91 = ") {" + NL + "    \t\t/*" + NL + "    \t\t * can not obtain a connection to network server." + NL + "    \t\t */ \t " + NL + "    \t\tthrow new java.lang.Exception(\"Can not obtain a connection to network server\");" + NL + "    \t}" + NL + "    \t//derby network server started." + NL + "\t";
  protected final String TEXT_92 = NL + NL + "int nb_line_";
  protected final String TEXT_93 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_94 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_95 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_96 = " = 0;" + NL + "int nb_line_rejected_";
  protected final String TEXT_97 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_98 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_99 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_100 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_101 = " = ";
  protected final String TEXT_102 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_103 = " = false;" + NL + "" + NL + "Class.forName(jdbcDriver_";
  protected final String TEXT_104 = ").newInstance();";
  protected final String TEXT_105 = NL + "java.util.Properties properties_";
  protected final String TEXT_106 = " = new java.util.Properties();" + NL + "properties_";
  protected final String TEXT_107 = ".put(\"user\",";
  ...
  protected final String TEXT_116 = NL + "  " + NL + "" + NL + "properties_";
  protected final String TEXT_117 = ".put(\"password\",decryptedPassword_";
  ...
  protected final String TEXT_123 = NL + "resourceMap.put(\"conn_";
  protected final String TEXT_124 = "\", conn_";
  protected final String TEXT_125 = ");" + NL;
  protected final String TEXT_126 = NL + "                conn_";
  protected final String TEXT_127 = ".setAutoCommit(false);";
  ...
  protected final String TEXT_155 = ".getString(\"TABLE_NAME\");" + NL + "                if(table_";
  protected final String TEXT_156 = ".equalsIgnoreCase(";
  protected final String TEXT_157 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_158 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_168 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();";
  protected final String TEXT_171 = NL + "                    stmtDrop_";
  ...
  protected final String TEXT_190 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_191 = " + \"\\\" (";
  protected final String TEXT_192 = ") VALUES (";
  ...
  protected final String TEXT_197 = NL + "\t    String update_";
  protected final String TEXT_198 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_199 = " + \"\\\" SET ";
  protected final String TEXT_200 = " WHERE ";
  protected final String TEXT_201 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".prepareStatement(update_";
  ...
  protected final String TEXT_209 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_210 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_211 = " + \"\\\" (";
  protected final String TEXT_212 = ") VALUES (";
  protected final String TEXT_213 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_214 = " = conn_";
  protected final String TEXT_215 = ".prepareStatement(insert_";
  protected final String TEXT_216 = ");" + NL + "\t    String update_";
  protected final String TEXT_217 = " = \"UPDATE \\\"\" + ";
  ...
  protected final String TEXT_222 = ".prepareStatement(update_";
  protected final String TEXT_223 = ");" + NL + "\t    ";
  protected final String TEXT_224 = NL + "\t    String update_";
  protected final String TEXT_225 = " = \"UPDATE \\\"\" + ";
  ...
  protected final String TEXT_230 = ".prepareStatement(update_";
  protected final String TEXT_231 = ");" + NL + "\t    String insert_";
  protected final String TEXT_232 = " = \"INSERT INTO \\\"\" + ";
  protected final String TEXT_233 = " + \"\\\" (";
  protected final String TEXT_234 = ") VALUES (";
  protected final String TEXT_235 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_236 = " = conn_";
  protected final String TEXT_237 = ".prepareStatement(insert_";
  protected final String TEXT_238 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_239 = NL + "\t    String delete_";
  protected final String TEXT_240 = " = \"DELETE  FROM \\\"\" + ";
  protected final String TEXT_241 = " + \"\\\" WHERE ";
  protected final String TEXT_242 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_243 = " = conn_";
  protected final String TEXT_244 = ".prepareStatement(delete_";
  protected final String TEXT_245 = ");" + NL + "\t    ";
  protected final String TEXT_246 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_255 = NL + "\t\t\tupdate_";
  protected final String TEXT_256 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_257 = " = update_";
  protected final String TEXT_258 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_259 = " = insert_";
  protected final String TEXT_260 = ".split(\"\\\\?\");";
  protected final String TEXT_261 = NL + "\t\t\tdelete_";
  protected final String TEXT_262 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_263 = " = delete_";
  protected final String TEXT_264 = ".split(\"\\\\?\");";
  protected final String TEXT_265 = NL + "\t\t\treplace_";
  protected final String TEXT_266 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_267 = " = replace_";
  protected final String TEXT_268 = ".split(\"\\\\?\");";
  protected final String TEXT_269 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_270 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_271 = " = insertIgnore_";
  protected final String TEXT_272 = ".split(\"\\\\?\");";
  protected final String TEXT_273 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_274 = " = insert_";
  protected final String TEXT_275 = ".split(\"\\\\?\");";
  protected final String TEXT_276 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_277 = " = ";
  protected final String TEXT_278 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_279 = " = 0;" + NL + "        ";
