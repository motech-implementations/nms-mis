...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_141 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_142 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  ...
  protected final String TEXT_149 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_152 = ".get(dsAlias_";
  protected final String TEXT_153 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_154 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_155 = " = dataSources_";
  protected final String TEXT_156 = ".get(dsAlias_";
  protected final String TEXT_157 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_158 = "\", conn_";
  protected final String TEXT_159 = ");" + NL + "\t}";
  protected final String TEXT_160 = NL + "\tif (null != conn_";
  protected final String TEXT_161 = ") {" + NL + "\t\t";
  protected final String TEXT_162 = NL + "\t}";
  protected final String TEXT_163 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
