...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_56 = "=0;" + NL + "String dbschema_";
  protected final String TEXT_57 = " = null;" + NL + "String tableName_";
  protected final String TEXT_58 = " = null;" + NL + "boolean whetherReject_";
  protected final String TEXT_59 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_60 = " = java.util.Calendar.getInstance();" + NL + "long year1_";
  protected final String TEXT_61 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"0001-01-01\").getTime();" + NL + "long year2_";
  protected final String TEXT_62 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"1753-01-01\").getTime();" + NL + "long year10000_";
  protected final String TEXT_63 = " = TalendDate.parseDate(\"yyyy-MM-dd HH:mm:ss\",\"9999-12-31 24:00:00\").getTime();" + NL + "long date_";
  protected final String TEXT_64 = ";" + NL + "" + NL + "java.util.Calendar calendar_datetimeoffset_";
  protected final String TEXT_65 = " = java.util.Calendar.getInstance(java.util.TimeZone.getTimeZone(\"UTC\"));" + NL;
  protected final String TEXT_66 = NL;
  protected final String TEXT_67 = NL + "        int updateKeyCount_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_70 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_71 = NL + "        int deleteKeyCount_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_74 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_75 = NL + "        int insertKeyCount_";
  protected final String TEXT_76 = " = ";
  protected final String TEXT_77 = ";" + NL + "        if(insertKeyCount_";
  protected final String TEXT_78 = " < 1) {" + NL + "            throw new RuntimeException(\"For insert if not exist, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_87 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_88 = "\");" + NL + "\t";
  protected final String TEXT_89 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_90 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  ...
  protected final String TEXT_104 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_105 = NL + "    String driverClass_";
  protected final String TEXT_106 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_107 = NL + "\t";
  protected final String TEXT_108 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_109 = ");" + NL + "    String port_";
  protected final String TEXT_110 = " = ";
  protected final String TEXT_111 = ";" + NL + "    String dbname_";
  protected final String TEXT_112 = " = ";
  protected final String TEXT_113 = " ;";
  protected final String TEXT_114 = NL + "    String url_";
  protected final String TEXT_115 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_116 = " ;";
  protected final String TEXT_117 = NL + "    String url_";
  protected final String TEXT_118 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_119 = " ;";
  protected final String TEXT_120 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_121 = ")) {" + NL + "    \turl_";
  protected final String TEXT_122 = " += \":\" + ";
  protected final String TEXT_123 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_124 = ")) {";
  protected final String TEXT_125 = NL + "\t\t\t\turl_";
  protected final String TEXT_126 = " += \"//\" + ";
  protected final String TEXT_127 = "; " + NL + "\t";
  protected final String TEXT_128 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_129 = " += \";databaseName=\" + ";
  protected final String TEXT_130 = "; " + NL + "\t";
  protected final String TEXT_131 = NL + "    }" + NL + "    url_";
  protected final String TEXT_132 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_133 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_143 = NL + NL + "    String dbPwd_";
  protected final String TEXT_144 = " = decryptedPassword_";
  protected final String TEXT_145 = ";";
  protected final String TEXT_146 = "\t" + NL + "    conn_";
  protected final String TEXT_147 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_148 = ",dbUser_";
  protected final String TEXT_149 = ",dbPwd_";
  protected final String TEXT_150 = ");";
  protected final String TEXT_151 = NL + "\t";
  protected final String TEXT_152 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_153 = NL + "\t\tresourceMap.put(\"conn_";
  protected final String TEXT_154 = "\", conn_";
  protected final String TEXT_155 = ");" + NL + "\t";
  protected final String TEXT_156 = NL + "        conn_";
  protected final String TEXT_157 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_158 = " = ";
  protected final String TEXT_159 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_160 = " = 0;" + NL;
  protected final String TEXT_161 = NL + "   int batchSize_";
  protected final String TEXT_162 = " = ";
  protected final String TEXT_163 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_164 = "=0;";
  protected final String TEXT_165 = NL + NL + "if(dbschema_";
  protected final String TEXT_166 = " == null || dbschema_";
  protected final String TEXT_167 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_168 = " = ";
  protected final String TEXT_169 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_170 = " = dbschema_";
  protected final String TEXT_171 = " + \"].[\" + ";
  protected final String TEXT_172 = ";" + NL + "}";
  protected final String TEXT_173 = NL + "\tint count_";
  protected final String TEXT_174 = "=0;" + NL;
  protected final String TEXT_175 = NL + "            java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_186 = ".close();" + NL + "            java.sql.Statement stmtCreate_";
  protected final String TEXT_187 = " = conn_";
  protected final String TEXT_188 = ".createStatement();";
  protected final String TEXT_189 = NL + "                              stmtCreate_";
  protected final String TEXT_190 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_243 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_246 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  ...
  protected final String TEXT_250 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_255 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_256 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_257 = " = tableNameForSearch_";
  protected final String TEXT_258 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_259 = " = tableNameForSearch_";
  protected final String TEXT_260 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_288 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_306 = ".toUpperCase()";
  protected final String TEXT_307 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_312 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_313 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_322 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_323 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_324 = " == null || dbschema_";
  protected final String TEXT_325 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_326 = " = conn_";
  protected final String TEXT_327 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_328 = " = stmtSchema_";
  protected final String TEXT_329 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_330 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_331 = " = rsSchema_";
  protected final String TEXT_332 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_333 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_334 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_335 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_336 = " = rsTable_";
  protected final String TEXT_337 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_338 = " = rsTable_";
  protected final String TEXT_339 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_340 = ".equals";
  protected final String TEXT_341 = "IgnoreCase";
  protected final String TEXT_342 = "(";
  protected final String TEXT_343 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_348 = " ==null || dbschema_";
  protected final String TEXT_349 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_350 = ".equals";
  protected final String TEXT_351 = "IgnoreCase";
  protected final String TEXT_352 = "(schema_";
  ...
  protected final String TEXT_356 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_359 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_360 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_361 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_362 = " =  tableForSearch_";
  protected final String TEXT_363 = ".substring(1,tableForSearch_";
  protected final String TEXT_364 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_365 = " =  tableForSearch_";
  protected final String TEXT_366 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_367 = " = conn_";
  protected final String TEXT_368 = ".getMetaData();" + NL + "\t\t\t\t                java.sql.ResultSet rsTable_";
  protected final String TEXT_369 = " = dbMetaData_";
  protected final String TEXT_370 = ".getTables(null, conn_";
  protected final String TEXT_371 = ".getSchema(), tableForSearch_";
  protected final String TEXT_372 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_373 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_374 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_375 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  protected final String TEXT_376 = ".close();" + NL + "\t\t\t\t            ";
  protected final String TEXT_377 = NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_378 = " = conn_";
  protected final String TEXT_379 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_380 = " = dbMetaData_";
  protected final String TEXT_381 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_382 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_383 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_384 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_385 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_391 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_392 = " = dbMetaData_";
  protected final String TEXT_393 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_394 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_402 = NL + "                                if(!whetherExist_";
  protected final String TEXT_403 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_411 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_412 = ".";
  protected final String TEXT_413 = ", \"";
  protected final String TEXT_414 = "\")";
  protected final String TEXT_415 = ".toUpperCase()";
  ...
  protected final String TEXT_423 = NL + "                                if(whetherExist_";
  protected final String TEXT_424 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_456 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_457 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_461 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_471 = NL + "                              stmtTruncCount_";
  protected final String TEXT_472 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_473 = "));";
  protected final String TEXT_474 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_475 = " = stmtTruncCount_";
  protected final String TEXT_476 = ".executeQuery(\"";
  protected final String TEXT_477 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_478 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_479 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_480 = " = rsTruncCount_";
  protected final String TEXT_481 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_482 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_483 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_499 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_500 = ".close();";
  protected final String TEXT_501 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_502 = " = conn_";
  protected final String TEXT_503 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_504 = " = stmtTruncCount_";
  protected final String TEXT_505 = ".executeQuery(\"";
  protected final String TEXT_506 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_507 = " = conn_";
  protected final String TEXT_508 = ".createStatement();";
  protected final String TEXT_509 = NL + "                conn_";
  protected final String TEXT_510 = ".commit();";
  protected final String TEXT_511 = NL + "            stmtTrunc_";
  ...
  protected final String TEXT_520 = ".close();";
  ...
  protected final String TEXT_526 = NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_532 = " = null;" + NL + "\t\tString keyPsmt_";
  protected final String TEXT_533 = " = conn_";
  protected final String TEXT_534 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_535 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_536 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_537 = ",insert_";
  protected final String TEXT_538 = ",keyPsmt_";
  ...
  protected final String TEXT_546 = ".prepareStatement(update_";
  protected final String TEXT_547 = ");";
  protected final String TEXT_548 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_549 = " = conn_";
  protected final String TEXT_550 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_551 = " + \"] WHERE ";
  protected final String TEXT_552 = "\");" + NL + "        String insert_";
  protected final String TEXT_553 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_554 = " + \"] (";
  protected final String TEXT_555 = ") VALUES (";
  protected final String TEXT_556 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_562 = " WHERE ";
  protected final String TEXT_563 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_571 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_578 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_579 = " = conn_";
  protected final String TEXT_580 = ".prepareStatement(insert_";
  protected final String TEXT_581 = ");";
  protected final String TEXT_582 = NL + "        String delete_";
  protected final String TEXT_583 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_587 = ".prepareStatement(delete_";
  protected final String TEXT_588 = ");";
  protected final String TEXT_589 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_590 = " = conn_";
  protected final String TEXT_591 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_601 = NL + NL + "    class BufferLine_";
  protected final String TEXT_602 = " {";
  protected final String TEXT_603 = NL + "                ";
  protected final String TEXT_604 = " ";
  protected final String TEXT_605 = ";";
  protected final String TEXT_606 = NL + NL + "        public BufferLine_";
  protected final String TEXT_607 = "(";
  protected final String TEXT_608 = NL + "                    ,";
  protected final String TEXT_609 = NL + "                ";
  protected final String TEXT_610 = " ";
  protected final String TEXT_611 = NL + "        ){";
  protected final String TEXT_612 = NL + "                    this.";
  protected final String TEXT_613 = " = ";
  protected final String TEXT_614 = ";";
  protected final String TEXT_615 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_616 = "> sInsertColValueList";
  protected final String TEXT_617 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_618 = " sInsertColValue";
  protected final String TEXT_619 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_620 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_621 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_622 = ".append(\"(";
  protected final String TEXT_623 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_624 = "-1) extendInsertValueStmt_";
  protected final String TEXT_625 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_626 = " = \"INSERT INTO \"+";
  protected final String TEXT_627 = "+\" (";
  protected final String TEXT_628 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_629 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_630 = " =  conn_";
  protected final String TEXT_631 = ".prepareStatement(insert_";
  protected final String TEXT_632 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_633 = " = \"";
  protected final String TEXT_634 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_635 = " =  \"";
  protected final String TEXT_636 = "\";" + NL + "    int rowCount";
  protected final String TEXT_637 = " = 0;";
  protected final String TEXT_638 = NL + "        StringBuffer query_";
  protected final String TEXT_639 = " = null;" + NL + "       \t";
  protected final String TEXT_640 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_641 = " = insert_";
  protected final String TEXT_642 = ".split(\"\\\\?\");";
  protected final String TEXT_643 = NL + "\t\t\tupdate_";
  protected final String TEXT_644 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_645 = " = update_";
  protected final String TEXT_646 = ".split(\"\\\\?\");";
  protected final String TEXT_647 = NL + "\t\t\tupdate_";
  protected final String TEXT_648 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_649 = " = update_";
  protected final String TEXT_650 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_651 = " = insert_";
  protected final String TEXT_652 = ".split(\"\\\\?\");";
  protected final String TEXT_653 = NL + "\t\t\tdelete_";
  protected final String TEXT_654 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_655 = " = delete_";
  protected final String TEXT_656 = ".split(\"\\\\?\");";
  protected final String TEXT_657 = NL + "\t\t\treplace_";
  protected final String TEXT_658 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_659 = " = replace_";
  protected final String TEXT_660 = ".split(\"\\\\?\");";
  protected final String TEXT_661 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_662 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_663 = " = insertIgnore_";
  protected final String TEXT_664 = ".split(\"\\\\?\");";
  protected final String TEXT_665 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_666 = " = insert_";
  protected final String TEXT_667 = ".split(\"\\\\?\");";
  protected final String TEXT_668 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_669 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_670 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_671 = "\") == true;";
  protected final String TEXT_672 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_673 = " = conn_";
  protected final String TEXT_674 = ".createStatement();";
  protected final String TEXT_675 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_676 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_677 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_678 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_679 = NL + "     \t\tstmt_";
  protected final String TEXT_680 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_681 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_682 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_683 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_684 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_685 = " =null;" + NL + "\t";
  protected final String TEXT_686 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_687 = " = null;" + NL + "\t\t";
  protected final String TEXT_688 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_689 = " = null;";
  protected final String TEXT_690 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_691 = " =  null;";
  protected final String TEXT_692 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_693 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_694 = " = null;";
  protected final String TEXT_695 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_696 = " = null;";
  protected final String TEXT_697 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_698 = " = null;";
  protected final String TEXT_699 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_700 = " = null;";
  protected final String TEXT_701 = NL + "\t\t \tString[] insertSQLSplits_";
