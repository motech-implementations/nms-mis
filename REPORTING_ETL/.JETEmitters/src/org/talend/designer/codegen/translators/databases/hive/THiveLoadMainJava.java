...
public class THiveLoadMainJava
{
  ...
  protected final String TEXT_628 = NL + "            java.sql.Statement setCompression_";
  protected final String TEXT_629 = " = conn_";
  protected final String TEXT_630 = ".createStatement();" + NL + "            try {" + NL + "                setCompression_";
  protected final String TEXT_631 = ".execute(\"SET parquet.compression=";
  protected final String TEXT_632 = "\");" + NL + "            } finally {" + NL + "                setCompression_";
  protected final String TEXT_633 = ".close();" + NL + "            }";
  protected final String TEXT_634 = NL + "            bw_";
  protected final String TEXT_635 = ".write(\"SET parquet.compression=";
  protected final String TEXT_636 = ";\");";
  protected final String TEXT_637 = NL + "\t\tString path_";
  ...
  protected final String TEXT_646 = NL + "\t\t\tString tablename_";
  protected final String TEXT_647 = " = ";
  protected final String TEXT_648 = ";";
  protected final String TEXT_649 = NL + "\t\t\t\tString partition_";
  protected final String TEXT_650 = " = ";
  protected final String TEXT_651 = ";";
  protected final String TEXT_652 = NL + "\t\t\tString path_";
  protected final String TEXT_653 = " = ";
  protected final String TEXT_654 = ";";
  protected final String TEXT_655 = NL + "\t\tString query_";
  protected final String TEXT_656 = " = ";
  protected final String TEXT_657 = ";";
  protected final String TEXT_658 = NL + NL + "\tString querySQL_";
  protected final String TEXT_659 = " = \"";
  protected final String TEXT_660 = "\";";
  protected final String TEXT_661 = NL + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_662 = " = conn_";
  protected final String TEXT_663 = ".createStatement();" + NL + "" + NL + "        try {" + NL + "            stmt_";
  protected final String TEXT_664 = ".execute(querySQL_";
  protected final String TEXT_665 = ");" + NL + "        } catch(java.sql.SQLException e_";
  protected final String TEXT_666 = ") {";
  protected final String TEXT_667 = NL + "                throw(e_";
  protected final String TEXT_668 = ");";
  protected final String TEXT_669 = NL + "                System.err.println(e_";
  protected final String TEXT_670 = ".getMessage());";
  protected final String TEXT_671 = NL + "        }" + NL + "        stmt_";
  protected final String TEXT_672 = ".close();";
  protected final String TEXT_673 = NL + "            conn_";
  protected final String TEXT_674 = ".close();";
  protected final String TEXT_675 = NL + "        globalMap.put(\"";
  protected final String TEXT_676 = "_QUERY\", querySQL_";
  protected final String TEXT_677 = ");" + NL + "" + NL + "        String currentClientPathSeparator_";
  protected final String TEXT_678 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "        if(currentClientPathSeparator_";
  protected final String TEXT_679 = "!=null) {" + NL + "            System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_680 = ");" + NL + "            globalMap.put(\"current_client_path_separator\", null);" + NL + "        }" + NL + "" + NL + "        String currentClientUsername_";
  protected final String TEXT_681 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "        if(currentClientUsername_";
  protected final String TEXT_682 = "!=null) {" + NL + "            System.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_683 = ");" + NL + "            globalMap.put(\"current_client_user_name\", null);" + NL + "        }" + NL + "" + NL + "        String originalHadoopUsername_";
  protected final String TEXT_684 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_685 = "\");" + NL + "        if(originalHadoopUsername_";
  protected final String TEXT_686 = "!=null) {" + NL + "            System.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_687 = ");" + NL + "            globalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_688 = "\", null);" + NL + "        } else {" + NL + "            System.clearProperty(\"HADOOP_USER_NAME\");" + NL + "        }";
  protected final String TEXT_689 = NL + "        bw_";
  protected final String TEXT_690 = ".write(querySQL_";
  protected final String TEXT_691 = " + \";\");" + NL + "        globalMap.put(\"";
  protected final String TEXT_692 = "_QUERY\", querySQL_";
  protected final String TEXT_693 = ");" + NL + "" + NL + "        bw_";
  protected final String TEXT_694 = ".close();" + NL + "" + NL + "        if(libjars_";
  protected final String TEXT_695 = ".length() > 0) {" + NL + "            instance_";
  protected final String TEXT_696 = ".setLibJars(libjars_";
  protected final String TEXT_697 = ".toString().substring(0, libjars_";
  protected final String TEXT_698 = ".length()-1));" + NL + "        }" + NL + "        instance_";
  protected final String TEXT_699 = ".callWS(instance_";
  protected final String TEXT_700 = ".sendFiles());" + NL + "        int exitCode_";
  protected final String TEXT_701 = " = instance_";
  protected final String TEXT_702 = ".execute();" + NL + "        if(exitCode_";
  protected final String TEXT_703 = " > 0) {" + NL;
  protected final String TEXT_704 = NL + "                throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_705 = NL + "                System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_706 = NL + "                    log.error(\"";
  protected final String TEXT_707 = " - The Hive job failed. Please read the logs for more details\");";
