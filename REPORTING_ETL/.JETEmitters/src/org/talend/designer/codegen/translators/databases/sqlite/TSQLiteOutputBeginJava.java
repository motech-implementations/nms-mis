...
public class TSQLiteOutputBeginJava {
  ...
  protected final String TEXT_81 = NL + "    java.lang.Class.forName(\"";
  protected final String TEXT_82 = "\");" + NL + "    String url_";
  protected final String TEXT_83 = " = \"jdbc:sqlite:\"+ \"/\" + ";
  ...
  protected final String TEXT_88 = NL + "\tresourceMap.put(\"conn_";
  protected final String TEXT_89 = "\", conn_";
  protected final String TEXT_90 = ");";
  protected final String TEXT_91 = NL + "        conn_";
  protected final String TEXT_92 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_93 = " = ";
  protected final String TEXT_94 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_95 = " = 0;";
  protected final String TEXT_96 = NL;
  protected final String TEXT_97 = NL + "            java.sql.Statement stmtDrop_";
  protected final String TEXT_98 = " = conn_";
  protected final String TEXT_99 = ".createStatement();" + NL + "            \t";
  ...
  protected final String TEXT_131 = ".createStatement();" + NL + "                    \t";
  ...
  protected final String TEXT_143 = NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_152 = NL + "            deletedCount_";
  protected final String TEXT_153 = " = deletedCount_";
  protected final String TEXT_154 = " + stmtClear_";
  ...
  protected final String TEXT_161 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_171 = ".prepareStatement(update_";
  protected final String TEXT_172 = ");" + NL + "\t    ";
  protected final String TEXT_173 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_174 = " = conn_";
  protected final String TEXT_175 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  ...
  protected final String TEXT_188 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_207 = NL + "\t    String delete_";
  protected final String TEXT_208 = " = \"DELETE FROM \\\"\" + ";
  protected final String TEXT_209 = " + \"\\\" WHERE ";
  protected final String TEXT_210 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".prepareStatement(delete_";
  protected final String TEXT_213 = ");" + NL + "\t    ";
  protected final String TEXT_214 = NL + "        StringBuffer query_";
  protected final String TEXT_215 = " = null;" + NL + "       \t";
  protected final String TEXT_216 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_217 = " = insert_";
  ...
  protected final String TEXT_226 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_227 = " = insert_";
  protected final String TEXT_228 = ".split(\"\\\\?\");";
  protected final String TEXT_229 = NL + "\t\t\tdelete_";
  protected final String TEXT_230 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_231 = " = delete_";
  protected final String TEXT_232 = ".split(\"\\\\?\");";
  protected final String TEXT_233 = NL + "\t\t\treplace_";
  protected final String TEXT_234 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_235 = " = replace_";
  protected final String TEXT_236 = ".split(\"\\\\?\");";
  protected final String TEXT_237 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_238 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_239 = " = insertIgnore_";
  protected final String TEXT_240 = ".split(\"\\\\?\");";
  protected final String TEXT_241 = NL + "\t\t \tString[] insertSQLSplits_";
