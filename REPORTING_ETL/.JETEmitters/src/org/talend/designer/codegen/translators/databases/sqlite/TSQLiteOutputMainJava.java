...
public class TSQLiteOutputMainJava {
  ...
  protected final String TEXT_111 = "_QUERY\", query_";
  protected final String TEXT_112 = ".toString().trim());";
  protected final String TEXT_113 = NL;
  protected final String TEXT_114 = NL + "                       pstmt_";
  protected final String TEXT_115 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_116 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_117 = "++;";
  protected final String TEXT_118 = NL + "                        try {" + NL + "                            updatedCount_";
  protected final String TEXT_119 = " = updatedCount_";
  protected final String TEXT_120 = " + pstmt_";
  protected final String TEXT_121 = ".executeUpdate();" + NL + "                            nb_line_";
  protected final String TEXT_122 = "++;";
  protected final String TEXT_123 = NL + "                        } catch(java.lang.Exception e) {" + NL + "                            whetherReject_";
  ...
  protected final String TEXT_134 = NL + "                                    nb_line_rejected_";
  protected final String TEXT_135 = "++;";
  protected final String TEXT_136 = NL + "                                    ";
  protected final String TEXT_137 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_148 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_149 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_150 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_151 = " = rs_";
  protected final String TEXT_152 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_170 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_222 = NL + "                            nb_line_rejected_";
  protected final String TEXT_223 = "++;";
  protected final String TEXT_224 = NL + "                            ";
  protected final String TEXT_225 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_226 = NL + "                            ";
  protected final String TEXT_227 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_228 = ";";
  protected final String TEXT_229 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_230 = NL + "                }" + NL + "            }";
  protected final String TEXT_231 = NL + "            int updateFlag_";
  protected final String TEXT_232 = "=0;";
  ...
  protected final String TEXT_249 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_250 = "=pstmtUpdate_";
  protected final String TEXT_251 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_252 = " = updatedCount_";
  protected final String TEXT_253 = " + updateFlag_";
  protected final String TEXT_254 = ";" + NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_265 = NL + "                        nb_line_rejected_";
  protected final String TEXT_266 = "++;";
  protected final String TEXT_267 = NL + "                        ";
  protected final String TEXT_268 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_269 = NL + "                        ";
  protected final String TEXT_270 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_271 = ";";
  protected final String TEXT_272 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_273 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_282 = "_QUERY\", query_";
  protected final String TEXT_283 = ".toString().trim());";
  protected final String TEXT_284 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_285 = " = insertedCount_";
  protected final String TEXT_286 = " + pstmtInsert_";
  protected final String TEXT_287 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_288 = "++;";
  protected final String TEXT_289 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_296 = "Struct();";
  ...
  protected final String TEXT_305 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_306 = NL + "                            ";
  protected final String TEXT_307 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_308 = ";";
  protected final String TEXT_309 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_310 = NL + "                }" + NL + "            }else{" + NL + "            \tnb_line_";
  ...
  protected final String TEXT_323 = "_QUERY\", query_";
  protected final String TEXT_324 = ".toString().trim());";
  protected final String TEXT_325 = NL + "                     pstmt_";
  protected final String TEXT_326 = ".addBatch();" + NL + "                     batchSizeCounter_";
  protected final String TEXT_327 = "++;" + NL + "                     nb_line_";
  protected final String TEXT_328 = "++;";
  protected final String TEXT_329 = NL + "                      try {" + NL + "                          deletedCount_";
  protected final String TEXT_330 = " = deletedCount_";
  protected final String TEXT_331 = " + pstmt_";
  protected final String TEXT_332 = ".executeUpdate();" + NL + "                          nb_line_";
  protected final String TEXT_333 = "++;";
  protected final String TEXT_334 = NL + "                      } catch(java.lang.Exception e) {" + NL + "                          whetherReject_";
  protected final String TEXT_335 = " = true;";
  protected final String TEXT_336 = NL + "                              throw(e);";
  ...
  protected final String TEXT_347 = NL + "                                  nb_line_rejected_";
  protected final String TEXT_348 = "++;";
  protected final String TEXT_349 = NL + "                                  ";
  protected final String TEXT_350 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_351 = NL + "                                  ";
  protected final String TEXT_352 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_353 = ";";
  protected final String TEXT_354 = NL + "                                  System.err.print(e.getMessage());";
  protected final String TEXT_355 = NL + "                      }";
  protected final String TEXT_356 = NL + "            if(!whetherReject_";
  protected final String TEXT_357 = ") {";
  protected final String TEXT_358 = NL + "                            ";
  protected final String TEXT_359 = " = new ";
  protected final String TEXT_360 = "Struct();";
  ...
  protected final String TEXT_367 = NL + "                if ((batchSize_";
  protected final String TEXT_368 = " > 0) && (batchSize_";
  protected final String TEXT_369 = " <= batchSizeCounter_";
  protected final String TEXT_370 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_371 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_372 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_373 = " = 0;";
  protected final String TEXT_374 = NL + "                        status_";
  protected final String TEXT_375 = " = pstmt_";
  protected final String TEXT_376 = ".executeBatch();";
  protected final String TEXT_377 = NL + "                        for(int countEach_";
  protected final String TEXT_378 = ": status_";
  protected final String TEXT_379 = ") {" + NL + "                            countSum_";
  protected final String TEXT_380 = " += (countEach_";
  protected final String TEXT_381 = " < 0 ? 0 : countEach_";
  protected final String TEXT_382 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_383 = NL + "                            throw(e);";
  protected final String TEXT_384 = NL + "                        for(int countEach_";
  protected final String TEXT_385 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_386 = " += (countEach_";
  protected final String TEXT_387 = " < 0 ? 0 : countEach_";
  protected final String TEXT_388 = ");" + NL + "                        }";
  protected final String TEXT_389 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_390 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_391 = " = pstmt_";
  protected final String TEXT_392 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_393 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_394 = " = tmp_batchUpdateCount_";
  protected final String TEXT_395 = " > countSum_";
  protected final String TEXT_396 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_397 = " : countSum_";
  protected final String TEXT_398 = ";";
  protected final String TEXT_399 = NL + "                        insertedCount_";
  protected final String TEXT_400 = " += tmp_batchUpdateCount_";
  protected final String TEXT_401 = ";";
  protected final String TEXT_402 = NL + "                        updatedCount_";
  protected final String TEXT_403 = " += tmp_batchUpdateCount_";
  protected final String TEXT_404 = ";";
  protected final String TEXT_405 = NL + "                        deletedCount_";
  protected final String TEXT_406 = " += tmp_batchUpdateCount_";
  protected final String TEXT_407 = ";";
  protected final String TEXT_408 = NL + "               }";
  protected final String TEXT_409 = NL + "                commitCounter_";
  protected final String TEXT_410 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_411 = " <= commitCounter_";
  protected final String TEXT_412 = ") {";
  protected final String TEXT_413 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_414 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_415 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_416 = NL + "\t                    for(int countEach_";
  protected final String TEXT_417 = ": pstmt_";
  protected final String TEXT_418 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_419 = " += (countEach_";
  protected final String TEXT_420 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_432 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_433 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_434 = NL + "                        throw(e);";
  protected final String TEXT_435 = NL + "                        int countSum_";
  protected final String TEXT_436 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_437 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_438 = " += (countEach_";
  protected final String TEXT_439 = " < 0 ? 0 : countEach_";
  protected final String TEXT_440 = ");" + NL + "                        }";
  protected final String TEXT_441 = NL + "                            insertedCount_";
  protected final String TEXT_442 = " += countSum_";
  protected final String TEXT_443 = ";";
  protected final String TEXT_444 = NL + "                            updatedCount_";
  protected final String TEXT_445 = " += countSum_";
  protected final String TEXT_446 = ";";
  protected final String TEXT_447 = NL + "                            deletedCount_";
  protected final String TEXT_448 = " += countSum_";
  ...
  protected final String TEXT_454 = ".commit();";
  protected final String TEXT_455 = NL + "                commitCounter_";
