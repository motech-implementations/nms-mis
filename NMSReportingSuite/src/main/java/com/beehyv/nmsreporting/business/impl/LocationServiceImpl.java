...
//    }
    ...
    @Override
    public List<HealthSubFacility> getChildSubcenters(Integer blockId) {
        return healthSubFacilityDao.getSubcentersOfBlock(blockDao.findByblockId(blockId).getBlockId());
    }
