    ...
    public AggregateKilkariRepeatListenerMonthWiseDto getKilkariRepeatListenerMonthWiseReport(ReportRequest reportRequest){
        ...
        if(!(kilkariRepeatListenerMonthWiseList.isEmpty())){
            for(int i = 0; i < kilkariRepeatListenerMonthWiseList.size(); i++){
                ...
                kilkariRepeatListenerMonthWisePercentDto.setFiveCallsAnsweredPercent(kilkariRepeatListenerMonthWiseDto.getFiveCallsAnswered() == 0 ? 0 : Math.round((((float)kilkariRepeatListenerMonthWiseDto.getFiveCallsAnswered()/(float)kilkariRepeatListenerMonthWiseDto.getTotal())*100)*1000.0)/1000.0);
                kilkariRepeatListenerMonthWisePercentDto.setFourCallsAnsweredPercent(kilkariRepeatListenerMonthWiseDto.getFourCallsAnswered() == 0 ? 0 :  Math.round((((float)kilkariRepeatListenerMonthWiseDto.getFourCallsAnswered()/(float)kilkariRepeatListenerMonthWiseDto.getTotal())*100)*1000.0)/1000.0);
                kilkariRepeatListenerMonthWisePercentDto.setThreeCallsAnsweredPercent(kilkariRepeatListenerMonthWiseDto.getThreeCallsAnswered() == 0 ? 0 :  Math.round((((float)kilkariRepeatListenerMonthWiseDto.getThreeCallsAnswered()/(float)kilkariRepeatListenerMonthWiseDto.getTotal())*100)*1000.0)/1000.0);
                kilkariRepeatListenerMonthWisePercentDto.setTwoCallsAnsweredPercent(kilkariRepeatListenerMonthWiseDto.getTwoCallsAnswered() == 0 ? 0 :  Math.round((((float)kilkariRepeatListenerMonthWiseDto.getTwoCallsAnswered()/(float)kilkariRepeatListenerMonthWiseDto.getTotal())*100)*1000.0)/1000.0);
