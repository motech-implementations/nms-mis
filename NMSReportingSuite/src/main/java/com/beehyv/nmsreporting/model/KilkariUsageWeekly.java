...
@Entity
@Table(name="agg_kilkari_usage_week")
public class KilkariUsageWeekly {
    ...
    public KilkariUsageWeekly(Integer id, String locationType, Long locationId, Date date, Long calls_75_100, Long calls_50_75, Long calls_25_50, Long calls_1_25, Long calledInbox) {
        this.id = id;
