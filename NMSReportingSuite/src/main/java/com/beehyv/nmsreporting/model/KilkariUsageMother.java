 ...
 */
@Entity
@Table(name="agg_kilkari_usage_mother")
public class KilkariUsageMother {
    ...
    public KilkariUsageMother(Integer id, String locationType, Long locationId, Date date, Long calls_75_100, Long calls_50_75, Long calls_25_50, Long calls_1_25, Long calledInbox, Long answeredAtleastOneCall, Long totalBeneficiariesCalled, String periodType) {
        this.id = id;
