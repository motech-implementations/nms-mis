...
@Entity
@Table(name="agg_kilkari_listening_matrix_week")
public class ListeningMatrixWeek {
    ...
    public ListeningMatrixWeek() {
    }

    public ListeningMatrixWeek(Integer id, String locationType, Long locationId, Date date, String calls_listened_percentage, Long contentListened_morethan75, Long contentListened_50_75, Long contentListened_25_50, Long contentListened_lessthan25) {
        this.id = id;
