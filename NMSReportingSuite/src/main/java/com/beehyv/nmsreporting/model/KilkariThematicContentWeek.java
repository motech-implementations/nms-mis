...
@Entity
@Table(name="agg_kilkari_thematic_content_week")
public class KilkariThematicContentWeek {
    ...
    public KilkariThematicContentWeek(){

    }

    public KilkariThematicContentWeek(Integer id, Date date, String messageWeekNumber, Long uniqueBeneficiariesCalled, Long callsAnswered, Double minutesConsumed){
        this.id = id;
        this.date = date;
