...
@Entity
@Table(name="agg_aggregate_beneficiaries_week")
public class AggregateCumulativeBeneficiaryWeek {
    ...
    public AggregateCumulativeBeneficiaryWeek(Integer id, String locationType, Long locationId, Date date, Long selfDeactivated, Long notAnswering, Long lowListenership, Long systemDeactivation, Long motherCompletion, Long childCompletion, Long joinedSubscription) {
        this.id = id;
    ...
    public AggregateCumulativeBeneficiaryWeek(){
