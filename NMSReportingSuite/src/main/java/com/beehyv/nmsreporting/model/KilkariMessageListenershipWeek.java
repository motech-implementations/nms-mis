...
@Entity
@Table(name="agg_kilkari_message_listenership_week")

public class KilkariMessageListenershipWeek {
    ...
    public KilkariMessageListenershipWeek(Integer id, String locationType, Long locationId, Date date, Long answeredAtleastOneCall, Long answered1To25Per, Long answered25To50Per, Long answered50To75Per, Long answeredMoreThan75Per, Long answeredNoCalls, Long totalBeneficiariesCalled){
        this.id = id;
    ...
    public KilkariMessageListenershipWeek(){
