...
public class Reports {
    public static String pageContent ="<div  class=\"container-fluid\" data-ng-controller=\"ReportsController\">\n" +
            ...
            "\n" +
            "\t\t\t\t\t\t<div class=\"form-group col-xs-2\" data-ng-hide = \"report.name == 'Mobile Academy Performance Report' || report.reportEnum == 'Kilkari_Cumulative_Summary'\">\n" +
            ...
            "\t\t\t\t\t\t</div>\n" +
            "\n" +
            "\t\t\t\t\t\t<div class=\"form-group col-xs-2\" data-ng-hide = \" periodDisplayType == '' || (report.name == 'Mobile Academy Performance Report' ||  report.reportEnum == 'Kilkari_Cumulative_Summary' || periodDisplayType == 'Current Period' ) \">\n" +
            ...
            "\t\t\t\t\t\t</div>\n" +
            "\n" +
            "\t\t\t\t\t\t<div class=\"form-group col-xs-2\" data-ng-hide = \" (report.name != 'Mobile Academy Performance Report' &&  report.reportEnum != 'Kilkari_Cumulative_Summary' && periodDisplayType != 'Custom Range')\">\n" +
            ...
            "\t\t\t<p class=\"ng-binding\" style=\"display: inline-block;\"> {{reportHeaderName == \"Mobile Academy Performance Report\" || reportHeaderName == \"Kilkari Performance Report\" ? reportHeaderName : reportHeaderName + ' Report'}} </p>\n" +
