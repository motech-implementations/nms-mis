	...
	var nmsReportsApp = angular
		...
		nmsReportsApp.controller("faqController", ['$scope', '$state', function($scope, $state){
            ...
            switch($state.current.name){
                case "faq.faqGeneralInfo":$scope.active1 = 'faq-general';break;
                case "faq.faqLoginInfo":$scope.active1 = 'faq-login';break;
                case "faq.faqReportsInfo":$scope.active1 = 'faq-reports';break;
                case "faq.faqLineListingInfo":$scope.active1 = 'faq-line-listing';break;
                case "faq.faqAggregateInfo":$scope.active1 = 'faq-aggregate';break;
                default :$scope.active1 = 'faq-general';break;
            }
