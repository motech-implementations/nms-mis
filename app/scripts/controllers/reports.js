...
//					$scope.clearBlock();
            ...
            $scope.Kilkari_Beneficiary_Completion_Definitions = [
                                                     ...
                                                     { field: 'calls_25_50', name: 'Beneficiaries who have listened greater than or equal to 50% and less than  75% content (consolidated)',cellFilter: 'indianFilter',footerCellFilter: 'indianFilter',  aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false },
            ...
            $scope.Kilkari_Message_Listenership_Definitions = [
                                                     ...
                                                     { field: 'beneficiariesAnswered25To50', name: 'Beneficiaries who have answered greater than or equal to 25% to les than 50% calls', cellFilter: 'indianFilter',footerCellFilter: 'indianFilter', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false },
