...
//					$scope.clearBlock();
            ...
            $scope.Kilkari_Subscriber_Definitions = [
                                                     ...
                                                     { field: 'totalRecordsRejected', name: 'Total beneficiary records rejected due to wrong/duplicate mobile numbers',  aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"14%", enableHiding: false},
