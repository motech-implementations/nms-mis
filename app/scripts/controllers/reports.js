            ...
            .then(function(result){
				...
				.then(function(result){
					...
					if($scope.isAggregateReport()){
					    ...
					    if($scope.report.reportEnum == 'Mobile Academy Performance Report'){
                        ...
                        else if($scope.report.reportEnum == 'Kilkari Performance Report'){
...
//                                    responseType: 'arraybuffer',
            ...
            $scope.Kilkari_Subscriber_with_RegistrationDate_Definitions = [
                                                     ...
                                                     { field: 'totalSubscriberCount_PW', displayName: 'Records received for PW', cellFilter: 'indianFilter',footerCellFilter: 'indianFilter', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false },
                                                     { field: 'totalSubscriberCount_Child', displayName: 'Records received for Child', cellFilter: 'indianFilter',footerCellFilter: 'indianFilter', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false },
                                                     { field: 'totalSubscriberCount_Ineligible', displayName: 'Ineligible (LMP date > registration date)', cellFilter: 'indianFilter',footerCellFilter: 'indianFilter', aggregationType: uiGridConstants.aggregationTypes.sum, aggregationHideLabel: true, width:"*", enableHiding: false },
