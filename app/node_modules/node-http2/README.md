...
```javascript
require('http2').get('https://192.168.200.112:8080/', function(response) {
...
```bash
$ node ./example/client.js 'https://192.168.200.112:8080/server.js' >/tmp/server.js
```
...
```bash
$ HTTP2_LOG=info node ./example/client.js 'https://192.168.200.112:8080/server.js' >/dev/null
```
