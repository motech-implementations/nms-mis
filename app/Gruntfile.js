  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      dist1: {
        ...
        'scripts/controllers/staticPages.js','scripts/controllers/userManagement.js','scripts/controllers/userManual.js', 'scripts/directives/pagination.js','scripts/controllers/userTable.js','scripts/controllers/pageRequest.js'],
        dest: 'dist/app1.js'
      },
      dist2: {
